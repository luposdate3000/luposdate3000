...
project.buildDir = file("build-jvm-commonS00ResultFlowGenerateTestsMain-commonS00ExecutionParallelMain-commonS01BufferDiskbasedMain-jvmS12DummyMain-commonS14NoneMain")
dependencies {
