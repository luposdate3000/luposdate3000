...
project.buildDir = file("build-jvm-commonS00ResultFlowExecuteTestsMain-commonS00ExecutionSequentialMain-commonS00TraceOffMain-commonS01BufferMainmemoryMain-jvmS12DummyMain-jvmS14KorioMain-commonS15LocalMain")
dependencies {
