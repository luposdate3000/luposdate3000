...
project.buildDir = file("build-jvm-commonS00ResultFlowFastMain-commonS00ExecutionParallelMain-commonS01BufferDiskbasedMain-commonS03DictionaryIntArrayMain-jvmS12DummyMain-commonS14NoneMain-commonS15LocalMain")
dependencies {
