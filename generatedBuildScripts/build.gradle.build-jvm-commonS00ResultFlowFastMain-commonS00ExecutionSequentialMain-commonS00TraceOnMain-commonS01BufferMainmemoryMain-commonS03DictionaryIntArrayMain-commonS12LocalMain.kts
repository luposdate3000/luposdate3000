...
project.buildDir = file("build-jvm-commonS00ResultFlowFastMain-commonS00ExecutionSequentialMain-commonS00TraceOnMain-commonS01BufferMainmemoryMain-commonS03DictionaryIntArrayMain-commonS12LocalMain")
dependencies {
