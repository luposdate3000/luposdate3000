...
project.buildDir = file("build-jvm-commonS00ResultFlowExecuteTestsMain-commonS00ExecutionParallelMain-commonS01BufferDiskbasedMain-jvmS12DummyMain-commonS14NoneMain-commonS15DistributedMain")
dependencies {
