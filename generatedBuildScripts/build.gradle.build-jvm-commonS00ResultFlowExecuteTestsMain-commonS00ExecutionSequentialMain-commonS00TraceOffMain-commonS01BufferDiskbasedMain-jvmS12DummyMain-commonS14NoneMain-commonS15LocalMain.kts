...
project.buildDir = file("build-jvm-commonS00ResultFlowExecuteTestsMain-commonS00ExecutionSequentialMain-commonS00TraceOffMain-commonS01BufferDiskbasedMain-jvmS12DummyMain-commonS14NoneMain-commonS15LocalMain")
dependencies {
