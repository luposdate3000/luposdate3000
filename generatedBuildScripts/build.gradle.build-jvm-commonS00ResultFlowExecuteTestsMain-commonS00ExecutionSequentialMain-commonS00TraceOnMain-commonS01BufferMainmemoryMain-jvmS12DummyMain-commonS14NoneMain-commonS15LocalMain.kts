...
project.buildDir = file("build-jvm-commonS00ResultFlowExecuteTestsMain-commonS00ExecutionSequentialMain-commonS00TraceOnMain-commonS01BufferMainmemoryMain-jvmS12DummyMain-commonS14NoneMain-commonS15LocalMain")
dependencies {
