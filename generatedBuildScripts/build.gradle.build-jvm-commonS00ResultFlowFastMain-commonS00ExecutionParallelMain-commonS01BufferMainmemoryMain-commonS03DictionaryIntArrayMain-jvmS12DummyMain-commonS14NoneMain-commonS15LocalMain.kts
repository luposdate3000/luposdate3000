...
project.buildDir = file("build-jvm-commonS00ResultFlowFastMain-commonS00ExecutionParallelMain-commonS01BufferMainmemoryMain-commonS03DictionaryIntArrayMain-jvmS12DummyMain-commonS14NoneMain-commonS15LocalMain")
dependencies {
...
sourceSets["main"].java.srcDir("src/commonS14NoneMain/kotlin")
