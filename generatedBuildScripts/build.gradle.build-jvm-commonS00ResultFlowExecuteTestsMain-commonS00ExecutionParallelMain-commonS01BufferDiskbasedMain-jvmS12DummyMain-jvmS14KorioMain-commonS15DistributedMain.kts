...
project.buildDir = file("build-jvm-commonS00ResultFlowExecuteTestsMain-commonS00ExecutionParallelMain-commonS01BufferDiskbasedMain-jvmS12DummyMain-jvmS14KorioMain-commonS15DistributedMain")
dependencies {
