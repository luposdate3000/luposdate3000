...
project.buildDir = file("build-jvm-commonS00ResultFlowFastMain-commonS00ExecutionParallelMain-commonS01BufferDiskbasedMain-commonS03DictionaryIntArrayMain-commonS12LocalMain")
dependencies {
