...
project.buildDir = file("build-jvm-commonS00ResultFlowGenerateTestsMain-commonS00ExecutionSequentialMain-commonS00TraceOnMain-commonS01BufferDiskbasedMain-jvmS12DummyMain-jvmS14KorioMain")
dependencies {
