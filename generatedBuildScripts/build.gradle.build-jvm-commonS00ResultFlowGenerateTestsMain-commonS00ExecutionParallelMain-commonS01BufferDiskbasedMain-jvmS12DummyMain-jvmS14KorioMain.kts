...
project.buildDir = file("build-jvm-commonS00ResultFlowGenerateTestsMain-commonS00ExecutionParallelMain-commonS01BufferDiskbasedMain-jvmS12DummyMain-jvmS14KorioMain")
dependencies {
