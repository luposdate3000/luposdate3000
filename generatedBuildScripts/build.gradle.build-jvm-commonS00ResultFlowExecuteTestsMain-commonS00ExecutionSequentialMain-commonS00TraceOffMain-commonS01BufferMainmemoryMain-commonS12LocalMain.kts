...
project.buildDir = file("build-jvm-commonS00ResultFlowExecuteTestsMain-commonS00ExecutionSequentialMain-commonS00TraceOffMain-commonS01BufferMainmemoryMain-commonS12LocalMain")
dependencies {
