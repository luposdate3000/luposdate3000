...
project.buildDir = file("build-jvm-commonS00ResultFlowGenerateTestsMain-commonS00ExecutionSequentialMain-commonS00TraceOffMain-commonS01BufferMainmemoryMain-jvmS12DummyMain-commonS14NoneMain")
dependencies {
