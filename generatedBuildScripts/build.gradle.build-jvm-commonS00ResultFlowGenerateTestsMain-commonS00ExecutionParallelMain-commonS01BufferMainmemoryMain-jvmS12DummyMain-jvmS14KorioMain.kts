...
project.buildDir = file("build-jvm-commonS00ResultFlowGenerateTestsMain-commonS00ExecutionParallelMain-commonS01BufferMainmemoryMain-jvmS12DummyMain-jvmS14KorioMain")
dependencies {
