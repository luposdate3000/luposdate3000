...
project.buildDir = file("build-jvm-commonS00ResultFlowFastMain-commonS00ExecutionSequentialMain-commonS00TraceOnMain-commonS01BufferDiskbasedMain-commonS03DictionaryIntArrayMain-jvmS12DummyMain-jvmS14KorioMain-commonS15LocalMain")
dependencies {
