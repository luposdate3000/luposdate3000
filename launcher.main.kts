...
fun onGenerateEnums() {
    val turtleGeneratingArgs = arrayOf(
        ...
        listOf("EVariablePlaceholder", "lupos.code_generator_shared", "internal", "src/luposdate3000_code_generator_shared/src/jvmMain/kotlin/lupos/code_generator_shared/EVariablePlaceholder")
        )
