...
./tool-gradle-build.sh
kotlinc -script generate-buildfile.kts jvm commonS00LaunchBinaryTestsMain commonS00ExecutionParallelMain commonS01BufferMainmemoryMain commonS12LocalMain commonS14ClientNoneMain
./tool-gradle-build.sh
