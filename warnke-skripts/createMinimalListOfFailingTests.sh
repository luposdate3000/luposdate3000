...
then
grep -v -F -f resources/tests/timeout x > tmp/x ; mv tmp/x x
fi
...
then
grep -v -F -f resources/tests/failed x > tmp/x ; mv tmp/x x
fi
...
then
  grep -v -F -f resources/tests/passed x > tmp/x ; mv tmp/x x
fi
...
grep -v -F -f resources/tests/failed resources/tests/passed > tmp/x
mv tmp/x resources/tests/passed
grep -v -F -f resources/tests/timeout resources/tests/passed > tmp/x
mv tmp/x resources/tests/passed
