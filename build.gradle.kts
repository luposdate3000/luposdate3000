...
project.buildDir = file("build/build_jvm_S00LaunchEndpoint_S00SanityChecksOff_S00ExecutionSequential_S00TraceOn_S01Heap_S03DictionaryIntArray_S12Dummy_jvmS14ServerKorio_S14ClientNone_S15Distributed")
dependencies {
