...
project.buildDir = file("build/build_jvm_S00LaunchEndpoint_S00SanityChecksOff_S00ExecutionSequential_S01Heap_S05SingleList_S12Dummy_jvmS14ServerKorio_S14ClientNone_S15Local_S00WrapperJenaOff")
dependencies {
