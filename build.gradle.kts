...
project.buildDir = file("build/build_jvm_S00LaunchSparqlTestSuite_S00SanityChecksOn_S00ExecutionSequential_S01Heap_S05SingleList_S12Dummy_S14ServerNone_jvmS14ClientKtorTarget_S15Local_jvmS00WrapperJenaOn")
dependencies {
