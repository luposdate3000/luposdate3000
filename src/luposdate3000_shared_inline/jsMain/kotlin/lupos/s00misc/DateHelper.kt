...
internal actual class DateHelper {
    ...
    actual inline fun hours(): Int = throw  NotImplementedException("DateHelper", "hours not implemented")
    actual inline fun minutes(): Int = throw  NotImplementedException("DateHelper", "minutes not implemented")
    actual inline fun seconds(): Int = throw  NotImplementedException("DateHelper", "seconds not implemented")
}
