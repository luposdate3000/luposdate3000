...
this.filename=filename
    ...
    inline actual fun myPrintWriter() :IPrintWriter = throw  NotImplementedException("File", "myPrintWriter not implemented")
    inline actual fun printWriter(crossinline action: (IPrintWriter) -> Unit) :Unit = throw  NotImplementedException("File", "printWriter not implemented")
    inline suspend actual fun printWriterSuspended(crossinline action: suspend (IPrintWriter) -> Unit) :Unit = throw  NotImplementedException("File", "printWriterSuspended not implemented")
    ...
    inline actual fun dataOutputStream(crossinline action: (IDataOutputStream) -> Unit) :Unit = throw  NotImplementedException("File", "dataOutputStream not implemented")
    inline actual fun dataOutputStreamSuspend(crossinline action: (IDataOutputStream) -> Unit):Unit = throw  NotImplementedException("File", "dataOutputStreamSuspend not implemented")
    inline actual fun dataInputStream(crossinline action: (IDataInputStream) -> Unit) :Unit = throw  NotImplementedException("File", "dataInputStream not implemented")
    suspend inline actual fun dataInputStreamSuspended(crossinline action: suspend (IDataInputStream) -> Unit) :Unit = throw  NotImplementedException("File", "dataInputStreamSuspended not implemented")
