...
public class bind10BINDscopingVariableinfilternotinscope {
    ...
    @Ignore
    @Test(timeout = 2000)
    public fun `bind10  BIND scoping  Variable in filter not in scope - in simulator - PartitionByID_1_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Ignore
    @Test(timeout = 2000)
    public fun `bind10  BIND scoping  Variable in filter not in scope - in simulator - PartitionByID_2_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Ignore
    @Test(timeout = 2000)
    public fun `bind10  BIND scoping  Variable in filter not in scope - in simulator - PartitionByID_O_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Ignore
    @Test(timeout = 2000)
    public fun `bind10  BIND scoping  Variable in filter not in scope - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Ignore
    @Test(timeout = 2000)
    public fun `bind10  BIND scoping  Variable in filter not in scope - in simulator - PartitionByID_1_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Ignore
    @Test(timeout = 2000)
    public fun `bind10  BIND scoping  Variable in filter not in scope - in simulator - PartitionByID_2_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Ignore
    @Test(timeout = 2000)
    public fun `bind10  BIND scoping  Variable in filter not in scope - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
