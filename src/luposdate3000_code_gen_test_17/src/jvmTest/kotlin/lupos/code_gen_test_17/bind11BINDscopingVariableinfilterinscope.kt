...
public class bind11BINDscopingVariableinfilterinscope {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/bind11BINDscopingVariableinfilterinscope.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/bind11BINDscopingVariableinfilterinscope.input",
    )
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_1_AllCollations - Centralized - false - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_1_AllCollations - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_1_AllCollations - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_2_AllCollations - Centralized - false - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_2_AllCollations - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_2_AllCollations - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_O_AllCollations - Centralized - false - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_O_AllCollations - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_O_AllCollations - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByKeyAllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByKeyAllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByKeyAllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByKeyAllCollations - Centralized - false - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByKeyAllCollations - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - PartitionByKeyAllCollations - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - Simple - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - Simple - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - Simple - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - Simple - Centralized - false - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - Simple - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `bind11  BIND scoping  Variable in filter in scope - in simulator - Simple - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
