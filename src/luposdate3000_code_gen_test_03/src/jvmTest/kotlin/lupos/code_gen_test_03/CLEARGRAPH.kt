...
public class CLEARGRAPH {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/CLEARGRAPH.input").readAsString(),
        File("src/jvmTest/resources/CLEARGRAPH.input1").readAsString(),
        File("src/jvmTest/resources/CLEARGRAPH.input2").readAsString(),
    )
    ...
    internal val outputData = arrayOf(
        File("src/jvmTest/resources/CLEARGRAPH.output0").readAsString(),
        File("src/jvmTest/resources/CLEARGRAPH.output1").readAsString(),
        File("src/jvmTest/resources/CLEARGRAPH.output2").readAsString(),
    )
