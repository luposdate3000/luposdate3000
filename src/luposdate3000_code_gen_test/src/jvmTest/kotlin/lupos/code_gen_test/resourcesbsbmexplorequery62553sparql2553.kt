...
public class resourcesbsbmexplorequery62553sparql2553 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmexplorequery62553sparql2553.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmexplorequery62553sparql2553 - in simulator`() {
