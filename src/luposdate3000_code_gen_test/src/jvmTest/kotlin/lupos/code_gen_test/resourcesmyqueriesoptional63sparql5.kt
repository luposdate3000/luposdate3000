...
public class resourcesmyqueriesoptional63sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional63sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional63sparql5 - in simulator`() {
