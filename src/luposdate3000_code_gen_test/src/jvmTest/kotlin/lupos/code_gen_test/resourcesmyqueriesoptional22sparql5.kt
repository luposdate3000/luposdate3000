...
public class resourcesmyqueriesoptional22sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional22sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional22sparql5 - in simulator`() {
