...
public class resourcesmyqueriesoptional56sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional56sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional56sparql5 - in simulator`() {
