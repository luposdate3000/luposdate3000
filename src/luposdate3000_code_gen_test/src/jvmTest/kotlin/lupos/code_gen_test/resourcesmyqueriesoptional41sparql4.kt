...
public class resourcesmyqueriesoptional41sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional41sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional41sparql4 - in simulator`() {
