...
public class resourcesmyqueriesoptional37sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional37sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional37sparql5 - in simulator`() {
