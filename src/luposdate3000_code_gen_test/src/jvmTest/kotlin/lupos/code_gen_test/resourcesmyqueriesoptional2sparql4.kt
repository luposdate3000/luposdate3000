...
public class resourcesmyqueriesoptional2sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional2sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional2sparql4 - in simulator`() {
