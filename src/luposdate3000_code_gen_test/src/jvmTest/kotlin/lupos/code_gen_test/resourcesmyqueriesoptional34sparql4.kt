...
public class resourcesmyqueriesoptional34sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional34sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator`() {
