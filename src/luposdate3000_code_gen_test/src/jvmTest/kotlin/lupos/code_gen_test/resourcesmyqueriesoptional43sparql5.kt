...
public class resourcesmyqueriesoptional43sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional43sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional43sparql5 - in simulator`() {
