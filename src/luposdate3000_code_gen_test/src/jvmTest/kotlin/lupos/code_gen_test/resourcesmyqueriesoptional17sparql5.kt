...
public class resourcesmyqueriesoptional17sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional17sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional17sparql5 - in simulator`() {
