...
public class SubtractionwithMINUSfromafullyboundminuend {
    ...
    internal val query = File("src/jvmTest/resources/SubtractionwithMINUSfromafullyboundminuend.query").readAsString()
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Subtraction with MINUS from a fully bound minuend - in simulator`() {
