...
public class resourcesmyqueriesoptional58sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional58sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional58sparql5 - in simulator`() {
