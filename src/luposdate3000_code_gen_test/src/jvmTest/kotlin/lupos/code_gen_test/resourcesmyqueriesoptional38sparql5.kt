...
public class resourcesmyqueriesoptional38sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional38sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional38sparql5 - in simulator`() {
