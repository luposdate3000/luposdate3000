...
public class resourcesmyqueriesoptional40sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional40sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional40sparql4 - in simulator`() {
