...
public class resourcesmyqueriesoptional51sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional51sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional51sparql5 - in simulator`() {
