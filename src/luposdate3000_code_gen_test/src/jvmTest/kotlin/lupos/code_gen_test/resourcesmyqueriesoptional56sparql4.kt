...
public class resourcesmyqueriesoptional56sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional56sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional56sparql4 - in simulator`() {
