...
public class resourcesmyqueriesoptional3sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional3sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional3sparql5 - in simulator`() {
