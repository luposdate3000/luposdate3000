...
public class resourcesbsbmbiquery61853sparql1853 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmbiquery61853sparql1853.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery61853sparql1853 - in simulator`() {
