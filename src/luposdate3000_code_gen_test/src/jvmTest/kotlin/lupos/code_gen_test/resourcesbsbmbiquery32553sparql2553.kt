...
public class resourcesbsbmbiquery32553sparql2553 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmbiquery32553sparql2553.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery32553sparql2553 - in simulator`() {
