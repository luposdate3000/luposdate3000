...
public class resourcesmyqueriesoptional6sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional6sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional6sparql4 - in simulator`() {
