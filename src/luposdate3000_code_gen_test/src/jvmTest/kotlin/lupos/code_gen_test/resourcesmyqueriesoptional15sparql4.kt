...
public class resourcesmyqueriesoptional15sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional15sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional15sparql4 - in simulator`() {
