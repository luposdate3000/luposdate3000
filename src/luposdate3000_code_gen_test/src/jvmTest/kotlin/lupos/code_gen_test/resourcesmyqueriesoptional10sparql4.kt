...
public class resourcesmyqueriesoptional10sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional10sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional10sparql4 - in simulator`() {
