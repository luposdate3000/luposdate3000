...
public class resourcesmyqueriesoptional49sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional49sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional49sparql5 - in simulator`() {
