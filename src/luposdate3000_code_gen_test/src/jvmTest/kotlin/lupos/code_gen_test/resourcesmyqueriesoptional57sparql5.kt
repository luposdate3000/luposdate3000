...
public class resourcesmyqueriesoptional57sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional57sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional57sparql5 - in simulator`() {
