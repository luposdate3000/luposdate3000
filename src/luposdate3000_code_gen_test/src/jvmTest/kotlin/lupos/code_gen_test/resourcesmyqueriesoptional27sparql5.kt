...
public class resourcesmyqueriesoptional27sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional27sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional27sparql5 - in simulator`() {
