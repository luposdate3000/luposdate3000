...
public class pp16Duplicatepathsandcyclesthroughfoafknows {
    ...
    internal val query = File("src/jvmTest/resources/pp16Duplicatepathsandcyclesthroughfoafknows.query").readAsString()
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `pp16 Duplicate paths and cycles through foafknows - in simulator`() {
