...
public class resourcesmyqueriesoptional48sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional48sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional48sparql5 - in simulator`() {
