...
public class resourcesmyqueriesoptional35sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional35sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional35sparql4 - in simulator`() {
