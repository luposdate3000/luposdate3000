...
public class resourcesmyqueriesoptional46sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional46sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional46sparql5 - in simulator`() {
