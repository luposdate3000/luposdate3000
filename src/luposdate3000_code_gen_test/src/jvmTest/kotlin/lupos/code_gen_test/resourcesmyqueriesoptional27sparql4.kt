...
public class resourcesmyqueriesoptional27sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional27sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional27sparql4 - in simulator`() {
