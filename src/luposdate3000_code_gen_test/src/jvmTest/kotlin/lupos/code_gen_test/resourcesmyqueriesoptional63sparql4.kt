...
public class resourcesmyqueriesoptional63sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional63sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional63sparql4 - in simulator`() {
