...
public class resourcesbsbmbiquery32210sparql2210 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmbiquery32210sparql2210.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery32210sparql2210 - in simulator`() {
