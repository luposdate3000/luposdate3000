...
public class resourcesmyqueriesoptional37sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional37sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional37sparql4 - in simulator`() {
