...
public class resourcesmyqueriesoptional50sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional50sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional50sparql5 - in simulator`() {
