...
public class resourcesmyqueriesoptional8sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional8sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional8sparql5 - in simulator`() {
