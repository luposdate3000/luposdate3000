...
public class resourcesmyqueriesoptional42sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional42sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional42sparql4 - in simulator`() {
