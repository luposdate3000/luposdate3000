...
public class constructwhere01CONSTRUCTWHERE {
    ...
    internal val query = File("src/jvmTest/resources/constructwhere01CONSTRUCTWHERE.query").readAsString()

    @Test
    fun `constructwhere01  CONSTRUCT WHERE`() {
    ...
    @Test
    fun `constructwhere01  CONSTRUCT WHERE - in simulator`() {
