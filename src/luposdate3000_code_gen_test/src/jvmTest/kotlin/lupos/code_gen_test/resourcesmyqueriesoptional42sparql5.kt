...
public class resourcesmyqueriesoptional42sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional42sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional42sparql5 - in simulator`() {
