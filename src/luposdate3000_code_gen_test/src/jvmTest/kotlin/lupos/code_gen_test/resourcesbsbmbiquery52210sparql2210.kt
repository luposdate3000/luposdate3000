...
public class resourcesbsbmbiquery52210sparql2210 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmbiquery52210sparql2210.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmbiquery52210sparql2210 - in simulator`() {
