...
public class resourcesmyqueriesoptional12sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional12sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional12sparql5 - in simulator`() {
