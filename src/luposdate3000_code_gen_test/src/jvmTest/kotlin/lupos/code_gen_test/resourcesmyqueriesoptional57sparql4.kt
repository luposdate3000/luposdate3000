...
public class resourcesmyqueriesoptional57sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional57sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional57sparql4 - in simulator`() {
