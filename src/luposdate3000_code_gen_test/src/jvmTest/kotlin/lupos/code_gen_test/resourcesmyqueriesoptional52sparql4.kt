...
public class resourcesmyqueriesoptional52sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional52sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional52sparql4 - in simulator`() {
