...
public class resourcesmyqueriesoptional47sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional47sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional47sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional47sparql4 - in simulator`() {
