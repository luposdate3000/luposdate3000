...
public class resourcesmyqueriesoptional29sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional29sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional29sparql5 - in simulator`() {
