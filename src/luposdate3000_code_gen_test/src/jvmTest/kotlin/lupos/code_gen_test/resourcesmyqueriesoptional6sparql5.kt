...
public class resourcesmyqueriesoptional6sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional6sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional6sparql5 - in simulator`() {
