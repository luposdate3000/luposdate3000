...
public class resourcesmyqueriesoptional24sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional24sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional24sparql5 - in simulator`() {
