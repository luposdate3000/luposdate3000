...
public class resourcesmyqueriesoptional44sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional44sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional44sparql4 - in simulator`() {
