...
public class resourcesmyqueriesoptional3sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional3sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional3sparql4 - in simulator`() {
