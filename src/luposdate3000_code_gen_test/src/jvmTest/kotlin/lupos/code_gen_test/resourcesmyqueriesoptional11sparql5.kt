...
public class resourcesmyqueriesoptional11sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional11sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional11sparql5 - in simulator`() {
