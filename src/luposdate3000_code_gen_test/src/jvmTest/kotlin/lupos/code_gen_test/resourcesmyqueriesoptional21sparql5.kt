...
public class resourcesmyqueriesoptional21sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional21sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional21sparql5 - in simulator`() {
