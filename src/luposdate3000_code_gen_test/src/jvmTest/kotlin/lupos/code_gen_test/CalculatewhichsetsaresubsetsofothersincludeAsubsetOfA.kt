...
public class CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA {
    ...
    internal val query = File("src/jvmTest/resources/CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA.query").readAsString()
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Calculate which sets are subsets of others include A subsetOf A - in simulator`() {
