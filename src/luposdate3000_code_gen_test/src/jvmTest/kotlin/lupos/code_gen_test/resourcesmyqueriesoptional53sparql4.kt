...
public class resourcesmyqueriesoptional53sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional53sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional53sparql4 - in simulator`() {
