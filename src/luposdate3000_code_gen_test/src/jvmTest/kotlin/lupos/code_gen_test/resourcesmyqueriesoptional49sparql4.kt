...
public class resourcesmyqueriesoptional49sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional49sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional49sparql4 - in simulator`() {
