...
public class resourcesmyqueriesoptional51sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional51sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional51sparql4 - in simulator`() {
