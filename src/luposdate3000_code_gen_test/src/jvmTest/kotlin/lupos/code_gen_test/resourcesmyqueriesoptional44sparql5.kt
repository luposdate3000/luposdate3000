...
public class resourcesmyqueriesoptional44sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional44sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional44sparql5 - in simulator`() {
