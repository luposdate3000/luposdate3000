...
public class resourcesmyqueriesoptional1sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional1sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional1sparql4 - in simulator`() {
