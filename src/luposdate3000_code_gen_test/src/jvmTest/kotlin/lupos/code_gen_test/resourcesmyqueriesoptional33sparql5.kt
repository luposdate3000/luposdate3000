...
public class resourcesmyqueriesoptional33sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional33sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional33sparql5 - in simulator`() {
