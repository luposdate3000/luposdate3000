...
public class resourcesmyqueriesoptional39sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional39sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional39sparql5 - in simulator`() {
