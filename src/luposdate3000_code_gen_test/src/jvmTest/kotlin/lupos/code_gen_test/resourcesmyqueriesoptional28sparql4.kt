...
public class resourcesmyqueriesoptional28sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional28sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional28sparql4 - in simulator`() {
