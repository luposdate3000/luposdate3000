...
public class resourcesmyqueriesoptional20sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional20sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional20sparql5 - in simulator`() {
