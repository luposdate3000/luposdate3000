...
public class resourcesmyqueriesoptional26sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional26sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional26sparql4 - in simulator`() {
