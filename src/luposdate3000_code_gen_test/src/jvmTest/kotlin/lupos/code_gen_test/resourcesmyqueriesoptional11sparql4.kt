...
public class resourcesmyqueriesoptional11sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional11sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional11sparql4 - in simulator`() {
