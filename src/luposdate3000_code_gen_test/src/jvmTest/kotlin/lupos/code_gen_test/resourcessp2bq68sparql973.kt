...
public class resourcessp2bq68sparql973 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq68sparql973.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq68sparql973`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq68sparql973 - in simulator`() {
