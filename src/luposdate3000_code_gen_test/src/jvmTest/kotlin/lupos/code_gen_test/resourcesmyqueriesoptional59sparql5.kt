...
public class resourcesmyqueriesoptional59sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional59sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional59sparql5 - in simulator`() {
