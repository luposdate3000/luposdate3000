...
public class resourcesmyqueriesoptional9sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional9sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional9sparql5 - in simulator`() {
