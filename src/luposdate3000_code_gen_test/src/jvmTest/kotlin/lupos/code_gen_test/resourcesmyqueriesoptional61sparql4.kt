...
public class resourcesmyqueriesoptional61sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional61sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional61sparql4 - in simulator`() {
