...
public class resourcesmyqueriesoptional31sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional31sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional31sparql5 - in simulator`() {
