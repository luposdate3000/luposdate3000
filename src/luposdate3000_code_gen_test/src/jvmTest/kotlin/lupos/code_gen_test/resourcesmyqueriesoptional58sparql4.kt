...
public class resourcesmyqueriesoptional58sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional58sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional58sparql4 - in simulator`() {
