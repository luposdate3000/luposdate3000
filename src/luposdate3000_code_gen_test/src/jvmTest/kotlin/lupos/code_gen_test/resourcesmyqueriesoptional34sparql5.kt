...
public class resourcesmyqueriesoptional34sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional34sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql5 - in simulator`() {
