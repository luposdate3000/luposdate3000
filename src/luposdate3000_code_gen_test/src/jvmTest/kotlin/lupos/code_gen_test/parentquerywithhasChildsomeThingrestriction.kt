...
public class parentquerywithhasChildsomeThingrestriction {
    ...
    internal val query = File("src/jvmTest/resources/parentquerywithhasChildsomeThingrestriction.query").readAsString()
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `parent query with hasChild some Thing restriction - in simulator`() {
