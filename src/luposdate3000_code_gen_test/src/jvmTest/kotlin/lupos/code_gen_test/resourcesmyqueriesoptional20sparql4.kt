...
public class resourcesmyqueriesoptional20sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional20sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional20sparql4 - in simulator`() {
