...
public class resourcesmyqueriesoptional32sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional32sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional32sparql5 - in simulator`() {
