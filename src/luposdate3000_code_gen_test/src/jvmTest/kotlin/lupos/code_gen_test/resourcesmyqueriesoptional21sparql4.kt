...
public class resourcesmyqueriesoptional21sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional21sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional21sparql4 - in simulator`() {
