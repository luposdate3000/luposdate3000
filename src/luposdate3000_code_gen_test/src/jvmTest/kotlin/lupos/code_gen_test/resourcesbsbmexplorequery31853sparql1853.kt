...
public class resourcesbsbmexplorequery31853sparql1853 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmexplorequery31853sparql1853.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmexplorequery31853sparql1853 - in simulator`() {
