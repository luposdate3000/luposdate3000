...
public class resourcesmyqueriesoptional64sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional64sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional64sparql5 - in simulator`() {
