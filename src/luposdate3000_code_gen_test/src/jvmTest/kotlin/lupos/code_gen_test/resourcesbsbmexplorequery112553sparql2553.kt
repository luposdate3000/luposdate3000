...
public class resourcesbsbmexplorequery112553sparql2553 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmexplorequery112553sparql2553.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmexplorequery112553sparql2553 - in simulator`() {
