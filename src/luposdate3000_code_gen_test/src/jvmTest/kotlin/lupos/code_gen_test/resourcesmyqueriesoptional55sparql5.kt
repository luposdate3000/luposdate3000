...
public class resourcesmyqueriesoptional55sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional55sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional55sparql5 - in simulator`() {
