...
public class resourcesmyqueriesoptional14sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional14sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional14sparql5 - in simulator`() {
