...
public class resourcesmyqueriesoptional60sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional60sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional60sparql4 - in simulator`() {
