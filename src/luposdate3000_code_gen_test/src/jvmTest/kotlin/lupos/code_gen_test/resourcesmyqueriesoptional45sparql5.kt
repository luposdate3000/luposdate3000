...
public class resourcesmyqueriesoptional45sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional45sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional45sparql5 - in simulator`() {
