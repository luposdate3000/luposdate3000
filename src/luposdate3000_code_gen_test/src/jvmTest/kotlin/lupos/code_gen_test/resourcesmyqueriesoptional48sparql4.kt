...
public class resourcesmyqueriesoptional48sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional48sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional48sparql4 - in simulator`() {
