...
public class resourcesmyqueriesoptional61sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional61sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional61sparql5 - in simulator`() {
