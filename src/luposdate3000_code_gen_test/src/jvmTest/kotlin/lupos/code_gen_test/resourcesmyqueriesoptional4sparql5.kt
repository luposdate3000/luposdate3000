...
public class resourcesmyqueriesoptional4sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional4sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional4sparql5 - in simulator`() {
