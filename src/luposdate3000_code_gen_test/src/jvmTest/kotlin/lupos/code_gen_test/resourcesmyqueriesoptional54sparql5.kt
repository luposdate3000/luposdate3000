...
public class resourcesmyqueriesoptional54sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional54sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional54sparql5 - in simulator`() {
