...
public class resourcesmyqueriesoptional38sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional38sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional38sparql4 - in simulator`() {
