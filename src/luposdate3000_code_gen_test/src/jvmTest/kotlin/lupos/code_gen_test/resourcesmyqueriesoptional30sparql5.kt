...
public class resourcesmyqueriesoptional30sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional30sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional30sparql5 - in simulator`() {
