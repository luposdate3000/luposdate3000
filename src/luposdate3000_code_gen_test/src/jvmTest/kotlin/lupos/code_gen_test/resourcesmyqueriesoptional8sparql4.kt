...
public class resourcesmyqueriesoptional8sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional8sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional8sparql4 - in simulator`() {
