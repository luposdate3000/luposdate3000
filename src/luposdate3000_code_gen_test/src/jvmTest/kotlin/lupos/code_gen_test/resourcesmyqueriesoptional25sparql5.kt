...
public class resourcesmyqueriesoptional25sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional25sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional25sparql5 - in simulator`() {
