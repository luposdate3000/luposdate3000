...
/src/parser/parsergenerator.kts parse_dot                                   DOT
...
/src/parser/parsergenerator.kts parse_triple_end_or_object_iri              PN_LOCAL PREDICATE_LIST1 OBJECT_LIST1 DOT SKIP_WS_FORCED
/src/parser/parsergenerator.kts parse_triple_end_or_object_string           LANGTAG IRI1 PREDICATE_LIST1 OBJECT_LIST1 DOT SKIP_WS_FORCED
/src/parser/parsergenerator.kts parse_triple_end_or_object_string_typed     IRIREF PNAME_NS
/src/parser/parsergenerator.kts parse_triple_end_or_object_string_typed_iri PN_LOCAL PREDICATE_LIST1 OBJECT_LIST1 DOT SKIP_WS_FORCED
