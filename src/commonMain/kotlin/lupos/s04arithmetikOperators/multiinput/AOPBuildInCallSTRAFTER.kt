        ...
        return {
            ...
            if (b is ValueSimpleLiteral) {
                if (a is ValueSimpleLiteral) {
                    var idx = a.content.indexOf(b.content)
                    if (idx < 0) {
                        res = a
                    } else {
                        idx += b.content.length
                        res = ValueSimpleLiteral(a.delimiter, a.content.substring(idx, a.content.length))
                    }
                    ...
                    if (idx < 0) {
                        ...
                        idx += b.content.length
                        res = ValueLanguageTaggedLiteral(a.delimiter, a.content.substring(idx, a.content.length),a.language)
                    }
