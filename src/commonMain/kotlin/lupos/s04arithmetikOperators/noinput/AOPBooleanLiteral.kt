...
override fun toDouble():Double{throw Exception("cannot cast AOPBooleanLiteral to Double")}
override fun toInt():Int{throw Exception("cannot cast AOPBooleanLiteral to Int")}
