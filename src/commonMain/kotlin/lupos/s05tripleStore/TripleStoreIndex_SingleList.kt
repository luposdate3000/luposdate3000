...
println("XXX v2 ${data.size} $key2")
                    data.add(key2)
                }
            }
        }
for(i in 0 until data.size){
println("ZZZ $i ${data[i]}")
}
}
    }
