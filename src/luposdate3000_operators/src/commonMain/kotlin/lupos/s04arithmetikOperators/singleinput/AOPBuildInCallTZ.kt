...
public class AOPBuildInCallTZ public constructor(query: IQuery, child: AOPBase) : AOPBase(query, EOperatorIDExt.AOPBuildInCallTZID, "AOPBuildInCallTZ", arrayOf(child)) {
