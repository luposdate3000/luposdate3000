...
public class AOPBuildInCallYEAR public constructor(query: IQuery, child: AOPBase) : AOPBase(query, EOperatorIDExt.AOPBuildInCallYEARID, "AOPBuildInCallYEAR", arrayOf(child)) {
