...
public class AOPBuildInCallMONTH public constructor(query: IQuery, child: AOPBase) : AOPBase(query, EOperatorIDExt.AOPBuildInCallMONTHID, "AOPBuildInCallMONTH", arrayOf(child)) {
