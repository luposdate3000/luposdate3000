...
public class AOPBuildInCallUCASE public constructor(query: IQuery, child: AOPBase) : AOPBase(query, EOperatorIDExt.AOPBuildInCallUCASEID, "AOPBuildInCallUCASE", arrayOf(child)) {
