...
public class AOPBuildInCallNotExists public constructor(query: IQuery, @JvmField public var child: IOPBase) : AOPBase(query, EOperatorID.AOPBuildInCallNotExistsID, "AOPBuildInCallNotExists", arrayOf(child)) {
