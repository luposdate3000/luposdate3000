...
public class AOPBuildInCallNotExists(query: IQuery, @JvmField var child: IOPBase) : AOPBase(query, EOperatorID.AOPBuildInCallNotExistsID, "AOPBuildInCallNotExists", arrayOf(child)) {
