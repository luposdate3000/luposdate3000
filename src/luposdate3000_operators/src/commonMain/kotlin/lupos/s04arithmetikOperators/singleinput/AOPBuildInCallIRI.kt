...
public class AOPBuildInCallIRI public constructor(query: IQuery, child: AOPBase, @JvmField public var prefix: String ) : AOPBase(query, EOperatorID.AOPBuildInCallIRIID, "AOPBuildInCallIRI", arrayOf(child)) {
