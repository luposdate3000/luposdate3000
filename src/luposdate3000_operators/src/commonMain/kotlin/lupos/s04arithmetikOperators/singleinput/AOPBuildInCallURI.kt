...
public class AOPBuildInCallURI(query: IQuery, child: AOPBase, @JvmField public var prefix: String = "") : AOPBase(query, EOperatorID.AOPBuildInCallURIID, "AOPBuildInCallURI", arrayOf(child)) {
