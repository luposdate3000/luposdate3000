...
public class AOPBuildInCallSHA1 public constructor(query: IQuery, child: AOPBase) : AOPBase(query, EOperatorIDExt.AOPBuildInCallSHA1ID, "AOPBuildInCallSHA1", arrayOf(child)) {
