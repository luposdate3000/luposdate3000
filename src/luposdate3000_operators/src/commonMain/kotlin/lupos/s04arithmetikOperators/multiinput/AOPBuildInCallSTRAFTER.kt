...
public class AOPBuildInCallSTRAFTER public constructor(query: IQuery, child: AOPBase, childB: AOPBase) : AOPBase(query, EOperatorIDExt.AOPBuildInCallSTRAFTERID, "AOPBuildInCallSTRAFTER", arrayOf(child, childB)) {
