...
public class AOPBuildInCallSTRAFTER public constructor(query: IQuery, child: AOPBase, childB: AOPBase) : AOPBase(query, EOperatorID.AOPBuildInCallSTRAFTERID, "AOPBuildInCallSTRAFTER", arrayOf(child, childB)) {
