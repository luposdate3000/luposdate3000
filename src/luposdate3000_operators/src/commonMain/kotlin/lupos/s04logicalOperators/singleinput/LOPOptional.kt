...
public class LOPOptional public constructor(query: IQuery, child: IOPBase ) : LOPBase(query, EOperatorID.LOPOptionalID, "LOPOptional", arrayOf(child), ESortPriority.SAME_AS_CHILD) {
