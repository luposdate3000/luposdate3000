...
public class LOPPrefix(query: IQuery, @JvmField val name: String, @JvmField val iri: String, child: IOPBase = OPEmptyRow(query)) : LOPBase(query, EOperatorID.LOPPrefixID, "LOPPrefix", arrayOf(child), ESortPriority.SAME_AS_CHILD) {
