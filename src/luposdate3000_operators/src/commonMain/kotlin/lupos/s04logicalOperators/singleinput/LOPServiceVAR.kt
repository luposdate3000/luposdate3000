...
public class LOPServiceVAR(query: IQuery, @JvmField val name: String, @JvmField val silent: Boolean, constraint: IOPBase, child: IOPBase = OPEmptyRow(query)) : LOPBase(query, EOperatorID.LOPServiceVARID, "LOPServiceVAR", arrayOf(child, constraint), ESortPriority.PREVENT_ANY) {
