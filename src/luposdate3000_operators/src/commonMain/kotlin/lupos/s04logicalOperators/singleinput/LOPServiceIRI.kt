...
public class LOPServiceIRI(query: IQuery, @JvmField val name: String, @JvmField val silent: Boolean, child: IOPBase) : LOPBase(query, EOperatorID.LOPServiceIRIID, "LOPServiceIRI", arrayOf(child), ESortPriority.PREVENT_ANY) {
