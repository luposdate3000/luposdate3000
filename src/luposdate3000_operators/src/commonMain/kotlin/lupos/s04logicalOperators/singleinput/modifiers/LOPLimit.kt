...
public class LOPLimit public constructor(query: IQuery, @JvmField public val limit: Int, child: IOPBase ) : LOPBase(query, EOperatorID.LOPLimitID, "LOPLimit", arrayOf(child), ESortPriority.SAME_AS_CHILD) {
