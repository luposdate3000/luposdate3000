...
public class LOPOffset(query: IQuery, @JvmField val offset: Int, child: IOPBase = OPEmptyRow(query)) : LOPBase(query, EOperatorID.LOPOffsetID, "LOPOffset", arrayOf(child), ESortPriority.SAME_AS_CHILD) {
