...
public class LOPModifyData(query: IQuery, @JvmField public val type: EModifyType, @JvmField public val data: MutableList<LOPTriple> = mutableListOf()) : LOPBase(query, EOperatorID.LOPModifyDataID, "LOPModifyData", arrayOf(), ESortPriority.PREVENT_ANY) {
