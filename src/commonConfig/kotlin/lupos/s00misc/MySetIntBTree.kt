...
class MySetIntBTree() {
    ...
    class MySetIntBTreeNodeIterator(val node: MySetIntBTreeNode) : Iterator<Int> {
        var i = 0
        var childIterator: Iterator<Int>? = null
    ...
    class MySetIntBTreeNode(val leaf: Boolean, val parentuuid: Int) {
        companion object {
            var debughelperUUID = 0
        }

        val uuid = debughelperUUID++
        val keys = IntArray(2 * B_TREE_BRANCHING_FACTOR - 1) 
        val C = Array<MySetIntBTreeNode?>(2 * B_TREE_BRANCHING_FACTOR) { null }
        var n = 0
        fun free() {
            /*later when buffer-manager is used*/
        }

        fun iterator(): MySetIntBTreeNodeIterator {
            return MySetIntBTreeNodeIterator(this)
        }
...
/*Coverage Unreachable*/
        ...
        fun splitChild(i: Int, y: MySetIntBTreeNode) {
            val z = MySetIntBTreeNode(y.leaf, uuid)
    ...
    fun add(k: Int, onCreate: () -> Unit = {}, onExists: (Int) -> Unit = {}) {
        ...
        SanityCheck {
            ...
            val sanitycheckhelper2 = mutableSetOf<Int>()
        ...
        SanityCheck {
            ...
            val sanitycheckhelper3 = mutableSetOf<Int>()
            val iterator = iterator()
            while (iterator.hasNext()) {
