...
public abstract class OPBase public constructor(
    ...
    override /*suspend*/ fun getHistogram(): HistogramResult {
        ...
        SanityCheck(
            { /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:129"/*SOURCE_FILE_END*/ },
            {
                val v1 = getProvidedVariableNames()
                val v2 = histogramResult!!.values.keys
                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:133"/*SOURCE_FILE_END*/ }, { v1.containsAll(v2) }, { "getHistogramSanity1 $classname $v1 $v2" })
                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:134"/*SOURCE_FILE_END*/ }, { v2.containsAll(v1) }, { "getHistogramSanity2 $classname $v1 $v2" })
            }
        )
    ...
    override /*suspend*/ fun evaluateRoot(): IteratorBundle {
        ...
        SanityCheck(
            { /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:143"/*SOURCE_FILE_END*/ },
            {
            ...
            if (!target.contains(data)) {
                ...
                loop@ for (c in target) {
                    ...
                    if (idx == c.size) {
                        ...
                        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:189"/*SOURCE_FILE_END*/ }, { idx == data.size })
                        needToAdd = false
                    }
                    break@loop
                }
    ...
    override fun selectSortPriority(priority: List<SortHelper>) {
        ...
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:255"/*SOURCE_FILE_END*/ }, { getProvidedVariableNames().containsAll(mySortPriority.map { it.variableName }) }, { "$this" })
        sortPriorities = tmp
    }
            ...
            if (mySortPriority.size > 0) {
                ...
                when (provided.size) {
                    ...
                    3 -> {
                        ...
                        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:298"/*SOURCE_FILE_END*/ }, { provided.isEmpty() })
                    }
                }
            }
...
// it is required, that both join-inputs are sorted by the same join columns in the same order - _if all join columns are equally sorted, than allow any additional sort by one of the children
    ...
    override fun updateChildren(i: Int, child: IOPBase) {
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:378"/*SOURCE_FILE_END*/ }, { i < children.size })
        children[i] = child
    }
    ...
    public open override fun replaceVariableWithAnother(name: String, name2: String, parent: IOPBase, parentIdx: Int): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:395"/*SOURCE_FILE_END*/ }, { parent.getChildren()[parentIdx] == this })
        for (i in this.getChildren().indices) {
    ...
    public open /*suspend*/ fun toXMLElementHelper(partial: Boolean, excludeChildren: Boolean): XMLElement {
    ...
    public /*suspend*/ fun childrenToXML(partial: Boolean): XMLElement {
    ...
    override fun setChild(child: IOPBase): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/OPBase.kt:518"/*SOURCE_FILE_END*/ }, { children.isNotEmpty() })
