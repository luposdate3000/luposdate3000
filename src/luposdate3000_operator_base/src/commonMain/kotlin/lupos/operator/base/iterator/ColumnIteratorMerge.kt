...
public object ColumnIteratorMerge {
    public /*suspend*/ operator fun invoke(a: ColumnIterator, comparator: Comparator<DictionaryValueType>): ColumnIterator {
        ...
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/iterator/ColumnIteratorMerge.kt:123"/*SOURCE_FILE_END*/ }, { resultList.size > 0 })
    ...
    public /*suspend*/ operator fun invoke(a: ColumnIterator): ColumnIterator {
        ...
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_base/src/commonMain/kotlin/lupos/operator/base/iterator/ColumnIteratorMerge.kt:225"/*SOURCE_FILE_END*/ }, { resultList.size > 0 })
        return resultList[resultList.size - 1]!!
    }
}
