...
public class resourcesbsbmbiquery42210sparql2210 {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - true`() {
        simulatorHelper(
            MySimulatorConfig(
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - true - Routing - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - true - Routing - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - false - Routing - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - false - Routing - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - true - Centralized - true`() {
        simulatorHelper(
            MySimulatorConfig(
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - true - Centralized - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - true - Routing - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - true - Routing - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - false - Centralized - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - false - Centralized - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - false - Routing - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - false - Routing - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = false,
