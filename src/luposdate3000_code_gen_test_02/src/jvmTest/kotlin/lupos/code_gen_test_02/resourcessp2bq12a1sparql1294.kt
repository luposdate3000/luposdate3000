...
public class resourcessp2bq12a1sparql1294 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcessp2bq12a1sparql1294.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/resourcessp2bq12a1sparql1294.input",
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcessp2bq12a1sparql1294.output").readAsString()
    ...
    @Test
    public fun `resourcessp2bq12a1sparql1294 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `resourcessp2bq12a1sparql1294 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `resourcessp2bq12a1sparql1294 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
