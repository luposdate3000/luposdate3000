...
internal fun generatePOPJoinMerge(
    ...
    imports.add("lupos.shared.operator.iterator.ColumnIterator   ChildIterator")
    ...
    imports.add("lupos.shared.operator.iterator.ColumnIterator   MultiIterator")
    imports.add("lupos.shared.operator.iterator.ColumnIterator   MultiValue")
    imports.add("lupos.shared.operator.iterator.ColumnIterator   RepeatIterator")
    imports.add("lupos.shared.operator.iterator.ColumnIterator   RepeatValue")
