...
internal fun generatePOPJoinMerge(
    ...
    imports.add("lupos.operator.iterator.ColumnIteratorMultiIterator")
    imports.add("lupos.operator.iterator.ColumnIteratorMultiValue")
    imports.add("lupos.operator.iterator.ColumnIteratorRepeatIterator")
    imports.add("lupos.operator.iterator.ColumnIteratorRepeatValue")
