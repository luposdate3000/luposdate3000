...
public class resourcessp2bq10sparql247 {
    ...
    @Test(timeout = 2000)
    public fun `resourcessp2bq10sparql247 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - None`() {
        simulatorHelper(
    ...
    @Test(timeout = 2000)
    public fun `resourcessp2bq10sparql247 - in simulator - PartitionByID_S_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
