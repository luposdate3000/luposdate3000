...
public class resourcesmyqueriesoptional12sparql5 {
    ...
    @Test(timeout = 2000)
    public fun `resourcesmyqueriesoptional12sparql5 - None - PartitionByID_O_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `resourcesmyqueriesoptional12sparql5 - None - PartitionByID_S_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
