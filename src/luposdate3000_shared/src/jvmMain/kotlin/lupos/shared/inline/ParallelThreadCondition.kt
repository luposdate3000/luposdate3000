        ...
        synchronized(this) {
            if (!wasSignalled && condition()) {
                try {
                    ...
                    e.myPrintStackTrace(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_shared/src/jvmMain/kotlin/lupos/shared/inline/ParallelThreadCondition.kt:31"/*SOURCE_FILE_END*/)
                }
            }
            wasSignalled = false
        }
