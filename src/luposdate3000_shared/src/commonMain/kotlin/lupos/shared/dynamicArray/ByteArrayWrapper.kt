...
public class ByteArrayWrapper : Comparable<ByteArrayWrapper> {
    ...
    public constructor(buf: ByteArray, size: Int) {
        this.buf_ = buf
        this.size_ = size
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_shared/src/commonMain/kotlin/lupos/shared/dynamicArray/ByteArrayWrapper.kt:35"/*SOURCE_FILE_END*/ }, { size <= buf.size })
    }
