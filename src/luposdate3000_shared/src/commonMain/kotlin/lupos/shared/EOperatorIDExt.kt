...
public object EOperatorIDExt {
    ...
    public const val LOPLimitID: EOperatorID = 78 // 0x0000004e
    public const val LOPMakeBooleanResultID: EOperatorID = 79 // 0x0000004f
    public const val LOPMinusID: EOperatorID = 80 // 0x00000050
    public const val LOPModifyDataID: EOperatorID = 81 // 0x00000051
    public const val LOPModifyID: EOperatorID = 82 // 0x00000052
    public const val LOPNOOPID: EOperatorID = 83 // 0x00000053
    public const val LOPOffsetID: EOperatorID = 84 // 0x00000054
    public const val LOPOptionalID: EOperatorID = 85 // 0x00000055
    public const val LOPPrefixID: EOperatorID = 86 // 0x00000056
    public const val LOPProjectionID: EOperatorID = 87 // 0x00000057
    public const val LOPReducedID: EOperatorID = 88 // 0x00000058
    public const val LOPServiceIRIID: EOperatorID = 89 // 0x00000059
    public const val LOPServiceVARID: EOperatorID = 90 // 0x0000005a
    public const val LOPSortAnyID: EOperatorID = 91 // 0x0000005b
    public const val LOPSortID: EOperatorID = 92 // 0x0000005c
    public const val LOPSubGroupID: EOperatorID = 93 // 0x0000005d
    public const val LOPTripleID: EOperatorID = 94 // 0x0000005e
    public const val LOPUnionID: EOperatorID = 95 // 0x0000005f
    ...
    public const val POPBindID: EOperatorID = 99 // 0x00000063
    public const val POPChangePartitionOrderedByIntIdID: EOperatorID = 100 // 0x00000064
    public const val POPDebugID: EOperatorID = 101 // 0x00000065
    public const val POPDistributedReceiveMultiCountID: EOperatorID = 102 // 0x00000066
    public const val POPDistributedReceiveMultiID: EOperatorID = 103 // 0x00000067
    public const val POPDistributedReceiveMultiOrderedID: EOperatorID = 104 // 0x00000068
    public const val POPDistributedReceiveSingleCountID: EOperatorID = 105 // 0x00000069
    public const val POPDistributedReceiveSingleID: EOperatorID = 106 // 0x0000006a
    public const val POPDistributedSendMultiID: EOperatorID = 107 // 0x0000006b
    public const val POPDistributedSendSingleCountID: EOperatorID = 108 // 0x0000006c
    public const val POPDistributedSendSingleID: EOperatorID = 109 // 0x0000006d
    public const val POPEmptyRowID: EOperatorID = 110 // 0x0000006e
    public const val POPFilterID: EOperatorID = 111 // 0x0000006f
    public const val POPGenerated: EOperatorID = 112 // 0x00000070
    public const val POPGraphOperationID: EOperatorID = 113 // 0x00000071
    public const val POPGroupCount0ID: EOperatorID = 114 // 0x00000072
    public const val POPGroupCount1ID: EOperatorID = 115 // 0x00000073
    public const val POPGroupID: EOperatorID = 116 // 0x00000074
    public const val POPGroupSortedID: EOperatorID = 117 // 0x00000075
    public const val POPGroupWithoutKeyColumnID: EOperatorID = 118 // 0x00000076
    public const val POPJoinCartesianProductID: EOperatorID = 119 // 0x00000077
    public const val POPJoinHashMapID: EOperatorID = 120 // 0x00000078
    public const val POPJoinMergeID: EOperatorID = 121 // 0x00000079
    public const val POPJoinMergeOptionalID: EOperatorID = 122 // 0x0000007a
    public const val POPJoinMergeSingleColumnID: EOperatorID = 123 // 0x0000007b
    public const val POPJoinWithStoreExistsID: EOperatorID = 124 // 0x0000007c
    public const val POPJoinWithStoreID: EOperatorID = 125 // 0x0000007d
    public const val POPLimitID: EOperatorID = 126 // 0x0000007e
    public const val POPMakeBooleanResultID: EOperatorID = 127 // 0x0000007f
    public const val POPMergePartitionCountID: EOperatorID = 128 // 0x00000080
    public const val POPMergePartitionID: EOperatorID = 129 // 0x00000081
    public const val POPMergePartitionOrderedByIntIdID: EOperatorID = 130 // 0x00000082
    public const val POPMinusID: EOperatorID = 131 // 0x00000083
    public const val POPModifyDataID: EOperatorID = 132 // 0x00000084
    public const val POPModifyID: EOperatorID = 133 // 0x00000085
    public const val POPNothingID: EOperatorID = 134 // 0x00000086
    public const val POPOffsetID: EOperatorID = 135 // 0x00000087
    public const val POPProjectionID: EOperatorID = 136 // 0x00000088
    public const val POPReducedID: EOperatorID = 137 // 0x00000089
    public const val POPSortID: EOperatorID = 138 // 0x0000008a
    public const val POPSplitMergePartitionFromStoreID: EOperatorID = 139 // 0x0000008b
    public const val POPSplitPartitionFromStoreCountID: EOperatorID = 140 // 0x0000008c
    public const val POPSplitPartitionFromStoreID: EOperatorID = 141 // 0x0000008d
    public const val POPSplitPartitionID: EOperatorID = 142 // 0x0000008e
    public const val POPSplitPartitionPassThroughID: EOperatorID = 143 // 0x0000008f
    public const val POPTripleStoreIterator: EOperatorID = 144 // 0x00000090
    public const val POPUnionID: EOperatorID = 145 // 0x00000091
    public const val POPValuesCountID: EOperatorID = 146 // 0x00000092
    public const val POPValuesID: EOperatorID = 147 // 0x00000093
    public const val values_size: Int = 148
