...
public fun executeBufferManagerTest(nextRandom: () -> Int, hasNextRandom: () -> Int, @Suppress("UNUSED_PARAMETER") resetRandom: () -> Unit, BufferManager: (Luposdate3000Instance) -> IBufferManager, isInMemoryOnly: Boolean, allowInitFromDisk: (Boolean) -> Unit, isUnitTest: Boolean) {
    ...
    fun testReleasePageOk(pageid: Int) {
        ...
        instance.bufferManager!!.releasePage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:45"/*SOURCE_FILE_END*/, pageid)
    ...
    fun testReleasePageFail(pageid: Int) {
        ...
        var flag = true
        try {
            instance.bufferManager!!.releasePage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:64"/*SOURCE_FILE_END*/, pageid)
        } catch (e: Throwable) {
    ...
    fun testGetPageOk(pageid: Int) {
        ...
        val page = instance.bufferManager!!.getPage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:78"/*SOURCE_FILE_END*/, pageid)
    ...
    fun testGetPageFail(pageid: Int) {
        ...
        var flag = true
        try {
            instance.bufferManager!!.getPage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:102"/*SOURCE_FILE_END*/, pageid)
        } catch (e: Throwable) {
            // e.printStackTrace() this is handled correctly
            flag = false
        }
    ...
    fun testCreateNewPageOk() {
        val pageid = instance.bufferManager!!.allocPage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:113"/*SOURCE_FILE_END*/)
        val page = instance.bufferManager!!.getPage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:114"/*SOURCE_FILE_END*/, pageid)
    ...
    fun testDeletePageOk(pageid: Int) {
        ...
        instance.bufferManager!!.deletePage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:138"/*SOURCE_FILE_END*/, pageid)
        mappedPagesCtr.remove(pageid)
        mappedPages.remove(pageid)
    ...
    fun testDeletePageFail(pageid: Int) {
        ...
        var flag = true
        try {
            instance.bufferManager!!.deletePage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:150"/*SOURCE_FILE_END*/, pageid)
        } catch (e: Throwable) {
            // e.printStackTrace() this is handled correctly
            flag = false
        }
    ...
    for (pageid in pageIds) {
        val page = instance.bufferManager!!.getPage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:260"/*SOURCE_FILE_END*/, pageid)
        val id = BufferManagerPage.readInt4(page, 0)
        if (id != pageid) {
            throw Exception("")
        }
        instance.bufferManager!!.releasePage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:265"/*SOURCE_FILE_END*/, pageid)
    }
    if (instance.bufferManager!!.getNumberOfReferencedPages() != 0) {
        throw Exception("")
    }
    ...
    for (pageid in pageIds) {
        val page = instance.bufferManager!!.getPage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:282"/*SOURCE_FILE_END*/, pageid)
        val id = BufferManagerPage.readInt4(page, 0)
        if (id != pageid) {
            throw Exception("")
        }
        instance.bufferManager!!.deletePage(/*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_test_buffermanager/src/commonMain/kotlin/lupos/test_buffermanager/executeBufferManagerTest.kt:287"/*SOURCE_FILE_END*/, pageid)
    }
    if (instance.bufferManager!!.getNumberOfReferencedPages() != 0) {
        throw Exception("")
    }
