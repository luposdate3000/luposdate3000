...
// blank nodes are used for dont care within the queries. the only place, where the bnode is required as a value is within the insert/delete-clauses. there it needs to be replaced
    ...
    override fun visit(node: ASTBuiltInCall, childrenValues: List<IOPBase>): IOPBase {
        when (node.function) {
            ...
            BuiltInFunctionsExt.LANGMATCHES -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:974"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
            ...
            BuiltInFunctionsExt.URI -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:990"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
            ...
            BuiltInFunctionsExt.ROUND -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1012"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallROUND(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.CONCAT -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1016"/*SOURCE_FILE_END*/ }, { childrenValues.isNotEmpty() })
            ...
            BuiltInFunctionsExt.LCASE -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1035"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
            ...
            BuiltInFunctionsExt.STRENDS -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1047"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
            ...
            BuiltInFunctionsExt.TZ -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1079"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
            ...
            BuiltInFunctionsExt.STRUUID -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1091"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
            ...
            BuiltInFunctionsExt.SHA256 -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1103"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallSHA256(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.IF -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1107"/*SOURCE_FILE_END*/ }, { childrenValues.size == 3 })
            ...
            BuiltInFunctionsExt.STRDT -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1123"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
            ...
            BuiltInFunctionsExt.isNUMERIC -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1135"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
    ...
    override fun visit(node: ASTUnion, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1184"/*SOURCE_FILE_END*/ }, { childrenValues.size >= 2 })
    ...
    override fun visit(node: ASTFilter, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1199"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
    ...
    override fun visit(node: ASTOrderCondition, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1208"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
    ...
    override fun visit(node: ASTVar, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1218"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
    ...
    override fun visit(node: ASTAdd, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1349"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
    ...
    override fun visit(node: ASTMove, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1356"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        val g1 = graphRefToEnum(node.fromGraph)
        val g2 = graphRefToEnum(node.toGraph)
    ...
    override fun visit(node: ASTCopy, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1363"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        val g1 = graphRefToEnum(node.fromGraph)
        val g2 = graphRefToEnum(node.toGraph)
    ...
    override fun visit(node: ASTDrop, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1376"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        val g1 = graphRefToEnum(node.graphref)
    ...
    override fun visit(node: ASTCreate, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1382"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        val g1 = graphRefToEnum(node.graphref)
    ...
    override fun visit(node: ASTMinus, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1615"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
