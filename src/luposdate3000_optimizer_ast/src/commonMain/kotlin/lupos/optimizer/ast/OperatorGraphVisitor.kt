...
*/
    ...
    override fun visit(node: ASTTriple, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:970"/*SOURCE_FILE_END*/ }, { childrenValues.size == 3 })
    ...
    override fun visit(node: ASTOr, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:988"/*SOURCE_FILE_END*/ }, { childrenValues.size > 1 })
    ...
    override fun visit(node: ASTEQ, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1014"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
    ...
    override fun visit(node: ASTNEQ, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1019"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
    ...
    override fun visit(node: ASTLEQ, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1024"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
    ...
    override fun visit(node: ASTGEQ, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1029"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
    ...
    override fun visit(node: ASTLT, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1034"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
    ...
    override fun visit(node: ASTNotIn, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1049"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
    ...
    override fun visit(node: ASTAddition, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1054"/*SOURCE_FILE_END*/ }, { childrenValues.size > 1 })
        var res: AOPBase? = null
        for (v in childrenValues) {
            res = if (res == null) {
                v as AOPBase
    ...
    override fun visit(node: ASTMultiplication, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1081"/*SOURCE_FILE_END*/ }, { childrenValues.size > 1 })
        var res: AOPBase? = null
        for (v in childrenValues) {
            res = if (res == null) {
                v as AOPBase
    ...
    override fun visit(node: ASTDivision, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1094"/*SOURCE_FILE_END*/ }, { childrenValues.size > 1 })
        var res: AOPBase? = null
        for (i in childrenValues.indices) {
            val v = childrenValues[childrenValues.size - 1 - i]
            res = if (res == null) {
    ...
    override fun visit(node: ASTNot, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1108"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
        return AOPNot(query, childrenValues[0] as AOPBase)
    }

    override fun visit(node: ASTBase, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1113"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        return LOPPrefix(query, "", node.iri)
    }

    override fun visit(node: ASTPrefix, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1118"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        return LOPPrefix(query, node.name, node.iri)
    }

    override fun visit(node: ASTAs, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1123"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
    ...
    override fun visit(node: ASTBlankNode, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1133"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
...
// blank nodes are used for dont care within the queries. the only place, where the bnode is required as a value is within the insert/delete-clauses. there it needs to be replaced
    ...
    override fun visit(node: ASTBuiltInCall, childrenValues: List<IOPBase>): IOPBase {
        when (node.function) {
            BuiltInFunctionsExt.STR -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1141"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallSTR(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.LANG -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1145"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallLANG(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.LANGMATCHES -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1149"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
            ...
            BuiltInFunctionsExt.DATATYPE -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1153"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallDATATYPE(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.BOUND -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1157"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallBOUND(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.IRI -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1161"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallIRI(query, childrenValues[0] as AOPBase, "")
            }
            BuiltInFunctionsExt.URI -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1165"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
            ...
            BuiltInFunctionsExt.ABS -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1175"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallABS(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.CEIL -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1179"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallCEIL(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.FLOOR -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1183"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallFLOOR(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.ROUND -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1187"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallROUND(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.CONCAT -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1191"/*SOURCE_FILE_END*/ }, { childrenValues.isNotEmpty() })
            ...
            BuiltInFunctionsExt.STRLEN -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1202"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallSTRLEN(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.UCASE -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1206"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallUCASE(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.LCASE -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1210"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallLCASE(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.CONTAINS -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1214"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
                return AOPBuildInCallCONTAINS(query, childrenValues[0] as AOPBase, childrenValues[1] as AOPBase)
            }
            BuiltInFunctionsExt.STRSTARTS -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1218"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
                return AOPBuildInCallSTRSTARTS(query, childrenValues[0] as AOPBase, childrenValues[1] as AOPBase)
            }
            BuiltInFunctionsExt.STRENDS -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1222"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
                return AOPBuildInCallSTRENDS(query, childrenValues[0] as AOPBase, childrenValues[1] as AOPBase)
            }
            BuiltInFunctionsExt.YEAR -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1226"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallYEAR(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.MONTH -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1230"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallMONTH(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.DAY -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1234"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallDAY(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.HOURS -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1238"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallHOURS(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.MINUTES -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1242"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallMINUTES(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.SECONDS -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1246"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallSECONDS(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.TIMEZONE -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1250"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallTIMEZONE(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.TZ -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1254"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallTZ(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.NOW -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1258"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
                return AOPConstant(query, queryExecutionStartTime)
            }
            BuiltInFunctionsExt.UUID -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1262"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
                return AOPBuildInCallUUID(query)
            }
            BuiltInFunctionsExt.STRUUID -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1266"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
                return AOPBuildInCallSTRUUID(query)
            }
            BuiltInFunctionsExt.MD5 -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1270"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallMD5(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.SHA1 -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1274"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallSHA1(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.SHA256 -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1278"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallSHA256(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.IF -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1282"/*SOURCE_FILE_END*/ }, { childrenValues.size == 3 })
            ...
            BuiltInFunctionsExt.STRLANG -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1286"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
                return AOPBuildInCallSTRLANG(query, childrenValues[0] as AOPBase, childrenValues[1] as AOPBase)
            }
            BuiltInFunctionsExt.STRAFTER -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1290"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
                return AOPBuildInCallSTRAFTER(query, childrenValues[0] as AOPBase, childrenValues[1] as AOPBase)
            }
            BuiltInFunctionsExt.STRBEFORE -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1294"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
                return AOPBuildInCallSTRBEFORE(query, childrenValues[0] as AOPBase, childrenValues[1] as AOPBase)
            }
            BuiltInFunctionsExt.STRDT -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1298"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
                return AOPBuildInCallSTRDT(query, childrenValues[0] as AOPBase, childrenValues[1] as AOPBase)
            }
            BuiltInFunctionsExt.isLITERAL -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1302"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallIsLITERAL(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.isIRI -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1306"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
                return AOPBuildInCallIsIri(query, childrenValues[0] as AOPBase)
            }
            BuiltInFunctionsExt.isNUMERIC -> {
                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1310"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
    ...
    override fun visit(node: ASTUnion, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1359"/*SOURCE_FILE_END*/ }, { childrenValues.size >= 2 })
    ...
    override fun visit(node: ASTFilter, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1374"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
    ...
    override fun visit(node: ASTOrderCondition, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1383"/*SOURCE_FILE_END*/ }, { childrenValues.size == 1 })
    ...
    override fun visit(node: ASTVar, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1393"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
    ...
    override fun visit(node: ASTAdd, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1524"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
    ...
    override fun visit(node: ASTMove, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1531"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        val g1 = graphRefToEnum(node.fromGraph)
        val g2 = graphRefToEnum(node.toGraph)
    ...
    override fun visit(node: ASTCopy, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1538"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        val g1 = graphRefToEnum(node.fromGraph)
        val g2 = graphRefToEnum(node.toGraph)
    ...
    override fun visit(node: ASTClear, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1545"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
    ...
    override fun visit(node: ASTDrop, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1551"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        val g1 = graphRefToEnum(node.graphref)
    ...
    override fun visit(node: ASTCreate, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1557"/*SOURCE_FILE_END*/ }, { childrenValues.isEmpty() })
        val g1 = graphRefToEnum(node.graphref)
    ...
    override fun visit(node: ASTMinus, childrenValues: List<IOPBase>): IOPBase {
        SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_ast/src/commonMain/kotlin/lupos/optimizer/ast/OperatorGraphVisitor.kt:1790"/*SOURCE_FILE_END*/ }, { childrenValues.size == 2 })
