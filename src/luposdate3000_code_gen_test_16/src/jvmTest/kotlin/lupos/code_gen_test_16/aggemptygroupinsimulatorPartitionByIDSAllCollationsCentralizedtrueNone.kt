...
public class aggemptygroupinsimulatorPartitionByIDSAllCollationsCentralizedtrueNone {
    ...
    @Test(timeout = 2000)
    public fun `agg empty group - in simulator - PartitionByID_S_AllCollations - Centralized - true - None`() {
        simulatorHelper(
