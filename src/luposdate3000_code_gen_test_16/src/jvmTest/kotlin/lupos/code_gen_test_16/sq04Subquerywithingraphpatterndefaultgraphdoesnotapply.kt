...
public class sq04Subquerywithingraphpatterndefaultgraphdoesnotapply {
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_1_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_1_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_2_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_2_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_O_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_O_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_S_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_S_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_1_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_1_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_2_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_2_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_O_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_O_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_S_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_S_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_1_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_2_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_2_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_O_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `sq04  Subquery within graph pattern default graph does not apply - in simulator - PartitionByID_S_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
