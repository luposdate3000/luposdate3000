...
public class resourcessp2bq67sparql1294 {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcessp2bq67sparql1294 - in simulator - Simple - true - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcessp2bq67sparql1294 - in simulator - Simple - true - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcessp2bq67sparql1294 - in simulator - Simple - true - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcessp2bq67sparql1294 - in simulator - Simple - true - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcessp2bq67sparql1294 - in simulator - Simple - false - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcessp2bq67sparql1294 - in simulator - Simple - false - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcessp2bq67sparql1294 - in simulator - Simple - false - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcessp2bq67sparql1294 - in simulator - Simple - false - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
