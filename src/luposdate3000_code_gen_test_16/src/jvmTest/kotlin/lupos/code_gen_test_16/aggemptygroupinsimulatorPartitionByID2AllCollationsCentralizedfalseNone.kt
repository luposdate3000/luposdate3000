...
public class aggemptygroupinsimulatorPartitionByID2AllCollationsCentralizedfalseNone {
    ...
    @Test(timeout = 2000)
    public fun `agg empty group - in simulator - PartitionByID_2_AllCollations - Centralized - false - None`() {
        simulatorHelper(
