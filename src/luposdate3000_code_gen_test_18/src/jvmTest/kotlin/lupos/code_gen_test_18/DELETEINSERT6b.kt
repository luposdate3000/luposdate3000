...
public class DELETEINSERT6b {
    ...
    @Test(timeout = 2000)
    public fun `DELETE INSERT 6b - in simulator - PartitionByID_1_AllCollations - Centralized - false - None`() {
        simulatorHelper(
    ...
    @Test(timeout = 2000)
    public fun `DELETE INSERT 6b - in simulator - PartitionByID_S_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
