...
public class DROPDEFAULT {
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByIDTwiceAllCollations - false`() {
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByID_1_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByID_1_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByID_2_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByID_2_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByID_O_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByID_O_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByID_S_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByID_S_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByKeyAllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByKeyAllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    public fun `DROP DEFAULT - None - Simple - false`() {
      ...
      try{
        ...
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator75, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query76 = Query(instance)
        val graph76 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected76 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph77 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected77 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByIDTwiceAllCollations - true`() {
      ...
      try{
        ...
        val graph80 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected80 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByID_1_AllCollations - true`() {
      ...
      try{
        ...
        val graph92 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected92 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByID_1_AllCollations - false`() {
      ...
      try{
        ...
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator99, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query100 = Query(instance)
        val graph100 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected100 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph101 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected101 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByID_2_AllCollations - true`() {
      ...
      try{
        ...
        val graph104 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected104 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByID_2_AllCollations - false`() {
      ...
      try{
        ...
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator111, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query112 = Query(instance)
        val graph112 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected112 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph113 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected113 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByID_O_AllCollations - true`() {
      ...
      try{
        ...
        val graph116 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected116 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByID_O_AllCollations - false`() {
      ...
      try{
        ...
        val query122 = Query(instance)
        val graph122 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        val operator122 = graph122.getIterator(query122, arrayOf(AOPVariable(query122, "s"), AOPVariable(query122, "p"), AOPVariable(query122, "o")), EIndexPatternExt.SPO)
        val actual122 = (LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator122, buf, EQueryResultToStreamExt.MEMORY_TABLE) as List<MemoryTable>).first()
        val expected122 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        val buf_err122 = MyPrintWriter()
        if (!expected122.equalsVerbose(actual122, true, true, buf_err122)) {
            fail(expected122.toString() + " .. " + actual122.toString() + " .. " + buf_err122.toString() + " .. " + operator122)
        }
        val operator123 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator123, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query124 = Query(instance)
        val graph124 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected124 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph125 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected125 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByID_S_AllCollations - false`() {
      ...
      try{
        ...
        val graph134 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected134 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        ...
        val operator135 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator135, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query136 = Query(instance)
        val graph136 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected136 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph137 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected137 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByKeyAllCollations - true`() {
      ...
      try{
        ...
        val graph140 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected140 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        ...
        val operator141 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator141, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query142 = Query(instance)
        val graph142 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected142 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph143 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected143 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - PartitionByKeyAllCollations - false`() {
      ...
      try{
        ...
        val graph146 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected146 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        ...
        val operator147 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator147, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query148 = Query(instance)
        val graph148 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected148 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph149 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected149 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - Simple - true`() {
      ...
      try{
        ...
        val graph152 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected152 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        ...
        val operator153 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator153, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query154 = Query(instance)
        val graph154 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected154 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph155 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected155 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    public fun `DROP DEFAULT - Thread - Simple - false`() {
      ...
      try{
        ...
        val graph158 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected158 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        ...
        val operator159 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator159, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query160 = Query(instance)
        val graph160 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected160 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph161 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected161 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    public fun simulatorHelper(fileName:String,cfg:MutableMap<String,Any>) {
        ...
        val pkg7 = MySimulatorTestingCompareGraphPackage("SELECT ?s ?p ?o WHERE { GRAPH <${outputGraph[0]}> { ?s ?p ?o . }}",MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!, {verifyExecuted7++})
        pkg6.onFinish = pkg7
