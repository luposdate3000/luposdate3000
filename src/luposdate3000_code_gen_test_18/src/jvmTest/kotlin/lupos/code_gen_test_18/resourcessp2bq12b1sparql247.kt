...
public class resourcessp2bq12b1sparql247 {
    ...
    @Test
    public fun `resourcessp2bq12b1sparql247 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `resourcessp2bq12b1sparql247 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `resourcessp2bq12b1sparql247 - in simulator - PartitionByKeyAllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `resourcessp2bq12b1sparql247 - in simulator - PartitionByKeyAllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `resourcessp2bq12b1sparql247 - in simulator - Simple - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `resourcessp2bq12b1sparql247 - in simulator - Simple - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
