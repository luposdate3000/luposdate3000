...
public class resourcessp2bq7sparql700 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/resourcessp2bq7sparql700.input",
    )
    ...
    @Test
    public fun `resourcessp2bq7sparql700 - None - Simple - true`() {
    ...
    @Test
    public fun `resourcessp2bq7sparql700 - None - Simple - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
    ...
    @Test
    public fun `resourcessp2bq7sparql700 - in simulator - Simple - Centralized - true - None - RPL`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcessp2bq7sparql700 - in simulator - Simple - Centralized - false - None - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
