        ...
        for (i in nodes.indices) {
            ...
            if (node is OPNothing) {
                ...
                if (columnProjectionOrder[i].isNotEmpty()) {
                    ...
                    SanityCheck.check({ /*SOURCE_FILE_START*/""/*SOURCE_FILE_END*/ }, { node.getProvidedVariableNames().containsAll(columnNames) })
                } else {
                ...
                if (variables.size == 1 && variables[0] == "?boolean") {
                    ...
                    SanityCheck.check({ /*SOURCE_FILE_START*/""/*SOURCE_FILE_END*/ }, { value.endsWith("\"^^<$datatype>") })
                                    ...
                                    if (value.length > 1) {
                                        if (value.startsWith("\"") && !value.endsWith("\"")) {
                                            ...
                                            if (idx >= 0) {
                                                ...
                                                SanityCheck.check({ /*SOURCE_FILE_START*/""/*SOURCE_FILE_END*/ }, { idx2 >= 0 })
