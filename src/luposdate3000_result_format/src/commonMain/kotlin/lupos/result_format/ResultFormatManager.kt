...
public var ResultFormatManager: MutableMap<String, IResultFormat> = mutableMapOf<String, IResultFormat>(
    ...
    "MEMORY_TABLE" to QueryResultToMemoryTable(),
    "TURTLE_STREAM" to QueryResultToTurtleStream(),
    "XML_STREAM" to QueryResultToXMLStream(),
    "DEFAULT_STREAM" to QueryResultToXMLStream(),
)
