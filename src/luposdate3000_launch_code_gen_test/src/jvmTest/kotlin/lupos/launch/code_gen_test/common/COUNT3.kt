...
public class COUNT3 {
    val inputData = File("src/jvmTest/resources/COUNT3.input").readAsString()
    val targetData = File("src/jvmTest/resources/COUNT3.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/COUNT3.query").readAsString()
    @Test
    fun `COUNT 3}`() {
