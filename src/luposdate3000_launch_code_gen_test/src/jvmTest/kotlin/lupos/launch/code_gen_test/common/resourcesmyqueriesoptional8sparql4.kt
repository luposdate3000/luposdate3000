...
public class resourcesmyqueriesoptional8sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional8sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional8sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional8sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional8sparql4}`() {
