...
public class sparqldl02rqsimplecombinedquery {
    val inputData = File("src/jvmTest/resources/sparqldl02rqsimplecombinedquery.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl02rqsimplecombinedquery.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
