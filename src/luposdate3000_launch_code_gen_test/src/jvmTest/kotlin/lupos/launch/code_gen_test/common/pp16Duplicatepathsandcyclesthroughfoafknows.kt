...
public class pp16Duplicatepathsandcyclesthroughfoafknows {
    val inputData = File("src/jvmTest/resources/pp16Duplicatepathsandcyclesthroughfoafknows.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp16Duplicatepathsandcyclesthroughfoafknows.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
