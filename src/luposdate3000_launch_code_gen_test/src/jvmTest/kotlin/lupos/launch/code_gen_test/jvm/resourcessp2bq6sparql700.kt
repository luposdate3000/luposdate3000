...
public class resourcessp2bq6sparql700 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcessp2bq6sparql700.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcessp2bq6sparql700.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcessp2bq6sparql700.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq6sparql700}`() {
