...
public class resourcesmyqueriesoptional13sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional13sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional13sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional13sparql4 - in simulator`() {
