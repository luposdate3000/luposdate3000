...
public class COUNT6 {
    val inputData = File("src/jvmTest/resources/COUNT6.input").readAsString()
    val targetData = File("src/jvmTest/resources/COUNT6.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/COUNT6.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
    fun `COUNT 6}`() {
