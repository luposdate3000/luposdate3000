...
public class bind03BIND {
    val inputData = File("src/jvmTest/resources/bind03BIND.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind03BIND.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind03BIND.query").readAsString()

    @Test fun `bind03  BIND}`() {
