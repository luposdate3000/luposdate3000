...
public class resourcesbsbmbiquery11853sparql1853 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmbiquery11853sparql1853.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmbiquery11853sparql1853 - in simulator`() {
