...
public class bind08BINDfixeddataforOWLDL {
    val inputData = File("src/jvmTest/resources/bind08BINDfixeddataforOWLDL.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind08BINDfixeddataforOWLDL.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
