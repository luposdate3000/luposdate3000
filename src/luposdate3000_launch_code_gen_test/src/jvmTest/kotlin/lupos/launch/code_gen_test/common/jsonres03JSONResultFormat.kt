...
public class jsonres03JSONResultFormat {
    val inputData = File("src/jvmTest/resources/jsonres03JSONResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/jsonres03JSONResultFormat.output").readAsString()
    val targetType = ".srj"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/jsonres03JSONResultFormat.query").readAsString()
