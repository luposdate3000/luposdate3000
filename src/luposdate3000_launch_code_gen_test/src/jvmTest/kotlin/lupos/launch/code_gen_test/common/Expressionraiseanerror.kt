...
public class Expressionraiseanerror {
    val inputData = File("src/jvmTest/resources/Expressionraiseanerror.input").readAsString()
    val targetData = File("src/jvmTest/resources/Expressionraiseanerror.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
