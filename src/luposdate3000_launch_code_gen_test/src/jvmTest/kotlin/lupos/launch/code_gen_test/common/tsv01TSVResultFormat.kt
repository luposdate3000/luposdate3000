...
public class tsv01TSVResultFormat {
    val inputData = File("src/jvmTest/resources/tsv01TSVResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/tsv01TSVResultFormat.output").readAsString()
    val targetType = ".tsv"
    val inputType = ".ttl"
