...
public class tvs02TSVResultFormat {
    val inputData = File("src/jvmTest/resources/tvs02TSVResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/tvs02TSVResultFormat.output").readAsString()
    val targetType = ".tsv"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/tvs02TSVResultFormat.query").readAsString()

    @Test fun `tvs02  TSV Result Format}`() {
