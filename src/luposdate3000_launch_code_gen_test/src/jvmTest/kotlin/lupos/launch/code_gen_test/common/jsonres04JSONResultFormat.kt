...
public class jsonres04JSONResultFormat {
    val inputData = File("src/jvmTest/resources/jsonres04JSONResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/jsonres04JSONResultFormat.output").readAsString()
    val targetType = ".srj"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/jsonres04JSONResultFormat.query").readAsString()
