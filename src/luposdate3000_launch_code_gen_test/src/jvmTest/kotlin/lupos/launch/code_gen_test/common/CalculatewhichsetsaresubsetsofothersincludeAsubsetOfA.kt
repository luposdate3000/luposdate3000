...
public class CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA {
    val inputData = File("src/jvmTest/resources/CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA.input").readAsString()
    val targetData = File("src/jvmTest/resources/CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
