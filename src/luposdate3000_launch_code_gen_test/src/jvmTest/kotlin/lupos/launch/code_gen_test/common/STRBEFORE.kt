...
public class STRBEFORE {
    val inputData = File("src/jvmTest/resources/STRBEFORE.input").readAsString()
    val targetData = File("src/jvmTest/resources/STRBEFORE.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/STRBEFORE.query").readAsString()
