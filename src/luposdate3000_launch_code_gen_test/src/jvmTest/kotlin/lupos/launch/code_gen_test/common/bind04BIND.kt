...
public class bind04BIND {
    val inputData = File("src/jvmTest/resources/bind04BIND.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind04BIND.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind04BIND.query").readAsString()

    @Test fun `bind04  BIND}`() {
