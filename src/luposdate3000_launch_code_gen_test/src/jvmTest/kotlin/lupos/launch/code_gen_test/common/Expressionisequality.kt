...
public class Expressionisequality {
    val inputData = File("src/jvmTest/resources/Expressionisequality.input").readAsString()
    val targetData = File("src/jvmTest/resources/Expressionisequality.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/Expressionisequality.query").readAsString()

    @Test fun `Expression is equality}`() {
