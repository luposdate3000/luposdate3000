...
public class sparqldl06rqcycleofundistinguishedvariables {
    val inputData = File("src/jvmTest/resources/sparqldl06rqcycleofundistinguishedvariables.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl06rqcycleofundistinguishedvariables.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
