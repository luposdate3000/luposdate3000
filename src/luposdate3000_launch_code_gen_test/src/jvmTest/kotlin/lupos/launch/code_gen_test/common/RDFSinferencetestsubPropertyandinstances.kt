...
public class RDFSinferencetestsubPropertyandinstances {
    val inputData = File("src/jvmTest/resources/RDFSinferencetestsubPropertyandinstances.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetestsubPropertyandinstances.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
