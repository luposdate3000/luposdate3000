...
public class resourcesbsbmexplorequery101853sparql1853 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmexplorequery101853sparql1853.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmexplorequery101853sparql1853}`() {
        ...
        if (!input_a_0.equalsVerbose(result_a_0, false, true, buf_err_a_0)) {
        ...
        if (!target.equalsVerbose(result, false, true, buf_err)) {
