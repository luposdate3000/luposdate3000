...
public class MINwithGROUPBY {
    val inputData = File("src/jvmTest/resources/MINwithGROUPBY.input").readAsString()
    val targetData = File("src/jvmTest/resources/MINwithGROUPBY.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
