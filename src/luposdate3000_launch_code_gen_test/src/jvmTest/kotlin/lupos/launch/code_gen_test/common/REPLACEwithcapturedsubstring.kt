...
public class REPLACEwithcapturedsubstring {
    val inputData = File("src/jvmTest/resources/REPLACEwithcapturedsubstring.input").readAsString()
    val targetData = File("src/jvmTest/resources/REPLACEwithcapturedsubstring.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
