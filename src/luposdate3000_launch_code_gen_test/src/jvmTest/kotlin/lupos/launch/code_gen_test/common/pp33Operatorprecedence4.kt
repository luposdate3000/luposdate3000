...
public class pp33Operatorprecedence4 {
    val inputData = File("src/jvmTest/resources/pp33Operatorprecedence4.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp33Operatorprecedence4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
