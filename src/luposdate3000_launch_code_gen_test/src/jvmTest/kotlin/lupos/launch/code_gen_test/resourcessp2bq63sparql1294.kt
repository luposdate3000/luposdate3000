...
public class resourcessp2bq63sparql1294 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcessp2bq63sparql1294.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcessp2bq63sparql1294.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcessp2bq63sparql1294.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq63sparql1294`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq63sparql1294 - in simulator`() {
