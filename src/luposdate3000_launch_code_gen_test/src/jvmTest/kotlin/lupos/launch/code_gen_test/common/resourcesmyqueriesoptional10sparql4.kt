...
public class resourcesmyqueriesoptional10sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional10sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional10sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional10sparql4.query").readAsString()

    @Ignore
    @Test
    fun `resourcesmyqueriesoptional10sparql4}`() {
