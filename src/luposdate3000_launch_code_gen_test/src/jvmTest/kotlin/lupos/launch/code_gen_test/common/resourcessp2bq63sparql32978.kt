...
public class resourcessp2bq63sparql32978 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq63sparql32978.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq63sparql32978.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq63sparql32978.query").readAsString()
