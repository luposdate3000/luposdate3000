...
public class InlineVALUESgraphpattern {
    val inputData = File("src/jvmTest/resources/InlineVALUESgraphpattern.input").readAsString()
    val targetData = File("src/jvmTest/resources/InlineVALUESgraphpattern.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/InlineVALUESgraphpattern.query").readAsString()

    @Test fun `Inline VALUES graph pattern}`() {
