...
public class PostqueryVALUESwithobjvar1row {
    val inputData = File("src/jvmTest/resources/PostqueryVALUESwithobjvar1row.input").readAsString()
    val targetData = File("src/jvmTest/resources/PostqueryVALUESwithobjvar1row.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/PostqueryVALUESwithobjvar1row.query").readAsString()
