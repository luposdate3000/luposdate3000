...
public class resourcessp2bq12b2sparql973 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcessp2bq12b2sparql973.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcessp2bq12b2sparql973.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcessp2bq12b2sparql973.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12b2sparql973}`() {
