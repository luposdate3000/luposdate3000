...
public class parentquerywithhasChildmin1restriction {
    val inputData = File("src/jvmTest/resources/parentquerywithhasChildmin1restriction.input").readAsString()
    val targetData = File("src/jvmTest/resources/parentquerywithhasChildmin1restriction.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/parentquerywithhasChildmin1restriction.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
