...
public class resourcessp2bq5bsparql21 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq5bsparql21.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq5bsparql21`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq5bsparql21 - in simulator`() {
