...
public class resourcessp2bq5asparql700 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcessp2bq5asparql700.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcessp2bq5asparql700.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcessp2bq5asparql700.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq5asparql700`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq5asparql700 - in simulator`() {
