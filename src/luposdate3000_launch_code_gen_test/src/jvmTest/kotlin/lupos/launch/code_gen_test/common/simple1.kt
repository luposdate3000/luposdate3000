...
public class simple1 {
    val inputData = File("src/jvmTest/resources/simple1.input").readAsString()
    val targetData = File("src/jvmTest/resources/simple1.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/simple1.query").readAsString()
