...
public class SubsetsbyexclusionMINUS {
    val inputData = File("src/jvmTest/resources/SubsetsbyexclusionMINUS.input").readAsString()
    val targetData = File("src/jvmTest/resources/SubsetsbyexclusionMINUS.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/SubsetsbyexclusionMINUS.query").readAsString()

    @Test fun `Subsets by exclusion MINUS}`() {
