...
public class parentquerywithhasChildexactly1Femalerestriction {
    val inputData = File("src/jvmTest/resources/parentquerywithhasChildexactly1Femalerestriction.input").readAsString()
    val targetData = File("src/jvmTest/resources/parentquerywithhasChildexactly1Femalerestriction.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
