...
public class resourcesmyqueriesoptional53sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional53sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional53sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional53sparql5 - in simulator`() {
