...
public class resourcessp2bq12bsparql700 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq12bsparql700.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq12bsparql700.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq12bsparql700.query").readAsString()
