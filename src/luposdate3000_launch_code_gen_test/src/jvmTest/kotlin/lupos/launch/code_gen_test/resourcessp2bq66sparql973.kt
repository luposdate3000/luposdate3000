...
public class resourcessp2bq66sparql973 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcessp2bq66sparql973.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcessp2bq66sparql973.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcessp2bq66sparql973.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq66sparql973`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq66sparql973 - in simulator`() {
