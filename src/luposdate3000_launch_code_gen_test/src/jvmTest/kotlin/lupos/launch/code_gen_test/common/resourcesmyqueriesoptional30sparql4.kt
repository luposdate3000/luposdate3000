...
public class resourcesmyqueriesoptional30sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional30sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional30sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional30sparql4.query").readAsString()

    @Ignore
    @Test
    fun `resourcesmyqueriesoptional30sparql4}`() {
