...
public class filteredsubclassquerywithhasChildsomeThingrestriction {
    val inputData = File("src/jvmTest/resources/filteredsubclassquerywithhasChildsomeThingrestriction.input").readAsString()
    val targetData = File("src/jvmTest/resources/filteredsubclassquerywithhasChildsomeThingrestriction.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
