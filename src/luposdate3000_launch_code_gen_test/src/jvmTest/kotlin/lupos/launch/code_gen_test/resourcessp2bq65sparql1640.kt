...
public class resourcessp2bq65sparql1640 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcessp2bq65sparql1640.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcessp2bq65sparql1640.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcessp2bq65sparql1640.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq65sparql1640`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq65sparql1640 - in simulator`() {
