...
public class resourcesmyqueriesoptional3sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional3sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional3sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional3sparql4.query").readAsString()

    @Ignore
    @Test
    fun `resourcesmyqueriesoptional3sparql4}`() {
