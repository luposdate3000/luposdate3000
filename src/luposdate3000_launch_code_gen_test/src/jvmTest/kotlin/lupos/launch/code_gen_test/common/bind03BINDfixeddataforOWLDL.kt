...
public class bind03BINDfixeddataforOWLDL {
    val inputData = File("src/jvmTest/resources/bind03BINDfixeddataforOWLDL.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind03BINDfixeddataforOWLDL.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
