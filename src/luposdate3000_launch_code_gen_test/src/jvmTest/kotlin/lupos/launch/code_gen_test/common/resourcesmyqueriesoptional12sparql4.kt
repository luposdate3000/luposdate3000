...
public class resourcesmyqueriesoptional12sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional12sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional12sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional12sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional12sparql4}`() {
