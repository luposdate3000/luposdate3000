...
public class resourcesbsbmexplorequery11853sparql1853 {
    val inputData = File("src/jvmTest/resources/resourcesbsbmexplorequery11853sparql1853.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbsbmexplorequery11853sparql1853.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcesbsbmexplorequery11853sparql1853.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmexplorequery11853sparql1853}`() {
