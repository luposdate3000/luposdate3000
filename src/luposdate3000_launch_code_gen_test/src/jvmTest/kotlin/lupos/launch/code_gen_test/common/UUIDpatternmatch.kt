...
public class UUIDpatternmatch {
    val inputData = File("src/jvmTest/resources/UUIDpatternmatch.input").readAsString()
    val targetData = File("src/jvmTest/resources/UUIDpatternmatch.output").readAsString()
    val targetType = ".srx"
    val inputType = ".nt"
