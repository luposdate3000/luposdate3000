...
public class SUBSTR2argument {
    val inputData = File("src/jvmTest/resources/SUBSTR2argument.input").readAsString()
    val targetData = File("src/jvmTest/resources/SUBSTR2argument.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
