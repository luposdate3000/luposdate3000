...
public class Reuseaprojectexpressionvariableinorderby {
    val inputData = File("src/jvmTest/resources/Reuseaprojectexpressionvariableinorderby.input").readAsString()
    val targetData = File("src/jvmTest/resources/Reuseaprojectexpressionvariableinorderby.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/Reuseaprojectexpressionvariableinorderby.query").readAsString()

    @Test fun `Reuse a project expression variable in order by}`() {
