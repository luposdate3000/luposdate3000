...
public class SubtractionwithMINUSfromapartiallyboundminuend {
    val inputData = File("src/jvmTest/resources/SubtractionwithMINUSfromapartiallyboundminuend.input").readAsString()
    val targetData = File("src/jvmTest/resources/SubtractionwithMINUSfromapartiallyboundminuend.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
