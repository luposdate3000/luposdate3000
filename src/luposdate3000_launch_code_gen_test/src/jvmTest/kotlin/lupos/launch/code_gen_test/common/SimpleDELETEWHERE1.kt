...
public class SimpleDELETEWHERE1 {
    val inputData = File("src/jvmTest/resources/SimpleDELETEWHERE1.input").readAsString()
    val targetData = File("src/jvmTest/resources/SimpleDELETEWHERE1.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/SimpleDELETEWHERE1.query").readAsString()
