...
public class RDFSinferencetestrdfXMLLiteral {
    val inputData = File("src/jvmTest/resources/RDFSinferencetestrdfXMLLiteral.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetestrdfXMLLiteral.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/RDFSinferencetestrdfXMLLiteral.query").readAsString()

    @Test fun `RDFS inference test rdfXMLLiteral}`() {
