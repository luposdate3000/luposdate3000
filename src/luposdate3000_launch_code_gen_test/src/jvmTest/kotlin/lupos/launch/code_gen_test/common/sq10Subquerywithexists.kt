...
public class sq10Subquerywithexists {
    val inputData = File("src/jvmTest/resources/sq10Subquerywithexists.input").readAsString()
    val targetData = File("src/jvmTest/resources/sq10Subquerywithexists.output").readAsString()
    val targetType = ".srx"
    val inputType = ".rdf"
