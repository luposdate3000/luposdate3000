...
public class DELETEINSERT2 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/DELETEINSERT2.input").readAsString(),
    )
    ...
    internal val outputData = arrayOf(
        File("src/jvmTest/resources/DELETEINSERT2.output0").readAsString(),
    )
    ...
    internal val query = File("src/jvmTest/resources/DELETEINSERT2.query").readAsString()
    ...
    @Ignore // Reason: >Bug<
    @Test
    fun `DELETE INSERT 2 - in simulator`() {
