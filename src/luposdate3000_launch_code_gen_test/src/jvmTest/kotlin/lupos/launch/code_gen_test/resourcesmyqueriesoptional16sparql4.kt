...
public class resourcesmyqueriesoptional16sparql4 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcesmyqueriesoptional16sparql4.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional16sparql4.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional16sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional16sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional16sparql4 - in simulator`() {
