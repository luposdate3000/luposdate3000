...
public class resourcesmyqueriesoptional39sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional39sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional39sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional39sparql4.query").readAsString()

    @Ignore
    @Test
    fun `resourcesmyqueriesoptional39sparql4}`() {
