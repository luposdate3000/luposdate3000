...
public class resourcesbtc035sparql61664 {
    val inputData = File("src/jvmTest/resources/resourcesbtc035sparql61664.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbtc035sparql61664.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcesbtc035sparql61664.query").readAsString()
