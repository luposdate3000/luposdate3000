...
public class subclassquerywithhasChildsomeThingrestriction {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/subclassquerywithhasChildsomeThingrestriction.input").readAsString(),
    )
    ...
    @Ignore // Reason: >Bug<
    @Test
    fun `subclass query with hasChild some Thing restriction`() {
    ...
    @Ignore // Reason: >Bug<
    @Test
    fun `subclass query with hasChild some Thing restriction - in simulator`() {
