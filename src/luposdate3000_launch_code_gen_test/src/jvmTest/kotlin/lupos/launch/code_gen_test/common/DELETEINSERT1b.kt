...
public class DELETEINSERT1b {
    val inputData = File("src/jvmTest/resources/DELETEINSERT1b.input").readAsString()
    val targetData = File("src/jvmTest/resources/DELETEINSERT1b.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/DELETEINSERT1b.query").readAsString()
