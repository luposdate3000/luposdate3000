...
public class MAXwithGROUPBY {
    val inputData = File("src/jvmTest/resources/MAXwithGROUPBY.input").readAsString()
    val targetData = File("src/jvmTest/resources/MAXwithGROUPBY.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
