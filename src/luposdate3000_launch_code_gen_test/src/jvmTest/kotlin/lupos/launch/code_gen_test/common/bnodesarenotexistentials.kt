...
public class bnodesarenotexistentials {
    val inputData = File("src/jvmTest/resources/bnodesarenotexistentials.input").readAsString()
    val targetData = File("src/jvmTest/resources/bnodesarenotexistentials.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
