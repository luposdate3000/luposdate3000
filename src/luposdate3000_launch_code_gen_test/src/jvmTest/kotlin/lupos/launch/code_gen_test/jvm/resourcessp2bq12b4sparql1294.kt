...
public class resourcessp2bq12b4sparql1294 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq12b4sparql1294.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12b4sparql1294`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12b4sparql1294 - in simulator`() {
