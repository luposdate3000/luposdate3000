...
public class RDFSinferencetestcontainers {
    val inputData = File("src/jvmTest/resources/RDFSinferencetestcontainers.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetestcontainers.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
