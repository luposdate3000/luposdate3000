...
public class MD5overUnicodedata {
    val inputData = File("src/jvmTest/resources/MD5overUnicodedata.input").readAsString()
    val targetData = File("src/jvmTest/resources/MD5overUnicodedata.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/MD5overUnicodedata.query").readAsString()

    @Test fun `MD5 over Unicode data}`() {
