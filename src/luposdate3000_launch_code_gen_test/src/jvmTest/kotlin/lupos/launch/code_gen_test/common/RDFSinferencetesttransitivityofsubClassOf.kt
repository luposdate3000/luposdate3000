...
public class RDFSinferencetesttransitivityofsubClassOf {
    val inputData = File("src/jvmTest/resources/RDFSinferencetesttransitivityofsubClassOf.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetesttransitivityofsubClassOf.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
