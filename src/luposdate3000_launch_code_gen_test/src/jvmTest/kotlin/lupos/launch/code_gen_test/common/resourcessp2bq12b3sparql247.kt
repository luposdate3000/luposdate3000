...
public class resourcessp2bq12b3sparql247 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq12b3sparql247.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq12b3sparql247.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq12b3sparql247.query").readAsString()
