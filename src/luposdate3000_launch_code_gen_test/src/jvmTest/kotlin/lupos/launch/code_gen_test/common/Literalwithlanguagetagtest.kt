...
public class Literalwithlanguagetagtest {
    val inputData = File("src/jvmTest/resources/Literalwithlanguagetagtest.input").readAsString()
    val targetData = File("src/jvmTest/resources/Literalwithlanguagetagtest.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/Literalwithlanguagetagtest.query").readAsString()

    @Test fun `Literal with language tag test}`() {
