...
public class AVGwithGROUPBY {
    val inputData = File("src/jvmTest/resources/AVGwithGROUPBY.input").readAsString()
    val targetData = File("src/jvmTest/resources/AVGwithGROUPBY.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
