...
public class RDFtestforblanknodecardinalities {
    val inputData = File("src/jvmTest/resources/RDFtestforblanknodecardinalities.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFtestforblanknodecardinalities.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/RDFtestforblanknodecardinalities.query").readAsString()

    @Test fun `RDF test for blank node cardinalities}`() {
