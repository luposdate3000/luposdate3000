...
public class resourcesbtc030sparql867 {
    val inputData = File("src/jvmTest/resources/resourcesbtc030sparql867.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbtc030sparql867.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
