...
public class resourcesmyqueriesoptional40sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional40sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional40sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional40sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional40sparql4}`() {
