...
public class resourcesmyqueriesoptional25sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional25sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional25sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional25sparql4 - in simulator`() {
