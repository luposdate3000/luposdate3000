...
public class bind11BINDscopingVariableinfilterinscope {
    val inputData = File("src/jvmTest/resources/bind11BINDscopingVariableinfilterinscope.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind11BINDscopingVariableinfilterinscope.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind11BINDscopingVariableinfilterinscope.query").readAsString()

    @Test fun `bind11  BIND scoping  Variable in filter in scope}`() {
