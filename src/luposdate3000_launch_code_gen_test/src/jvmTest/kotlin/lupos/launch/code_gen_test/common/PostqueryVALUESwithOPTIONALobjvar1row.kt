...
public class PostqueryVALUESwithOPTIONALobjvar1row {
    val inputData = File("src/jvmTest/resources/PostqueryVALUESwithOPTIONALobjvar1row.input").readAsString()
    val targetData = File("src/jvmTest/resources/PostqueryVALUESwithOPTIONALobjvar1row.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
