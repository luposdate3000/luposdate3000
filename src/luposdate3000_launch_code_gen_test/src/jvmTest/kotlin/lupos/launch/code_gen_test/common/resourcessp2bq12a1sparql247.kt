...
public class resourcessp2bq12a1sparql247 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq12a1sparql247.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq12a1sparql247.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq12a1sparql247.query").readAsString()
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12a1sparql247}`() {
