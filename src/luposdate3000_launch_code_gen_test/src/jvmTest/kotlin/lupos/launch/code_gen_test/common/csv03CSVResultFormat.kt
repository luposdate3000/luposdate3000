...
public class csv03CSVResultFormat {
    val inputData = File("src/jvmTest/resources/csv03CSVResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/csv03CSVResultFormat.output").readAsString()
    val targetType = ".csv"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/csv03CSVResultFormat.query").readAsString()
