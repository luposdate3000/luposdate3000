...
public class resourcesmyqueriesoptional22sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional22sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional22sparql4 - in simulator`() {
