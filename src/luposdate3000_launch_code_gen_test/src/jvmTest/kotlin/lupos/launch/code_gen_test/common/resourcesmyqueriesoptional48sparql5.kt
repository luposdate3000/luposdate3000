...
public class resourcesmyqueriesoptional48sparql5 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional48sparql5.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional48sparql5.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional48sparql5.query").readAsString()
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional48sparql5}`() {
