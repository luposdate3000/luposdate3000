...
public class resourcessp2bq67sparql32978 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq67sparql32978.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq67sparql32978`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq67sparql32978 - in simulator`() {
