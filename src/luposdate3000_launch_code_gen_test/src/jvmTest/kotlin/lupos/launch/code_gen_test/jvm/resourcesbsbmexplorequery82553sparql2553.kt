...
public class resourcesbsbmexplorequery82553sparql2553 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcesbsbmexplorequery82553sparql2553.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcesbsbmexplorequery82553sparql2553.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcesbsbmexplorequery82553sparql2553.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmexplorequery82553sparql2553}`() {
