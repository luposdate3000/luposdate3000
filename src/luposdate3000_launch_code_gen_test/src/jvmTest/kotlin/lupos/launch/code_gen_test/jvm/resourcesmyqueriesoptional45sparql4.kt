...
public class resourcesmyqueriesoptional45sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional45sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional45sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional45sparql4 - in simulator`() {
