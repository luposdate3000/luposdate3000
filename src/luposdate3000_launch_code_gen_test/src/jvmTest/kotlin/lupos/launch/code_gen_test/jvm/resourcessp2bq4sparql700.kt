...
public class resourcessp2bq4sparql700 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq4sparql700.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq4sparql700`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq4sparql700 - in simulator`() {
