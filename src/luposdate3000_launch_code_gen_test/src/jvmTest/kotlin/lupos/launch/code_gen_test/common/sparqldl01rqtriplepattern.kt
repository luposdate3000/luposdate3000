...
public class sparqldl01rqtriplepattern {
    val inputData = File("src/jvmTest/resources/sparqldl01rqtriplepattern.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl01rqtriplepattern.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/sparqldl01rqtriplepattern.query").readAsString()

    @Test fun `sparqldl01rq triple pattern}`() {
