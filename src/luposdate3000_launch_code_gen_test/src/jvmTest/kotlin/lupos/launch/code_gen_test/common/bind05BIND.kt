...
public class bind05BIND {
    val inputData = File("src/jvmTest/resources/bind05BIND.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind05BIND.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind05BIND.query").readAsString()

    @Test fun `bind05  BIND}`() {
