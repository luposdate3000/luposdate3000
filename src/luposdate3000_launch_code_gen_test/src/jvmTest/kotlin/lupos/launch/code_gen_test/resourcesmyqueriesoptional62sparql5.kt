...
public class resourcesmyqueriesoptional62sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional62sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional62sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional62sparql5 - in simulator`() {
