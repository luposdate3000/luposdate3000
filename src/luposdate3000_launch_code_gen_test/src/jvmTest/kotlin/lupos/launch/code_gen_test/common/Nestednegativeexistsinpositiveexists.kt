...
public class Nestednegativeexistsinpositiveexists {
    val inputData = File("src/jvmTest/resources/Nestednegativeexistsinpositiveexists.input").readAsString()
    val targetData = File("src/jvmTest/resources/Nestednegativeexistsinpositiveexists.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
