...
public class bind07BIND {
    val inputData = File("src/jvmTest/resources/bind07BIND.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind07BIND.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind07BIND.query").readAsString()

    @Test fun `bind07  BIND}`() {
