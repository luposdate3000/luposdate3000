...
public class RDFSinferencetestdomain {
    val inputData = File("src/jvmTest/resources/RDFSinferencetestdomain.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetestdomain.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
