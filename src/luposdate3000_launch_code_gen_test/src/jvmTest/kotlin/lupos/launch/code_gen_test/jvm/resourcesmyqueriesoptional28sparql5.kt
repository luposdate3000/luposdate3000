...
public class resourcesmyqueriesoptional28sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional28sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional28sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional28sparql5 - in simulator`() {
