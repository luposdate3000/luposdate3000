...
public class parentquerywithhasChildsomeFemalerestriction {
    val inputData = File("src/jvmTest/resources/parentquerywithhasChildsomeFemalerestriction.input").readAsString()
    val targetData = File("src/jvmTest/resources/parentquerywithhasChildsomeFemalerestriction.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
