...
public class resourcesmyqueriesoptional6sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional6sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional6sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional6sparql4.query").readAsString()
