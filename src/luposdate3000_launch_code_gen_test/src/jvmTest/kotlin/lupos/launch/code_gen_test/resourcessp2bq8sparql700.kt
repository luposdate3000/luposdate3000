...
public class resourcessp2bq8sparql700 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq8sparql700.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq8sparql700`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq8sparql700 - in simulator`() {
