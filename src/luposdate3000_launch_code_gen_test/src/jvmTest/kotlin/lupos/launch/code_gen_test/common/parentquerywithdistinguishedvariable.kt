...
public class parentquerywithdistinguishedvariable {
    val inputData = File("src/jvmTest/resources/parentquerywithdistinguishedvariable.input").readAsString()
    val targetData = File("src/jvmTest/resources/parentquerywithdistinguishedvariable.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
