...
public class RDFinferencetest {
    val inputData = File("src/jvmTest/resources/RDFinferencetest.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFinferencetest.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/RDFinferencetest.query").readAsString()

    @Test fun `RDF inference test}`() {
