...
public class SHA1onUnicodedata {
    val inputData = File("src/jvmTest/resources/SHA1onUnicodedata.input").readAsString()
    val targetData = File("src/jvmTest/resources/SHA1onUnicodedata.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
