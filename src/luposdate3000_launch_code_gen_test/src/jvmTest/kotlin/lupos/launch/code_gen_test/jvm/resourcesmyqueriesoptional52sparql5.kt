...
public class resourcesmyqueriesoptional52sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional52sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional52sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional52sparql5 - in simulator`() {
