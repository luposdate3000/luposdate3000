...
public class csv01CSVResultFormat {
    val inputData = File("src/jvmTest/resources/csv01CSVResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/csv01CSVResultFormat.output").readAsString()
    val targetType = ".csv"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/csv01CSVResultFormat.query").readAsString()

    @Ignore
    @Test
    fun `csv01  CSV Result Format}`() {
