...
public class CLEARSILENTGRAPHiri {
    val inputData = File("src/jvmTest/resources/CLEARSILENTGRAPHiri.input").readAsString()
    val targetData = File("src/jvmTest/resources/CLEARSILENTGRAPHiri.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/CLEARSILENTGRAPHiri.query").readAsString()

    @Test fun `CLEAR SILENT GRAPH iri}`() {
