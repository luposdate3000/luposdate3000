...
public class MINUTES {
    val inputData = File("src/jvmTest/resources/MINUTES.input").readAsString()
    val targetData = File("src/jvmTest/resources/MINUTES.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/MINUTES.query").readAsString()
