...
public class resourcesmyqueriesoptional31sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional31sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional31sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional31sparql4 - in simulator`() {
