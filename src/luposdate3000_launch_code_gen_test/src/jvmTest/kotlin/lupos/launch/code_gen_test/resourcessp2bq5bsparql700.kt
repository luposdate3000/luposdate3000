...
public class resourcessp2bq5bsparql700 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq5bsparql700.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq5bsparql700`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq5bsparql700 - in simulator`() {
