...
public class sparqldl08rqtwodistinguishedvariablesundist {
    val inputData = File("src/jvmTest/resources/sparqldl08rqtwodistinguishedvariablesundist.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl08rqtwodistinguishedvariablesundist.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/sparqldl08rqtwodistinguishedvariablesundist.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
