...
public class papersparqldlQ4 {
    val inputData = File("src/jvmTest/resources/papersparqldlQ4.input").readAsString()
    val targetData = File("src/jvmTest/resources/papersparqldlQ4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/papersparqldlQ4.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
    fun `papersparqldlQ4}`() {
