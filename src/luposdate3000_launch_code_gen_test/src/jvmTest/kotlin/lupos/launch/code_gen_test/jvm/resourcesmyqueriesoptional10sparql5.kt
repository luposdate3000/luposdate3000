...
public class resourcesmyqueriesoptional10sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional10sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional10sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional10sparql5 - in simulator`() {
