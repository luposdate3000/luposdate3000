...
public class BNODEstr {
    val inputData = File("src/jvmTest/resources/BNODEstr.input").readAsString()
    val targetData = File("src/jvmTest/resources/BNODEstr.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/BNODEstr.query").readAsString()
