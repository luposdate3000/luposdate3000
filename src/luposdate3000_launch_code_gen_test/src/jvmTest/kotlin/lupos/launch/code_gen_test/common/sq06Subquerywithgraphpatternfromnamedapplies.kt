...
public class sq06Subquerywithgraphpatternfromnamedapplies {
    val inputData = File("src/jvmTest/resources/sq06Subquerywithgraphpatternfromnamedapplies.input").readAsString()
    val targetData = File("src/jvmTest/resources/sq06Subquerywithgraphpatternfromnamedapplies.output").readAsString()
    val targetType = ".srx"
    val inputType = ".rdf"
