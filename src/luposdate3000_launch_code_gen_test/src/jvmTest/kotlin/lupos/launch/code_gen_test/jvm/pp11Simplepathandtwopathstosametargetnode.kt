...
public class pp11Simplepathandtwopathstosametargetnode {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/pp11Simplepathandtwopathstosametargetnode.input").readAsString(),
    )
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    fun `pp11 Simple path and two paths to same target node - in simulator`() {
