...
public class resourcessp2bq12csparql32978 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq12csparql32978.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12csparql32978`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12csparql32978 - in simulator`() {
