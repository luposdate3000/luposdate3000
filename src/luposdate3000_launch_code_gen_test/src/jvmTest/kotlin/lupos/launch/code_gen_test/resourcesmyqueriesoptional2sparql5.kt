...
public class resourcesmyqueriesoptional2sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional2sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional2sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional2sparql5 - in simulator`() {
