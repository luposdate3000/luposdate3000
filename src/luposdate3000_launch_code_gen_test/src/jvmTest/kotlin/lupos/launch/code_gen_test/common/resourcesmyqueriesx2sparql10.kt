...
public class resourcesmyqueriesx2sparql10 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesx2sparql10.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesx2sparql10.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesx2sparql10.query").readAsString()
