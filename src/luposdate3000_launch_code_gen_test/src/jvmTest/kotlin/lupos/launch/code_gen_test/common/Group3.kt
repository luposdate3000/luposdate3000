...
public class Group3 {
    val inputData = File("src/jvmTest/resources/Group3.input").readAsString()
    val targetData = File("src/jvmTest/resources/Group3.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/Group3.query").readAsString()
