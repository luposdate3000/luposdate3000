...
public class resourcesmyqueriesoptional58sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional58sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional58sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional58sparql4.query").readAsString()
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional58sparql4}`() {
