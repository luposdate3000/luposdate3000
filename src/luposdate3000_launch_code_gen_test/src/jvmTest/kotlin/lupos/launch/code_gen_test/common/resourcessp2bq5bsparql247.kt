...
public class resourcessp2bq5bsparql247 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq5bsparql247.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq5bsparql247.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq5bsparql247.query").readAsString()
