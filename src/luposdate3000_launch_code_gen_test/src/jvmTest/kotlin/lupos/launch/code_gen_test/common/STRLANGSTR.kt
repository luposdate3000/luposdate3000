...
public class STRLANGSTR {
    val inputData = File("src/jvmTest/resources/STRLANGSTR.input").readAsString()
    val targetData = File("src/jvmTest/resources/STRLANGSTR.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/STRLANGSTR.query").readAsString()
    @Test
    fun `STRLANGSTR}`() {
