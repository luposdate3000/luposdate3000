...
public class Reuseaprojectexpressionvariableinselect {
    val inputData = File("src/jvmTest/resources/Reuseaprojectexpressionvariableinselect.input").readAsString()
    val targetData = File("src/jvmTest/resources/Reuseaprojectexpressionvariableinselect.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
