...
public class resourcessp2bq63sparql21 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq63sparql21.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq63sparql21`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq63sparql21 - in simulator`() {
