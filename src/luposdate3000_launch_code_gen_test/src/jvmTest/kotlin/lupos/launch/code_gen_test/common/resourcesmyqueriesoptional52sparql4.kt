...
public class resourcesmyqueriesoptional52sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional52sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional52sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional52sparql4.query").readAsString()

    @Ignore
    @Test
    fun `resourcesmyqueriesoptional52sparql4}`() {
