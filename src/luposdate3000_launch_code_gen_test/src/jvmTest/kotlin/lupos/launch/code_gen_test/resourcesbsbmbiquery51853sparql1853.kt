...
public class resourcesbsbmbiquery51853sparql1853 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesbsbmbiquery51853sparql1853.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmbiquery51853sparql1853`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmbiquery51853sparql1853 - in simulator`() {
