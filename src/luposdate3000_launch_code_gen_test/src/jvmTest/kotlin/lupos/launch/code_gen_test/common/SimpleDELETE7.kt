...
public class SimpleDELETE7 {
    val inputData = File("src/jvmTest/resources/SimpleDELETE7.input").readAsString()
    val targetData = File("src/jvmTest/resources/SimpleDELETE7.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/SimpleDELETE7.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
    fun `Simple DELETE 7}`() {
