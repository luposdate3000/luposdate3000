...
public class resourcessp2bq12b4sparql247 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq12b4sparql247.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12b4sparql247`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12b4sparql247 - in simulator`() {
