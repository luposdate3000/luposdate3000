...
public class pp14Starpathoverfoafknows {
    val inputData = File("src/jvmTest/resources/pp14Starpathoverfoafknows.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp14Starpathoverfoafknows.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/pp14Starpathoverfoafknows.query").readAsString()
