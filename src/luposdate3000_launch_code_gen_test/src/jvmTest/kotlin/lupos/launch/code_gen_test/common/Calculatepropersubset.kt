...
public class Calculatepropersubset {
    val inputData = File("src/jvmTest/resources/Calculatepropersubset.input").readAsString()
    val targetData = File("src/jvmTest/resources/Calculatepropersubset.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
