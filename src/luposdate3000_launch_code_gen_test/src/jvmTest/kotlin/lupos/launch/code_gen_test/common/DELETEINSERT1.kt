...
public class DELETEINSERT1 {
    val inputData = File("src/jvmTest/resources/DELETEINSERT1.input").readAsString()
    val targetData = File("src/jvmTest/resources/DELETEINSERT1.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/DELETEINSERT1.query").readAsString()
