...
public class resourcessp2bq3bsparql1640 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq3bsparql1640.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq3bsparql1640.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq3bsparql1640.query").readAsString()
