...
public class pp11Simplepathandtwopathstosametargetnode {
    val inputData = File("src/jvmTest/resources/pp11Simplepathandtwopathstosametargetnode.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp11Simplepathandtwopathstosametargetnode.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
