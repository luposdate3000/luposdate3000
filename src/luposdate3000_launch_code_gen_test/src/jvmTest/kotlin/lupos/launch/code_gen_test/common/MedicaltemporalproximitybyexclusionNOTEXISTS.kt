...
public class MedicaltemporalproximitybyexclusionNOTEXISTS {
    val inputData = File("src/jvmTest/resources/MedicaltemporalproximitybyexclusionNOTEXISTS.input").readAsString()
    val targetData = File("src/jvmTest/resources/MedicaltemporalproximitybyexclusionNOTEXISTS.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
