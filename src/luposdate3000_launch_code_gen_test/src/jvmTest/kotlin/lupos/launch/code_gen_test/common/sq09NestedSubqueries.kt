...
public class sq09NestedSubqueries {
    val inputData = File("src/jvmTest/resources/sq09NestedSubqueries.input").readAsString()
    val targetData = File("src/jvmTest/resources/sq09NestedSubqueries.output").readAsString()
    val targetType = ".srx"
    val inputType = ".rdf"
