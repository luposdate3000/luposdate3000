...
public class SubsetsbyexclusionNOTEXISTS {
    val inputData = File("src/jvmTest/resources/SubsetsbyexclusionNOTEXISTS.input").readAsString()
    val targetData = File("src/jvmTest/resources/SubsetsbyexclusionNOTEXISTS.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/SubsetsbyexclusionNOTEXISTS.query").readAsString()

    @Test fun `Subsets by exclusion NOT EXISTS}`() {
