...
public class RDFSinferencetestsubClassOf {
    val inputData = File("src/jvmTest/resources/RDFSinferencetestsubClassOf.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetestsubClassOf.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
