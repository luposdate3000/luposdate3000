...
public class resourcessp2bq3csparql21 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq3csparql21.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq3csparql21`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq3csparql21 - in simulator`() {
