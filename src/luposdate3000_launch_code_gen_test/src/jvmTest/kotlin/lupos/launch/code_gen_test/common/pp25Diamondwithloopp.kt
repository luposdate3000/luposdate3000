...
public class pp25Diamondwithloopp {
    val inputData = File("src/jvmTest/resources/pp25Diamondwithloopp.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp25Diamondwithloopp.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
