...
public class bind04BINDfixeddataforOWLDL {
    val inputData = File("src/jvmTest/resources/bind04BINDfixeddataforOWLDL.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind04BINDfixeddataforOWLDL.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind04BINDfixeddataforOWLDL.query").readAsString()
