...
public class SimpleDELETE3 {
    val inputData = File("src/jvmTest/resources/SimpleDELETE3.input").readAsString()
    val targetData = File("src/jvmTest/resources/SimpleDELETE3.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/SimpleDELETE3.query").readAsString()

    @Test fun `Simple DELETE 3}`() {
