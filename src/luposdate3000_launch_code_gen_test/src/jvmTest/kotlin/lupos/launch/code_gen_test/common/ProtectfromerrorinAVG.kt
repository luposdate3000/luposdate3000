...
public class ProtectfromerrorinAVG {
    val inputData = File("src/jvmTest/resources/ProtectfromerrorinAVG.input").readAsString()
    val targetData = File("src/jvmTest/resources/ProtectfromerrorinAVG.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/ProtectfromerrorinAVG.query").readAsString()
