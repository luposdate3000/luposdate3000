...
public class jsonres01JSONResultFormat {
    val inputData = File("src/jvmTest/resources/jsonres01JSONResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/jsonres01JSONResultFormat.output").readAsString()
    val targetType = ".srj"
    val inputType = ".ttl"
