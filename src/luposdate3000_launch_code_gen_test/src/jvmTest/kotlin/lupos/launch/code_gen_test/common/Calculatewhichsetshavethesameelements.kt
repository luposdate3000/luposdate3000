...
public class Calculatewhichsetshavethesameelements {
    val inputData = File("src/jvmTest/resources/Calculatewhichsetshavethesameelements.input").readAsString()
    val targetData = File("src/jvmTest/resources/Calculatewhichsetshavethesameelements.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
