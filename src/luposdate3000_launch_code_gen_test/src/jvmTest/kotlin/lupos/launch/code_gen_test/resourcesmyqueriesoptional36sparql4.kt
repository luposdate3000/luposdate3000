...
public class resourcesmyqueriesoptional36sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional36sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional36sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional36sparql4 - in simulator`() {
