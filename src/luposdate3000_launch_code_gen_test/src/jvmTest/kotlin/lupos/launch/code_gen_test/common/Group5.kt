...
public class Group5 {
    val inputData = File("src/jvmTest/resources/Group5.input").readAsString()
    val targetData = File("src/jvmTest/resources/Group5.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/Group5.query").readAsString()
    @Test
    fun `Group5}`() {
