...
public class SimpleDELETE1 {
    val inputData = File("src/jvmTest/resources/SimpleDELETE1.input").readAsString()
    val targetData = File("src/jvmTest/resources/SimpleDELETE1.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/SimpleDELETE1.query").readAsString()
