...
public class RDFSinferencetestcombiningsubPropertyOfanddomain {
    val inputData = File("src/jvmTest/resources/RDFSinferencetestcombiningsubPropertyOfanddomain.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetestcombiningsubPropertyOfanddomain.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
