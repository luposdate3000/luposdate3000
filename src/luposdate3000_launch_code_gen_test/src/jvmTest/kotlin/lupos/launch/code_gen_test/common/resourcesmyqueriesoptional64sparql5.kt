...
public class resourcesmyqueriesoptional64sparql5 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional64sparql5.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional64sparql5.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional64sparql5.query").readAsString()

    @Ignore
    @Test
    fun `resourcesmyqueriesoptional64sparql5}`() {
