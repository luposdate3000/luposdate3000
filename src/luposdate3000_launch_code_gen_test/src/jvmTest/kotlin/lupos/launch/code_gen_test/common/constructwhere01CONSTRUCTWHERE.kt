...
public class constructwhere01CONSTRUCTWHERE {
    val inputData = File("src/jvmTest/resources/constructwhere01CONSTRUCTWHERE.input").readAsString()
    val targetData = File("src/jvmTest/resources/constructwhere01CONSTRUCTWHERE.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/constructwhere01CONSTRUCTWHERE.query").readAsString()

    @Test fun `constructwhere01  CONSTRUCT WHERE}`() {
