...
public class SUBSTR3argument {
    val inputData = File("src/jvmTest/resources/SUBSTR3argument.input").readAsString()
    val targetData = File("src/jvmTest/resources/SUBSTR3argument.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
