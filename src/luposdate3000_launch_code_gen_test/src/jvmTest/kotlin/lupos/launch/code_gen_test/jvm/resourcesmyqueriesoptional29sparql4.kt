...
public class resourcesmyqueriesoptional29sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional29sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional29sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional29sparql4 - in simulator`() {
