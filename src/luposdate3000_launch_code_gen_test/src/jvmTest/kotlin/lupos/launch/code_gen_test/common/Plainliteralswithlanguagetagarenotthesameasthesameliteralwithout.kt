...
public class Plainliteralswithlanguagetagarenotthesameasthesameliteralwithout {
    val inputData = File("src/jvmTest/resources/Plainliteralswithlanguagetagarenotthesameasthesameliteralwithout.input").readAsString()
    val targetData = File("src/jvmTest/resources/Plainliteralswithlanguagetagarenotthesameasthesameliteralwithout.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/Plainliteralswithlanguagetagarenotthesameasthesameliteralwithout.query").readAsString()

    @Test fun `Plain literals with language tag are not the same as the same literal without}`() {
