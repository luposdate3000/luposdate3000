...
public class cvs02CSVResultFormat {
    val inputData = File("src/jvmTest/resources/cvs02CSVResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/cvs02CSVResultFormat.output").readAsString()
    val targetType = ".csv"
    val inputType = ".ttl"
