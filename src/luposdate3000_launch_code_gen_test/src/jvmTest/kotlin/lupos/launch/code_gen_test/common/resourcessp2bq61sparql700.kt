...
public class resourcessp2bq61sparql700 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq61sparql700.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq61sparql700.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq61sparql700.query").readAsString()

    @Ignore
    @Test
    fun `resourcessp2bq61sparql700}`() {
