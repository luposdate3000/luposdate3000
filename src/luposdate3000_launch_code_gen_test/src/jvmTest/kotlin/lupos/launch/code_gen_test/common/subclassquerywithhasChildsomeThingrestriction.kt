...
public class subclassquerywithhasChildsomeThingrestriction {
    val inputData = File("src/jvmTest/resources/subclassquerywithhasChildsomeThingrestriction.input").readAsString()
    val targetData = File("src/jvmTest/resources/subclassquerywithhasChildsomeThingrestriction.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/subclassquerywithhasChildsomeThingrestriction.query").readAsString()
