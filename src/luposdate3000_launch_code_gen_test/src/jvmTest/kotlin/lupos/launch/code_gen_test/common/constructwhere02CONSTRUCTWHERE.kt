...
public class constructwhere02CONSTRUCTWHERE {
    val inputData = File("src/jvmTest/resources/constructwhere02CONSTRUCTWHERE.input").readAsString()
    val targetData = File("src/jvmTest/resources/constructwhere02CONSTRUCTWHERE.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/constructwhere02CONSTRUCTWHERE.query").readAsString()

    @Test fun `constructwhere02  CONSTRUCT WHERE}`() {
