...
public class resourcesmyqueriesoptional64sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional64sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional64sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional64sparql4 - in simulator`() {
