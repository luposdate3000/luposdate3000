...
public class pp12Variablelengthpathandtwopathstosametargetnode {
    val inputData = File("src/jvmTest/resources/pp12Variablelengthpathandtwopathstosametargetnode.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp12Variablelengthpathandtwopathstosametargetnode.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
