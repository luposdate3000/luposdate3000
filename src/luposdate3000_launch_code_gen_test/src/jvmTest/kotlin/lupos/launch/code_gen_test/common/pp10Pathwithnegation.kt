...
public class pp10Pathwithnegation {
    val inputData = File("src/jvmTest/resources/pp10Pathwithnegation.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp10Pathwithnegation.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
