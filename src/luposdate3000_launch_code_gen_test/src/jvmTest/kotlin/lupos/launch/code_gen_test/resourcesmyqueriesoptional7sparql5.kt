...
public class resourcesmyqueriesoptional7sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional7sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional7sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional7sparql5 - in simulator`() {
