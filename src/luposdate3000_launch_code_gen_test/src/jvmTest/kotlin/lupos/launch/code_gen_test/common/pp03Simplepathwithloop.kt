...
public class pp03Simplepathwithloop {
    val inputData = File("src/jvmTest/resources/pp03Simplepathwithloop.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp03Simplepathwithloop.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/pp03Simplepathwithloop.query").readAsString()
