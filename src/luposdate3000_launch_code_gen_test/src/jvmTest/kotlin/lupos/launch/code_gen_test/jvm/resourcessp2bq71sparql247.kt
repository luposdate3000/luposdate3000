...
public class resourcessp2bq71sparql247 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq71sparql247.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq71sparql247`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq71sparql247 - in simulator`() {
