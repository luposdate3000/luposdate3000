...
public class pp09Reversesequencepath {
    val inputData = File("src/jvmTest/resources/pp09Reversesequencepath.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp09Reversesequencepath.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
