...
public class STRUUIDpatternmatch {
    val inputData = File("src/jvmTest/resources/STRUUIDpatternmatch.input").readAsString()
    val targetData = File("src/jvmTest/resources/STRUUIDpatternmatch.output").readAsString()
    val targetType = ".srx"
    val inputType = ".nt"
    val query = File("src/jvmTest/resources/STRUUIDpatternmatch.query").readAsString()
