...
public class resourcessp2bq62sparql1294 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq62sparql1294.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq62sparql1294.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq62sparql1294.query").readAsString()
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq62sparql1294}`() {
