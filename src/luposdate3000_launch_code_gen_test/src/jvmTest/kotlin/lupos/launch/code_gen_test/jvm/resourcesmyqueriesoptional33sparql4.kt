...
public class resourcesmyqueriesoptional33sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional33sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional33sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional33sparql4 - in simulator`() {
