...
public class resourcesmyqueriesoptional17sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional17sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional17sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional17sparql4 - in simulator`() {
