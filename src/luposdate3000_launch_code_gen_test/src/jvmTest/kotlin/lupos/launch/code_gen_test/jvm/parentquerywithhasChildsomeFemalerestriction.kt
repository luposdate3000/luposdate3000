...
public class parentquerywithhasChildsomeFemalerestriction {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/parentquerywithhasChildsomeFemalerestriction.input").readAsString(),
    )
    ...
    @Ignore // Reason: >Bug<
    @Test
    fun `parent query with hasChild some Female restriction - in simulator`() {
