...
public class COUNT2 {
    val inputData = File("src/jvmTest/resources/COUNT2.input").readAsString()
    val targetData = File("src/jvmTest/resources/COUNT2.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/COUNT2.query").readAsString()
    @Test
    fun `COUNT 2}`() {
