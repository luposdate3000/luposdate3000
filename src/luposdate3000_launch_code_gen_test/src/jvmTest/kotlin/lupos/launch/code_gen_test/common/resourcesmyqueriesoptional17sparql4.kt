...
public class resourcesmyqueriesoptional17sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional17sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional17sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional17sparql4.query").readAsString()
