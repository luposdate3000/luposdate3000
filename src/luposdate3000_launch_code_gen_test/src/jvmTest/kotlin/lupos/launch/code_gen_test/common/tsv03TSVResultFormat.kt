...
public class tsv03TSVResultFormat {
    val inputData = File("src/jvmTest/resources/tsv03TSVResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/tsv03TSVResultFormat.output").readAsString()
    val targetType = ".tsv"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/tsv03TSVResultFormat.query").readAsString()

    @Test fun `tsv03  TSV Result Format}`() {
