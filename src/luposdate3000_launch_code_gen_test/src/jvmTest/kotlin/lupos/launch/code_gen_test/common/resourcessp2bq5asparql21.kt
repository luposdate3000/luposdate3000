...
public class resourcessp2bq5asparql21 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq5asparql21.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq5asparql21.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq5asparql21.query").readAsString()
