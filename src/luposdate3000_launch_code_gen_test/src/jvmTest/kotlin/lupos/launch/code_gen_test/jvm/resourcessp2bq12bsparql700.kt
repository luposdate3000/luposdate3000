...
public class resourcessp2bq12bsparql700 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq12bsparql700.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12bsparql700`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12bsparql700 - in simulator`() {
