...
public class pp01Simplepath {
    val inputData = File("src/jvmTest/resources/pp01Simplepath.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp01Simplepath.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
