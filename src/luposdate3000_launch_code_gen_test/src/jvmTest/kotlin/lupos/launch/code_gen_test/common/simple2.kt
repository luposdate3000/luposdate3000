...
public class simple2 {
    val inputData = File("src/jvmTest/resources/simple2.input").readAsString()
    val targetData = File("src/jvmTest/resources/simple2.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/simple2.query").readAsString()
