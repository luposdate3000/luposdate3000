...
public class resourcesmyqueriesoptional62sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional62sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional62sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional62sparql4 - in simulator`() {
