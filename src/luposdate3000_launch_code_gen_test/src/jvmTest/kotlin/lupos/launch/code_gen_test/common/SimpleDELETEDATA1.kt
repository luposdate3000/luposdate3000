...
public class SimpleDELETEDATA1 {
    val inputData = File("src/jvmTest/resources/SimpleDELETEDATA1.input").readAsString()
    val targetData = File("src/jvmTest/resources/SimpleDELETEDATA1.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
