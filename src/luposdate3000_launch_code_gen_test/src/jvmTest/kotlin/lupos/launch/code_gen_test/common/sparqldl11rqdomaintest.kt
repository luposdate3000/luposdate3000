...
public class sparqldl11rqdomaintest {
    val inputData = File("src/jvmTest/resources/sparqldl11rqdomaintest.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl11rqdomaintest.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
