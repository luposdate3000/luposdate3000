...
public class RDFSinferencetestrange {
    val inputData = File("src/jvmTest/resources/RDFSinferencetestrange.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetestrange.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
