...
public class PostsubqueryVALUES {
    val inputData = File("src/jvmTest/resources/PostsubqueryVALUES.input").readAsString()
    val targetData = File("src/jvmTest/resources/PostsubqueryVALUES.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/PostsubqueryVALUES.query").readAsString()

    @Test fun `Postsubquery VALUES}`() {
