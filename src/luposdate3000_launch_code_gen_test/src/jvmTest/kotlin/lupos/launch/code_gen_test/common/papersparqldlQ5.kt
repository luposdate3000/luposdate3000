...
public class papersparqldlQ5 {
    val inputData = File("src/jvmTest/resources/papersparqldlQ5.input").readAsString()
    val targetData = File("src/jvmTest/resources/papersparqldlQ5.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/papersparqldlQ5.query").readAsString()
