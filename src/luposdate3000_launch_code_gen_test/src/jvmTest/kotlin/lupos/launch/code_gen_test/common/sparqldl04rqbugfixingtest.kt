...
public class sparqldl04rqbugfixingtest {
    val inputData = File("src/jvmTest/resources/sparqldl04rqbugfixingtest.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl04rqbugfixingtest.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
