...
public class bnodesarenotexistentialswithanswer {
    val inputData = File("src/jvmTest/resources/bnodesarenotexistentialswithanswer.input").readAsString()
    val targetData = File("src/jvmTest/resources/bnodesarenotexistentialswithanswer.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
