...
public class Expressionmayreturnnovalue {
    val inputData = File("src/jvmTest/resources/Expressionmayreturnnovalue.input").readAsString()
    val targetData = File("src/jvmTest/resources/Expressionmayreturnnovalue.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
