...
public class sq11Subquerylimitperresource {
    val inputData = File("src/jvmTest/resources/sq11Subquerylimitperresource.input").readAsString()
    val targetData = File("src/jvmTest/resources/sq11Subquerylimitperresource.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
