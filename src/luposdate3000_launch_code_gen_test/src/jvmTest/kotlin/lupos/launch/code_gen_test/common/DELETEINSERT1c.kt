...
public class DELETEINSERT1c {
    val inputData = File("src/jvmTest/resources/DELETEINSERT1c.input").readAsString()
    val targetData = File("src/jvmTest/resources/DELETEINSERT1c.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/DELETEINSERT1c.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
    fun `DELETE INSERT 1c}`() {
