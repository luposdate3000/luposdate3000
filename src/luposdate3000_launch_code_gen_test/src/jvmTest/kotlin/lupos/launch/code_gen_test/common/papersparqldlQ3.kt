...
public class papersparqldlQ3 {
    val inputData = File("src/jvmTest/resources/papersparqldlQ3.input").readAsString()
    val targetData = File("src/jvmTest/resources/papersparqldlQ3.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/papersparqldlQ3.query").readAsString()
