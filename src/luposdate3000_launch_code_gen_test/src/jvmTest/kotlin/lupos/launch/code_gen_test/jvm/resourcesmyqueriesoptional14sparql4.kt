...
public class resourcesmyqueriesoptional14sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional14sparql4.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional14sparql4 - in simulator`() {
