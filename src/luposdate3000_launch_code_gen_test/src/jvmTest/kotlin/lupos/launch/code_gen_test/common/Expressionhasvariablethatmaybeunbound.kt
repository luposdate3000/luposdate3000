...
public class Expressionhasvariablethatmaybeunbound {
    val inputData = File("src/jvmTest/resources/Expressionhasvariablethatmaybeunbound.input").readAsString()
    val targetData = File("src/jvmTest/resources/Expressionhasvariablethatmaybeunbound.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
