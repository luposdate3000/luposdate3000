...
public class HOURS {
    val inputData = File("src/jvmTest/resources/HOURS.input").readAsString()
    val targetData = File("src/jvmTest/resources/HOURS.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/HOURS.query").readAsString()
    @Test
    fun `HOURS}`() {
