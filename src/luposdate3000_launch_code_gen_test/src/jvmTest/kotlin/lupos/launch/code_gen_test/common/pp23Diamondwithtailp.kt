...
public class pp23Diamondwithtailp {
    val inputData = File("src/jvmTest/resources/pp23Diamondwithtailp.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp23Diamondwithtailp.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/pp23Diamondwithtailp.query").readAsString()
