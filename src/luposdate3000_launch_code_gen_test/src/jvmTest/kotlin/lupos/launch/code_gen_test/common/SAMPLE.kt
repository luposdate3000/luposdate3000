...
public class SAMPLE {
    val inputData = File("src/jvmTest/resources/SAMPLE.input").readAsString()
    val targetData = File("src/jvmTest/resources/SAMPLE.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/SAMPLE.query").readAsString()
