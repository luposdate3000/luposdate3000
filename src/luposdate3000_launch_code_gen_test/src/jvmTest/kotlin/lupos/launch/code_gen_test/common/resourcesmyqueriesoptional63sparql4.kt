...
public class resourcesmyqueriesoptional63sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional63sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional63sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional63sparql4.query").readAsString()
