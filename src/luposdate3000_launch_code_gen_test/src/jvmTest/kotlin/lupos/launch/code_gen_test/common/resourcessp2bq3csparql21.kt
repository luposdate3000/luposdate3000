...
public class resourcessp2bq3csparql21 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq3csparql21.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq3csparql21.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq3csparql21.query").readAsString()
