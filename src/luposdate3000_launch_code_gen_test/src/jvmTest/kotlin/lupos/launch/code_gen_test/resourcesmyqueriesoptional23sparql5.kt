...
public class resourcesmyqueriesoptional23sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional23sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional23sparql5 - in simulator`() {
