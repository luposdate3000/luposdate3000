...
public class resourcesbtc020sparql80 {
    val inputData = File("src/jvmTest/resources/resourcesbtc020sparql80.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbtc020sparql80.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcesbtc020sparql80.query").readAsString()
