...
public class resourcesbtc005sparql578 {
    val inputData = File("src/jvmTest/resources/resourcesbtc005sparql578.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbtc005sparql578.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcesbtc005sparql578.query").readAsString()
