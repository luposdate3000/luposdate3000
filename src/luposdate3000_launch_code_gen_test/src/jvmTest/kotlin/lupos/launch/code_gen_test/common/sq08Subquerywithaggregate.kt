...
public class sq08Subquerywithaggregate {
    val inputData = File("src/jvmTest/resources/sq08Subquerywithaggregate.input").readAsString()
    val targetData = File("src/jvmTest/resources/sq08Subquerywithaggregate.output").readAsString()
    val targetType = ".srx"
    val inputType = ".rdf"
