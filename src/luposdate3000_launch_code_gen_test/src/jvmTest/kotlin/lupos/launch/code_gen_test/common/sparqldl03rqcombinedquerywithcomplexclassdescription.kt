...
public class sparqldl03rqcombinedquerywithcomplexclassdescription {
    val inputData = File("src/jvmTest/resources/sparqldl03rqcombinedquerywithcomplexclassdescription.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl03rqcombinedquerywithcomplexclassdescription.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
