...
public class SimpleDELETEWHERE3 {
    val inputData = File("src/jvmTest/resources/SimpleDELETEWHERE3.input").readAsString()
    val targetData = File("src/jvmTest/resources/SimpleDELETEWHERE3.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/SimpleDELETEWHERE3.query").readAsString()

    @Test fun `Simple DELETE WHERE 3}`() {
