...
public class simpletriplepatternmatch {
    val inputData = File("src/jvmTest/resources/simpletriplepatternmatch.input").readAsString()
    val targetData = File("src/jvmTest/resources/simpletriplepatternmatch.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
