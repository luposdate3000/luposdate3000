...
public class resourcesmyqueriesoptional41sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional41sparql5.query").readAsString()
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional41sparql5 - in simulator`() {
