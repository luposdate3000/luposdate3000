...
public class bind05BINDfixeddataforOWLDL {
    val inputData = File("src/jvmTest/resources/bind05BINDfixeddataforOWLDL.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind05BINDfixeddataforOWLDL.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind05BINDfixeddataforOWLDL.query").readAsString()
