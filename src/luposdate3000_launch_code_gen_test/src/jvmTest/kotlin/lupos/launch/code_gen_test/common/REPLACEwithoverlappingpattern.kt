...
public class REPLACEwithoverlappingpattern {
    val inputData = File("src/jvmTest/resources/REPLACEwithoverlappingpattern.input").readAsString()
    val targetData = File("src/jvmTest/resources/REPLACEwithoverlappingpattern.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/REPLACEwithoverlappingpattern.query").readAsString()
