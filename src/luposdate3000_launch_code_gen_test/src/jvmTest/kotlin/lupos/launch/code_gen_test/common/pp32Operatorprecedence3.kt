...
public class pp32Operatorprecedence3 {
    val inputData = File("src/jvmTest/resources/pp32Operatorprecedence3.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp32Operatorprecedence3.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/pp32Operatorprecedence3.query").readAsString()

    @Ignore
    @Test
    fun `pp32 Operator precedence 3}`() {
