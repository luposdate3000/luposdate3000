...
public class bind02BINDfixeddataforOWLDL {
    val inputData = File("src/jvmTest/resources/bind02BINDfixeddataforOWLDL.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind02BINDfixeddataforOWLDL.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind02BINDfixeddataforOWLDL.query").readAsString()
