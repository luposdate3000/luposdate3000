...
public class sparqldl07rqtwodistinguishedvariablesundist {
    val inputData = File("src/jvmTest/resources/sparqldl07rqtwodistinguishedvariablesundist.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl07rqtwodistinguishedvariablesundist.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
