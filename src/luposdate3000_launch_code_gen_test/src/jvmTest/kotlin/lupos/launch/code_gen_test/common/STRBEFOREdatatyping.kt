...
public class STRBEFOREdatatyping {
    val inputData = File("src/jvmTest/resources/STRBEFOREdatatyping.input").readAsString()
    val targetData = File("src/jvmTest/resources/STRBEFOREdatatyping.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
