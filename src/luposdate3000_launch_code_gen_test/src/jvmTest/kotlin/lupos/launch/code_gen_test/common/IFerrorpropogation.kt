...
public class IFerrorpropogation {
    val inputData = File("src/jvmTest/resources/IFerrorpropogation.input").readAsString()
    val targetData = File("src/jvmTest/resources/IFerrorpropogation.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
