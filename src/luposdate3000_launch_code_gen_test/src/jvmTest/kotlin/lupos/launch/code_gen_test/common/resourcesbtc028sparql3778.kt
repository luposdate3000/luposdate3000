...
public class resourcesbtc028sparql3778 {
    val inputData = File("src/jvmTest/resources/resourcesbtc028sparql3778.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbtc028sparql3778.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcesbtc028sparql3778.query").readAsString()
