...
public class PostqueryVALUESwithsubjobjvars2rowswithUNDEF {
    val inputData = File("src/jvmTest/resources/PostqueryVALUESwithsubjobjvars2rowswithUNDEF.input").readAsString()
    val targetData = File("src/jvmTest/resources/PostqueryVALUESwithsubjobjvars2rowswithUNDEF.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
