...
public class papersparqldlQ2 {
    val inputData = File("src/jvmTest/resources/papersparqldlQ2.input").readAsString()
    val targetData = File("src/jvmTest/resources/papersparqldlQ2.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/papersparqldlQ2.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
    fun `papersparqldlQ2}`() {
