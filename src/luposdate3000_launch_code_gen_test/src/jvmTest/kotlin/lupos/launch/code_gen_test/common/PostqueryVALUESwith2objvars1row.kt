...
public class PostqueryVALUESwith2objvars1row {
    val inputData = File("src/jvmTest/resources/PostqueryVALUESwith2objvars1row.input").readAsString()
    val targetData = File("src/jvmTest/resources/PostqueryVALUESwith2objvars1row.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/PostqueryVALUESwith2objvars1row.query").readAsString()

    @Ignore // Reason: >Bug<
    @Test
    fun `Postquery VALUES with 2 objvars 1 row}`() {
