...
public class simple7 {
    val inputData = File("src/jvmTest/resources/simple7.input").readAsString()
    val targetData = File("src/jvmTest/resources/simple7.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/simple7.query").readAsString()
