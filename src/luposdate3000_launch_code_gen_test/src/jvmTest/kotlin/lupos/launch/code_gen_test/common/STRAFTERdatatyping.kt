...
public class STRAFTERdatatyping {
    val inputData = File("src/jvmTest/resources/STRAFTERdatatyping.input").readAsString()
    val targetData = File("src/jvmTest/resources/STRAFTERdatatyping.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
