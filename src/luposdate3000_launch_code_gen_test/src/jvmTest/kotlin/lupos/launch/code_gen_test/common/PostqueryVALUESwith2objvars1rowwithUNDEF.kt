...
public class PostqueryVALUESwith2objvars1rowwithUNDEF {
    val inputData = File("src/jvmTest/resources/PostqueryVALUESwith2objvars1rowwithUNDEF.input").readAsString()
    val targetData = File("src/jvmTest/resources/PostqueryVALUESwith2objvars1rowwithUNDEF.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
