...
public class resourcessp2bq67sparql700 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq67sparql700.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq67sparql700.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq67sparql700.query").readAsString()
