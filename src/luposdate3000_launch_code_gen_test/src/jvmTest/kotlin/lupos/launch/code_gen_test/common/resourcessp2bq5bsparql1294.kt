...
public class resourcessp2bq5bsparql1294 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq5bsparql1294.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq5bsparql1294.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq5bsparql1294.query").readAsString()
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq5bsparql1294}`() {
