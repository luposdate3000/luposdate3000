...
public class bind01BINDfixeddataforOWLDL {
    val inputData = File("src/jvmTest/resources/bind01BINDfixeddataforOWLDL.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind01BINDfixeddataforOWLDL.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind01BINDfixeddataforOWLDL.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
