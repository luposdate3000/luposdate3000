...
public class resourcessp2bq5asparql247 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq5asparql247.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq5asparql247.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq5asparql247.query").readAsString()
