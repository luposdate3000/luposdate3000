...
public class resourcessp2bq62sparql21 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq62sparql21.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq62sparql21.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq62sparql21.query").readAsString()
