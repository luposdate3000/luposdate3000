...
public class sparqldl09rqundistvarstest {
    val inputData = File("src/jvmTest/resources/sparqldl09rqundistvarstest.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl09rqundistvarstest.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/sparqldl09rqundistvarstest.query").readAsString()
