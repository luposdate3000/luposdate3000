...
public class pp28aDiamondwithlooppp {
    val inputData = File("src/jvmTest/resources/pp28aDiamondwithlooppp.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp28aDiamondwithlooppp.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
