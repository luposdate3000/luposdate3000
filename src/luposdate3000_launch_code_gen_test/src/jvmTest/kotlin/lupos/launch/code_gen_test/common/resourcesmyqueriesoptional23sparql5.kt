...
public class resourcesmyqueriesoptional23sparql5 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional23sparql5.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional23sparql5.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
