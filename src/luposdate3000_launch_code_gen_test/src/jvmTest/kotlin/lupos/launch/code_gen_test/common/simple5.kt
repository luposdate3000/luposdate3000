...
public class simple5 {
    val inputData = File("src/jvmTest/resources/simple5.input").readAsString()
    val targetData = File("src/jvmTest/resources/simple5.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/simple5.query").readAsString()
