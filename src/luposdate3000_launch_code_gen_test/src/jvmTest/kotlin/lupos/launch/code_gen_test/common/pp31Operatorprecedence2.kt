...
public class pp31Operatorprecedence2 {
    val inputData = File("src/jvmTest/resources/pp31Operatorprecedence2.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp31Operatorprecedence2.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/pp31Operatorprecedence2.query").readAsString()
