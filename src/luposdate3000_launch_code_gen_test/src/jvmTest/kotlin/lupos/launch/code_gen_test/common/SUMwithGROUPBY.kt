...
public class SUMwithGROUPBY {
    val inputData = File("src/jvmTest/resources/SUMwithGROUPBY.input").readAsString()
    val targetData = File("src/jvmTest/resources/SUMwithGROUPBY.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
