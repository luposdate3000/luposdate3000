...
public class sparqldl12rqrangetest {
    val inputData = File("src/jvmTest/resources/sparqldl12rqrangetest.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl12rqrangetest.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
