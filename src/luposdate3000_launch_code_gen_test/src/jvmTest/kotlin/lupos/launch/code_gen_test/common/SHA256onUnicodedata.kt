...
public class SHA256onUnicodedata {
    val inputData = File("src/jvmTest/resources/SHA256onUnicodedata.input").readAsString()
    val targetData = File("src/jvmTest/resources/SHA256onUnicodedata.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
