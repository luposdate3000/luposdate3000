...
public class PositiveEXISTS1 {
    val inputData = File("src/jvmTest/resources/PositiveEXISTS1.input").readAsString()
    val targetData = File("src/jvmTest/resources/PositiveEXISTS1.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
