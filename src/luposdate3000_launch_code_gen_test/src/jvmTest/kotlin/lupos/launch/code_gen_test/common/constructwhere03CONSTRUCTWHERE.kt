...
public class constructwhere03CONSTRUCTWHERE {
    val inputData = File("src/jvmTest/resources/constructwhere03CONSTRUCTWHERE.input").readAsString()
    val targetData = File("src/jvmTest/resources/constructwhere03CONSTRUCTWHERE.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/constructwhere03CONSTRUCTWHERE.query").readAsString()

    @Test fun `constructwhere03  CONSTRUCT WHERE}`() {
