...
public class parentquerywithhasChildmin1Femalerestriction {
    val inputData = File("src/jvmTest/resources/parentquerywithhasChildmin1Femalerestriction.input").readAsString()
    val targetData = File("src/jvmTest/resources/parentquerywithhasChildmin1Femalerestriction.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/parentquerywithhasChildmin1Femalerestriction.query").readAsString()
