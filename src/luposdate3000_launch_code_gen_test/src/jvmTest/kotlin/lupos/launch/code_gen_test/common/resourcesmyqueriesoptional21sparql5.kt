...
public class resourcesmyqueriesoptional21sparql5 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional21sparql5.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional21sparql5.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional21sparql5.query").readAsString()
