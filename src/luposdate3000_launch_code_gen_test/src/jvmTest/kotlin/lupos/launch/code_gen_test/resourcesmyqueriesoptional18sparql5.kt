...
public class resourcesmyqueriesoptional18sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional18sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional18sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional18sparql5 - in simulator`() {
