...
public class resourcesbsbmexplorequery91853sparql1853 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcesbsbmexplorequery91853sparql1853.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcesbsbmexplorequery91853sparql1853.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcesbsbmexplorequery91853sparql1853.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmexplorequery91853sparql1853`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmexplorequery91853sparql1853 - in simulator`() {
