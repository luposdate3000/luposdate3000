...
public class SHA512onUnicodedata {
    val inputData = File("src/jvmTest/resources/SHA512onUnicodedata.input").readAsString()
    val targetData = File("src/jvmTest/resources/SHA512onUnicodedata.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
