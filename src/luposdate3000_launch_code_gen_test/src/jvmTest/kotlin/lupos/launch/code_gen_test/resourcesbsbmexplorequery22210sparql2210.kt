...
public class resourcesbsbmexplorequery22210sparql2210 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcesbsbmexplorequery22210sparql2210.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcesbsbmexplorequery22210sparql2210.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcesbsbmexplorequery22210sparql2210.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmexplorequery22210sparql2210`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmexplorequery22210sparql2210 - in simulator`() {
