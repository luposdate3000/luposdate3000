...
public class STRLANGTypeErrors {
    val inputData = File("src/jvmTest/resources/STRLANGTypeErrors.input").readAsString()
    val targetData = File("src/jvmTest/resources/STRLANGTypeErrors.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
