...
public class resourcesmyqueriesoptional55sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional55sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional55sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional55sparql4 - in simulator`() {
