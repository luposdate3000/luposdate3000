...
public class resourcesmyqueriesoptional24sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional24sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional24sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional24sparql4 - in simulator`() {
