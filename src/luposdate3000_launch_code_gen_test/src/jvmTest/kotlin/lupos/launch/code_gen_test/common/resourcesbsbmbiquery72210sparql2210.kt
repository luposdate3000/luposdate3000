...
public class resourcesbsbmbiquery72210sparql2210 {
    val inputData = File("src/jvmTest/resources/resourcesbsbmbiquery72210sparql2210.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbsbmbiquery72210sparql2210.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcesbsbmbiquery72210sparql2210.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesbsbmbiquery72210sparql2210}`() {
