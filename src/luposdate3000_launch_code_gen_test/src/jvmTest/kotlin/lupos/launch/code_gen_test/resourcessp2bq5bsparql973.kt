...
public class resourcessp2bq5bsparql973 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq5bsparql973.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq5bsparql973`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq5bsparql973 - in simulator`() {
