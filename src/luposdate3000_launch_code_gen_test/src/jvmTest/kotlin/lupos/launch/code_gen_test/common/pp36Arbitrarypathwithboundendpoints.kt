...
public class pp36Arbitrarypathwithboundendpoints {
    val inputData = File("src/jvmTest/resources/pp36Arbitrarypathwithboundendpoints.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp36Arbitrarypathwithboundendpoints.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
