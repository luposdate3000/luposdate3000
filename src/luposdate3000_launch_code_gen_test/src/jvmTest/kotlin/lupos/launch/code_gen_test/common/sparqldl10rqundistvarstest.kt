...
public class sparqldl10rqundistvarstest {
    val inputData = File("src/jvmTest/resources/sparqldl10rqundistvarstest.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl10rqundistvarstest.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
