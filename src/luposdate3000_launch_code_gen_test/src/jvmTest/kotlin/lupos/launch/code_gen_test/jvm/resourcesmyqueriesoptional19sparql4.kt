...
public class resourcesmyqueriesoptional19sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional19sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional19sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional19sparql4 - in simulator`() {
