...
public class bind06BINDfixeddataforOWLDL {
    val inputData = File("src/jvmTest/resources/bind06BINDfixeddataforOWLDL.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind06BINDfixeddataforOWLDL.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind06BINDfixeddataforOWLDL.query").readAsString()
