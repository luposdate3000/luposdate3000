...
public class sparqldl05rqsimpleundistinguishedvariabletest {
    val inputData = File("src/jvmTest/resources/sparqldl05rqsimpleundistinguishedvariabletest.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl05rqsimpleundistinguishedvariabletest.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
