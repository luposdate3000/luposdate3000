...
public class jsonres02JSONResultFormat {
    val inputData = File("src/jvmTest/resources/jsonres02JSONResultFormat.input").readAsString()
    val targetData = File("src/jvmTest/resources/jsonres02JSONResultFormat.output").readAsString()
    val targetType = ".srj"
    val inputType = ".ttl"
