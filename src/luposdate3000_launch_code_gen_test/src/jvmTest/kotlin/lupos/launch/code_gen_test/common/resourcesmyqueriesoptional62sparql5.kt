...
public class resourcesmyqueriesoptional62sparql5 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional62sparql5.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional62sparql5.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional62sparql5.query").readAsString()
