...
public class DELETEINSERT5b {
    val inputData = File("src/jvmTest/resources/DELETEINSERT5b.input").readAsString()
    val targetData = File("src/jvmTest/resources/DELETEINSERT5b.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/DELETEINSERT5b.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
