...
public class sparqldl13rqsameAs {
    val inputData = File("src/jvmTest/resources/sparqldl13rqsameAs.input").readAsString()
    val targetData = File("src/jvmTest/resources/sparqldl13rqsameAs.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
