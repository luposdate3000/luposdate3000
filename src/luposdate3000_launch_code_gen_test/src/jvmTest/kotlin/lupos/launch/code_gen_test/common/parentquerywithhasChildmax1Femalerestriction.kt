...
public class parentquerywithhasChildmax1Femalerestriction {
    val inputData = File("src/jvmTest/resources/parentquerywithhasChildmax1Femalerestriction.input").readAsString()
    val targetData = File("src/jvmTest/resources/parentquerywithhasChildmax1Femalerestriction.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/parentquerywithhasChildmax1Femalerestriction.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
