...
public class papersparqldlQ1rdfs {
    val inputData = File("src/jvmTest/resources/papersparqldlQ1rdfs.input").readAsString()
    val targetData = File("src/jvmTest/resources/papersparqldlQ1rdfs.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
