...
public class Existswithoneconstant {
    val inputData = File("src/jvmTest/resources/Existswithoneconstant.input").readAsString()
    val targetData = File("src/jvmTest/resources/Existswithoneconstant.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/Existswithoneconstant.query").readAsString()
