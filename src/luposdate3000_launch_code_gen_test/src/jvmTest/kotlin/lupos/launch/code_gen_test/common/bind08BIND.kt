...
public class bind08BIND {
    val inputData = File("src/jvmTest/resources/bind08BIND.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind08BIND.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind08BIND.query").readAsString()

    @Test fun `bind08  BIND}`() {
