...
public class pp30Operatorprecedence1 {
    val inputData = File("src/jvmTest/resources/pp30Operatorprecedence1.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp30Operatorprecedence1.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/pp30Operatorprecedence1.query").readAsString()

    @Ignore // Reason: >using not implemented feature<
    @Test
    fun `pp30 Operator precedence 1}`() {
