...
public class resourcesmyqueriesoptional18sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional18sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional18sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional18sparql4 - in simulator`() {
