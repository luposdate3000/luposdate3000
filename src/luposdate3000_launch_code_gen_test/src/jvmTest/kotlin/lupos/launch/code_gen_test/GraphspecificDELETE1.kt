...
public class GraphspecificDELETE1 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/GraphspecificDELETE1.input").readAsString(),
        File("src/jvmTest/resources/GraphspecificDELETE1.input1").readAsString(),
        File("src/jvmTest/resources/GraphspecificDELETE1.input2").readAsString(),
    )
    ...
    internal val outputData = arrayOf(
        File("src/jvmTest/resources/GraphspecificDELETE1.output0").readAsString(),
        File("src/jvmTest/resources/GraphspecificDELETE1.output1").readAsString(),
        File("src/jvmTest/resources/GraphspecificDELETE1.output2").readAsString(),
    )
