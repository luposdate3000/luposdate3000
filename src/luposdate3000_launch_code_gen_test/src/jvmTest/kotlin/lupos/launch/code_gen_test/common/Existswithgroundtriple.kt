...
public class Existswithgroundtriple {
    val inputData = File("src/jvmTest/resources/Existswithgroundtriple.input").readAsString()
    val targetData = File("src/jvmTest/resources/Existswithgroundtriple.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
