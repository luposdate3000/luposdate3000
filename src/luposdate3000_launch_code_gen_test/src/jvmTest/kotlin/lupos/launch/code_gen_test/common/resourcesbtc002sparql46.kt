...
public class resourcesbtc002sparql46 {
    val inputData = File("src/jvmTest/resources/resourcesbtc002sparql46.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbtc002sparql46.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcesbtc002sparql46.query").readAsString()

    @Ignore
    @Test
    fun `resourcesbtc002sparql46}`() {
