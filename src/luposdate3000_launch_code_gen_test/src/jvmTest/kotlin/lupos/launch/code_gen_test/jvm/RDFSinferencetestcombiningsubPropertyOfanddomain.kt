...
public class RDFSinferencetestcombiningsubPropertyOfanddomain {
    ...
    internal val query = File("src/jvmTest/resources/RDFSinferencetestcombiningsubPropertyOfanddomain.query").readAsString()
    ...
    @Ignore // Reason: >Bug<
    @Test
    fun `RDFS inference test combining subPropertyOf and domain - in simulator`() {
