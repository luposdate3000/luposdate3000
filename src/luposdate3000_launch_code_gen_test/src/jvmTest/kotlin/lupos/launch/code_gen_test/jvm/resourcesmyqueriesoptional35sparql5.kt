...
public class resourcesmyqueriesoptional35sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional35sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional35sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional35sparql5 - in simulator`() {
