...
public class resourcesmyqueriesoptional32sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional32sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional32sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional32sparql4 - in simulator`() {
