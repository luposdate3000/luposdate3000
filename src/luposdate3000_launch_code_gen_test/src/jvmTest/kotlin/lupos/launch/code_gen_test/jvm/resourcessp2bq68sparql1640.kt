...
public class resourcessp2bq68sparql1640 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq68sparql1640.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq68sparql1640`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq68sparql1640 - in simulator`() {
