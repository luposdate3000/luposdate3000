...
public class resourcesbsbmbiquery12553sparql2553 {
    val inputData = File("src/jvmTest/resources/resourcesbsbmbiquery12553sparql2553.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbsbmbiquery12553sparql2553.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
