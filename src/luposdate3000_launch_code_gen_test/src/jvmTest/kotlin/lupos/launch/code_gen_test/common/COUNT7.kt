...
public class COUNT7 {
    val inputData = File("src/jvmTest/resources/COUNT7.input").readAsString()
    val targetData = File("src/jvmTest/resources/COUNT7.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/COUNT7.query").readAsString()
