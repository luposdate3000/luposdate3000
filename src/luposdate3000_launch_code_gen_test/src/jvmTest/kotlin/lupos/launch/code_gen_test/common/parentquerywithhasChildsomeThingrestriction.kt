...
public class parentquerywithhasChildsomeThingrestriction {
    val inputData = File("src/jvmTest/resources/parentquerywithhasChildsomeThingrestriction.input").readAsString()
    val targetData = File("src/jvmTest/resources/parentquerywithhasChildsomeThingrestriction.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
