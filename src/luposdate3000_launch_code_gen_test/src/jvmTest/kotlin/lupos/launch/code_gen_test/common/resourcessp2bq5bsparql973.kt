...
public class resourcessp2bq5bsparql973 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq5bsparql973.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq5bsparql973.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq5bsparql973.query").readAsString()
