...
public class resourcessp2bq12b1sparql32978 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcessp2bq12b1sparql32978.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcessp2bq12b1sparql32978.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcessp2bq12b1sparql32978.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12b1sparql32978`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12b1sparql32978 - in simulator`() {
