...
public class sq12SubqueryinCONSTRUCTwithbuiltins {
    val inputData = File("src/jvmTest/resources/sq12SubqueryinCONSTRUCTwithbuiltins.input").readAsString()
    val targetData = File("src/jvmTest/resources/sq12SubqueryinCONSTRUCTwithbuiltins.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/sq12SubqueryinCONSTRUCTwithbuiltins.query").readAsString()

    @Test fun `sq12  Subquery in CONSTRUCT with builtins}`() {
