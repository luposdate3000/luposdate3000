...
public class simple8 {
    val inputData = File("src/jvmTest/resources/simple8.input").readAsString()
    val targetData = File("src/jvmTest/resources/simple8.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/simple8.query").readAsString()
