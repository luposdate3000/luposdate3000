...
public class resourcesmyqueriesoptional40sparql5 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional40sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional40sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional40sparql5 - in simulator`() {
