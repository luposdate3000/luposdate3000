...
public class PostqueryVALUESwithpredvar1row {
    val inputData = File("src/jvmTest/resources/PostqueryVALUESwithpredvar1row.input").readAsString()
    val targetData = File("src/jvmTest/resources/PostqueryVALUESwithpredvar1row.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/PostqueryVALUESwithpredvar1row.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
