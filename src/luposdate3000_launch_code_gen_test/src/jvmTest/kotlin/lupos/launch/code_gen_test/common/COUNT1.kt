...
public class COUNT1 {
    val inputData = File("src/jvmTest/resources/COUNT1.input").readAsString()
    val targetData = File("src/jvmTest/resources/COUNT1.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/COUNT1.query").readAsString()
    @Test
    fun `COUNT 1}`() {
