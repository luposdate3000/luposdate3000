...
public class simple4 {
    val inputData = File("src/jvmTest/resources/simple4.input").readAsString()
    val targetData = File("src/jvmTest/resources/simple4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/simple4.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
    fun `simple 4}`() {
