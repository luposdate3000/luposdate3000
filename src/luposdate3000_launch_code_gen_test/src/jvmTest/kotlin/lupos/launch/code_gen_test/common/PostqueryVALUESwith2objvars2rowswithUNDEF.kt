...
public class PostqueryVALUESwith2objvars2rowswithUNDEF {
    val inputData = File("src/jvmTest/resources/PostqueryVALUESwith2objvars2rowswithUNDEF.input").readAsString()
    val targetData = File("src/jvmTest/resources/PostqueryVALUESwith2objvars2rowswithUNDEF.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
