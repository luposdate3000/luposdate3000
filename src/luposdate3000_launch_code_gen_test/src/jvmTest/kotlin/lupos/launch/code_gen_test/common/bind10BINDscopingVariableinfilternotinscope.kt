...
public class bind10BINDscopingVariableinfilternotinscope {
    val inputData = File("src/jvmTest/resources/bind10BINDscopingVariableinfilternotinscope.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind10BINDscopingVariableinfilternotinscope.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind10BINDscopingVariableinfilternotinscope.query").readAsString()

    @Test fun `bind10  BIND scoping  Variable in filter not in scope}`() {
