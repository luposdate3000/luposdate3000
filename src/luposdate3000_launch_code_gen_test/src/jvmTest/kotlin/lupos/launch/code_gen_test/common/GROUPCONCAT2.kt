...
public class GROUPCONCAT2 {
    val inputData = File("src/jvmTest/resources/GROUPCONCAT2.input").readAsString()
    val targetData = File("src/jvmTest/resources/GROUPCONCAT2.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/GROUPCONCAT2.query").readAsString()
