...
public class STRAFTER {
    val inputData = File("src/jvmTest/resources/STRAFTER.input").readAsString()
    val targetData = File("src/jvmTest/resources/STRAFTER.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/STRAFTER.query").readAsString()
