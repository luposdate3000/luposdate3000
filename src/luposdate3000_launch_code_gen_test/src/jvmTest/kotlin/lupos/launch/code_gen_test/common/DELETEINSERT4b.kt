...
public class DELETEINSERT4b {
    val inputData = File("src/jvmTest/resources/DELETEINSERT4b.input").readAsString()
    val targetData = File("src/jvmTest/resources/DELETEINSERT4b.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/DELETEINSERT4b.query").readAsString()
