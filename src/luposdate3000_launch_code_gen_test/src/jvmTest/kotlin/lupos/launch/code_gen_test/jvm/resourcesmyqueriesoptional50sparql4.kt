...
public class resourcesmyqueriesoptional50sparql4 {
    ...
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional50sparql4.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional50sparql4`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional50sparql4 - in simulator`() {
