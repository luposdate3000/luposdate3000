...
public class bind06BIND {
    val inputData = File("src/jvmTest/resources/bind06BIND.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind06BIND.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind06BIND.query").readAsString()

    @Test fun `bind06  BIND}`() {
