...
public class pp08Reversepath {
    val inputData = File("src/jvmTest/resources/pp08Reversepath.input").readAsString()
    val targetData = File("src/jvmTest/resources/pp08Reversepath.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
