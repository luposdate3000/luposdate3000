...
public class RDFSinferencetesttransitivityofsubPropertyOf {
    val inputData = File("src/jvmTest/resources/RDFSinferencetesttransitivityofsubPropertyOf.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetesttransitivityofsubPropertyOf.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/RDFSinferencetesttransitivityofsubPropertyOf.query").readAsString()
