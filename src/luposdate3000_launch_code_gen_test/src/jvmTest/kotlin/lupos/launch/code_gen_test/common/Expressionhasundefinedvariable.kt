...
public class Expressionhasundefinedvariable {
    val inputData = File("src/jvmTest/resources/Expressionhasundefinedvariable.input").readAsString()
    val targetData = File("src/jvmTest/resources/Expressionhasundefinedvariable.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
