...
public class GROUPCONCATwithSEPARATOR {
    val inputData = File("src/jvmTest/resources/GROUPCONCATwithSEPARATOR.input").readAsString()
    val targetData = File("src/jvmTest/resources/GROUPCONCATwithSEPARATOR.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
