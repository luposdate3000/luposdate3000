...
public class PostqueryVALUESwithsubjvar1row {
    val inputData = File("src/jvmTest/resources/PostqueryVALUESwithsubjvar1row.input").readAsString()
    val targetData = File("src/jvmTest/resources/PostqueryVALUESwithsubjvar1row.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/PostqueryVALUESwithsubjvar1row.query").readAsString()

    @Test fun `Postquery VALUES with subjvar 1 row}`() {
