...
public class sq14limitbyresource {
    val inputData = File("src/jvmTest/resources/sq14limitbyresource.input").readAsString()
    val targetData = File("src/jvmTest/resources/sq14limitbyresource.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
