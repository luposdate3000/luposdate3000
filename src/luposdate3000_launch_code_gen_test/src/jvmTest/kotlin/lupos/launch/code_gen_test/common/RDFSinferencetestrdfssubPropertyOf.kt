...
public class RDFSinferencetestrdfssubPropertyOf {
    val inputData = File("src/jvmTest/resources/RDFSinferencetestrdfssubPropertyOf.input").readAsString()
    val targetData = File("src/jvmTest/resources/RDFSinferencetestrdfssubPropertyOf.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/RDFSinferencetestrdfssubPropertyOf.query").readAsString()
