...
public class resourcessp2bq12asparql973 {
    ...
    internal val query = File("src/jvmTest/resources/resourcessp2bq12asparql973.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12asparql973`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcessp2bq12asparql973 - in simulator`() {
