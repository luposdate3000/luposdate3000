...
public class sq13Subqueriesdontinjectbindings {
    val inputData = File("src/jvmTest/resources/sq13Subqueriesdontinjectbindings.input").readAsString()
    val targetData = File("src/jvmTest/resources/sq13Subqueriesdontinjectbindings.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
