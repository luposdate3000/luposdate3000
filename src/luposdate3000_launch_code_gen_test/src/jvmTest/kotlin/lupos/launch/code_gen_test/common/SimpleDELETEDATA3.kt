...
public class SimpleDELETEDATA3 {
    val inputData = File("src/jvmTest/resources/SimpleDELETEDATA3.input").readAsString()
    val targetData = File("src/jvmTest/resources/SimpleDELETEDATA3.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/SimpleDELETEDATA3.query").readAsString()

    @Ignore // Reason: >Bug<
    @Test
    fun `Simple DELETE DATA 3}`() {
