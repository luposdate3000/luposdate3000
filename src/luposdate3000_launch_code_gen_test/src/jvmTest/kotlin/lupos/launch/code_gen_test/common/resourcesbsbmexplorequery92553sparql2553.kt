...
public class resourcesbsbmexplorequery92553sparql2553 {
    val inputData = File("src/jvmTest/resources/resourcesbsbmexplorequery92553sparql2553.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbsbmexplorequery92553sparql2553.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcesbsbmexplorequery92553sparql2553.query").readAsString()
