...
public class bind01BIND {
    val inputData = File("src/jvmTest/resources/bind01BIND.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind01BIND.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind01BIND.query").readAsString()

    @Test fun `bind01  BIND}`() {
