...
public class resourcesmyqueriesoptional26sparql4 {
    val inputData = File("src/jvmTest/resources/resourcesmyqueriesoptional26sparql4.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional26sparql4.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/resourcesmyqueriesoptional26sparql4.query").readAsString()

    @Ignore
    @Test
    fun `resourcesmyqueriesoptional26sparql4}`() {
