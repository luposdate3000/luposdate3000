...
public class resourcessp2bq9sparql973 {
    val inputData = File("src/jvmTest/resources/resourcessp2bq9sparql973.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcessp2bq9sparql973.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcessp2bq9sparql973.query").readAsString()
