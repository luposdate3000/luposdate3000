...
public class DELETEINSERT6b {
    val inputData = File("src/jvmTest/resources/DELETEINSERT6b.input").readAsString()
    val targetData = File("src/jvmTest/resources/DELETEINSERT6b.output").readAsString()
    val targetType = ".ttl"
    val inputType = ".ttl"
