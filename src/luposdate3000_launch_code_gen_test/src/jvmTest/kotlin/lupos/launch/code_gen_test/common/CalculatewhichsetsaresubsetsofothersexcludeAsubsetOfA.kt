...
public class CalculatewhichsetsaresubsetsofothersexcludeAsubsetOfA {
    val inputData = File("src/jvmTest/resources/CalculatewhichsetsaresubsetsofothersexcludeAsubsetOfA.input").readAsString()
    val targetData = File("src/jvmTest/resources/CalculatewhichsetsaresubsetsofothersexcludeAsubsetOfA.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/CalculatewhichsetsaresubsetsofothersexcludeAsubsetOfA.query").readAsString()
    @Ignore // Reason: >Bug<
    @Test
