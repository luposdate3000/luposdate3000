...
public class bind07BINDfixeddataforOWLDL {
    val inputData = File("src/jvmTest/resources/bind07BINDfixeddataforOWLDL.input").readAsString()
    val targetData = File("src/jvmTest/resources/bind07BINDfixeddataforOWLDL.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/bind07BINDfixeddataforOWLDL.query").readAsString()
