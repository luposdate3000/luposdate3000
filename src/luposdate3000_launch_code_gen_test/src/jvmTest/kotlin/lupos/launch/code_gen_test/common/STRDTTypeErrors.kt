...
public class STRDTTypeErrors {
    val inputData = File("src/jvmTest/resources/STRDTTypeErrors.input").readAsString()
    val targetData = File("src/jvmTest/resources/STRDTTypeErrors.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
