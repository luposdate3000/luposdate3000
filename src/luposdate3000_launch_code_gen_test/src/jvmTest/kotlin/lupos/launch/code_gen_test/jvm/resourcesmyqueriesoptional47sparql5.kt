...
public class resourcesmyqueriesoptional47sparql5 {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/resourcesmyqueriesoptional47sparql5.input").readAsString(),
    )
    ...
    internal val targetData = File("src/jvmTest/resources/resourcesmyqueriesoptional47sparql5.output").readAsString()
    internal val targetType = ".srx"
    internal val query = File("src/jvmTest/resources/resourcesmyqueriesoptional47sparql5.query").readAsString()

    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional47sparql5`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    fun `resourcesmyqueriesoptional47sparql5 - in simulator`() {
