...
public class Nestedpositiveexists {
    val inputData = File("src/jvmTest/resources/Nestedpositiveexists.input").readAsString()
    val targetData = File("src/jvmTest/resources/Nestedpositiveexists.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
