...
public class resourcesbtc029sparql1198 {
    val inputData = File("src/jvmTest/resources/resourcesbtc029sparql1198.input").readAsString()
    val targetData = File("src/jvmTest/resources/resourcesbtc029sparql1198.output").readAsString()
    val targetType = ".srx"
    val inputType = ".n3"
    val query = File("src/jvmTest/resources/resourcesbtc029sparql1198.query").readAsString()
