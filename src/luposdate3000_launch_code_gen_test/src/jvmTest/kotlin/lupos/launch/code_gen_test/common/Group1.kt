...
public class Group1 {
    val inputData = File("src/jvmTest/resources/Group1.input").readAsString()
    val targetData = File("src/jvmTest/resources/Group1.output").readAsString()
    val targetType = ".srx"
    val inputType = ".ttl"
    val query = File("src/jvmTest/resources/Group1.query").readAsString()
