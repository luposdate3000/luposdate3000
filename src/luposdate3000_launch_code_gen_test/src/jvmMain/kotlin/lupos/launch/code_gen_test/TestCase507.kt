...
public object TestCase507 {
    internal const val inputFileName=".//resources/sp2b/sp2b-247.n3"
    internal const val targetFileName=".//resources/sp2b/q2-247.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/sp2b/q2.sparql-247'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/sp2b/q2.sparql-247' success")
        } else {
            println("Result: './/resources/sp2b/q2.sparql-247' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/sp2b/q2.sparql-247' failed")
            }
        }
    }
}
