...
public object TestCase458 {
    internal const val inputFileName=".//resources/btc/./035.sparql.n3"
    internal const val targetFileName=".//resources/btc/./035.sparql.srx"
    @CodeGenerationAnnotation
    internal const val query = "#TripleBit: a Fast and Compact System for Large Scale RDF Data --- BTC 2012 " +
    ...
    internal operator fun invoke(){
        println("Test: './/resources/btc/./035.sparql-61664'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/btc/./035.sparql-61664' success")
        } else {
            println("Result: './/resources/btc/./035.sparql-61664' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/btc/./035.sparql-61664' failed")
            }
        }
    }
}
