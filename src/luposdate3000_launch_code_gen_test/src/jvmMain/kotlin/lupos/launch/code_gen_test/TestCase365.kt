...
public object TestCase365 {
    internal const val inputFileName=".//resources/myqueries/optional1.ttl"
    internal const val targetFileName=".//resources/myqueries/optional1-46.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/myqueries/optional46.sparql-5'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/myqueries/optional46.sparql-5' success")
        } else {
            println("Result: './/resources/myqueries/optional46.sparql-5' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/myqueries/optional46.sparql-5' failed")
            }
        }
    }
}
