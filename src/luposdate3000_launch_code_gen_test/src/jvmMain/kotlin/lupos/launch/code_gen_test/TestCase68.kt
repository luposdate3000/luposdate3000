...
public object TestCase68 {
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'Simple DELETE 7' success")
        } else {
            println("Result: 'Simple DELETE 7' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'Simple DELETE 7' failed")
            }
        }
    }
}
