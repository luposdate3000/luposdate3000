...
public object TestCase134 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/simple.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/simple8.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'simple 8' success")
        } else {
            println("Result: 'simple 8' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'simple 8' failed")
            }
        }
    }
}
