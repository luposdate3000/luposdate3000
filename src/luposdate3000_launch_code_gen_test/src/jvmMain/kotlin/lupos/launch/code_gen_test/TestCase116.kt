...
public object TestCase116 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/data-08.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/sparqldl-13.srx"
    @CodeGenerationAnnotation
    internal const val query = "# Query13 - sameAs test " +
    ...
    internal operator fun invoke(){
        println("Test: 'sparqldl-13.rq: sameAs'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'sparqldl-13.rq: sameAs' success")
        } else {
            println("Result: 'sparqldl-13.rq: sameAs' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'sparqldl-13.rq: sameAs' failed")
            }
        }
    }
}
