...
public object TestCase8 {
    internal const val inputFileName=".//resources/sparql11-test-suite/aggregates/agg08.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/aggregates/agg08b.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'COUNT 8b' success")
        } else {
            println("Result: 'COUNT 8b' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'COUNT 8b' failed")
            }
        }
    }
}
