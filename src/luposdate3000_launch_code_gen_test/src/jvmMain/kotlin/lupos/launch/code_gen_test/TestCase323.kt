...
public object TestCase323 {
    internal const val inputFileName=".//resources/myqueries/x5.ttl"
    internal const val targetFileName=".//resources/myqueries/x5.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/myqueries/x5.sparql-4'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/myqueries/x5.sparql-4' success")
        } else {
            println("Result: './/resources/myqueries/x5.sparql-4' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/myqueries/x5.sparql-4' failed")
            }
        }
    }
}
