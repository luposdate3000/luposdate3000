...
public object TestCase391 {
    internal const val inputFileName=".//resources/myqueries/x2.ttl"
    internal const val targetFileName=".//resources/myqueries/x2.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/myqueries/x2.sparql-10'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/myqueries/x2.sparql-10' success")
        } else {
            println("Result: './/resources/myqueries/x2.sparql-10' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/myqueries/x2.sparql-10' failed")
            }
        }
    }
}
