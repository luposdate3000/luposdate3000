...
public object TestCase3 {
    ...
    internal const val targetFileName=".//resources/sparql11-test-suite/aggregates/agg03.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'COUNT 3' success")
        } else {
            println("Result: 'COUNT 3' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'COUNT 3' failed")
            }
        }
    }
}
