...
public object TestCase113 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/data-07.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/sparqldl-10.srx"
    ...
    internal operator fun invoke(){
        println("Test: 'sparqldl-10.rq: undist vars test'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'sparqldl-10.rq: undist vars test' success")
        } else {
            println("Result: 'sparqldl-10.rq: undist vars test' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'sparqldl-10.rq: undist vars test' failed")
            }
        }
    }
}
