...
public object TestCase60 {
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'DELETE INSERT 4' success")
        } else {
            println("Result: 'DELETE INSERT 4' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'DELETE INSERT 4' failed")
            }
        }
    }
}
