...
public object TestCase130 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/simple.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/simple4.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'simple 4' success")
        } else {
            println("Result: 'simple 4' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'simple 4' failed")
            }
        }
    }
}
