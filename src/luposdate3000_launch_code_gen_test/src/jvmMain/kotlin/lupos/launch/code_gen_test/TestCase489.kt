...
public object TestCase489 {
    internal const val inputFileName=".//resources/sp2b/sp2b-21.n3"
    internal const val targetFileName=".//resources/sp2b/q7-2-21.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/sp2b/q7-2.sparql-21'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/sp2b/q7-2.sparql-21' success")
        } else {
            println("Result: './/resources/sp2b/q7-2.sparql-21' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/sp2b/q7-2.sparql-21' failed")
            }
        }
    }
}
