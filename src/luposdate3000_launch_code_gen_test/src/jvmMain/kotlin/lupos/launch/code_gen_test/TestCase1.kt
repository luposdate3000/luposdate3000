...
public object TestCase1 {
    ...
    internal const val targetFileName=".//resources/sparql11-test-suite/aggregates/agg01.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'COUNT 1' success")
        } else {
            println("Result: 'COUNT 1' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'COUNT 1' failed")
            }
        }
    }
}
