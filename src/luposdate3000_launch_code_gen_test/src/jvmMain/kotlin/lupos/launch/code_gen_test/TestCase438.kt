...
public object TestCase438 {
    internal const val inputFileName=".//resources/bsbm/bsbm-2553.n3"
    internal const val targetFileName=".//resources/bsbm/./bi_query7-2553.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/bsbm/./bi_query7-2553.sparql-2553'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/bsbm/./bi_query7-2553.sparql-2553' success")
        } else {
            println("Result: './/resources/bsbm/./bi_query7-2553.sparql-2553' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/bsbm/./bi_query7-2553.sparql-2553' failed")
            }
        }
    }
}
