...
public object TestCase129 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/simple.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/simple3.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'simple 3' success")
        } else {
            println("Result: 'simple 3' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'simple 3' failed")
            }
        }
    }
}
