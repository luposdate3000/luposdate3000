...
public object TestCase108 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/data-03.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/sparqldl-05.srx"
    @CodeGenerationAnnotation
    internal const val query = "# Query5 " +
    ...
    internal operator fun invoke(){
        println("Test: 'sparqldl-05.rq: simple undistinguished variable test.'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'sparqldl-05.rq: simple undistinguished variable test.' success")
        } else {
            println("Result: 'sparqldl-05.rq: simple undistinguished variable test.' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'sparqldl-05.rq: simple undistinguished variable test.' failed")
            }
        }
    }
}
