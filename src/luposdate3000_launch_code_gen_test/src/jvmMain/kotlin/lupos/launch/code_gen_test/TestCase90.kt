...
public object TestCase90 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/paper-sparqldl-data.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/paper-sparqldl-Q1-rdfs.srx"
    ...
    internal operator fun invoke(){
        println("Test: 'paper-sparqldl-Q1-rdfs'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'paper-sparqldl-Q1-rdfs' success")
        } else {
            println("Result: 'paper-sparqldl-Q1-rdfs' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'paper-sparqldl-Q1-rdfs' failed")
            }
        }
    }
}
