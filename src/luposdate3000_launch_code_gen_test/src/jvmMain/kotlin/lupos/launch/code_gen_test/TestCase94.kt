...
public object TestCase94 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/paper-sparqldl-data.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/paper-sparqldl-Q5.srx"
    ...
    internal operator fun invoke(){
        println("Test: 'paper-sparqldl-Q5'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'paper-sparqldl-Q5' success")
        } else {
            println("Result: 'paper-sparqldl-Q5' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'paper-sparqldl-Q5' failed")
            }
        }
    }
}
