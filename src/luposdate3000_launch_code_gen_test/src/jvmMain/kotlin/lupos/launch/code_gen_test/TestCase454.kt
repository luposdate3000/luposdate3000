...
public object TestCase454 {
    internal const val inputFileName=".//resources/btc/./005.sparql.n3"
    internal const val targetFileName=".//resources/btc/./005.sparql.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/btc/./005.sparql-578'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/btc/./005.sparql-578' success")
        } else {
            println("Result: './/resources/btc/./005.sparql-578' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/btc/./005.sparql-578' failed")
            }
        }
    }
}
