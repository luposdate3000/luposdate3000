...
public object TestCase5 {
    ...
    internal const val targetFileName=".//resources/sparql11-test-suite/aggregates/agg05.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'COUNT 5' success")
        } else {
            println("Result: 'COUNT 5' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'COUNT 5' failed")
            }
        }
    }
}
