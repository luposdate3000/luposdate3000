...
public object TestCase688 {
    internal const val inputFileName=".//resources/sp2b/sp2b-32978.n3"
    internal const val targetFileName=".//resources/sp2b/q3a-32978.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/sp2b/q3a.sparql-32978'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/sp2b/q3a.sparql-32978' success")
        } else {
            println("Result: './/resources/sp2b/q3a.sparql-32978' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/sp2b/q3a.sparql-32978' failed")
            }
        }
    }
}
