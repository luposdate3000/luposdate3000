...
public object TestCase455 {
    internal const val inputFileName=".//resources/btc/./030.sparql.n3"
    internal const val targetFileName=".//resources/btc/./030.sparql.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/btc/./030.sparql-867'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/btc/./030.sparql-867' success")
        } else {
            println("Result: './/resources/btc/./030.sparql-867' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/btc/./030.sparql-867' failed")
            }
        }
    }
}
