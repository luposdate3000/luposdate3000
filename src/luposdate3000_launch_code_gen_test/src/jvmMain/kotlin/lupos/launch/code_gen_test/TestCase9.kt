...
public object TestCase9 {
    internal const val inputFileName=".//resources/sparql11-test-suite/aggregates/agg-groupconcat-1.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/aggregates/agg-groupconcat-1.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'GROUP_CONCAT 1' success")
        } else {
            println("Result: 'GROUP_CONCAT 1' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'GROUP_CONCAT 1' failed")
            }
        }
    }
}
