...
public object TestCase417 {
    internal const val inputFileName=".//resources/bsbm/bsbm-2210.n3"
    internal const val targetFileName=".//resources/bsbm/./bi_query6-2210.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/bsbm/./bi_query6-2210.sparql-2210'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/bsbm/./bi_query6-2210.sparql-2210' success")
        } else {
            println("Result: './/resources/bsbm/./bi_query6-2210.sparql-2210' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/bsbm/./bi_query6-2210.sparql-2210' failed")
            }
        }
    }
}
