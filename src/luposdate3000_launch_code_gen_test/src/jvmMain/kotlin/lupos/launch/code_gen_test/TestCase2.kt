...
public object TestCase2 {
    ...
    internal const val targetFileName=".//resources/sparql11-test-suite/aggregates/agg02.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'COUNT 2' success")
        } else {
            println("Result: 'COUNT 2' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'COUNT 2' failed")
            }
        }
    }
}
