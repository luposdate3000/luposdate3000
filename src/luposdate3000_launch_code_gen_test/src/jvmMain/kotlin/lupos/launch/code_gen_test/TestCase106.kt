...
public object TestCase106 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/data-02.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/sparqldl-03.srx"
    ...
    internal operator fun invoke(){
        println("Test: 'sparqldl-03.rq: combined query with complex class description'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'sparqldl-03.rq: combined query with complex class description' success")
        } else {
            println("Result: 'sparqldl-03.rq: combined query with complex class description' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'sparqldl-03.rq: combined query with complex class description' failed")
            }
        }
    }
}
