...
public object TestCase398 {
    internal const val inputFileName=".//resources/bsbm/bsbm-1853.n3"
    internal const val targetFileName=".//resources/bsbm/./bi_query7-1853.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/bsbm/./bi_query7-1853.sparql-1853'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/bsbm/./bi_query7-1853.sparql-1853' success")
        } else {
            println("Result: './/resources/bsbm/./bi_query7-1853.sparql-1853' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/bsbm/./bi_query7-1853.sparql-1853' failed")
            }
        }
    }
}
