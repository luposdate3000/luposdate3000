...
public object TestCase224 {
    internal const val inputFileName=".//resources/sparql11-test-suite/project-expression/projexp06.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/project-expression/projexp06.srx"
    ...
    internal operator fun invoke(){
        println("Test: 'Expression has undefined variable'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'Expression has undefined variable' success")
        } else {
            println("Result: 'Expression has undefined variable' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'Expression has undefined variable' failed")
            }
        }
    }
}
