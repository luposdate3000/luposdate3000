...
public object TestCase48 {
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'csv01 - CSV Result Format' success")
        } else {
            println("Result: 'csv01 - CSV Result Format' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'csv01 - CSV Result Format' failed")
            }
        }
    }
}
