...
public object TestCase104 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/data-01.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/sparqldl-01.srx"
    ...
    internal operator fun invoke(){
        println("Test: 'sparqldl-01.rq: triple pattern'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'sparqldl-01.rq: triple pattern' success")
        } else {
            println("Result: 'sparqldl-01.rq: triple pattern' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'sparqldl-01.rq: triple pattern' failed")
            }
        }
    }
}
