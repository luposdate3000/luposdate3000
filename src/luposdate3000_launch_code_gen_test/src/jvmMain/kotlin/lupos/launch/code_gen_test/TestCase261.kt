...
public object TestCase261 {
    internal const val inputFileName=".//resources/myqueries/optional2.ttl"
    internal const val targetFileName=".//resources/myqueries/optional2-14.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/myqueries/optional14.sparql-4'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/myqueries/optional14.sparql-4' success")
        } else {
            println("Result: './/resources/myqueries/optional14.sparql-4' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/myqueries/optional14.sparql-4' failed")
            }
        }
    }
}
