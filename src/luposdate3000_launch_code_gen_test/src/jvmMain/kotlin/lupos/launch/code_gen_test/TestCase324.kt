...
public object TestCase324 {
    internal const val inputFileName=".//resources/myqueries/x6.ttl"
    internal const val targetFileName=".//resources/myqueries/x6.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/myqueries/x6.sparql-4'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/myqueries/x6.sparql-4' success")
        } else {
            println("Result: './/resources/myqueries/x6.sparql-4' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/myqueries/x6.sparql-4' failed")
            }
        }
    }
}
