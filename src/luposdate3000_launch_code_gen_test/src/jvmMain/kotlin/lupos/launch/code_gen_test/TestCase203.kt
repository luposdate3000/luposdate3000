...
public object TestCase203 {
    internal const val inputFileName=".//resources/sparql11-test-suite/grouping/group-data-2.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/grouping/group05.srx"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'Group-5' success")
        } else {
            println("Result: 'Group-5' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'Group-5' failed")
            }
        }
    }
}
