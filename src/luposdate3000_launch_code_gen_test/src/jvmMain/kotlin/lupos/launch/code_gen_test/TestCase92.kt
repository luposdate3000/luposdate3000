...
public object TestCase92 {
    internal const val inputFileName=".//resources/sparql11-test-suite/entailment/paper-sparqldl-data.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/entailment/paper-sparqldl-Q3.srx"
    ...
    internal operator fun invoke(){
        println("Test: 'paper-sparqldl-Q3'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'paper-sparqldl-Q3' success")
        } else {
            println("Result: 'paper-sparqldl-Q3' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'paper-sparqldl-Q3' failed")
            }
        }
    }
}
