...
public object TestCase61 {
    internal const val inputFileName=".//resources/sparql11-test-suite/delete-insert/delete-insert-pre-01.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/delete-insert/delete-insert-post-02.ttl"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'DELETE INSERT 4b' success")
        } else {
            println("Result: 'DELETE INSERT 4b' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'DELETE INSERT 4b' failed")
            }
        }
    }
}
