...
public object TestCase59 {
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'DELETE INSERT 2' success")
        } else {
            println("Result: 'DELETE INSERT 2' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'DELETE INSERT 2' failed")
            }
        }
    }
}
