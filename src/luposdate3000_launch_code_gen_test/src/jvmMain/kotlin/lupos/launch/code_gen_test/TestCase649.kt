...
public object TestCase649 {
    internal const val inputFileName=".//resources/sp2b/sp2b-1640.n3"
    internal const val targetFileName=".//resources/sp2b/q12c-1640.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/sp2b/q12c.sparql-1640'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/sp2b/q12c.sparql-1640' success")
        } else {
            println("Result: './/resources/sp2b/q12c.sparql-1640' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/sp2b/q12c.sparql-1640' failed")
            }
        }
    }
}
