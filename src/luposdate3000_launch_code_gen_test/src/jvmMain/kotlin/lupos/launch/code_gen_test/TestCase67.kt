...
public object TestCase67 {
    internal const val inputFileName=".//resources/sparql11-test-suite/delete/delete-pre-01.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/delete/delete-post-01f.ttl"
    ...
    internal operator fun invoke(){
        ...
        if (success) {
            println("Result: 'Simple DELETE 3' success")
        } else {
            println("Result: 'Simple DELETE 3' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'Simple DELETE 3' failed")
            }
        }
    }
}
