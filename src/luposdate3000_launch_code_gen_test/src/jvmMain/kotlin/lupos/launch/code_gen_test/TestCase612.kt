...
public object TestCase612 {
    internal const val inputFileName=".//resources/sp2b/sp2b-1294.n3"
    internal const val targetFileName=".//resources/sp2b/q12b-1294.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/sp2b/q12b.sparql-1294'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/sp2b/q12b.sparql-1294' success")
        } else {
            println("Result: './/resources/sp2b/q12b.sparql-1294' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/sp2b/q12b.sparql-1294' failed")
            }
        }
    }
}
