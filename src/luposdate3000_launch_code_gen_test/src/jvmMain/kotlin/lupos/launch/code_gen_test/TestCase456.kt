...
public object TestCase456 {
    internal const val inputFileName=".//resources/btc/./029.sparql.n3"
    internal const val targetFileName=".//resources/btc/./029.sparql.srx"
    ...
    internal operator fun invoke(){
        println("Test: './/resources/btc/./029.sparql-1198'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: './/resources/btc/./029.sparql-1198' success")
        } else {
            println("Result: './/resources/btc/./029.sparql-1198' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: './/resources/btc/./029.sparql-1198' failed")
            }
        }
    }
}
