...
public object TestCase65 {
    internal const val inputFileName=".//resources/sparql11-test-suite/delete-where/delete-pre-01.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/delete-where/delete-post-01f.ttl"
    ...
    internal operator fun invoke(){
        println("Test: 'Simple DELETE WHERE 3'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'Simple DELETE WHERE 3' success")
        } else {
            println("Result: 'Simple DELETE WHERE 3' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'Simple DELETE WHERE 3' failed")
            }
        }
    }
}
