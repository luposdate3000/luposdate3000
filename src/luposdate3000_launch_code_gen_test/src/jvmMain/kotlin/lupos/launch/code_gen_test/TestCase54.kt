...
public object TestCase54 {
    internal const val inputFileName=".//resources/sparql11-test-suite/delete-data/delete-pre-01.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/delete-data/delete-post-01s.ttl"
    ...
    internal operator fun invoke(){
        println("Test: 'Simple DELETE DATA 1'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'Simple DELETE DATA 1' success")
        } else {
            println("Result: 'Simple DELETE DATA 1' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'Simple DELETE DATA 1' failed")
            }
        }
    }
}
