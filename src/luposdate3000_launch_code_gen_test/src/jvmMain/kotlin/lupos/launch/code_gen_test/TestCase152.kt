...
public object TestCase152 {
    internal const val inputFileName=".//resources/sparql11-test-suite/functions/data.ttl"
    internal const val targetFileName=".//resources/sparql11-test-suite/functions/substring01.srx"
    ...
    internal operator fun invoke(){
        println("Test: 'SUBSTR() (3-argument)'")
        var success = true
        try {
        ...
        if (success) {
            println("Result: 'SUBSTR() (3-argument)' success")
        } else {
            println("Result: 'SUBSTR() (3-argument)' failed")
        }
        if(success){
            var success2 = true
            try {
                ...
                LuposdateEndpoint.close()
            if (!success2) {
                println("ResultCodegen: 'SUBSTR() (3-argument)' failed")
            }
        }
    }
}
