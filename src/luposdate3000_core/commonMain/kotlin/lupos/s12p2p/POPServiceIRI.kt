...
class POPServiceIRI(query: IQuery, projectedVariables: List<String>, @JvmField val serverName: String, @JvmField val silent: Boolean, @JvmField val constraint: IOPBase) : POPBase(query, projectedVariables, EOperatorID.POPServiceIRIID, "POPServiceIRI", arrayOf(), ESortPriority.PREVENT_ANY) {
