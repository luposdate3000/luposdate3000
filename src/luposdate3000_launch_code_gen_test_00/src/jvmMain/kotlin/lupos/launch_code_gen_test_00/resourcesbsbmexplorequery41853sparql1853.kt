...
public class resourcesbsbmexplorequery41853sparql1853 {
    ...
    internal val query = "PREFIX bsbm: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/> \n" +
        ...
        "       ?product rdf:type bsbm-inst:ProductType5 . \n" +
        "       ?product bsbm:productFeature bsbm-inst:ProductFeature118 . \n" +
        "    ?product bsbm:productFeature bsbm-inst:ProductFeature145 . \n" +
        "       ?product bsbm:productPropertyTextual1 ?propertyTextual . \n" +
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery41853sparql1853 - None - Simple - true" to ::`resourcesbsbmexplorequery41853sparql1853 - None - Simple - true`,
