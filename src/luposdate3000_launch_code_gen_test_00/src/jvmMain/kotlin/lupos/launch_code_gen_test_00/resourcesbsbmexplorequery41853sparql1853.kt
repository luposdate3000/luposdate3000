...
public class resourcesbsbmexplorequery41853sparql1853 {
    ...
    public fun `resourcesbsbmexplorequery41853sparql1853 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery41853sparql1853 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL" to ::`resourcesbsbmexplorequery41853sparql1853 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main(){
