...
public class filteredsubclassquerywithhasChildsomeThingrestriction {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "filtered subclass query with hasChild some Thing restriction - Thread - PartitionByID_O_AllCollations - true" to ::`filtered subclass query with hasChild some Thing restriction - Thread - PartitionByID_O_AllCollations - true`,
        )
    }
}
public fun main(){
