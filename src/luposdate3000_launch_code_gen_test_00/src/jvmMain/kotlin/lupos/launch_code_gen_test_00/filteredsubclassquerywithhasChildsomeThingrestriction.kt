...
public class filteredsubclassquerywithhasChildsomeThingrestriction {
    ...
    public fun `filtered subclass query with hasChild some Thing restriction - None - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/filteredsubclassquerywithhasChildsomeThingrestriction.kt:78"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "filtered subclass query with hasChild some Thing restriction - None - Simple - false" to ::`filtered subclass query with hasChild some Thing restriction - None - Simple - false`,
        )
    }
}
public fun main(){
