...
public class resourcesmyqueriessimulatorparkingquery6sparql377simulatorparkinginputsmallttl {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriessimulatorparkingquery6sparql377 simulatorparkinginputsmallttl - Thread - Simple - true" to ::`resourcesmyqueriessimulatorparkingquery6sparql377 simulatorparkinginputsmallttl - Thread - Simple - true`,
        )
    }
}
public fun main(){
