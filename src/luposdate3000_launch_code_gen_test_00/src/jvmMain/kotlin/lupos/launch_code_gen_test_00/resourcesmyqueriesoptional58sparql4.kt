...
public class resourcesmyqueriesoptional58sparql4 {
    ...
    public fun `resourcesmyqueriesoptional58sparql4 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesmyqueriesoptional58sparql4.kt:83"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
