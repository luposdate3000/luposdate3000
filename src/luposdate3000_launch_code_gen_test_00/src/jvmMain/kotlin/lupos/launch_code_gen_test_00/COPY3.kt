...
public class COPY3 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.input1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.input1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.output1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.output1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPY3.output2",
    )
    ...
    public fun `COPY 3 - Thread - PartitionByKeyAllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/COPY3.kt:95"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `COPY 3 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY 3 - Thread - PartitionByKeyAllCollations - true" to ::`COPY 3 - Thread - PartitionByKeyAllCollations - true`,
            "COPY 3 - in simulator - Simple - Centralized - true - None - AllShortestPath" to ::`COPY 3 - in simulator - Simple - Centralized - true - None - AllShortestPath`,
            "COPY 3 - in simulator - Simple - Centralized - false - None - AllShortestPath" to ::`COPY 3 - in simulator - Simple - Centralized - false - None - AllShortestPath`,
            "COPY 3 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast" to ::`COPY 3 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`,
            "COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL" to ::`COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL`,
            "COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast" to ::`COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast`,
            "COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL" to ::`COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL`,
            "COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath" to ::`COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath`,
            "COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL" to ::`COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL`,
            "COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
            "COPY 3 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL" to ::`COPY 3 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL`,
            "COPY 3 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL_Fast" to ::`COPY 3 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL_Fast`,
            "COPY 3 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL" to ::`COPY 3 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL`,
            "COPY 3 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath" to ::`COPY 3 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`,
            "COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL" to ::`COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`,
            "COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath" to ::`COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath`,
            "COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast" to ::`COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast`,
            "COPY 3 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL" to ::`COPY 3 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL`,
            "COPY 3 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`COPY 3 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
            "COPY 3 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath" to ::`COPY 3 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in COPY3().getTests()){
        if (stop){
            return
        }
