...
public class COPY3 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY 3 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath" to ::`COPY 3 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`,
