...
public class InlineVALUESgraphpattern {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "Inline VALUES graph pattern - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - AllShortestPath" to ::`Inline VALUES graph pattern - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
