...
public class constructwhere01CONSTRUCTWHERE {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "constructwhere01  CONSTRUCT WHERE - Thread - PartitionByIDTwiceAllCollations - false" to ::`constructwhere01  CONSTRUCT WHERE - Thread - PartitionByIDTwiceAllCollations - false`,
        )
    }
}
public fun main(){
