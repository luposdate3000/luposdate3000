...
public class SimpleDELETE1WITH {
    ...
    public fun `Simple DELETE 1 WITH - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETE1WITH.kt:94"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
