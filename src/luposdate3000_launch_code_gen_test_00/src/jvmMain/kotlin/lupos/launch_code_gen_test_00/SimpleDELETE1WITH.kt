...
public class SimpleDELETE1WITH {
    ...
    public fun `Simple DELETE 1 WITH - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 1 WITH - Thread - PartitionByID_O_AllCollations - true" to ::`Simple DELETE 1 WITH - Thread - PartitionByID_O_AllCollations - true`,
            "Simple DELETE 1 WITH - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL" to ::`Simple DELETE 1 WITH - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`,
        )
    }
}
public fun main(){
