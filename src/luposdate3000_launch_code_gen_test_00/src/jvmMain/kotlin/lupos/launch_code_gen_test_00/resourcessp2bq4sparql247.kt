...
public class resourcessp2bq4sparql247 {
    ...
    public fun `resourcessp2bq4sparql247 - Thread - PartitionByID_O_AllCollations - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq4sparql247 - Thread - PartitionByID_O_AllCollations - false" to ::`resourcessp2bq4sparql247 - Thread - PartitionByID_O_AllCollations - false`,
        )
    }
}
public fun main(){
