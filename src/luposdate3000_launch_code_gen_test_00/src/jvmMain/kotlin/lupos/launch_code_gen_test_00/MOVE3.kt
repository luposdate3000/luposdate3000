...
public class MOVE3 {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "MOVE 3 - Thread - PartitionByKeyAllCollations - false" to ::`MOVE 3 - Thread - PartitionByKeyAllCollations - false`,
            "MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - AllShortestPath" to ::`MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - AllShortestPath`,
            "MOVE 3 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath" to ::`MOVE 3 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main() {
