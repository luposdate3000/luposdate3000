...
public class MOVE3 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "MOVE 3 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`MOVE 3 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
