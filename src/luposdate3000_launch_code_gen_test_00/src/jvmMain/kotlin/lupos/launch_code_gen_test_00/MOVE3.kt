...
public class MOVE3 {
    ...
    public fun `MOVE 3 - Thread - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/MOVE3.kt:91"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `MOVE 3 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `MOVE 3 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "MOVE 3 - in simulator - Simple - Centralized - true - None - AllShortestPath" to ::`MOVE 3 - in simulator - Simple - Centralized - true - None - AllShortestPath`,
            "MOVE 3 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL" to ::`MOVE 3 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`,
            "MOVE 3 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL_Fast" to ::`MOVE 3 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL_Fast`,
            "MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast" to ::`MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast`,
            "MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL" to ::`MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL`,
            "MOVE 3 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast" to ::`MOVE 3 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast`,
            "MOVE 3 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL" to ::`MOVE 3 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL`,
            "MOVE 3 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL" to ::`MOVE 3 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL`,
            "MOVE 3 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath" to ::`MOVE 3 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath`,
            "MOVE 3 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast" to ::`MOVE 3 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`,
            "MOVE 3 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath" to ::`MOVE 3 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`,
            "MOVE 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast" to ::`MOVE 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast`,
            "MOVE 3 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath" to ::`MOVE 3 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`,
            "MOVE 3 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL" to ::`MOVE 3 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
