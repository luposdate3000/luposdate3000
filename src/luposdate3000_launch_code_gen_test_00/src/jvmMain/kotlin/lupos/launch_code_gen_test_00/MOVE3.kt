...
public class MOVE3 {
    ...
    public fun `MOVE 3 - Thread - PartitionByID_1_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/MOVE3.kt:106"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `MOVE 3 - Thread - PartitionByID_1_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/MOVE3.kt:121"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `MOVE 3 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "MOVE 3 - Thread - PartitionByID_1_AllCollations - false" to ::`MOVE 3 - Thread - PartitionByID_1_AllCollations - false`,
            "MOVE 3 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL" to ::`MOVE 3 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`,
            "MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL" to ::`MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL`,
            "MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath" to ::`MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath`,
            "MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`MOVE 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
            "MOVE 3 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL" to ::`MOVE 3 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL`,
            "MOVE 3 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL" to ::`MOVE 3 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL`,
            "MOVE 3 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast" to ::`MOVE 3 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast`,
            ...
            "MOVE 3 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath" to ::`MOVE 3 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
