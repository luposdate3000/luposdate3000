...
public class resourcessp2bq12b3sparql973 {
    ...
    public fun `resourcessp2bq12b3sparql973 - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq12b3sparql973 - Thread - Simple - true" to ::`resourcessp2bq12b3sparql973 - Thread - Simple - true`,
        )
    }
}
public fun main(){
