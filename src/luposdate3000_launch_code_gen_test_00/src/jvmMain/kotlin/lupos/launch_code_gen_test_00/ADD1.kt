...
public class ADD1 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 1 - None - Simple - true" to ::`ADD 1 - None - Simple - true`,
            "ADD 1 - in simulator - Simple - Centralized - false - None - RPL" to ::`ADD 1 - in simulator - Simple - Centralized - false - None - RPL`,
            "ADD 1 - in simulator - Simple - Centralized - false - None - RPL_Fast" to ::`ADD 1 - in simulator - Simple - Centralized - false - None - RPL_Fast`,
            "ADD 1 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL" to ::`ADD 1 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`,
            "ADD 1 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL" to ::`ADD 1 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`,
            "ADD 1 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - AllShortestPath" to ::`ADD 1 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - AllShortestPath`,
            "ADD 1 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL_Fast" to ::`ADD 1 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL_Fast`,
            "ADD 1 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - AllShortestPath" to ::`ADD 1 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - AllShortestPath`,
            "ADD 1 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath" to ::`ADD 1 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`,
            "ADD 1 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL_Fast" to ::`ADD 1 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL_Fast`,
            "ADD 1 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath" to ::`ADD 1 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
