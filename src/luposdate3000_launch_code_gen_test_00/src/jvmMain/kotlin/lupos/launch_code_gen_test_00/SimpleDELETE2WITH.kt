...
public class SimpleDELETE2WITH {
    ...
    public fun `Simple DELETE 2 WITH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 2 WITH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Simple DELETE 2 WITH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
