...
public class SimpleDELETE2WITH {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/SimpleDELETE2WITH.input0",
        "src/jvmTest/resources/SimpleDELETE2WITH.input1",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/SimpleDELETE2WITH.output0",
        "src/jvmTest/resources/SimpleDELETE2WITH.output1",
    )
    ...
    public fun `Simple DELETE 2 WITH - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 2 WITH - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL" to ::`Simple DELETE 2 WITH - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL`,
        )
    }
    public fun main(){
