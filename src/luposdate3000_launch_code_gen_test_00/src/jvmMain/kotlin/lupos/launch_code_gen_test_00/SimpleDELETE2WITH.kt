...
public class SimpleDELETE2WITH {
    ...
    public fun `Simple DELETE 2 WITH - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "Simple DELETE 2 WITH - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast" to ::`Simple DELETE 2 WITH - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast`,
        )
    }
}
public fun main() {
