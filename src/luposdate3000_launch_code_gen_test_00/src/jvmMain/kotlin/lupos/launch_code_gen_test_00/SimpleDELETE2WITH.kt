...
public class SimpleDELETE2WITH {
    ...
    public fun `Simple DELETE 2 WITH - None - Simple - true`() {
    ...
    public fun `Simple DELETE 2 WITH - None - Simple - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "Simple DELETE 2 WITH - None - Simple - true" to ::`Simple DELETE 2 WITH - None - Simple - true`,
            "Simple DELETE 2 WITH - None - Simple - false" to ::`Simple DELETE 2 WITH - None - Simple - false`,
        )
    }
}
public fun main() {
