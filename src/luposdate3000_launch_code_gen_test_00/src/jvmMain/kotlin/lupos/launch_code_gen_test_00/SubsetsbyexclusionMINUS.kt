...
public class SubsetsbyexclusionMINUS {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/SubsetsbyexclusionMINUS.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/SubsetsbyexclusionMINUS.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/SubsetsbyexclusionMINUS.output").readAsString()
    ...
    public fun `Subsets by exclusion MINUS - Thread - PartitionByID_O_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SubsetsbyexclusionMINUS.kt:74"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Subsets by exclusion MINUS - Thread - PartitionByID_O_AllCollations - true" to ::`Subsets by exclusion MINUS - Thread - PartitionByID_O_AllCollations - true`,
            ...
            "Subsets by exclusion MINUS - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL" to ::`Subsets by exclusion MINUS - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL`,
            "Subsets by exclusion MINUS - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL" to ::`Subsets by exclusion MINUS - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
    for((name,func) in SubsetsbyexclusionMINUS().getTests()){
