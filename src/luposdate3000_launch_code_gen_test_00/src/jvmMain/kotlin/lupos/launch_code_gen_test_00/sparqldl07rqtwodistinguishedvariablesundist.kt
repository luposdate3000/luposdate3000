...
public class sparqldl07rqtwodistinguishedvariablesundist {
    ...
    public fun `sparqldl07rq two distinguished variables  undist - Thread - BenchmarkFig5 - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "sparqldl07rq two distinguished variables  undist - Thread - BenchmarkFig5 - false" to ::`sparqldl07rq two distinguished variables  undist - Thread - BenchmarkFig5 - false`,
            "sparqldl07rq two distinguished variables  undist - Thread - PartitionByID_1_AllCollations - true" to ::`sparqldl07rq two distinguished variables  undist - Thread - PartitionByID_1_AllCollations - true`,
            "sparqldl07rq two distinguished variables  undist - Thread - PartitionByID_O_AllCollations - false" to ::`sparqldl07rq two distinguished variables  undist - Thread - PartitionByID_O_AllCollations - false`,
        )
    }
}
public fun main(){
