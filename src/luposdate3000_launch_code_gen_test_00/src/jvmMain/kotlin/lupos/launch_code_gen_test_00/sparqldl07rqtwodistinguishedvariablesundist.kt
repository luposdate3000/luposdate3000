...
public class sparqldl07rqtwodistinguishedvariablesundist {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "sparqldl07rq two distinguished variables  undist - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`sparqldl07rq two distinguished variables  undist - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
