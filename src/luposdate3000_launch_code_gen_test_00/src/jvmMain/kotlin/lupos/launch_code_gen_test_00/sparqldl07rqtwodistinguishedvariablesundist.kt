...
public class sparqldl07rqtwodistinguishedvariablesundist {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "sparqldl07rq two distinguished variables  undist - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - AllShortestPath" to ::`sparqldl07rq two distinguished variables  undist - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
