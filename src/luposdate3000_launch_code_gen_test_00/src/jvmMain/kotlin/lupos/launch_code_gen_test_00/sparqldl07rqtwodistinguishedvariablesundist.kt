...
public class sparqldl07rqtwodistinguishedvariablesundist {
    ...
    public fun `sparqldl07rq two distinguished variables  undist - None - Simple - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/sparqldl07rqtwodistinguishedvariablesundist.kt:66"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
    ...
    public fun `sparqldl07rq two distinguished variables  undist - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/sparqldl07rqtwodistinguishedvariablesundist.kt:81"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "sparqldl07rq two distinguished variables  undist - None - Simple - true" to ::`sparqldl07rq two distinguished variables  undist - None - Simple - true`,
