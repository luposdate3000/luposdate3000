...
public class resourcesbsbmexplorequery51853sparql1853 {
    ...
    public fun `resourcesbsbmexplorequery51853sparql1853 - Thread - PartitionByID_2_AllCollations - false`() {
    ...
    public fun `resourcesbsbmexplorequery51853sparql1853 - Thread - PartitionByID_S_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery51853sparql1853 - Thread - PartitionByID_2_AllCollations - false" to ::`resourcesbsbmexplorequery51853sparql1853 - Thread - PartitionByID_2_AllCollations - false`,
            "resourcesbsbmexplorequery51853sparql1853 - Thread - PartitionByID_S_AllCollations - true" to ::`resourcesbsbmexplorequery51853sparql1853 - Thread - PartitionByID_S_AllCollations - true`,
        )
    }
}
public fun main(){
