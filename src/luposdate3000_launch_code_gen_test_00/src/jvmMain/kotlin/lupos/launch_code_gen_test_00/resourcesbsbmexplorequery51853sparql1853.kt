...
public class resourcesbsbmexplorequery51853sparql1853 {
    ...
    public fun `resourcesbsbmexplorequery51853sparql1853 - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery51853sparql1853 - Thread - Simple - true" to ::`resourcesbsbmexplorequery51853sparql1853 - Thread - Simple - true`,
        )
    }
}
public fun main(){
