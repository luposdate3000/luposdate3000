...
public class resourcessp2bq7sparql1294 {
    ...
    public fun `resourcessp2bq7sparql1294 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "resourcessp2bq7sparql1294 - Thread - PartitionByID_1_AllCollations - true" to ::`resourcessp2bq7sparql1294 - Thread - PartitionByID_1_AllCollations - true`,
            "resourcessp2bq7sparql1294 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL" to ::`resourcessp2bq7sparql1294 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL`,
            "resourcessp2bq7sparql1294 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL" to ::`resourcessp2bq7sparql1294 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main() {
