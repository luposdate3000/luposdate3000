...
public class ADD3 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 3 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`ADD 3 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
