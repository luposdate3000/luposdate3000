...
public class ADD3 {
    ...
    public fun `ADD 3 - Thread - PartitionByKeyAllCollations - false`() {
    ...
    public fun `ADD 3 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 3 - Thread - PartitionByKeyAllCollations - false" to ::`ADD 3 - Thread - PartitionByKeyAllCollations - false`,
            "ADD 3 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast" to ::`ADD 3 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`,
