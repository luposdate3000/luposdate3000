...
public class ADD3 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.input1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.input1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.output1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.output1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD3.output2",
    )
    ...
    public fun `ADD 3 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/ADD3.kt:95"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 3 - Thread - Simple - true" to ::`ADD 3 - Thread - Simple - true`,
            "ADD 3 - in simulator - Simple - Centralized - true - None - RPL_Fast" to ::`ADD 3 - in simulator - Simple - Centralized - true - None - RPL_Fast`,
            "ADD 3 - in simulator - Simple - Centralized - true - None - AllShortestPath" to ::`ADD 3 - in simulator - Simple - Centralized - true - None - AllShortestPath`,
            "ADD 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast" to ::`ADD 3 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`,
            "ADD 3 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath" to ::`ADD 3 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath`,
            "ADD 3 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast" to ::`ADD 3 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast`,
            "ADD 3 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL_Fast" to ::`ADD 3 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL_Fast`,
            "ADD 3 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL" to ::`ADD 3 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL`,
            "ADD 3 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast" to ::`ADD 3 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast`,
            "ADD 3 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath" to ::`ADD 3 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`,
            "ADD 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL" to ::`ADD 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`,
            "ADD 3 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL" to ::`ADD 3 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL`,
            "ADD 3 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath" to ::`ADD 3 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in ADD3().getTests()){
        if (stop){
            return
        }
