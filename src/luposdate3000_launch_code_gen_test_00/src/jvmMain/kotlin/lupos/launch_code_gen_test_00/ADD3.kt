...
public class ADD3 {
    ...
    public fun `ADD 3 - Thread - BenchmarkFig5 - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
    ...
    public fun `ADD 3 - Thread - PartitionByID_2_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    public fun `ADD 3 - Thread - PartitionByID_S_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "ADD 3 - Thread - BenchmarkFig5 - true" to ::`ADD 3 - Thread - BenchmarkFig5 - true`,
            "ADD 3 - Thread - PartitionByID_2_AllCollations - true" to ::`ADD 3 - Thread - PartitionByID_2_AllCollations - true`,
            "ADD 3 - Thread - PartitionByID_S_AllCollations - true" to ::`ADD 3 - Thread - PartitionByID_S_AllCollations - true`,
        )
    }
}
public fun main(){
