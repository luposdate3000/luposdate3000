...
public class Group1 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Group1 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Group1 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
