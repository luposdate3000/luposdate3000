...
public class RDFtestforblanknodecardinalities {
    ...
    public fun `RDF test for blank node cardinalities - Thread - PartitionByKeyAllCollations - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "RDF test for blank node cardinalities - Thread - PartitionByKeyAllCollations - true" to ::`RDF test for blank node cardinalities - Thread - PartitionByKeyAllCollations - true`,
        )
    }
    public fun main(){
