...
public class COPY1 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY 1 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - AllShortestPath" to ::`COPY 1 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
