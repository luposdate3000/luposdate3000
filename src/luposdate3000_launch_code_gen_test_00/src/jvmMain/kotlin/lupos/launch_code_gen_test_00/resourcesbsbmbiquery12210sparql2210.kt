...
public class resourcesbsbmbiquery12210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery12210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            ...
            "resourcesbsbmbiquery12210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`resourcesbsbmbiquery12210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main() {
