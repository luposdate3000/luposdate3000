...
public class resourcesbsbmbiquery12210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery12210sparql2210 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbsbmbiquery12210sparql2210.kt:101"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
