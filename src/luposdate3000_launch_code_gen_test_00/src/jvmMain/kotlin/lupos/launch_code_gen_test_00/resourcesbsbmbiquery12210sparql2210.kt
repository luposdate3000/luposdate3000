...
public class resourcesbsbmbiquery12210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery12210sparql2210 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcesbsbmbiquery12210sparql2210 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL" to ::`resourcesbsbmbiquery12210sparql2210 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`,
        )
    }
}
public fun main(){
