...
public class CLEARDEFAULT {
    ...
    public fun `CLEAR DEFAULT - Thread - PartitionByID_1_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CLEARDEFAULT.kt:111"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `CLEAR DEFAULT - in simulator - Simple - Centralized - false - None - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun `CLEAR DEFAULT - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun `CLEAR DEFAULT - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `CLEAR DEFAULT - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `CLEAR DEFAULT - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR DEFAULT - Thread - PartitionByIDTwiceAllCollations - true" to ::`CLEAR DEFAULT - Thread - PartitionByIDTwiceAllCollations - true`,
            "CLEAR DEFAULT - Thread - PartitionByID_1_AllCollations - false" to ::`CLEAR DEFAULT - Thread - PartitionByID_1_AllCollations - false`,
            "CLEAR DEFAULT - in simulator - Simple - Centralized - false - None - RPL_Fast" to ::`CLEAR DEFAULT - in simulator - Simple - Centralized - false - None - RPL_Fast`,
            "CLEAR DEFAULT - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath" to ::`CLEAR DEFAULT - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath`,
            "CLEAR DEFAULT - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL" to ::`CLEAR DEFAULT - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL`,
            "CLEAR DEFAULT - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath" to ::`CLEAR DEFAULT - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`,
            "CLEAR DEFAULT - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL" to ::`CLEAR DEFAULT - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL`,
