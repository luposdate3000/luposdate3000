...
public class CLEARDEFAULT {
    ...
    public fun `CLEAR DEFAULT - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR DEFAULT - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast" to ::`CLEAR DEFAULT - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
