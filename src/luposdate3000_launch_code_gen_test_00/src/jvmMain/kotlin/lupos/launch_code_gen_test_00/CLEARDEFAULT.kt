...
public class CLEARDEFAULT {
    ...
    public fun `CLEAR DEFAULT - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR DEFAULT - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL" to ::`CLEAR DEFAULT - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
