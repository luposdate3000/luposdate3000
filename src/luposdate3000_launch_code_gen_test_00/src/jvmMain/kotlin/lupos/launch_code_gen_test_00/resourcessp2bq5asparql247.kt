...
public class resourcessp2bq5asparql247 {
    ...
    public fun `resourcessp2bq5asparql247 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq5asparql247 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - AllShortestPath" to ::`resourcessp2bq5asparql247 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
