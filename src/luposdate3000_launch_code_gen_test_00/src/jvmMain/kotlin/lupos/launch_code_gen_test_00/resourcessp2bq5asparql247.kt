...
public class resourcessp2bq5asparql247 {
    ...
    public fun `resourcessp2bq5asparql247 - Thread - PartitionByKeyAllCollations - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq5asparql247 - Thread - PartitionByKeyAllCollations - false" to ::`resourcessp2bq5asparql247 - Thread - PartitionByKeyAllCollations - false`,
        )
    }
}
public fun main(){
