...
public class SimpleDELETE4 {
    ...
    public fun `Simple DELETE 4 - Thread - PartitionByIDTwiceAllCollations - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 4 - Thread - PartitionByIDTwiceAllCollations - false" to ::`Simple DELETE 4 - Thread - PartitionByIDTwiceAllCollations - false`,
        )
    }
}
public fun main(){
