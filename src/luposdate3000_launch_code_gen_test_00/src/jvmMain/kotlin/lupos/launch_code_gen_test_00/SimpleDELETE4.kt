...
public class SimpleDELETE4 {
    ...
    public fun `Simple DELETE 4 - None - Simple - true`() {
    ...
    public fun `Simple DELETE 4 - None - Simple - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETE4.kt:104"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "Simple DELETE 4 - None - Simple - true" to ::`Simple DELETE 4 - None - Simple - true`,
            "Simple DELETE 4 - None - Simple - false" to ::`Simple DELETE 4 - None - Simple - false`,
        )
    }
}
public fun main() {
