...
public class SimpleDELETE4 {
    ...
    public fun `Simple DELETE 4 - Thread - PartitionByKeyAllCollations - true`() {
    ...
    public fun `Simple DELETE 4 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `Simple DELETE 4 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 4 - Thread - PartitionByKeyAllCollations - true" to ::`Simple DELETE 4 - Thread - PartitionByKeyAllCollations - true`,
            "Simple DELETE 4 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL" to ::`Simple DELETE 4 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`,
            "Simple DELETE 4 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath" to ::`Simple DELETE 4 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
