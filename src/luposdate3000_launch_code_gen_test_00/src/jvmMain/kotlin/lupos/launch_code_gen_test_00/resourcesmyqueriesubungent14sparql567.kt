...
public class resourcesmyqueriesubungent14sparql567 {
    ...
    public fun `resourcesmyqueriesubungent14sparql567 - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriesubungent14sparql567 - Thread - Simple - true" to ::`resourcesmyqueriesubungent14sparql567 - Thread - Simple - true`,
        )
    }
}
public fun main(){
