...
public class resourcessp2bq71sparql32978 {
    ...
    public fun `resourcessp2bq71sparql32978 - None - Simple - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcessp2bq71sparql32978.kt:77"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
    ...
    public fun `resourcessp2bq71sparql32978 - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcessp2bq71sparql32978.kt:92"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "resourcessp2bq71sparql32978 - None - Simple - true" to ::`resourcessp2bq71sparql32978 - None - Simple - true`,
            "resourcessp2bq71sparql32978 - None - Simple - false" to ::`resourcessp2bq71sparql32978 - None - Simple - false`,
        )
    }
}
public fun main() {
