...
public class sq07Subquerywithfrom {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/sq07Subquerywithfrom.input0").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/sq07Subquerywithfrom.input0",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/sq07Subquerywithfrom.output").readAsString()
    ...
    public fun `sq07  Subquery with from  - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `sq07  Subquery with from  - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            ...
            "sq07  Subquery with from  - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL" to ::`sq07  Subquery with from  - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL`,
            "sq07  Subquery with from  - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath" to ::`sq07  Subquery with from  - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main() {
    for ((name, func) in sq07Subquerywithfrom().getTests()) {
