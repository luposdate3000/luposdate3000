...
public class resourcesmyqueriessimulatorparkingquery71sparql2502simulatorparkinginputttl {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriessimulatorparkingquery71sparql2502 simulatorparkinginputttl - Thread - Simple - true" to ::`resourcesmyqueriessimulatorparkingquery71sparql2502 simulatorparkinginputttl - Thread - Simple - true`,
        )
    }
}
public fun main(){
