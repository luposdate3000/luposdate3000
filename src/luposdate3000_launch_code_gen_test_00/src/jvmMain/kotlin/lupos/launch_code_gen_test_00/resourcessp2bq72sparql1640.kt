...
public class resourcessp2bq72sparql1640 {
    ...
    public fun `resourcessp2bq72sparql1640 - Thread - PartitionByID_1_AllCollations - true`() {
    ...
    public fun `resourcessp2bq72sparql1640 - in simulator - Simple - Centralized - false - None - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq72sparql1640 - Thread - PartitionByID_1_AllCollations - true" to ::`resourcessp2bq72sparql1640 - Thread - PartitionByID_1_AllCollations - true`,
            "resourcessp2bq72sparql1640 - in simulator - Simple - Centralized - false - None - RPL_Fast" to ::`resourcessp2bq72sparql1640 - in simulator - Simple - Centralized - false - None - RPL_Fast`,
        )
    }
}
public fun main(){
