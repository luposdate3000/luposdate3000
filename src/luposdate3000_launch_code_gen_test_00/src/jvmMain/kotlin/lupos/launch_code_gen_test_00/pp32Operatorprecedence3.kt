...
public class pp32Operatorprecedence3 {
    ...
    public fun `pp32 Operator precedence 3 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "pp32 Operator precedence 3 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast" to ::`pp32 Operator precedence 3 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
