...
public class MOVE4 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/MOVE4.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/MOVE4.input1").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/MOVE4.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/MOVE4.input1",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/MOVE4.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/MOVE4.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/MOVE4.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/MOVE4.output1",
    )
    ...
    public fun `MOVE 4 - Thread - PartitionByID_O_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/MOVE4.kt:87"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `MOVE 4 - Thread - Simple - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/MOVE4.kt:102"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `MOVE 4 - in simulator - Simple - Centralized - false - None - RPL`() {
        simulatorHelper(
    ...
    public fun `MOVE 4 - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun `MOVE 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `MOVE 4 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `MOVE 4 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `MOVE 4 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `MOVE 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    public fun `MOVE 4 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "MOVE 4 - Thread - PartitionByID_O_AllCollations - true" to ::`MOVE 4 - Thread - PartitionByID_O_AllCollations - true`,
            "MOVE 4 - Thread - Simple - false" to ::`MOVE 4 - Thread - Simple - false`,
            "MOVE 4 - in simulator - Simple - Centralized - false - None - RPL" to ::`MOVE 4 - in simulator - Simple - Centralized - false - None - RPL`,
            "MOVE 4 - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath" to ::`MOVE 4 - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath`,
            "MOVE 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`MOVE 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
            "MOVE 4 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - AllShortestPath" to ::`MOVE 4 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - AllShortestPath`,
            "MOVE 4 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - AllShortestPath" to ::`MOVE 4 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - AllShortestPath`,
            ...
            "MOVE 4 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast" to ::`MOVE 4 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast`,
            "MOVE 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast" to ::`MOVE 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast`,
            "MOVE 4 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast" to ::`MOVE 4 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
