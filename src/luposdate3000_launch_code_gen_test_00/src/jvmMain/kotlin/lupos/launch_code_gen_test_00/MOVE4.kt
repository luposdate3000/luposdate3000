...
public class MOVE4 {
    ...
    public fun `MOVE 4 - in simulator - Simple - Centralized - false - None - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun `MOVE 4 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "MOVE 4 - in simulator - Simple - Centralized - false - None - RPL_Fast" to ::`MOVE 4 - in simulator - Simple - Centralized - false - None - RPL_Fast`,
            "MOVE 4 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL" to ::`MOVE 4 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL`,
        )
    }
}
public fun main(){
