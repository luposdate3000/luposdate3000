...
public class sq01Subquerywithingraphpattern {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "sq01  Subquery within graph pattern - None - Simple - true" to ::`sq01  Subquery within graph pattern - None - Simple - true`,
            ...
            "sq01  Subquery within graph pattern - Thread - PartitionByIDTwiceAllCollations - false" to ::`sq01  Subquery within graph pattern - Thread - PartitionByIDTwiceAllCollations - false`,
        )
    }
}
public fun main(){
