...
public class resourcesmyqueriessimulatorparkingquery8sparql377simulatorparkinginputsmallttl {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/resourcesmyqueriessimulatorparkingquery8sparql377simulatorparkinginputsmallttl.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/resourcesmyqueriessimulatorparkingquery8sparql377simulatorparkinginputsmallttl.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/resourcesmyqueriessimulatorparkingquery8sparql377simulatorparkinginputsmallttl.output").readAsString()
    ...
    public fun `resourcesmyqueriessimulatorparkingquery8sparql377 simulatorparkinginputsmallttl - None - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesmyqueriessimulatorparkingquery8sparql377simulatorparkinginputsmallttl.kt:88"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `resourcesmyqueriessimulatorparkingquery8sparql377 simulatorparkinginputsmallttl - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesmyqueriessimulatorparkingquery8sparql377simulatorparkinginputsmallttl.kt:103"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriessimulatorparkingquery8sparql377 simulatorparkinginputsmallttl - None - Simple - true" to ::`resourcesmyqueriessimulatorparkingquery8sparql377 simulatorparkinginputsmallttl - None - Simple - true`,
            "resourcesmyqueriessimulatorparkingquery8sparql377 simulatorparkinginputsmallttl - None - Simple - false" to ::`resourcesmyqueriessimulatorparkingquery8sparql377 simulatorparkinginputsmallttl - None - Simple - false`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in resourcesmyqueriessimulatorparkingquery8sparql377simulatorparkinginputsmallttl().getTests()){
        if (stop){
            return
        }
