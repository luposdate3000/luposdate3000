...
public class STRLANG {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "STRLANG - Thread - PartitionByID_1_AllCollations - true" to ::`STRLANG - Thread - PartitionByID_1_AllCollations - true`,
            "STRLANG - Thread - PartitionByID_2_AllCollations - true" to ::`STRLANG - Thread - PartitionByID_2_AllCollations - true`,
        )
    }
}
public fun main(){
