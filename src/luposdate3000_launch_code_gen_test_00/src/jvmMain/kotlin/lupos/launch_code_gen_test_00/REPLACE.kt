...
public class REPLACE {
    ...
    public fun `REPLACE - None - Simple - false`() {
    ...
    public fun `REPLACE - Thread - PartitionByID_1_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "REPLACE - None - Simple - false" to ::`REPLACE - None - Simple - false`,
            "REPLACE - Thread - PartitionByID_1_AllCollations - true" to ::`REPLACE - Thread - PartitionByID_1_AllCollations - true`,
        )
    }
}
public fun main(){
