...
public class Calculatewhichsetshavethesameelements {
    ...
    public fun `Calculate which sets have the same elements - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "Calculate which sets have the same elements - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL_Fast" to ::`Calculate which sets have the same elements - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main() {
