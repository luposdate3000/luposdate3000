...
public class Calculatewhichsetshavethesameelements {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Calculate which sets have the same elements - None - Simple - true" to ::`Calculate which sets have the same elements - None - Simple - true`,
            "Calculate which sets have the same elements - None - Simple - false" to ::`Calculate which sets have the same elements - None - Simple - false`,
        )
    }
}
public fun main(){
