...
public class RDFSinferencetestsubPropertyandinstances {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/RDFSinferencetestsubPropertyandinstances.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/RDFSinferencetestsubPropertyandinstances.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/RDFSinferencetestsubPropertyandinstances.output").readAsString()
    ...
    public fun `RDFS inference test subProperty and instances - Thread - BenchmarkFig5 - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/RDFSinferencetestsubPropertyandinstances.kt:75"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    public fun `RDFS inference test subProperty and instances - Thread - PartitionByID_2_AllCollations - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.Thread
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "RDFS inference test subProperty and instances - Thread - BenchmarkFig5 - false" to ::`RDFS inference test subProperty and instances - Thread - BenchmarkFig5 - false`,
            "RDFS inference test subProperty and instances - Thread - PartitionByID_2_AllCollations - false" to ::`RDFS inference test subProperty and instances - Thread - PartitionByID_2_AllCollations - false`,
...
public fun main() {
    for ((name, func) in RDFSinferencetestsubPropertyandinstances().getTests()) {
