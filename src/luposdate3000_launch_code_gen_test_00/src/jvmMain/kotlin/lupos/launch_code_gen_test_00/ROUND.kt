...
public class ROUND {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "ROUND - in simulator - Simple - Centralized - false - None - AllShortestPath" to ::`ROUND - in simulator - Simple - Centralized - false - None - AllShortestPath`,
            "ROUND - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast" to ::`ROUND - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
