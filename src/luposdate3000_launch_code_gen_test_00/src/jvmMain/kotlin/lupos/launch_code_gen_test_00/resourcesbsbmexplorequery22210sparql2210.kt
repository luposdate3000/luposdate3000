...
public class resourcesbsbmexplorequery22210sparql2210 {
    ...
    public fun `resourcesbsbmexplorequery22210sparql2210 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcesbsbmexplorequery22210sparql2210 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath" to ::`resourcesbsbmexplorequery22210sparql2210 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
