...
public class resourcesbsbmexplorequery22210sparql2210 {
    ...
    public fun `resourcesbsbmexplorequery22210sparql2210 - None - Simple - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcesbsbmexplorequery22210sparql2210 - None - Simple - false" to ::`resourcesbsbmexplorequery22210sparql2210 - None - Simple - false`,
        )
    }
}
public fun main(){
