...
public class resourcesbsbmexplorequery22210sparql2210 {
    ...
    public fun `resourcesbsbmexplorequery22210sparql2210 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery22210sparql2210 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL" to ::`resourcesbsbmexplorequery22210sparql2210 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main(){
