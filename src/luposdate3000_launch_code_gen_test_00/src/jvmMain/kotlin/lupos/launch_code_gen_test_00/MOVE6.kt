...
public class MOVE6 {
    ...
    public fun `MOVE 6 - Thread - PartitionByID_S_AllCollations - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "MOVE 6 - Thread - PartitionByID_S_AllCollations - true" to ::`MOVE 6 - Thread - PartitionByID_S_AllCollations - true`,
        )
    }
}
public fun main(){
