...
public class MOVE6 {
    ...
    public fun `MOVE 6 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "MOVE 6 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`MOVE 6 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
