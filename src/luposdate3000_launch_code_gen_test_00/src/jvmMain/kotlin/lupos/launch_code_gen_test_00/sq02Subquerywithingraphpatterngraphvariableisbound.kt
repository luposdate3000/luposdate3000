...
public class sq02Subquerywithingraphpatterngraphvariableisbound {
    ...
    public fun `sq02  Subquery within graph pattern graph variable is bound - Thread - BenchmarkFig5 - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/sq02Subquerywithingraphpatterngraphvariableisbound.kt:74"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `sq02  Subquery within graph pattern graph variable is bound - Thread - PartitionByID_O_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/sq02Subquerywithingraphpatterngraphvariableisbound.kt:89"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
