...
public class SimpleDELETE4USING {
    ...
    public fun `Simple DELETE 4 USING - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETE4USING.kt:110"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 4 USING - Thread - Simple - true" to ::`Simple DELETE 4 USING - Thread - Simple - true`,
        )
    }
}
public fun main(){
