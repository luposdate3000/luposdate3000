...
public class SimpleDELETE4USING {
    ...
    public fun `Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun `Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    public fun `Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    public fun `Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath" to ::`Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath`,
            "Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - true - Process - RPL" to ::`Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`,
            "Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath" to ::`Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`,
            "Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast" to ::`Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`,
            ...
            "Simple DELETE 4 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL_Fast" to ::`Simple DELETE 4 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL_Fast`,
            "Simple DELETE 4 USING - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL" to ::`Simple DELETE 4 USING - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL`,
            "Simple DELETE 4 USING - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL" to ::`Simple DELETE 4 USING - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL`,
        )
    }
}
public fun main(){
