...
public class SimpleDELETE4USING {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "Simple DELETE 4 USING - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL" to ::`Simple DELETE 4 USING - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main() {
