...
public class SimpleDELETE4USING {
    ...
    public fun `Simple DELETE 4 USING - Thread - PartitionByID_O_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETE4USING.kt:106"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `Simple DELETE 4 USING - Thread - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETE4USING.kt:121"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun `Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 4 USING - Thread - PartitionByID_O_AllCollations - true" to ::`Simple DELETE 4 USING - Thread - PartitionByID_O_AllCollations - true`,
            "Simple DELETE 4 USING - Thread - Simple - false" to ::`Simple DELETE 4 USING - Thread - Simple - false`,
            "Simple DELETE 4 USING - in simulator - Simple - Centralized - true - None - RPL" to ::`Simple DELETE 4 USING - in simulator - Simple - Centralized - true - None - RPL`,
            "Simple DELETE 4 USING - in simulator - Simple - Centralized - true - None - AllShortestPath" to ::`Simple DELETE 4 USING - in simulator - Simple - Centralized - true - None - AllShortestPath`,
            "Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast" to ::`Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`,
            "Simple DELETE 4 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath" to ::`Simple DELETE 4 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath`,
            ...
            "Simple DELETE 4 USING - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL" to ::`Simple DELETE 4 USING - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL`,
            "Simple DELETE 4 USING - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - AllShortestPath" to ::`Simple DELETE 4 USING - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - AllShortestPath`,
            "Simple DELETE 4 USING - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL" to ::`Simple DELETE 4 USING - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL`,
            "Simple DELETE 4 USING - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath" to ::`Simple DELETE 4 USING - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath`,
            "Simple DELETE 4 USING - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL" to ::`Simple DELETE 4 USING - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL`,
            "Simple DELETE 4 USING - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast" to ::`Simple DELETE 4 USING - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`,
            "Simple DELETE 4 USING - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath" to ::`Simple DELETE 4 USING - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`,
            "Simple DELETE 4 USING - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL" to ::`Simple DELETE 4 USING - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL`,
            "Simple DELETE 4 USING - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath" to ::`Simple DELETE 4 USING - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
