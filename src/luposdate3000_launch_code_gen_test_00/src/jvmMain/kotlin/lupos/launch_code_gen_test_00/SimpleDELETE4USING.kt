...
public class SimpleDELETE4USING {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 4 USING - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Simple DELETE 4 USING - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
