...
public class resourcessp2bq1sparql247 {
    ...
    public fun `resourcessp2bq1sparql247 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcessp2bq1sparql247.kt:83"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq1sparql247 - Thread - Simple - true" to ::`resourcessp2bq1sparql247 - Thread - Simple - true`,
        )
    }
}
public fun main(){
