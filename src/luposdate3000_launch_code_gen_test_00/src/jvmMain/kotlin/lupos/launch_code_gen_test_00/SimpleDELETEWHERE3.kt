...
public class SimpleDELETEWHERE3 {
    ...
    public fun `Simple DELETE WHERE 3 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETEWHERE3.kt:88"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
