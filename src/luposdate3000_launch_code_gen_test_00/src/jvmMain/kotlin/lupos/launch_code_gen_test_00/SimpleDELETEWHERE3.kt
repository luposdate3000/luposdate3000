...
public class SimpleDELETEWHERE3 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE WHERE 3 - None - Simple - true" to ::`Simple DELETE WHERE 3 - None - Simple - true`,
            "Simple DELETE WHERE 3 - None - Simple - false" to ::`Simple DELETE WHERE 3 - None - Simple - false`,
        )
    }
}
public fun main(){
