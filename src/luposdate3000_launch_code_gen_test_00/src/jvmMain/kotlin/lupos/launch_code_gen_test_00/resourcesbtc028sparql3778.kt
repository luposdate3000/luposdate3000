...
public class resourcesbtc028sparql3778 {
    ...
    public fun `resourcesbtc028sparql3778 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbtc028sparql3778.kt:79"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
