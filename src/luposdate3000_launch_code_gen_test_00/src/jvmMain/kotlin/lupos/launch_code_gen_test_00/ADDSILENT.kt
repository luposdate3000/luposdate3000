...
public class ADDSILENT {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD SILENT - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL_Fast" to ::`ADD SILENT - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
