...
public class ENCODEFORURI {
    ...
    public fun `ENCODEFORURI - Thread - BenchmarkFig5 - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ENCODEFORURI - None - Simple - false" to ::`ENCODEFORURI - None - Simple - false`,
            "ENCODEFORURI - Thread - BenchmarkFig5 - false" to ::`ENCODEFORURI - Thread - BenchmarkFig5 - false`,
        )
    }
}
public fun main(){
