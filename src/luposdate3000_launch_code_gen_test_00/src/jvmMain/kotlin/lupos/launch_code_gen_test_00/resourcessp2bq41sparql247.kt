...
public class resourcessp2bq41sparql247 {
    ...
    public fun `resourcessp2bq41sparql247 - Thread - BenchmarkFig5 - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq41sparql247 - Thread - BenchmarkFig5 - false" to ::`resourcessp2bq41sparql247 - Thread - BenchmarkFig5 - false`,
        )
    }
}
public fun main(){
