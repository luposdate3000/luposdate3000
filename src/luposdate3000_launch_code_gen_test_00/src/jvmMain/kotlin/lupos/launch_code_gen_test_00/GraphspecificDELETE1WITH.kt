...
public class GraphspecificDELETE1WITH {
    ...
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "Graphspecific DELETE 1 WITH - Thread - PartitionByID_1_AllCollations - true" to ::`Graphspecific DELETE 1 WITH - Thread - PartitionByID_1_AllCollations - true`,
            "Graphspecific DELETE 1 WITH - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`Graphspecific DELETE 1 WITH - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
            ...
            "Graphspecific DELETE 1 WITH - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath" to ::`Graphspecific DELETE 1 WITH - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main() {
