...
public class GraphspecificDELETE1WITH {
    ...
    public fun `Graphspecific DELETE 1 WITH - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE 1 WITH - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL" to ::`Graphspecific DELETE 1 WITH - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`,
            "Graphspecific DELETE 1 WITH - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL" to ::`Graphspecific DELETE 1 WITH - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
