...
public class resourcessp2bq6sparql247 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq6sparql247 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath" to ::`resourcessp2bq6sparql247 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
