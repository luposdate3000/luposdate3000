...
public class MOVE2 {
    ...
    public fun `MOVE 2 - in simulator - Simple - Centralized - false - None - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "MOVE 2 - in simulator - Simple - Centralized - false - None - AllShortestPath" to ::`MOVE 2 - in simulator - Simple - Centralized - false - None - AllShortestPath`,
        )
    }
}
public fun main() {
