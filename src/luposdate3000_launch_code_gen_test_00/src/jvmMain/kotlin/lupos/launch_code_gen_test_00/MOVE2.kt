...
public class MOVE2 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "MOVE 2 - Thread - PartitionByID_O_AllCollations - false" to ::`MOVE 2 - Thread - PartitionByID_O_AllCollations - false`,
            "MOVE 2 - Thread - Simple - false" to ::`MOVE 2 - Thread - Simple - false`,
        )
    }
}
public fun main(){
