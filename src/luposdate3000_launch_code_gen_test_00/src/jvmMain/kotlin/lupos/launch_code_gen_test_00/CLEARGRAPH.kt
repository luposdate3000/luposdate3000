...
public class CLEARGRAPH {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR GRAPH - Thread - PartitionByID_S_AllCollations - true" to ::`CLEAR GRAPH - Thread - PartitionByID_S_AllCollations - true`,
            "CLEAR GRAPH - Thread - PartitionByID_S_AllCollations - false" to ::`CLEAR GRAPH - Thread - PartitionByID_S_AllCollations - false`,
            "CLEAR GRAPH - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath" to ::`CLEAR GRAPH - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath`,
            "CLEAR GRAPH - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath" to ::`CLEAR GRAPH - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
