...
public class CLEARGRAPH {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "CLEAR GRAPH - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL_Fast" to ::`CLEAR GRAPH - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL_Fast`,
            "CLEAR GRAPH - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast" to ::`CLEAR GRAPH - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main() {
