...
public class CLEARGRAPH {
    ...
    public fun `CLEAR GRAPH - None - Simple - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CLEARGRAPH.kt:86"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
    ...
    public fun `CLEAR GRAPH - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CLEARGRAPH.kt:101"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "CLEAR GRAPH - None - Simple - true" to ::`CLEAR GRAPH - None - Simple - true`,
            "CLEAR GRAPH - None - Simple - false" to ::`CLEAR GRAPH - None - Simple - false`,
        )
    }
}
public fun main() {
