...
public class CLEARGRAPH {
    ...
    public fun `CLEAR GRAPH - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CLEARGRAPH.kt:100"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR GRAPH - Thread - Simple - true" to ::`CLEAR GRAPH - Thread - Simple - true`,
        )
    }
}
public fun main(){
