...
public class CLEARGRAPH {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR GRAPH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`CLEAR GRAPH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
