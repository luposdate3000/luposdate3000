...
public class bind10BINDscopingVariableinfilternotinscope {
    ...
    public fun `bind10  BIND scoping  Variable in filter not in scope - Thread - BenchmarkFig5 - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "bind10  BIND scoping  Variable in filter not in scope - Thread - BenchmarkFig5 - true" to ::`bind10  BIND scoping  Variable in filter not in scope - Thread - BenchmarkFig5 - true`,
        )
    }
}
public fun main(){
