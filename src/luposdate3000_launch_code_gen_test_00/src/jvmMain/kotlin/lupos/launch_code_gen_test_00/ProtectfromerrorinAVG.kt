...
public class ProtectfromerrorinAVG {
    ...
    public fun `Protect from error in AVG - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/ProtectfromerrorinAVG.kt:80"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Protect from error in AVG - Thread - Simple - true" to ::`Protect from error in AVG - Thread - Simple - true`,
        )
    }
}
public fun main(){
