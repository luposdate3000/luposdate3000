...
public class Simpleinsertdata1 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple insert data 1 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Simple insert data 1 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
