...
public class Simpleinsertdata1 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple insert data 1 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL" to ::`Simple insert data 1 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL`,
        )
    }
}
public fun main(){
