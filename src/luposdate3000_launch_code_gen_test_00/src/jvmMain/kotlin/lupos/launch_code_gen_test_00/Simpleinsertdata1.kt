...
public class Simpleinsertdata1 {
    ...
    public fun `Simple insert data 1 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/Simpleinsertdata1.kt:72"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple insert data 1 - Thread - Simple - true" to ::`Simple insert data 1 - Thread - Simple - true`,
        )
    }
}
public fun main(){
