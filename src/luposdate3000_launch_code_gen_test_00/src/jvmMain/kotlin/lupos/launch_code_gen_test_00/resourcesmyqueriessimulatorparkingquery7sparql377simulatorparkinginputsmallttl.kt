...
public class resourcesmyqueriessimulatorparkingquery7sparql377simulatorparkinginputsmallttl {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriessimulatorparkingquery7sparql377 simulatorparkinginputsmallttl - Thread - Simple - true" to ::`resourcesmyqueriessimulatorparkingquery7sparql377 simulatorparkinginputsmallttl - Thread - Simple - true`,
        )
    }
}
public fun main(){
