...
public class resourcesbsbmexplorequery712553sparql2553 {
    ...
    public fun `resourcesbsbmexplorequery712553sparql2553 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbsbmexplorequery712553sparql2553.kt:104"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
