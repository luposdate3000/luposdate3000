...
public class INSERTUSING01 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT USING 01 - Thread - PartitionByKeyAllCollations - false" to ::`INSERT USING 01 - Thread - PartitionByKeyAllCollations - false`,
            "INSERT USING 01 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast" to ::`INSERT USING 01 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`,
            "INSERT USING 01 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast" to ::`INSERT USING 01 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`,
            "INSERT USING 01 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath" to ::`INSERT USING 01 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath`,
            "INSERT USING 01 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath" to ::`INSERT USING 01 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath`,
            "INSERT USING 01 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL" to ::`INSERT USING 01 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`,
            "INSERT USING 01 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast" to ::`INSERT USING 01 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`,
            "INSERT USING 01 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath" to ::`INSERT USING 01 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath`,
            "INSERT USING 01 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL" to ::`INSERT USING 01 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main(){
