...
public class INSERTUSING01 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT USING 01 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`INSERT USING 01 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
