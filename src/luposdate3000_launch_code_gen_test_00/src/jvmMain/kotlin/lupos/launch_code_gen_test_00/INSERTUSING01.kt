...
public class INSERTUSING01 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT USING 01 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL_Fast" to ::`INSERT USING 01 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
