...
public class COUNT12 {
    ...
    public fun `COUNT 12 - Thread - PartitionByID_O_AllCollations - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COUNT 12 - Thread - PartitionByID_O_AllCollations - true" to ::`COUNT 12 - Thread - PartitionByID_O_AllCollations - true`,
        )
    }
}
public fun main(){
