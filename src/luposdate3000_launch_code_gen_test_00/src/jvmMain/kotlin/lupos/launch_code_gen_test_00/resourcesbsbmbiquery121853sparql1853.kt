...
public class resourcesbsbmbiquery121853sparql1853 {
    ...
    public fun `resourcesbsbmbiquery121853sparql1853 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbsbmbiquery121853sparql1853.kt:99"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery121853sparql1853 - Thread - Simple - true" to ::`resourcesbsbmbiquery121853sparql1853 - Thread - Simple - true`,
        )
    }
}
public fun main(){
