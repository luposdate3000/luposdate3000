...
public class PostqueryVALUESwithsubjobjvars2rowswithUNDEF {
    ...
    public fun `Postquery VALUES with subjobjvars 2 rows with UNDEF - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/PostqueryVALUESwithsubjobjvars2rowswithUNDEF.kt:95"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
