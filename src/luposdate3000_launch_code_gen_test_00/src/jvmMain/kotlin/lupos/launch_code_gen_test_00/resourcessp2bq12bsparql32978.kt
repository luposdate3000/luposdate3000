...
public class resourcessp2bq12bsparql32978 {
    ...
    public fun `resourcessp2bq12bsparql32978 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun `resourcessp2bq12bsparql32978 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq12bsparql32978 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast" to ::`resourcessp2bq12bsparql32978 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast`,
            "resourcessp2bq12bsparql32978 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast" to ::`resourcessp2bq12bsparql32978 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
