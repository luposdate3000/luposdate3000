...
public class parentquerywithhasChildmin1restriction {
    ...
    public fun `parent query with hasChild min 1 restriction - in simulator - BenchmarkFig5 - Routing - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "parent query with hasChild min 1 restriction - in simulator - BenchmarkFig5 - Routing - false - Process - RPL" to ::`parent query with hasChild min 1 restriction - in simulator - BenchmarkFig5 - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
