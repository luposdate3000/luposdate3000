...
public class resourcesbsbmbiquery82210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery82210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery82210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL" to ::`resourcesbsbmbiquery82210sparql2210 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main() {
