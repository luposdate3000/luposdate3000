...
public class resourcesbsbmbiquery82210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery82210sparql2210 - in simulator - Simple - Centralized - false - None - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery82210sparql2210 - in simulator - Simple - Centralized - false - None - RPL_Fast" to ::`resourcesbsbmbiquery82210sparql2210 - in simulator - Simple - Centralized - false - None - RPL_Fast`,
        )
    }
    public fun main(){
