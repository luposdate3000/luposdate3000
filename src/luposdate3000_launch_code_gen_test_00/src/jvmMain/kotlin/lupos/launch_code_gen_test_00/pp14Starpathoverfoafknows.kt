...
public class pp14Starpathoverfoafknows {
    ...
    public fun `pp14 Star path over foafknows - Thread - BenchmarkFig5 - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "pp14 Star path over foafknows - Thread - BenchmarkFig5 - true" to ::`pp14 Star path over foafknows - Thread - BenchmarkFig5 - true`,
        )
    }
}
public fun main(){
