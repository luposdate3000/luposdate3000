...
public class INSERTsamebnodetwice {
    ...
    public fun `INSERT same bnode twice - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/INSERTsamebnodetwice.kt:106"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT same bnode twice - None - Simple - true" to ::`INSERT same bnode twice - None - Simple - true`,
            "INSERT same bnode twice - None - Simple - false" to ::`INSERT same bnode twice - None - Simple - false`,
        )
    }
}
public fun main(){
