...
public class INSERTsamebnodetwice {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "INSERT same bnode twice - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath" to ::`INSERT same bnode twice - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main() {
