...
public class jsonres04JSONResultFormat {
    ...
    public fun `jsonres04  JSON Result Format - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "jsonres04  JSON Result Format - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast" to ::`jsonres04  JSON Result Format - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
