...
public class bind07BINDfixeddataforOWLDL {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "bind07  BIND fixed data for OWL DL - Thread - PartitionByID_1_AllCollations - true" to ::`bind07  BIND fixed data for OWL DL - Thread - PartitionByID_1_AllCollations - true`,
        )
    }
}
public fun main(){
