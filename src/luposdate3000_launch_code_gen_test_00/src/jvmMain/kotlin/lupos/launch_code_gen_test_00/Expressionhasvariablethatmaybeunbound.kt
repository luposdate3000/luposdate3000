...
public class Expressionhasvariablethatmaybeunbound {
    ...
    public fun `Expression has variable that may be unbound - Thread - PartitionByKeyAllCollations - false`() {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "Expression has variable that may be unbound - Thread - PartitionByKeyAllCollations - false" to ::`Expression has variable that may be unbound - Thread - PartitionByKeyAllCollations - false`,
