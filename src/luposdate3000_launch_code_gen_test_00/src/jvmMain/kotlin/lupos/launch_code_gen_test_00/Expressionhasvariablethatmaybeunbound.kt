...
public class Expressionhasvariablethatmaybeunbound {
    ...
    public fun `Expression has variable that may be unbound - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Expression has variable that may be unbound - Thread - Simple - true" to ::`Expression has variable that may be unbound - Thread - Simple - true`,
        )
    }
}
public fun main(){
