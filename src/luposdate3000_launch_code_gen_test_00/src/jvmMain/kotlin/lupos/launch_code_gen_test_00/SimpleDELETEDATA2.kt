...
public class SimpleDELETEDATA2 {
    ...
    public fun `Simple DELETE DATA 2 - None - Simple - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETEDATA2.kt:74"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
    ...
    public fun `Simple DELETE DATA 2 - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETEDATA2.kt:89"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "Simple DELETE DATA 2 - None - Simple - true" to ::`Simple DELETE DATA 2 - None - Simple - true`,
            "Simple DELETE DATA 2 - None - Simple - false" to ::`Simple DELETE DATA 2 - None - Simple - false`,
        )
    }
}
public fun main() {
