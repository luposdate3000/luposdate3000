...
public class cvs02CSVResultFormat {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "cvs02  CSV Result Format - None - Simple - true" to ::`cvs02  CSV Result Format - None - Simple - true`,
            "cvs02  CSV Result Format - None - Simple - false" to ::`cvs02  CSV Result Format - None - Simple - false`,
        )
    }
}
public fun main(){
