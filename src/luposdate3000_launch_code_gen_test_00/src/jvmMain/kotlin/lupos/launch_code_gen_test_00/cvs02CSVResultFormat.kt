...
public class cvs02CSVResultFormat {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "cvs02  CSV Result Format - Thread - PartitionByID_O_AllCollations - true" to ::`cvs02  CSV Result Format - Thread - PartitionByID_O_AllCollations - true`,
            "cvs02  CSV Result Format - Thread - Simple - true" to ::`cvs02  CSV Result Format - Thread - Simple - true`,
        )
    }
}
public fun main(){
