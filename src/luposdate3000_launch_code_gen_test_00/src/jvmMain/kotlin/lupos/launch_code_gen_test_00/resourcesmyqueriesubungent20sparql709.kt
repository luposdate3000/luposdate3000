...
public class resourcesmyqueriesubungent20sparql709 {
    ...
    public fun `resourcesmyqueriesubungent20sparql709 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriesubungent20sparql709 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath" to ::`resourcesmyqueriesubungent20sparql709 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
