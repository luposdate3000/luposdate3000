...
public class SAMPLE {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "SAMPLE - Thread - PartitionByID_O_AllCollations - true" to ::`SAMPLE - Thread - PartitionByID_O_AllCollations - true`,
            "SAMPLE - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast" to ::`SAMPLE - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
