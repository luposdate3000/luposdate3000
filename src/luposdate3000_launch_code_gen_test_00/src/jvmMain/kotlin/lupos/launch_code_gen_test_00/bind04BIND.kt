...
public class bind04BIND {
    ...
    public fun `bind04  BIND - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/bind04BIND.kt:78"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
