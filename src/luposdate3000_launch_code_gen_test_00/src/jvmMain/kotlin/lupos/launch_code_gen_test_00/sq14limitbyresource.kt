...
public class sq14limitbyresource {
    ...
    public fun `sq14  limit by resource - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "sq14  limit by resource - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL" to ::`sq14  limit by resource - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL`,
