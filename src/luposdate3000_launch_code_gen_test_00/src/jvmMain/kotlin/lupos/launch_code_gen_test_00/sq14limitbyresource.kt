...
public class sq14limitbyresource {
    ...
    public fun `sq14  limit by resource - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/sq14limitbyresource.kt:88"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "sq14  limit by resource - Thread - Simple - true" to ::`sq14  limit by resource - Thread - Simple - true`,
        )
    }
}
public fun main(){
