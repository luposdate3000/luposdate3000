...
public class sq05Subquerywithingraphpatternfromnamedapplies {
    ...
    public fun `sq05  Subquery within graph pattern from named applies - Thread - BenchmarkFig5 - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "sq05  Subquery within graph pattern from named applies - Thread - BenchmarkFig5 - false" to ::`sq05  Subquery within graph pattern from named applies - Thread - BenchmarkFig5 - false`,
