...
public class sq05Subquerywithingraphpatternfromnamedapplies {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/sq05Subquerywithingraphpatternfromnamedapplies.input0").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/sq05Subquerywithingraphpatternfromnamedapplies.input0",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/sq05Subquerywithingraphpatternfromnamedapplies.output").readAsString()
    ...
    public fun `sq05  Subquery within graph pattern from named applies - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/sq05Subquerywithingraphpatternfromnamedapplies.kt:76"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `sq05  Subquery within graph pattern from named applies - Thread - PartitionByID_S_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/sq05Subquerywithingraphpatternfromnamedapplies.kt:91"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `sq05  Subquery within graph pattern from named applies - Thread - PartitionByKeyAllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/sq05Subquerywithingraphpatternfromnamedapplies.kt:106"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
...
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in sq05Subquerywithingraphpatternfromnamedapplies().getTests()){
        if (stop){
            return
        }
