...
public class sq05Subquerywithingraphpatternfromnamedapplies {
    ...
    public fun `sq05  Subquery within graph pattern from named applies - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            ...
            "sq05  Subquery within graph pattern from named applies - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath" to ::`sq05  Subquery within graph pattern from named applies - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
}
public fun main() {
