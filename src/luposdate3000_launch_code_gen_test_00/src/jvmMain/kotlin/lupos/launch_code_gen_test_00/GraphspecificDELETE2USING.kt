...
public class GraphspecificDELETE2USING {
    ...
    public fun `Graphspecific DELETE 2 USING - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/GraphspecificDELETE2USING.kt:121"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    internal fun normalHelper(instance:Luposdate3000Instance) {
        ...
        if (listOf(".n3", ".ttl", ".nt").contains(inputType[1])) {
            ...
            TODO("unknown filetype "+inputType[1])
        }
        if (listOf(".n3", ".ttl", ".nt").contains(inputType[2])) {
            ...
            TODO("unknown filetype "+inputType[2])
        }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE 2 USING - None - Simple - true" to ::`Graphspecific DELETE 2 USING - None - Simple - true`,
            "Graphspecific DELETE 2 USING - None - Simple - false" to ::`Graphspecific DELETE 2 USING - None - Simple - false`,
        )
    }
}
public fun main(){
