...
public class GraphspecificDELETE2USING {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE 2 USING - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
