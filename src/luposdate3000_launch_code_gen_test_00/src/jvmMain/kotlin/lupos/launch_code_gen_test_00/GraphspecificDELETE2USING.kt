...
public class GraphspecificDELETE2USING {
    ...
    public fun `Graphspecific DELETE 2 USING - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun `Graphspecific DELETE 2 USING - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE 2 USING - Thread - PartitionByIDTwiceAllCollations - false" to ::`Graphspecific DELETE 2 USING - Thread - PartitionByIDTwiceAllCollations - false`,
            "Graphspecific DELETE 2 USING - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath" to ::`Graphspecific DELETE 2 USING - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`,
            "Graphspecific DELETE 2 USING - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath" to ::`Graphspecific DELETE 2 USING - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
