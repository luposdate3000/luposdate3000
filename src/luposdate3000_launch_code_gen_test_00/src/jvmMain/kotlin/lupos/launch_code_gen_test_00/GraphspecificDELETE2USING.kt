...
public class GraphspecificDELETE2USING {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.input0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.input1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.input0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.input1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.output1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.output1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETE2USING.output2",
    )
    ...
    public fun `Graphspecific DELETE 2 USING - Thread - PartitionByKeyAllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/GraphspecificDELETE2USING.kt:106"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE 2 USING - Thread - PartitionByKeyAllCollations - false" to ::`Graphspecific DELETE 2 USING - Thread - PartitionByKeyAllCollations - false`,
            "Graphspecific DELETE 2 USING - in simulator - Simple - Centralized - false - None - RPL_Fast" to ::`Graphspecific DELETE 2 USING - in simulator - Simple - Centralized - false - None - RPL_Fast`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath`,
            "Graphspecific DELETE 2 USING - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath" to ::`Graphspecific DELETE 2 USING - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in GraphspecificDELETE2USING().getTests()){
        if (stop){
            return
        }
