...
public class GraphspecificDELETE1 {
    ...
    public fun `Graphspecific DELETE 1 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "Graphspecific DELETE 1 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast" to ::`Graphspecific DELETE 1 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast`,
        )
    }
}
public fun main() {
