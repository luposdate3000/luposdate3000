...
public class resourcesbsbmbiquery42553sparql2553 {
    ...
    public fun `resourcesbsbmbiquery42553sparql2553 - in simulator - Simple - Centralized - false - None - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery42553sparql2553 - None - Simple - false" to ::`resourcesbsbmbiquery42553sparql2553 - None - Simple - false`,
            "resourcesbsbmbiquery42553sparql2553 - in simulator - Simple - Centralized - false - None - RPL" to ::`resourcesbsbmbiquery42553sparql2553 - in simulator - Simple - Centralized - false - None - RPL`,
