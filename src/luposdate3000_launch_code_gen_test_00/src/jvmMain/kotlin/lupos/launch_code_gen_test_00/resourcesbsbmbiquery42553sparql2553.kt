...
public class resourcesbsbmbiquery42553sparql2553 {
    ...
    public fun `resourcesbsbmbiquery42553sparql2553 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbsbmbiquery42553sparql2553.kt:110"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery42553sparql2553 - Thread - Simple - true" to ::`resourcesbsbmbiquery42553sparql2553 - Thread - Simple - true`,
        )
    }
}
public fun main(){
