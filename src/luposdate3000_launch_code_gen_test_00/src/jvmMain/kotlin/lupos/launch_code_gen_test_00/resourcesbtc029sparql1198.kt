...
public class resourcesbtc029sparql1198 {
    ...
    public fun `resourcesbtc029sparql1198 - None - Simple - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbtc029sparql1198.kt:66"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
    ...
    public fun `resourcesbtc029sparql1198 - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbtc029sparql1198.kt:81"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "resourcesbtc029sparql1198 - None - Simple - true" to ::`resourcesbtc029sparql1198 - None - Simple - true`,
            "resourcesbtc029sparql1198 - None - Simple - false" to ::`resourcesbtc029sparql1198 - None - Simple - false`,
        )
    }
}
public fun main() {
