...
public class resourcesbtc029sparql1198 {
    ...
    public fun `resourcesbtc029sparql1198 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbtc029sparql1198.kt:80"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbtc029sparql1198 - Thread - Simple - true" to ::`resourcesbtc029sparql1198 - Thread - Simple - true`,
        )
    }
}
public fun main(){
