...
public class resourcesbtc029sparql1198 {
    ...
    public fun `resourcesbtc029sparql1198 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcesbtc029sparql1198 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL" to ::`resourcesbtc029sparql1198 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
