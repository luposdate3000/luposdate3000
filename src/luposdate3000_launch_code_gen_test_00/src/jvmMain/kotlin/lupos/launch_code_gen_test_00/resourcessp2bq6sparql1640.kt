...
public class resourcessp2bq6sparql1640 {
    ...
    public fun `resourcessp2bq6sparql1640 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcessp2bq6sparql1640.kt:93"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
