...
public class GraphspecificDELETEWHERE1 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE WHERE 1 - Thread - PartitionByID_2_AllCollations - false" to ::`Graphspecific DELETE WHERE 1 - Thread - PartitionByID_2_AllCollations - false`,
            ...
            "Graphspecific DELETE WHERE 1 - Thread - PartitionByKeyAllCollations - false" to ::`Graphspecific DELETE WHERE 1 - Thread - PartitionByKeyAllCollations - false`,
        )
    }
}
public fun main(){
