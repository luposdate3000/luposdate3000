...
public class ADD5 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.input1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.input1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.output1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.output1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD5.output2",
    )
    ...
    public fun `ADD 5 - Thread - PartitionByID_1_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/ADD5.kt:95"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `ADD 5 - Thread - PartitionByID_S_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/ADD5.kt:110"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 5 - Thread - PartitionByID_1_AllCollations - false" to ::`ADD 5 - Thread - PartitionByID_1_AllCollations - false`,
            "ADD 5 - Thread - PartitionByID_S_AllCollations - false" to ::`ADD 5 - Thread - PartitionByID_S_AllCollations - false`,
            "ADD 5 - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath" to ::`ADD 5 - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`,
            "ADD 5 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL_Fast" to ::`ADD 5 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL_Fast`,
            "ADD 5 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast" to ::`ADD 5 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast`,
            "ADD 5 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath" to ::`ADD 5 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`,
            "ADD 5 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL" to ::`ADD 5 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL`,
            "ADD 5 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath" to ::`ADD 5 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`,
            "ADD 5 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL_Fast" to ::`ADD 5 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL_Fast`,
            "ADD 5 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath" to ::`ADD 5 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`,
            "ADD 5 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL_Fast" to ::`ADD 5 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL_Fast`,
            "ADD 5 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath" to ::`ADD 5 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath`,
            "ADD 5 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL" to ::`ADD 5 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in ADD5().getTests()){
        if (stop){
            return
        }
