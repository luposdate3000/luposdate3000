...
public class ADD5 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "ADD 5 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL" to ::`ADD 5 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`,
            "ADD 5 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast" to ::`ADD 5 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
