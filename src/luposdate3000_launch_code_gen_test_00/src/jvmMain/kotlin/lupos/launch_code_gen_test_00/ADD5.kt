...
public class ADD5 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 5 - Thread - BenchmarkFig5 - false" to ::`ADD 5 - Thread - BenchmarkFig5 - false`,
            "ADD 5 - Thread - PartitionByIDTwiceAllCollations - true" to ::`ADD 5 - Thread - PartitionByIDTwiceAllCollations - true`,
            "ADD 5 - Thread - PartitionByID_1_AllCollations - false" to ::`ADD 5 - Thread - PartitionByID_1_AllCollations - false`,
            "ADD 5 - Thread - PartitionByKeyAllCollations - false" to ::`ADD 5 - Thread - PartitionByKeyAllCollations - false`,
        )
    }
}
public fun main(){
