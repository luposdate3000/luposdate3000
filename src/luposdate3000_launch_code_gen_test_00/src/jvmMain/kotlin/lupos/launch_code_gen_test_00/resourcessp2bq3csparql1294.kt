...
public class resourcessp2bq3csparql1294 {
    ...
    public fun `resourcessp2bq3csparql1294 - Thread - BenchmarkFig5 - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq3csparql1294 - Thread - BenchmarkFig5 - true" to ::`resourcessp2bq3csparql1294 - Thread - BenchmarkFig5 - true`,
        )
    }
}
public fun main(){
