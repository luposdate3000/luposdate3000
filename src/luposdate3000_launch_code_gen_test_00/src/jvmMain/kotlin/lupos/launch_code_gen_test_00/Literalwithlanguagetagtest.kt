...
public class Literalwithlanguagetagtest {
    ...
    public fun `Literal with language tag test - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `Literal with language tag test - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Literal with language tag test - Thread - PartitionByID_1_AllCollations - false" to ::`Literal with language tag test - Thread - PartitionByID_1_AllCollations - false`,
            "Literal with language tag test - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL" to ::`Literal with language tag test - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`,
            "Literal with language tag test - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast" to ::`Literal with language tag test - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
