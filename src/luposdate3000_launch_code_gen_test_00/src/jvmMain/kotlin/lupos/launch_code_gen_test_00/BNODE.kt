...
public class BNODE {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/BNODE.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/BNODE.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/BNODE.output").readAsString()
    ...
    public fun `BNODE - Thread - PartitionByIDTwiceAllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/BNODE.kt:72"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `BNODE - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "BNODE - Thread - PartitionByIDTwiceAllCollations - false" to ::`BNODE - Thread - PartitionByIDTwiceAllCollations - false`,
            "BNODE - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL" to ::`BNODE - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL`,
        )
    }
}
public fun main(){
    for((name,func) in BNODE().getTests()){
