...
public class REPLACEwithcapturedsubstring {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "REPLACE with captured substring - Thread - PartitionByID_2_AllCollations - false" to ::`REPLACE with captured substring - Thread - PartitionByID_2_AllCollations - false`,
        )
    }
}
public fun main(){
