...
public class resourcesmyqueriessimulatorparkingquery3sparql377simulatorparkinginputsmallttl {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriessimulatorparkingquery3sparql377 simulatorparkinginputsmallttl - Thread - Simple - true" to ::`resourcesmyqueriessimulatorparkingquery3sparql377 simulatorparkinginputsmallttl - Thread - Simple - true`,
        )
    }
}
public fun main(){
