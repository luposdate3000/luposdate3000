...
public class resourcesbsbmbiquery72210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery72210sparql2210 - Thread - BenchmarkFig5 - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery72210sparql2210 - Thread - BenchmarkFig5 - true" to ::`resourcesbsbmbiquery72210sparql2210 - Thread - BenchmarkFig5 - true`,
        )
    }
}
public fun main(){
