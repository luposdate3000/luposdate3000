...
public class MD5overUnicodedata {
    ...
    public fun `MD5 over Unicode data - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/MD5overUnicodedata.kt:76"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "MD5 over Unicode data - Thread - Simple - true" to ::`MD5 over Unicode data - Thread - Simple - true`,
        )
    }
}
public fun main(){
