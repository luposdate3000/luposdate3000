...
public class resourcessp2bq66sparql1294 {
    ...
    public fun `resourcessp2bq66sparql1294 - Thread - PartitionByID_2_AllCollations - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq66sparql1294 - Thread - PartitionByID_2_AllCollations - true" to ::`resourcessp2bq66sparql1294 - Thread - PartitionByID_2_AllCollations - true`,
        )
    }
}
public fun main(){
