...
public class resourcesmyqueriesoptional47sparql5 {
    ...
    public fun `resourcesmyqueriesoptional47sparql5 - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriesoptional47sparql5 - Thread - Simple - true" to ::`resourcesmyqueriesoptional47sparql5 - Thread - Simple - true`,
        )
    }
}
public fun main(){
