...
public class syntaxbindings05arqwithVALUESclause {
    ...
    public fun `syntaxbindings05arq with VALUES clause - Thread - PartitionByID_1_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/syntaxbindings05arqwithVALUESclause.kt:55"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
...
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in syntaxbindings05arqwithVALUESclause().getTests()){
        if (stop){
            return
        }
