...
public class resourcesbtc005sparql578 {
    ...
    public fun `resourcesbtc005sparql578 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbtc005sparql578.kt:79"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
