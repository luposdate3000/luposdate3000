...
public class syntaxupdateother01 {
    ...
    public fun `syntaxupdateother01 - None - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/syntaxupdateother01.kt:195"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `syntaxupdateother01 - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/syntaxupdateother01.kt:210"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `syntaxupdateother01 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/syntaxupdateother01.kt:225"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `syntaxupdateother01 - Thread - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/syntaxupdateother01.kt:240"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "syntaxupdateother01 - None - Simple - true" to ::`syntaxupdateother01 - None - Simple - true`,
            "syntaxupdateother01 - None - Simple - false" to ::`syntaxupdateother01 - None - Simple - false`,
            "syntaxupdateother01 - Thread - Simple - true" to ::`syntaxupdateother01 - Thread - Simple - true`,
            "syntaxupdateother01 - Thread - Simple - false" to ::`syntaxupdateother01 - Thread - Simple - false`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in syntaxupdateother01().getTests()){
        if (stop){
            return
        }
