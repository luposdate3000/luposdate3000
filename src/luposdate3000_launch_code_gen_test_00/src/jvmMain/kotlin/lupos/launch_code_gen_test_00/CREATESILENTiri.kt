...
public class CREATESILENTiri {
    ...
    public fun `CREATE SILENT iri - None - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CREATESILENTiri.kt:79"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `CREATE SILENT iri - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CREATESILENTiri.kt:94"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CREATE SILENT iri - None - Simple - true" to ::`CREATE SILENT iri - None - Simple - true`,
            "CREATE SILENT iri - None - Simple - false" to ::`CREATE SILENT iri - None - Simple - false`,
        )
    }
}
public fun main(){
