...
public class INSERT01 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "INSERT 01 - Thread - BenchmarkFig5 - true" to ::`INSERT 01 - Thread - BenchmarkFig5 - true`,
            "INSERT 01 - Thread - PartitionByID_1_AllCollations - true" to ::`INSERT 01 - Thread - PartitionByID_1_AllCollations - true`,
        )
    }
}
public fun main(){
