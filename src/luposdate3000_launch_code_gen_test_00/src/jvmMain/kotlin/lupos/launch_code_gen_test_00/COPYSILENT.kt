...
public class COPYSILENT {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY SILENT - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL" to ::`COPY SILENT - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main(){
