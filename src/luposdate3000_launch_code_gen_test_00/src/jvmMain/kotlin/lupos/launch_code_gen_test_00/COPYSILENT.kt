...
public class COPYSILENT {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY SILENT - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`COPY SILENT - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
