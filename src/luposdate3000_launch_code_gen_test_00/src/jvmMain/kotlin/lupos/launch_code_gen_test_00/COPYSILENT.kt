...
public class COPYSILENT {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPYSILENT.input0").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPYSILENT.input0",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPYSILENT.output0").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/COPYSILENT.output0",
    )
    ...
    public fun `COPY SILENT - Thread - PartitionByID_O_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/COPYSILENT.kt:79"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY SILENT - Thread - PartitionByID_O_AllCollations - false" to ::`COPY SILENT - Thread - PartitionByID_O_AllCollations - false`,
            "COPY SILENT - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL" to ::`COPY SILENT - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL`,
            "COPY SILENT - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast" to ::`COPY SILENT - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast`,
            "COPY SILENT - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL" to ::`COPY SILENT - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL`,
            "COPY SILENT - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`COPY SILENT - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
            "COPY SILENT - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL" to ::`COPY SILENT - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL`,
            "COPY SILENT - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL_Fast" to ::`COPY SILENT - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL_Fast`,
            "COPY SILENT - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL_Fast" to ::`COPY SILENT - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in COPYSILENT().getTests()){
        if (stop){
            return
        }
