...
public class PositiveEXISTS2 {
    ...
    public fun `Positive EXISTS 2 - in simulator - Simple - Centralized - true - None - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Positive EXISTS 2 - in simulator - Simple - Centralized - true - None - RPL" to ::`Positive EXISTS 2 - in simulator - Simple - Centralized - true - None - RPL`,
        )
    }
}
public fun main(){
