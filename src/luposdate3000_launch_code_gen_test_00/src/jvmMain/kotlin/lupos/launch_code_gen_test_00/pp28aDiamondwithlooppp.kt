...
public class pp28aDiamondwithlooppp {
    ...
    public fun `pp28a Diamond with loop  pp - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "pp28a Diamond with loop  pp - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL" to ::`pp28a Diamond with loop  pp - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
