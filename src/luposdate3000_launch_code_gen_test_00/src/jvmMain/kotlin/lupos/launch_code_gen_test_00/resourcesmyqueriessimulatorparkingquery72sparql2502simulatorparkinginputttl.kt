...
public class resourcesmyqueriessimulatorparkingquery72sparql2502simulatorparkinginputttl {
    ...
    public fun `resourcesmyqueriessimulatorparkingquery72sparql2502 simulatorparkinginputttl - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesmyqueriessimulatorparkingquery72sparql2502simulatorparkinginputttl.kt:83"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriessimulatorparkingquery72sparql2502 simulatorparkinginputttl - Thread - Simple - true" to ::`resourcesmyqueriessimulatorparkingquery72sparql2502 simulatorparkinginputttl - Thread - Simple - true`,
        )
    }
}
public fun main(){
