...
public class resourcessp2bq92sparql700 {
    ...
    public fun `resourcessp2bq92sparql700 - Thread - PartitionByID_S_AllCollations - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq92sparql700 - Thread - PartitionByID_S_AllCollations - false" to ::`resourcessp2bq92sparql700 - Thread - PartitionByID_S_AllCollations - false`,
