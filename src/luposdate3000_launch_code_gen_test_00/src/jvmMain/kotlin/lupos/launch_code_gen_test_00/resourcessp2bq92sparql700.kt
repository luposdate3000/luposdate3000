...
public class resourcessp2bq92sparql700 {
    ...
    public fun `resourcessp2bq92sparql700 - Thread - BenchmarkFig5 - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq92sparql700 - Thread - BenchmarkFig5 - true" to ::`resourcessp2bq92sparql700 - Thread - BenchmarkFig5 - true`,
        )
    }
}
public fun main(){
