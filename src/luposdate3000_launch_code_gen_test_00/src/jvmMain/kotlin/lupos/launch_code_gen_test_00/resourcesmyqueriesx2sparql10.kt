...
public class resourcesmyqueriesx2sparql10 {
    ...
    public fun `resourcesmyqueriesx2sparql10 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesmyqueriesx2sparql10.kt:73"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriesx2sparql10 - Thread - Simple - true" to ::`resourcesmyqueriesx2sparql10 - Thread - Simple - true`,
        )
    }
}
public fun main(){
