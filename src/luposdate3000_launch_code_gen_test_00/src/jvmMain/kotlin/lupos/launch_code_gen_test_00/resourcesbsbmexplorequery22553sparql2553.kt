...
public class resourcesbsbmexplorequery22553sparql2553 {
    ...
    public fun `resourcesbsbmexplorequery22553sparql2553 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `resourcesbsbmexplorequery22553sparql2553 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "resourcesbsbmexplorequery22553sparql2553 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL" to ::`resourcesbsbmexplorequery22553sparql2553 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL`,
            "resourcesbsbmexplorequery22553sparql2553 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast" to ::`resourcesbsbmexplorequery22553sparql2553 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main() {
