...
public class sparqldl09rqundistvarstest {
    ...
    public fun `sparqldl09rq undist vars test - Thread - PartitionByID_2_AllCollations - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "sparqldl09rq undist vars test - Thread - PartitionByID_2_AllCollations - false" to ::`sparqldl09rq undist vars test - Thread - PartitionByID_2_AllCollations - false`,
        )
    }
}
public fun main(){
