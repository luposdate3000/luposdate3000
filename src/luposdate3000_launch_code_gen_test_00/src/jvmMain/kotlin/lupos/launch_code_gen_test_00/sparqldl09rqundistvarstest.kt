...
public class sparqldl09rqundistvarstest {
    ...
    public fun `sparqldl09rq undist vars test - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/sparqldl09rqundistvarstest.kt:88"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
