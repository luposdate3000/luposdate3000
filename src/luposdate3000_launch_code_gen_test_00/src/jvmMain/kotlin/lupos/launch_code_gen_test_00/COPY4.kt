...
public class COPY4 {
    ...
    public fun `COPY 4 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY 4 - Thread - PartitionByIDTwiceAllCollations - false" to ::`COPY 4 - Thread - PartitionByIDTwiceAllCollations - false`,
            "COPY 4 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL" to ::`COPY 4 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
