...
public class COPY4 {
    ...
    public fun `COPY 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast" to ::`COPY 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
