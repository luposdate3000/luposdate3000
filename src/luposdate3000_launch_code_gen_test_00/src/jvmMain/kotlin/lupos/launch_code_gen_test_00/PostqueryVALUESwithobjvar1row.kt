...
public class PostqueryVALUESwithobjvar1row {
    ...
    public fun `Postquery VALUES with objvar 1 row - Thread - PartitionByID_S_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
    ...
    public fun `Postquery VALUES with objvar 1 row - Thread - PartitionByKeyAllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "Postquery VALUES with objvar 1 row - Thread - PartitionByID_S_AllCollations - false" to ::`Postquery VALUES with objvar 1 row - Thread - PartitionByID_S_AllCollations - false`,
            "Postquery VALUES with objvar 1 row - Thread - PartitionByKeyAllCollations - true" to ::`Postquery VALUES with objvar 1 row - Thread - PartitionByKeyAllCollations - true`,
        )
    }
}
public fun main(){
