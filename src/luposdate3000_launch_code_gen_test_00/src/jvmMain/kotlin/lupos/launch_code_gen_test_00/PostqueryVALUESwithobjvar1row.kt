...
public class PostqueryVALUESwithobjvar1row {
    ...
    public fun `Postquery VALUES with objvar 1 row - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Postquery VALUES with objvar 1 row - Thread - Simple - true" to ::`Postquery VALUES with objvar 1 row - Thread - Simple - true`,
        )
    }
}
public fun main(){
