...
public class bind11BINDscopingVariableinfilterinscope {
    ...
    public fun `bind11  BIND scoping  Variable in filter in scope - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/bind11BINDscopingVariableinfilterinscope.kt:81"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "bind11  BIND scoping  Variable in filter in scope - Thread - Simple - true" to ::`bind11  BIND scoping  Variable in filter in scope - Thread - Simple - true`,
        )
    }
}
public fun main(){
