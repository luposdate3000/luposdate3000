...
public class UCASE {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "UCASE - Thread - Simple - false" to ::`UCASE - Thread - Simple - false`,
            "UCASE - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL" to ::`UCASE - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL`,
        )
    }
}
public fun main(){
