...
public class Group4 {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "Group4 - Thread - PartitionByID_1_AllCollations - true" to ::`Group4 - Thread - PartitionByID_1_AllCollations - true`,
            "Group4 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath" to ::`Group4 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main() {
