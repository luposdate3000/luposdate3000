...
public class SimpleDELETE2USING {
    ...
    public fun `Simple DELETE 2 USING - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun `Simple DELETE 2 USING - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "Simple DELETE 2 USING - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL_Fast" to ::`Simple DELETE 2 USING - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL_Fast`,
            "Simple DELETE 2 USING - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath" to ::`Simple DELETE 2 USING - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main() {
