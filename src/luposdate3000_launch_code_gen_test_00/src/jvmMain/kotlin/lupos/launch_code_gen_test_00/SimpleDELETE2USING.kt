...
public class SimpleDELETE2USING {
    ...
    public fun `Simple DELETE 2 USING - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETE2USING.kt:121"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 2 USING - None - Simple - true" to ::`Simple DELETE 2 USING - None - Simple - true`,
            "Simple DELETE 2 USING - None - Simple - false" to ::`Simple DELETE 2 USING - None - Simple - false`,
        )
    }
}
public fun main(){
