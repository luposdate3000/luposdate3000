...
public class SimpleDELETE2USING {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 2 USING - Thread - PartitionByID_O_AllCollations - true" to ::`Simple DELETE 2 USING - Thread - PartitionByID_O_AllCollations - true`,
            "Simple DELETE 2 USING - Thread - Simple - true" to ::`Simple DELETE 2 USING - Thread - Simple - true`,
        )
    }
}
public fun main(){
