...
public class ADD2 {
    ...
    public fun `ADD 2 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 2 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`ADD 2 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
