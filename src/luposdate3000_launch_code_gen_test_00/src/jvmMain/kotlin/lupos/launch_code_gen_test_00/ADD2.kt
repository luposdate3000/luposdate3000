...
public class ADD2 {
    ...
    public fun `ADD 2 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun `ADD 2 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 2 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast" to ::`ADD 2 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`,
            "ADD 2 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast" to ::`ADD 2 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
