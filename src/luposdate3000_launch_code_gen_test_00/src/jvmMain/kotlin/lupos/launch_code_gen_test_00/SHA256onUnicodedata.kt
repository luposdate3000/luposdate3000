...
public class SHA256onUnicodedata {
    ...
    public fun `SHA256 on Unicode data - None - Simple - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SHA256onUnicodedata.kt:72"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
