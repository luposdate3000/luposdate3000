...
public class SUM {
    ...
    public fun `SUM - Thread - PartitionByID_O_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SUM.kt:73"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "SUM - Thread - PartitionByID_O_AllCollations - true" to ::`SUM - Thread - PartitionByID_O_AllCollations - true`,
            "SUM - in simulator - Simple - Centralized - false - None - AllShortestPath" to ::`SUM - in simulator - Simple - Centralized - false - None - AllShortestPath`,
            "SUM - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath" to ::`SUM - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
