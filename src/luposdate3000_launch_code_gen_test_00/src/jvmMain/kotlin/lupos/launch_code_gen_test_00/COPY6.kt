...
public class COPY6 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY 6 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`COPY 6 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
