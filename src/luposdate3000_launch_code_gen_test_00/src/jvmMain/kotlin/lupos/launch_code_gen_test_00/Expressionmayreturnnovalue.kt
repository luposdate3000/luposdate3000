...
public class Expressionmayreturnnovalue {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Expression may return no value - Thread - PartitionByID_S_AllCollations - true" to ::`Expression may return no value - Thread - PartitionByID_S_AllCollations - true`,
            ...
            "Expression may return no value - Thread - PartitionByKeyAllCollations - true" to ::`Expression may return no value - Thread - PartitionByKeyAllCollations - true`,
        )
    }
}
public fun main(){
