...
public class Expressionmayreturnnovalue {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Expression may return no value - Thread - PartitionByIDTwiceAllCollations - false" to ::`Expression may return no value - Thread - PartitionByIDTwiceAllCollations - false`,
        )
    }
}
public fun main(){
