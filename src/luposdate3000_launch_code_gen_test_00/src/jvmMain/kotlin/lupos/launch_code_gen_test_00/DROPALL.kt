...
public class DROPALL {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DROP ALL - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`DROP ALL - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
