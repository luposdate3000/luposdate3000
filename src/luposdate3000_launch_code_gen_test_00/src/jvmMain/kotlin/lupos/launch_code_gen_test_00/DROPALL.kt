...
public class DROPALL {
    ...
    public fun `DROP ALL - Thread - PartitionByID_2_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/DROPALL.kt:76"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `DROP ALL - Thread - PartitionByID_S_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/DROPALL.kt:91"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DROP ALL - Thread - PartitionByID_2_AllCollations - true" to ::`DROP ALL - Thread - PartitionByID_2_AllCollations - true`,
            "DROP ALL - Thread - PartitionByID_S_AllCollations - false" to ::`DROP ALL - Thread - PartitionByID_S_AllCollations - false`,
            ...
            "DROP ALL - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL" to ::`DROP ALL - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL`,
            "DROP ALL - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath" to ::`DROP ALL - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`,
            "DROP ALL - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath" to ::`DROP ALL - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
