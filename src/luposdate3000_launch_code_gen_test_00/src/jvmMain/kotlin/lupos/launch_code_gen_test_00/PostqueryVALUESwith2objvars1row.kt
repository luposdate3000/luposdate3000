...
public class PostqueryVALUESwith2objvars1row {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Postquery VALUES with 2 objvars 1 row - Thread - PartitionByIDTwiceAllCollations - true" to ::`Postquery VALUES with 2 objvars 1 row - Thread - PartitionByIDTwiceAllCollations - true`,
        )
    }
}
public fun main(){
