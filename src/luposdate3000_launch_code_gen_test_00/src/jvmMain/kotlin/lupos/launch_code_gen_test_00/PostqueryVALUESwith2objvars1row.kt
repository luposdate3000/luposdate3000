...
public class PostqueryVALUESwith2objvars1row {
    ...
    public fun `Postquery VALUES with 2 objvars 1 row - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/PostqueryVALUESwith2objvars1row.kt:81"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
