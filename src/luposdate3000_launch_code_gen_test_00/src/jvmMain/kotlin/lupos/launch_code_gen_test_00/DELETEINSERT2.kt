...
public class DELETEINSERT2 {
    ...
    public fun `DELETE INSERT 2 - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/DELETEINSERT2.kt:102"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DELETE INSERT 2 - None - Simple - true" to ::`DELETE INSERT 2 - None - Simple - true`,
            "DELETE INSERT 2 - None - Simple - false" to ::`DELETE INSERT 2 - None - Simple - false`,
        )
    }
}
public fun main(){
