...
public class REPLACEwithoverlappingpattern {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/REPLACEwithoverlappingpattern.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/REPLACEwithoverlappingpattern.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/REPLACEwithoverlappingpattern.output").readAsString()
    ...
    public fun `REPLACE with overlapping pattern - Thread - PartitionByIDTwiceAllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/REPLACEwithoverlappingpattern.kt:73"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "REPLACE with overlapping pattern - Thread - PartitionByIDTwiceAllCollations - true" to ::`REPLACE with overlapping pattern - Thread - PartitionByIDTwiceAllCollations - true`,
...
public fun main(){
    for((name,func) in REPLACEwithoverlappingpattern().getTests()){
