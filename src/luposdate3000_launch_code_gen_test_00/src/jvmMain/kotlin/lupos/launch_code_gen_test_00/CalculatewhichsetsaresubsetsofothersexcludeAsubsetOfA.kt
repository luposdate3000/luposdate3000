...
public class CalculatewhichsetsaresubsetsofothersexcludeAsubsetOfA {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Calculate which sets are subsets of others exclude A subsetOf A - None - Simple - true" to ::`Calculate which sets are subsets of others exclude A subsetOf A - None - Simple - true`,
