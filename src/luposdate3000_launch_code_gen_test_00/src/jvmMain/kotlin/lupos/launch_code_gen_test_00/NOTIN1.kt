...
public class NOTIN1 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "NOT IN 1 - Thread - PartitionByID_1_AllCollations - false" to ::`NOT IN 1 - Thread - PartitionByID_1_AllCollations - false`,
            "NOT IN 1 - in simulator - Simple - Centralized - false - None - AllShortestPath" to ::`NOT IN 1 - in simulator - Simple - Centralized - false - None - AllShortestPath`,
        )
    }
}
public fun main(){
