...
public class DROPNAMED {
    ...
    public fun `DROP NAMED - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DROP NAMED - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`DROP NAMED - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
