...
public class DROPNAMED {
    ...
    public fun `DROP NAMED - None - Simple - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/DROPNAMED.kt:78"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
    ...
    public fun `DROP NAMED - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/DROPNAMED.kt:93"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            ...
            "DROP NAMED - None - Simple - false" to ::`DROP NAMED - None - Simple - false`,
        )
    }
}
public fun main() {
