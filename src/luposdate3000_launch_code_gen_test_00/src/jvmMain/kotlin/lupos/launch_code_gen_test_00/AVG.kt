...
public class AVG {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "AVG - Thread - BenchmarkFig5 - false" to ::`AVG - Thread - BenchmarkFig5 - false`,
            "AVG - Thread - PartitionByID_2_AllCollations - true" to ::`AVG - Thread - PartitionByID_2_AllCollations - true`,
        )
    }
}
public fun main(){
