...
public class resourcesbsbmexplorequery112553sparql2553 {
    ...
    public fun `resourcesbsbmexplorequery112553sparql2553 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcesbsbmexplorequery112553sparql2553 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL_Fast" to ::`resourcesbsbmexplorequery112553sparql2553 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
