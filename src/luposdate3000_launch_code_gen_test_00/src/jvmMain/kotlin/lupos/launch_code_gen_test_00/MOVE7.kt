...
public class MOVE7 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "MOVE 7 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`MOVE 7 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
