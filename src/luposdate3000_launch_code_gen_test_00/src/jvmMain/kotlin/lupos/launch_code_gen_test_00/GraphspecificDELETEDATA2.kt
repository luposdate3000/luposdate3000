...
public class GraphspecificDELETEDATA2 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.input1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.input1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.output1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.output1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/GraphspecificDELETEDATA2.output2",
    )
    ...
    public fun `Graphspecific DELETE DATA 2 - None - Simple - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/GraphspecificDELETEDATA2.kt:90"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
    ...
    public fun `Graphspecific DELETE DATA 2 - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/GraphspecificDELETEDATA2.kt:105"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "Graphspecific DELETE DATA 2 - None - Simple - true" to ::`Graphspecific DELETE DATA 2 - None - Simple - true`,
...
public fun main() {
    var idx = 0
    var stop = false
    for ((name, func) in GraphspecificDELETEDATA2().getTests()) {
        if (stop) {
            return
        }
