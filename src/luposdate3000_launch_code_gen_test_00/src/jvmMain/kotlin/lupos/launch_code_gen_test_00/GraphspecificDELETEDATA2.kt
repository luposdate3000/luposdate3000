...
public class GraphspecificDELETEDATA2 {
    ...
    public fun `Graphspecific DELETE DATA 2 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE DATA 2 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath" to ::`Graphspecific DELETE DATA 2 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath`,
