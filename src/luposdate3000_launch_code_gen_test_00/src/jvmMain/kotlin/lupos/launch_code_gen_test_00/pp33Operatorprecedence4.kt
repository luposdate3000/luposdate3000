...
public class pp33Operatorprecedence4 {
    ...
    public fun `pp33 Operator precedence 4 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "pp33 Operator precedence 4 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL" to ::`pp33 Operator precedence 4 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main() {
