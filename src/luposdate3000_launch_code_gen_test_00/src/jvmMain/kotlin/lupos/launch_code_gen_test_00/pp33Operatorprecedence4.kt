...
public class pp33Operatorprecedence4 {
    ...
    public fun `pp33 Operator precedence 4 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `pp33 Operator precedence 4 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "pp33 Operator precedence 4 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL" to ::`pp33 Operator precedence 4 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`,
            "pp33 Operator precedence 4 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast" to ::`pp33 Operator precedence 4 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
