...
public class resourcessp2bq12asparql973 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq12asparql973 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL" to ::`resourcessp2bq12asparql973 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL`,
        )
    }
}
public fun main(){
