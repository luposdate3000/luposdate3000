...
public class AVGwithGROUPBY {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "AVG with GROUP BY - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`AVG with GROUP BY - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
