...
public class syntaxupdatebad10ru {
    ...
    public fun `syntaxupdatebad10ru - Thread - PartitionByID_2_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/syntaxupdatebad10ru.kt:56"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
