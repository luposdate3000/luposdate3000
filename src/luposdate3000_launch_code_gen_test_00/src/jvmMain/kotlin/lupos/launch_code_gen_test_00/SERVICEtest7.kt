...
public class SERVICEtest7 {
    ...
    public fun `SERVICE test 7 - Thread - PartitionByID_S_AllCollations - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "SERVICE test 7 - Thread - PartitionByID_S_AllCollations - false" to ::`SERVICE test 7 - Thread - PartitionByID_S_AllCollations - false`,
        )
    }
}
public fun main(){
