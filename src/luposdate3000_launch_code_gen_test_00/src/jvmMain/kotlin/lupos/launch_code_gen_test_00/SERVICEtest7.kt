...
public class SERVICEtest7 {
    ...
    public fun `SERVICE test 7 - Thread - BenchmarkFig5 - false`() {
    ...
    public fun `SERVICE test 7 - Thread - Simple - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "SERVICE test 7 - Thread - BenchmarkFig5 - false" to ::`SERVICE test 7 - Thread - BenchmarkFig5 - false`,
            "SERVICE test 7 - Thread - Simple - true" to ::`SERVICE test 7 - Thread - Simple - true`,
        )
    }
}
public fun main(){
