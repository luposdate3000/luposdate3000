...
public class resourcesbsbmexplorequery21853sparql1853 {
    ...
    public fun `resourcesbsbmexplorequery21853sparql1853 - None - Simple - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcesbsbmexplorequery21853sparql1853 - None - Simple - false" to ::`resourcesbsbmexplorequery21853sparql1853 - None - Simple - false`,
        )
    }
}
public fun main(){
