...
public class resourcesbsbmexplorequery21853sparql1853 {
    ...
    public fun `resourcesbsbmexplorequery21853sparql1853 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery21853sparql1853 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - AllShortestPath" to ::`resourcesbsbmexplorequery21853sparql1853 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
