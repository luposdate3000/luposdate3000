...
public class resourcesbsbmexplorequery21853sparql1853 {
    ...
    public fun `resourcesbsbmexplorequery21853sparql1853 - Thread - PartitionByID_2_AllCollations - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery21853sparql1853 - Thread - PartitionByID_2_AllCollations - true" to ::`resourcesbsbmexplorequery21853sparql1853 - Thread - PartitionByID_2_AllCollations - true`,
        )
    }
}
public fun main(){
