...
public class resourcessp2bq6sparql32978 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/resourcessp2bq6sparql32978.input",
    )
    ...
    public fun `resourcessp2bq6sparql32978 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq6sparql32978 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL" to ::`resourcessp2bq6sparql32978 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL`,
        )
    }
}
public fun main(){
