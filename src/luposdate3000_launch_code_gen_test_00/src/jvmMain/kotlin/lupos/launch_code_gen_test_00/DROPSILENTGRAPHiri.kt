...
public class DROPSILENTGRAPHiri {
    ...
    public fun `DROP SILENT GRAPH iri - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DROP SILENT GRAPH iri - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL_Fast" to ::`DROP SILENT GRAPH iri - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
