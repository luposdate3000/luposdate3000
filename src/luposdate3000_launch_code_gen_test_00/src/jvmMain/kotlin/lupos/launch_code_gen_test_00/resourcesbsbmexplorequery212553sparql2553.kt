...
public class resourcesbsbmexplorequery212553sparql2553 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/resourcesbsbmexplorequery212553sparql2553.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/resourcesbsbmexplorequery212553sparql2553.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/resourcesbsbmexplorequery212553sparql2553.output").readAsString()
    ...
    public fun `resourcesbsbmexplorequery212553sparql2553 - None - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbsbmexplorequery212553sparql2553.kt:97"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `resourcesbsbmexplorequery212553sparql2553 - None - Simple - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesbsbmexplorequery212553sparql2553.kt:112"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery212553sparql2553 - None - Simple - true" to ::`resourcesbsbmexplorequery212553sparql2553 - None - Simple - true`,
            "resourcesbsbmexplorequery212553sparql2553 - None - Simple - false" to ::`resourcesbsbmexplorequery212553sparql2553 - None - Simple - false`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in resourcesbsbmexplorequery212553sparql2553().getTests()){
        if (stop){
            return
        }
