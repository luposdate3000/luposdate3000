...
public class simple4 {
    ...
    public fun `simple 4 - Thread - PartitionByIDTwiceAllCollations - true`() {
    ...
    public fun `simple 4 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "simple 4 - Thread - PartitionByIDTwiceAllCollations - true" to ::`simple 4 - Thread - PartitionByIDTwiceAllCollations - true`,
            "simple 4 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath" to ::`simple 4 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
