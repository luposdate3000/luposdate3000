...
public class DROPGRAPH {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DROP GRAPH - Thread - PartitionByID_1_AllCollations - true" to ::`DROP GRAPH - Thread - PartitionByID_1_AllCollations - true`,
            "DROP GRAPH - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL" to ::`DROP GRAPH - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL`,
        )
    }
}
public fun main(){
