...
public class DROPGRAPH {
    ...
    public fun `DROP GRAPH - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/DROPGRAPH.kt:107"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DROP GRAPH - None - Simple - true" to ::`DROP GRAPH - None - Simple - true`,
            "DROP GRAPH - None - Simple - false" to ::`DROP GRAPH - None - Simple - false`,
        )
    }
}
public fun main(){
