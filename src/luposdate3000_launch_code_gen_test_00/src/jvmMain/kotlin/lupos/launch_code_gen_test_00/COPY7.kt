...
public class COPY7 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COPY 7 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`COPY 7 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
