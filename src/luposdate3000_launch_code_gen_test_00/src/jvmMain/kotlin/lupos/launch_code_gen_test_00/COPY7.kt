...
public class COPY7 {
    ...
    public fun `COPY 7 - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/COPY7.kt:102"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "COPY 7 - None - Simple - true" to ::`COPY 7 - None - Simple - true`,
            "COPY 7 - None - Simple - false" to ::`COPY 7 - None - Simple - false`,
        )
    }
}
public fun main() {
