...
public class resourcesmyqueriesubungent17sparql709 {
    ...
    public fun `resourcesmyqueriesubungent17sparql709 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/resourcesmyqueriesubungent17sparql709.kt:79"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
