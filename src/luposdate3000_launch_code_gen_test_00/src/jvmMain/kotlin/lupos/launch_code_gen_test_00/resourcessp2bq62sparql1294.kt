...
public class resourcessp2bq62sparql1294 {
    ...
    public fun `resourcessp2bq62sparql1294 - Thread - PartitionByID_O_AllCollations - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq62sparql1294 - Thread - PartitionByID_O_AllCollations - false" to ::`resourcessp2bq62sparql1294 - Thread - PartitionByID_O_AllCollations - false`,
        )
    }
}
public fun main(){
