...
public class resourcessp2bq62sparql1294 {
    ...
    public fun `resourcessp2bq62sparql1294 - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq62sparql1294 - Thread - Simple - true" to ::`resourcessp2bq62sparql1294 - Thread - Simple - true`,
        )
    }
}
public fun main(){
