...
public class GraphspecificDELETE1USING {
    ...
    public fun `Graphspecific DELETE 1 USING - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE 1 USING - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Graphspecific DELETE 1 USING - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
