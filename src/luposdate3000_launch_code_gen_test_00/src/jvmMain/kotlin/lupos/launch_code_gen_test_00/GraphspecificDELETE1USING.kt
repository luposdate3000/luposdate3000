...
public class GraphspecificDELETE1USING {
    ...
    public fun `Graphspecific DELETE 1 USING - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE 1 USING - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL" to ::`Graphspecific DELETE 1 USING - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL`,
        )
    }
}
public fun main(){
