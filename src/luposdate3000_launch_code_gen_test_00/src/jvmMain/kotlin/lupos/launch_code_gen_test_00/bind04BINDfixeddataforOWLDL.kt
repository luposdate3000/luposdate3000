...
public class bind04BINDfixeddataforOWLDL {
    ...
    public fun `bind04  BIND fixed data for OWL DL - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "bind04  BIND fixed data for OWL DL - Thread - Simple - true" to ::`bind04  BIND fixed data for OWL DL - Thread - Simple - true`,
        )
    }
}
public fun main(){
