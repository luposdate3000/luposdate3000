...
public class bind04BINDfixeddataforOWLDL {
    ...
    public fun `bind04  BIND fixed data for OWL DL - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun `bind04  BIND fixed data for OWL DL - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "bind04  BIND fixed data for OWL DL - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath" to ::`bind04  BIND fixed data for OWL DL - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`,
            "bind04  BIND fixed data for OWL DL - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath" to ::`bind04  BIND fixed data for OWL DL - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
