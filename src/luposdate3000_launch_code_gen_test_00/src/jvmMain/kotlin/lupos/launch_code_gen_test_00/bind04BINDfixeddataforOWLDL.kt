...
public class bind04BINDfixeddataforOWLDL {
    ...
    public fun `bind04  BIND fixed data for OWL DL - Thread - PartitionByID_O_AllCollations - false`() {
    ...
    public fun `bind04  BIND fixed data for OWL DL - Thread - PartitionByKeyAllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "bind04  BIND fixed data for OWL DL - Thread - PartitionByID_O_AllCollations - false" to ::`bind04  BIND fixed data for OWL DL - Thread - PartitionByID_O_AllCollations - false`,
            "bind04  BIND fixed data for OWL DL - Thread - PartitionByKeyAllCollations - true" to ::`bind04  BIND fixed data for OWL DL - Thread - PartitionByKeyAllCollations - true`,
        )
    }
}
public fun main(){
