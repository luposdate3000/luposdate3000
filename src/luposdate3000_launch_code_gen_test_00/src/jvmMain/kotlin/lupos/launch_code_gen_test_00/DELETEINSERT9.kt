...
public class DELETEINSERT9 {
    ...
    public fun `DELETE INSERT 9 - Thread - PartitionByID_1_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/DELETEINSERT9.kt:59"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
...
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in DELETEINSERT9().getTests()){
        if (stop){
            return
        }
