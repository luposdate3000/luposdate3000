...
public class GraphspecificDELETEDATA1 {
    ...
    public fun `Graphspecific DELETE DATA 1 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "Graphspecific DELETE DATA 1 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL" to ::`Graphspecific DELETE DATA 1 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`,
        )
    }
}
public fun main() {
