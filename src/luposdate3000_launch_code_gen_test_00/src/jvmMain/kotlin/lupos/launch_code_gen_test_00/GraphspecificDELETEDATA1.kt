...
public class GraphspecificDELETEDATA1 {
    ...
    public fun `Graphspecific DELETE DATA 1 - Thread - BenchmarkFig5 - true`() {
    ...
    public fun `Graphspecific DELETE DATA 1 - Thread - BenchmarkFig5 - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE DATA 1 - Thread - BenchmarkFig5 - true" to ::`Graphspecific DELETE DATA 1 - Thread - BenchmarkFig5 - true`,
            "Graphspecific DELETE DATA 1 - Thread - BenchmarkFig5 - false" to ::`Graphspecific DELETE DATA 1 - Thread - BenchmarkFig5 - false`,
            "Graphspecific DELETE DATA 1 - Thread - PartitionByIDTwiceAllCollations - true" to ::`Graphspecific DELETE DATA 1 - Thread - PartitionByIDTwiceAllCollations - true`,
            "Graphspecific DELETE DATA 1 - Thread - PartitionByKeyAllCollations - true" to ::`Graphspecific DELETE DATA 1 - Thread - PartitionByKeyAllCollations - true`,
        )
    }
}
public fun main(){
