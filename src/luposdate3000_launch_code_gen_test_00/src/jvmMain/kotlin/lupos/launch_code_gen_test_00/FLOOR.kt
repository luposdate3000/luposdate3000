...
public class FLOOR {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "FLOOR - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`FLOOR - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
