...
public class FLOOR {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "FLOOR - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath" to ::`FLOOR - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
