...
public class resourcessp2bq12b3sparql1640 {
    ...
    public fun `resourcessp2bq12b3sparql1640 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcessp2bq12b3sparql1640 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL" to ::`resourcessp2bq12b3sparql1640 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main(){
