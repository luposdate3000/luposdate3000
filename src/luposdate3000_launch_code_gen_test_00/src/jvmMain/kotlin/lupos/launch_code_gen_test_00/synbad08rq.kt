...
public class synbad08rq {
    ...
    public fun `synbad08rq - None - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/synbad08rq.kt:55"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
...
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in synbad08rq().getTests()){
        if (stop){
            return
        }
