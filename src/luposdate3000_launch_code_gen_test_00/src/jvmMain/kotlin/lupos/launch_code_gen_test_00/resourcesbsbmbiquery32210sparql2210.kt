...
public class resourcesbsbmbiquery32210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery32210sparql2210 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery32210sparql2210 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL" to ::`resourcesbsbmbiquery32210sparql2210 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`,
        )
    }
}
public fun main(){
