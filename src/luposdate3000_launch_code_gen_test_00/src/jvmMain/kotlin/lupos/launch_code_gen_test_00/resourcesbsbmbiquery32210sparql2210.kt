...
public class resourcesbsbmbiquery32210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery32210sparql2210 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery32210sparql2210 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast" to ::`resourcesbsbmbiquery32210sparql2210 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
