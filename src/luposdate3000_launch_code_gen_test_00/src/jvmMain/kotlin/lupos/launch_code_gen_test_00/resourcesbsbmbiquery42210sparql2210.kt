...
public class resourcesbsbmbiquery42210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery42210sparql2210 - Thread - PartitionByIDTwiceAllCollations - true`() {
    ...
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery42210sparql2210 - Thread - PartitionByIDTwiceAllCollations - true" to ::`resourcesbsbmbiquery42210sparql2210 - Thread - PartitionByIDTwiceAllCollations - true`,
            "resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast" to ::`resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast`,
            "resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath" to ::`resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
