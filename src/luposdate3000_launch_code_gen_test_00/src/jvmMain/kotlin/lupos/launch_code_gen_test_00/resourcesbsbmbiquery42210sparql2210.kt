...
public class resourcesbsbmbiquery42210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL_Fast" to ::`resourcesbsbmbiquery42210sparql2210 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
