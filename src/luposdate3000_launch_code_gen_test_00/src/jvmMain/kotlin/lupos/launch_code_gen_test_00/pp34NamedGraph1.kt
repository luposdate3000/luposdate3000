...
public class pp34NamedGraph1 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "pp34 Named Graph 1 - None - Simple - false" to ::`pp34 Named Graph 1 - None - Simple - false`,
            "pp34 Named Graph 1 - Thread - PartitionByID_S_AllCollations - true" to ::`pp34 Named Graph 1 - Thread - PartitionByID_S_AllCollations - true`,
        )
    }
}
public fun main(){
