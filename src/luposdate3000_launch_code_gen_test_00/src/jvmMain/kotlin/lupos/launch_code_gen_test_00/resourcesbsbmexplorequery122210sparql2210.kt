...
public class resourcesbsbmexplorequery122210sparql2210 {
    ...
    public fun `resourcesbsbmexplorequery122210sparql2210 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery122210sparql2210 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast" to ::`resourcesbsbmexplorequery122210sparql2210 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main() {
