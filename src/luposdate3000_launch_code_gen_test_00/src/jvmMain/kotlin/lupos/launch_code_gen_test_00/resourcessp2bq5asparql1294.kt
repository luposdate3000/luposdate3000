...
public class resourcessp2bq5asparql1294 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq5asparql1294 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL" to ::`resourcessp2bq5asparql1294 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL`,
        )
    }
    public fun main(){
