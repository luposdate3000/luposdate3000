...
public class isNumeric {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/isNumeric.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/isNumeric.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/isNumeric.output").readAsString()
    ...
    public fun `isNumeric - Thread - PartitionByID_S_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/isNumeric.kt:73"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "isNumeric - Thread - PartitionByID_S_AllCollations - true" to ::`isNumeric - Thread - PartitionByID_S_AllCollations - true`,
            "isNumeric - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast" to ::`isNumeric - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
    for((name,func) in isNumeric().getTests()){
