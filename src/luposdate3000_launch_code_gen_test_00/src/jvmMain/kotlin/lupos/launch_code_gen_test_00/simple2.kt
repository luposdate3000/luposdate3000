...
public class simple2 {
    ...
    public fun `simple 2 - in simulator - Simple - Centralized - false - None - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "simple 2 - in simulator - Simple - Centralized - false - None - RPL" to ::`simple 2 - in simulator - Simple - Centralized - false - None - RPL`,
        )
    }
}
public fun main(){
