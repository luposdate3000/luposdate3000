...
public class DROPDEFAULT {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.input1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.input1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/DROPDEFAULT.output1",
    )
    ...
    public fun `DROP DEFAULT - Thread - PartitionByIDTwiceAllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/DROPDEFAULT.kt:107"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `DROP DEFAULT - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/DROPDEFAULT.kt:122"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "DROP DEFAULT - in simulator - Simple - Centralized - false - None - RPL_Fast" to ::`DROP DEFAULT - in simulator - Simple - Centralized - false - None - RPL_Fast`,
            "DROP DEFAULT - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL" to ::`DROP DEFAULT - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`,
            "DROP DEFAULT - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast" to ::`DROP DEFAULT - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`,
            "DROP DEFAULT - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath" to ::`DROP DEFAULT - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath`,
            "DROP DEFAULT - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL_Fast" to ::`DROP DEFAULT - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL_Fast`,
            "DROP DEFAULT - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast" to ::`DROP DEFAULT - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast`,
            "DROP DEFAULT - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast" to ::`DROP DEFAULT - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast`,
            "DROP DEFAULT - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL" to ::`DROP DEFAULT - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL`,
            "DROP DEFAULT - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast" to ::`DROP DEFAULT - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast`,
            "DROP DEFAULT - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath" to ::`DROP DEFAULT - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`,
            "DROP DEFAULT - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast" to ::`DROP DEFAULT - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`,
            "DROP DEFAULT - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL" to ::`DROP DEFAULT - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL`,
            "DROP DEFAULT - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath" to ::`DROP DEFAULT - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in DROPDEFAULT().getTests()){
        if (stop){
            return
        }
