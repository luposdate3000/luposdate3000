...
public class DROPDEFAULT {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DROP DEFAULT - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL" to ::`DROP DEFAULT - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main(){
