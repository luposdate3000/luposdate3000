...
public class Existswithingraphpattern {
    ...
    public fun `Exists within graph pattern - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Exists within graph pattern - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Exists within graph pattern - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
