...
public class Existswithingraphpattern {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Exists within graph pattern - None - Simple - true" to ::`Exists within graph pattern - None - Simple - true`,
            "Exists within graph pattern - None - Simple - false" to ::`Exists within graph pattern - None - Simple - false`,
        )
    }
}
public fun main(){
