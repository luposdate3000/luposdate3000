...
public class Existswithingraphpattern {
    ...
    public fun `Exists within graph pattern - Thread - PartitionByID_2_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Exists within graph pattern - Thread - BenchmarkFig5 - true" to ::`Exists within graph pattern - Thread - BenchmarkFig5 - true`,
            "Exists within graph pattern - Thread - PartitionByID_2_AllCollations - true" to ::`Exists within graph pattern - Thread - PartitionByID_2_AllCollations - true`,
        )
    }
}
public fun main(){
