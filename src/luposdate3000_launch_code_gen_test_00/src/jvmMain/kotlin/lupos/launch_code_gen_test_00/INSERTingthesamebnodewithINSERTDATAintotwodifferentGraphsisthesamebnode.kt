...
public class INSERTingthesamebnodewithINSERTDATAintotwodifferentGraphsisthesamebnode {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "INSERTing the same bnode with INSERT DATA into two different Graphs is the same bnode - None - Simple - false" to ::`INSERTing the same bnode with INSERT DATA into two different Graphs is the same bnode - None - Simple - false`,
        )
    }
}
public fun main(){
