...
public class resourcesmyqueriessimulatorparkingquery1sparql377simulatorparkinginputsmallttl {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriessimulatorparkingquery1sparql377 simulatorparkinginputsmallttl - Thread - Simple - true" to ::`resourcesmyqueriessimulatorparkingquery1sparql377 simulatorparkinginputsmallttl - Thread - Simple - true`,
        )
    }
}
public fun main(){
