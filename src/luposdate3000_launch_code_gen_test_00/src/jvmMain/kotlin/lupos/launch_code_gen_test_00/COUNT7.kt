...
public class COUNT7 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "COUNT 7 - Thread - PartitionByID_2_AllCollations - false" to ::`COUNT 7 - Thread - PartitionByID_2_AllCollations - false`,
            "COUNT 7 - Thread - PartitionByID_S_AllCollations - true" to ::`COUNT 7 - Thread - PartitionByID_S_AllCollations - true`,
        )
    }
}
public fun main(){
