...
public class DELETEINSERT1 {
    ...
    public fun `DELETE INSERT 1 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DELETE INSERT 1 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL" to ::`DELETE INSERT 1 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL`,
        )
    }
    public fun main(){
