...
public class NOTIN2 {
    ...
    public fun `NOT IN 2 - in simulator - Simple - Centralized - false - None - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "NOT IN 2 - in simulator - Simple - Centralized - false - None - AllShortestPath" to ::`NOT IN 2 - in simulator - Simple - Centralized - false - None - AllShortestPath`,
        )
    }
}
public fun main(){
