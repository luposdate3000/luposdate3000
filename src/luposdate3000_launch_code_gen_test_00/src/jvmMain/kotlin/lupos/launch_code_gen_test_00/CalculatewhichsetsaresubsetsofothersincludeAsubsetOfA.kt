...
public class CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Calculate which sets are subsets of others include A subsetOf A - Thread - PartitionByID_2_AllCollations - true" to ::`Calculate which sets are subsets of others include A subsetOf A - Thread - PartitionByID_2_AllCollations - true`,
