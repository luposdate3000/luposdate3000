...
public class CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA {
    ...
    public fun `Calculate which sets are subsets of others include A subsetOf A - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
