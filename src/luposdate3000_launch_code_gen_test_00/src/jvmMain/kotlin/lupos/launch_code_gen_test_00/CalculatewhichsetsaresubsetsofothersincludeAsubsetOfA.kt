...
public class CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA {
    ...
    public fun `Calculate which sets are subsets of others include A subsetOf A - None - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA.kt:89"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `Calculate which sets are subsets of others include A subsetOf A - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA.kt:104"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Calculate which sets are subsets of others include A subsetOf A - None - Simple - true" to ::`Calculate which sets are subsets of others include A subsetOf A - None - Simple - true`,
            "Calculate which sets are subsets of others include A subsetOf A - None - Simple - false" to ::`Calculate which sets are subsets of others include A subsetOf A - None - Simple - false`,
        )
    }
}
public fun main(){
