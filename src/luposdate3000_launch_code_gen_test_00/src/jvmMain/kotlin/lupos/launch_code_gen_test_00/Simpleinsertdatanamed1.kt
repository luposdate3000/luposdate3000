...
public class Simpleinsertdatanamed1 {
    ...
    public fun `Simple insert data named 1 - Thread - PartitionByID_S_AllCollations - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple insert data named 1 - Thread - PartitionByID_S_AllCollations - true" to ::`Simple insert data named 1 - Thread - PartitionByID_S_AllCollations - true`,
            "Simple insert data named 1 - Thread - PartitionByKeyAllCollations - false" to ::`Simple insert data named 1 - Thread - PartitionByKeyAllCollations - false`,
            "Simple insert data named 1 - Thread - Simple - false" to ::`Simple insert data named 1 - Thread - Simple - false`,
        )
    }
}
public fun main(){
