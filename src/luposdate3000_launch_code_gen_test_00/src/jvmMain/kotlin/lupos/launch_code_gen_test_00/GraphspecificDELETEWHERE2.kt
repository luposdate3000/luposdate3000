...
public class GraphspecificDELETEWHERE2 {
    ...
    public fun `Graphspecific DELETE WHERE 2 - Thread - PartitionByID_S_AllCollations - true`() {
    ...
    public fun `Graphspecific DELETE WHERE 2 - Thread - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/GraphspecificDELETEWHERE2.kt:115"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `Graphspecific DELETE WHERE 2 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    public fun `Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    public fun `Graphspecific DELETE WHERE 2 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE WHERE 2 - Thread - PartitionByID_S_AllCollations - true" to ::`Graphspecific DELETE WHERE 2 - Thread - PartitionByID_S_AllCollations - true`,
            "Graphspecific DELETE WHERE 2 - Thread - Simple - false" to ::`Graphspecific DELETE WHERE 2 - Thread - Simple - false`,
            "Graphspecific DELETE WHERE 2 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL" to ::`Graphspecific DELETE WHERE 2 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`,
            "Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL_Fast" to ::`Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL_Fast`,
            "Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath" to ::`Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath`,
            "Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
            "Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast" to ::`Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast`,
            ...
            "Graphspecific DELETE WHERE 2 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath" to ::`Graphspecific DELETE WHERE 2 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
