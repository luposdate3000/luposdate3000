...
public class GraphspecificDELETEWHERE2 {
    ...
    public fun `Graphspecific DELETE WHERE 2 - Thread - BenchmarkFig5 - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE WHERE 2 - Thread - BenchmarkFig5 - true" to ::`Graphspecific DELETE WHERE 2 - Thread - BenchmarkFig5 - true`,
