...
public class GraphspecificDELETEWHERE2 {
    ...
    public fun `Graphspecific DELETE WHERE 2 - Thread - PartitionByID_2_AllCollations - true`() {
    ...
    public fun `Graphspecific DELETE WHERE 2 - Thread - PartitionByID_O_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    public fun `Graphspecific DELETE WHERE 2 - Thread - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/GraphspecificDELETEWHERE2.kt:130"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun `Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE WHERE 2 - Thread - PartitionByID_2_AllCollations - true" to ::`Graphspecific DELETE WHERE 2 - Thread - PartitionByID_2_AllCollations - true`,
            "Graphspecific DELETE WHERE 2 - Thread - PartitionByID_O_AllCollations - true" to ::`Graphspecific DELETE WHERE 2 - Thread - PartitionByID_O_AllCollations - true`,
            ...
            "Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath" to ::`Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
