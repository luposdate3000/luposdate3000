...
public class GraphspecificDELETEWHERE2 {
    ...
    public fun `Graphspecific DELETE WHERE 2 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun `Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE WHERE 2 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast" to ::`Graphspecific DELETE WHERE 2 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`,
            "Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - AllShortestPath" to ::`Graphspecific DELETE WHERE 2 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
