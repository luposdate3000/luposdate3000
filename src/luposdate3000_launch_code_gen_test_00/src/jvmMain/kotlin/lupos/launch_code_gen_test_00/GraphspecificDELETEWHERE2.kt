...
public class GraphspecificDELETEWHERE2 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE WHERE 2 - None - Simple - true" to ::`Graphspecific DELETE WHERE 2 - None - Simple - true`,
            "Graphspecific DELETE WHERE 2 - None - Simple - false" to ::`Graphspecific DELETE WHERE 2 - None - Simple - false`,
        )
    }
}
public fun main(){
