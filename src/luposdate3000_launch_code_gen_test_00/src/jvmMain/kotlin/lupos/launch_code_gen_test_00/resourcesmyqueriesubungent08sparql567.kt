...
public class resourcesmyqueriesubungent08sparql567 {
    ...
    public fun `resourcesmyqueriesubungent08sparql567 - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriesubungent08sparql567 - Thread - Simple - true" to ::`resourcesmyqueriesubungent08sparql567 - Thread - Simple - true`,
        )
    }
}
public fun main(){
