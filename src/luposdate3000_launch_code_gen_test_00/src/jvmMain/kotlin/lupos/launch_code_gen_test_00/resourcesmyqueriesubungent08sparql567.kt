...
public class resourcesmyqueriesubungent08sparql567 {
    ...
    public fun `resourcesmyqueriesubungent08sparql567 - Thread - BenchmarkFig5 - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriesubungent08sparql567 - Thread - BenchmarkFig5 - true" to ::`resourcesmyqueriesubungent08sparql567 - Thread - BenchmarkFig5 - true`,
        )
    }
}
public fun main(){
