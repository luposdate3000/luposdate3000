...
public class ADD6 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD6.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD6.input1").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD6.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD6.input1",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD6.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD6.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD6.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD6.output1",
    )
    ...
    public fun `ADD 6 - Thread - PartitionByID_1_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/ADD6.kt:87"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 6 - Thread - PartitionByID_1_AllCollations - true" to ::`ADD 6 - Thread - PartitionByID_1_AllCollations - true`,
            "ADD 6 - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath" to ::`ADD 6 - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath`,
            "ADD 6 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL" to ::`ADD 6 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL`,
            "ADD 6 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL" to ::`ADD 6 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL`,
            "ADD 6 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - AllShortestPath" to ::`ADD 6 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - AllShortestPath`,
            "ADD 6 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath" to ::`ADD 6 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath`,
            "ADD 6 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast" to ::`ADD 6 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`,
            "ADD 6 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast" to ::`ADD 6 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast`,
            "ADD 6 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath" to ::`ADD 6 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`,
            "ADD 6 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL_Fast" to ::`ADD 6 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in ADD6().getTests()){
        if (stop){
            return
        }
