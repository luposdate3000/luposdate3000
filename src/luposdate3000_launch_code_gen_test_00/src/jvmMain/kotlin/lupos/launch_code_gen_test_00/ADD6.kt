...
public class ADD6 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 6 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath" to ::`ADD 6 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath`,
            "ADD 6 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL" to ::`ADD 6 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL`,
        )
    }
}
public fun main(){
