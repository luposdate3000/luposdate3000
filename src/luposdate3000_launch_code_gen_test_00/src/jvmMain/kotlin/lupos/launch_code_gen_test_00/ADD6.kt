...
public class ADD6 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 6 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`ADD 6 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
