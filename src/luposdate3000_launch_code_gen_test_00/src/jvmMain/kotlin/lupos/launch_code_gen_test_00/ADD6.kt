...
public class ADD6 {
    ...
    public fun `ADD 6 - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/ADD6.kt:102"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 6 - None - Simple - true" to ::`ADD 6 - None - Simple - true`,
            "ADD 6 - None - Simple - false" to ::`ADD 6 - None - Simple - false`,
        )
    }
}
public fun main(){
