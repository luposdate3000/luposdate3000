...
public class pp16Duplicatepathsandcyclesthroughfoafknows {
    ...
    public fun `pp16 Duplicate paths and cycles through foafknows - None - Simple - false`() {
    ...
    public fun `pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "pp16 Duplicate paths and cycles through foafknows - None - Simple - false" to ::`pp16 Duplicate paths and cycles through foafknows - None - Simple - false`,
            "pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL" to ::`pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL`,
        )
    }
}
public fun main(){
