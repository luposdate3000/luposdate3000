...
public class pp30Operatorprecedence1 {
    ...
    public fun `pp30 Operator precedence 1 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "pp30 Operator precedence 1 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath" to ::`pp30 Operator precedence 1 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
    public fun main(){
