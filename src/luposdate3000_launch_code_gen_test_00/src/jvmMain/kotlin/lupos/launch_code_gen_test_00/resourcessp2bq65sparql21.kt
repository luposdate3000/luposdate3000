...
public class resourcessp2bq65sparql21 {
    ...
    public fun `resourcessp2bq65sparql21 - Thread - PartitionByID_S_AllCollations - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq65sparql21 - Thread - PartitionByID_S_AllCollations - false" to ::`resourcessp2bq65sparql21 - Thread - PartitionByID_S_AllCollations - false`,
        )
    }
}
public fun main(){
