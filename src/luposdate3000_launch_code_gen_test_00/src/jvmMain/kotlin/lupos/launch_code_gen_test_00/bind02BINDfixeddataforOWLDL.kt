...
public class bind02BINDfixeddataforOWLDL {
    ...
    public fun `bind02  BIND fixed data for OWL DL - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/bind02BINDfixeddataforOWLDL.kt:82"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
