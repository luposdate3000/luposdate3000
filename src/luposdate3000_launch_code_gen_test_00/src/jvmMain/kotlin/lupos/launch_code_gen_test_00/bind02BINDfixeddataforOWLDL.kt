...
public class bind02BINDfixeddataforOWLDL {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "bind02  BIND fixed data for OWL DL - Thread - PartitionByID_O_AllCollations - false" to ::`bind02  BIND fixed data for OWL DL - Thread - PartitionByID_O_AllCollations - false`,
