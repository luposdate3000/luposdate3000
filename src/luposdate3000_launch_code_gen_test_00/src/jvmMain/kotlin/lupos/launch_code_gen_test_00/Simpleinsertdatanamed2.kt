...
public class Simpleinsertdatanamed2 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple insert data named 2 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Simple insert data named 2 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
