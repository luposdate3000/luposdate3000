...
public class Simpleinsertdatanamed2 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple insert data named 2 - Thread - PartitionByID_O_AllCollations - true" to ::`Simple insert data named 2 - Thread - PartitionByID_O_AllCollations - true`,
            ...
            "Simple insert data named 2 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast" to ::`Simple insert data named 2 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
