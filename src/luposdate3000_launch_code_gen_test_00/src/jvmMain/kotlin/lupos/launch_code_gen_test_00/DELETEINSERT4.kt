...
public class DELETEINSERT4 {
    ...
    public fun `DELETE INSERT 4 - None - Simple - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DELETE INSERT 4 - None - Simple - true" to ::`DELETE INSERT 4 - None - Simple - true`,
            "DELETE INSERT 4 - None - Simple - false" to ::`DELETE INSERT 4 - None - Simple - false`,
        )
    }
}
public fun main(){
