...
public class DELETEINSERT4 {
    ...
    public fun `DELETE INSERT 4 - Thread - PartitionByID_O_AllCollations - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DELETE INSERT 4 - Thread - PartitionByID_O_AllCollations - false" to ::`DELETE INSERT 4 - Thread - PartitionByID_O_AllCollations - false`,
        )
    }
}
public fun main(){
