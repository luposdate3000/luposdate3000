...
public class INSERTingthesamebnodewithtwoINSERTWHEREstatementwithinonerequestisNOTthesamebnode {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERTing the same bnode with two INSERT WHERE statement within one request is NOT the same bnode - None - Simple - true" to ::`INSERTing the same bnode with two INSERT WHERE statement within one request is NOT the same bnode - None - Simple - true`,
            "INSERTing the same bnode with two INSERT WHERE statement within one request is NOT the same bnode - None - Simple - false" to ::`INSERTing the same bnode with two INSERT WHERE statement within one request is NOT the same bnode - None - Simple - false`,
        )
    }
}
public fun main(){
