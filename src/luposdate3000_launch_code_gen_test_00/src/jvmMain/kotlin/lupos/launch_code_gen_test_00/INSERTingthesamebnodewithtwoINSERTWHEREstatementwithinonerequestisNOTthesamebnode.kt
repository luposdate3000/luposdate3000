...
public class INSERTingthesamebnodewithtwoINSERTWHEREstatementwithinonerequestisNOTthesamebnode {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERTing the same bnode with two INSERT WHERE statement within one request is NOT the same bnode - Thread - PartitionByID_1_AllCollations - false" to ::`INSERTing the same bnode with two INSERT WHERE statement within one request is NOT the same bnode - Thread - PartitionByID_1_AllCollations - false`,
