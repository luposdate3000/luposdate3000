...
public class bind01BINDfixeddataforOWLDL {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "bind01  BIND fixed data for OWL DL - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL_Fast" to ::`bind01  BIND fixed data for OWL DL - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
