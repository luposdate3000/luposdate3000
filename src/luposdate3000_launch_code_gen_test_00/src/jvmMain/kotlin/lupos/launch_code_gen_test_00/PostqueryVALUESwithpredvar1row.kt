...
public class PostqueryVALUESwithpredvar1row {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Postquery VALUES with predvar 1 row - Thread - PartitionByKeyAllCollations - false" to ::`Postquery VALUES with predvar 1 row - Thread - PartitionByKeyAllCollations - false`,
        )
    }
}
public fun main(){
