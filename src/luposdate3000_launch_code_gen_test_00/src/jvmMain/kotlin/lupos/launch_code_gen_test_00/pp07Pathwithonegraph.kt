...
public class pp07Pathwithonegraph {
    ...
    public fun `pp07 Path with one graph - Thread - PartitionByID_S_AllCollations - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "pp07 Path with one graph - Thread - PartitionByID_S_AllCollations - true" to ::`pp07 Path with one graph - Thread - PartitionByID_S_AllCollations - true`,
        )
    }
}
public fun main(){
