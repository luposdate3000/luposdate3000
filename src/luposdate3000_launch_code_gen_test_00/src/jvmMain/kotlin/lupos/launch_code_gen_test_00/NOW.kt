...
public class NOW {
    ...
    public fun `NOW - Thread - PartitionByID_2_AllCollations - false`() {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "NOW - Thread - PartitionByID_2_AllCollations - false" to ::`NOW - Thread - PartitionByID_2_AllCollations - false`,
        )
    }
}
public fun main() {
