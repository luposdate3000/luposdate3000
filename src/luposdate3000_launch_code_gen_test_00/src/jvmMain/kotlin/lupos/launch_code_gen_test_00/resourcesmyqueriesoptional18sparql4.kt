...
public class resourcesmyqueriesoptional18sparql4 {
    ...
    public fun `resourcesmyqueriesoptional18sparql4 - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesmyqueriesoptional18sparql4 - Thread - Simple - true" to ::`resourcesmyqueriesoptional18sparql4 - Thread - Simple - true`,
        )
    }
}
public fun main(){
