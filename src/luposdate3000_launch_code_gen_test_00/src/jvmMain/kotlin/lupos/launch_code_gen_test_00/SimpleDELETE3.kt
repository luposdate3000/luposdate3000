...
public class SimpleDELETE3 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 3 - Thread - BenchmarkFig5 - false" to ::`Simple DELETE 3 - Thread - BenchmarkFig5 - false`,
            "Simple DELETE 3 - Thread - PartitionByID_1_AllCollations - false" to ::`Simple DELETE 3 - Thread - PartitionByID_1_AllCollations - false`,
            "Simple DELETE 3 - Thread - PartitionByID_S_AllCollations - false" to ::`Simple DELETE 3 - Thread - PartitionByID_S_AllCollations - false`,
        )
    }
}
public fun main(){
