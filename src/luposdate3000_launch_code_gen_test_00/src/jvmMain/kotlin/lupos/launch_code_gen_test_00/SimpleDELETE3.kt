...
public class SimpleDELETE3 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 3 - Thread - PartitionByID_2_AllCollations - true" to ::`Simple DELETE 3 - Thread - PartitionByID_2_AllCollations - true`,
            "Simple DELETE 3 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath" to ::`Simple DELETE 3 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
