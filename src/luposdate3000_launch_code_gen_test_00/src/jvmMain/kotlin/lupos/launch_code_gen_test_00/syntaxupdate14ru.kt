...
public class syntaxupdate14ru {
    ...
    public fun `syntaxupdate14ru - Thread - PartitionByIDTwiceAllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/syntaxupdate14ru.kt:55"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
...
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in syntaxupdate14ru().getTests()){
        if (stop){
            return
        }
