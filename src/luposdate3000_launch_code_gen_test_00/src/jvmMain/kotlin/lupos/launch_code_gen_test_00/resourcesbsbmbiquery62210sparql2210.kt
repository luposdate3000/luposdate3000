...
public class resourcesbsbmbiquery62210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery62210sparql2210 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery62210sparql2210 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast" to ::`resourcesbsbmbiquery62210sparql2210 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
