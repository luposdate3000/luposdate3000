...
public class resourcesbsbmbiquery62210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery62210sparql2210 - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery62210sparql2210 - Thread - Simple - true" to ::`resourcesbsbmbiquery62210sparql2210 - Thread - Simple - true`,
        )
    }
}
public fun main(){
