...
public class resourcesbsbmbiquery62210sparql2210 {
    ...
    public fun `resourcesbsbmbiquery62210sparql2210 - Thread - PartitionByID_S_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcesbsbmbiquery62210sparql2210 - Thread - PartitionByID_S_AllCollations - true" to ::`resourcesbsbmbiquery62210sparql2210 - Thread - PartitionByID_S_AllCollations - true`,
        )
    }
}
public fun main(){
