...
public class resourcessp2bq10sparql21 {
    ...
    public fun `resourcessp2bq10sparql21 - in simulator - Simple - Centralized - true - None - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "resourcessp2bq10sparql21 - in simulator - Simple - Centralized - true - None - RPL_Fast" to ::`resourcessp2bq10sparql21 - in simulator - Simple - Centralized - true - None - RPL_Fast`,
        )
    }
}
public fun main(){
