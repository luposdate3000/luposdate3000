...
public class SimpleDELETE4WITH {
    ...
    public fun `Simple DELETE 4 WITH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 4 WITH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Simple DELETE 4 WITH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
