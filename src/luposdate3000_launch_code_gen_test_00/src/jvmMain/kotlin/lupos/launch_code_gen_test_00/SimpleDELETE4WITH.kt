...
public class SimpleDELETE4WITH {
    ...
    public fun `Simple DELETE 4 WITH - Thread - Simple - true`() {
    ...
    public fun `Simple DELETE 4 WITH - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `Simple DELETE 4 WITH - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 4 WITH - Thread - Simple - true" to ::`Simple DELETE 4 WITH - Thread - Simple - true`,
            ...
            "Simple DELETE 4 WITH - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast" to ::`Simple DELETE 4 WITH - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast`,
            "Simple DELETE 4 WITH - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast" to ::`Simple DELETE 4 WITH - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
