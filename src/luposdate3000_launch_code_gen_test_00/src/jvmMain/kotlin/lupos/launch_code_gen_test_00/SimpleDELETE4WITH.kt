...
public class SimpleDELETE4WITH {
    ...
    public fun `Simple DELETE 4 WITH - Thread - PartitionByID_1_AllCollations - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 4 WITH - Thread - PartitionByID_1_AllCollations - true" to ::`Simple DELETE 4 WITH - Thread - PartitionByID_1_AllCollations - true`,
