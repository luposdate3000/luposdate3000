...
public class Plainliteralswithlanguagetagarenotthesameasthesameliteralwithout {
    ...
    public fun `Plain literals with language tag are not the same as the same literal without - Thread - PartitionByKeyAllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/Plainliteralswithlanguagetagarenotthesameasthesameliteralwithout.kt:102"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
