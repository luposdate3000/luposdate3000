...
public class GraphspecificDELETE2WITH {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Graphspecific DELETE 2 WITH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Graphspecific DELETE 2 WITH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
