...
public class GraphspecificDELETE2WITH {
    ...
    public fun `Graphspecific DELETE 2 WITH - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun `Graphspecific DELETE 2 WITH - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun `Graphspecific DELETE 2 WITH - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "Graphspecific DELETE 2 WITH - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL_Fast" to ::`Graphspecific DELETE 2 WITH - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL_Fast`,
            "Graphspecific DELETE 2 WITH - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast" to ::`Graphspecific DELETE 2 WITH - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`,
            "Graphspecific DELETE 2 WITH - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath" to ::`Graphspecific DELETE 2 WITH - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
