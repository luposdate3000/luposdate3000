...
public class resourcesbsbmbiquery31853sparql1853 {
    ...
    public fun `resourcesbsbmbiquery31853sparql1853 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery31853sparql1853 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast" to ::`resourcesbsbmbiquery31853sparql1853 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
