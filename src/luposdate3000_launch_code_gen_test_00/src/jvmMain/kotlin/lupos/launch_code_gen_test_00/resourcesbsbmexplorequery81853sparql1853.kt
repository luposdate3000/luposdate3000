...
public class resourcesbsbmexplorequery81853sparql1853 {
    ...
    public fun `resourcesbsbmexplorequery81853sparql1853 - Thread - BenchmarkFig5 - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery81853sparql1853 - Thread - BenchmarkFig5 - true" to ::`resourcesbsbmexplorequery81853sparql1853 - Thread - BenchmarkFig5 - true`,
        )
    }
}
public fun main(){
