...
public class ADD7 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD7.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD7.input1").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD7.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD7.input1",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD7.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD7.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD7.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD7.output1",
    )
    ...
    public fun `ADD 7 - Thread - PartitionByID_2_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/ADD7.kt:87"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 7 - Thread - PartitionByID_2_AllCollations - true" to ::`ADD 7 - Thread - PartitionByID_2_AllCollations - true`,
            "ADD 7 - in simulator - Simple - Centralized - false - None - AllShortestPath" to ::`ADD 7 - in simulator - Simple - Centralized - false - None - AllShortestPath`,
            "ADD 7 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast" to ::`ADD 7 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`,
            "ADD 7 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast" to ::`ADD 7 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`,
            "ADD 7 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`ADD 7 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
            "ADD 7 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL" to ::`ADD 7 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL`,
            "ADD 7 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast" to ::`ADD 7 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast`,
            "ADD 7 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - AllShortestPath" to ::`ADD 7 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - AllShortestPath`,
            "ADD 7 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast" to ::`ADD 7 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`,
            "ADD 7 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast" to ::`ADD 7 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in ADD7().getTests()){
        if (stop){
            return
        }
