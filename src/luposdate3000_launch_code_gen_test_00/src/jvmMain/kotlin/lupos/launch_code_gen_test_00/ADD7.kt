...
public class ADD7 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 7 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL" to ::`ADD 7 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`,
            "ADD 7 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL" to ::`ADD 7 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL`,
        )
    }
}
public fun main(){
