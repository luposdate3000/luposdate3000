...
public class ADD7 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 7 - Thread - PartitionByKeyAllCollations - false" to ::`ADD 7 - Thread - PartitionByKeyAllCollations - false`,
            "ADD 7 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL" to ::`ADD 7 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`,
            "ADD 7 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL" to ::`ADD 7 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`,
            "ADD 7 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath" to ::`ADD 7 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath`,
            "ADD 7 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast" to ::`ADD 7 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast`,
            "ADD 7 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL" to ::`ADD 7 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL`,
            "ADD 7 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath" to ::`ADD 7 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath`,
            "ADD 7 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast" to ::`ADD 7 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
