...
public class ABS {
    ...
    public fun `ABS - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "ABS - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast" to ::`ABS - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
