...
public class ABS {
    ...
    public fun `ABS - Thread - PartitionByKeyAllCollations - true`() {
    ...
    public fun `ABS - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ABS - Thread - PartitionByKeyAllCollations - true" to ::`ABS - Thread - PartitionByKeyAllCollations - true`,
            "ABS - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - AllShortestPath" to ::`ABS - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
