...
public class DELETEINSERT4b {
    ...
    public fun `DELETE INSERT 4b - None - Simple - true`() {
    ...
    public fun `DELETE INSERT 4b - None - Simple - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "DELETE INSERT 4b - None - Simple - true" to ::`DELETE INSERT 4b - None - Simple - true`,
            "DELETE INSERT 4b - None - Simple - false" to ::`DELETE INSERT 4b - None - Simple - false`,
        )
    }
}
public fun main(){
