...
public class resourcesbsbmexplorequery12553sparql2553 {
    ...
    public fun `resourcesbsbmexplorequery12553sparql2553 - in simulator - Simple - Centralized - false - None - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery12553sparql2553 - in simulator - Simple - Centralized - false - None - RPL_Fast" to ::`resourcesbsbmexplorequery12553sparql2553 - in simulator - Simple - Centralized - false - None - RPL_Fast`,
        )
    }
}
public fun main(){
