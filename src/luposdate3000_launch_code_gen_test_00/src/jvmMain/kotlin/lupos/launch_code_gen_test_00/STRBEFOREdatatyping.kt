...
public class STRBEFOREdatatyping {
    ...
    public fun `STRBEFORE datatyping - Thread - BenchmarkFig5 - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "STRBEFORE datatyping - Thread - BenchmarkFig5 - false" to ::`STRBEFORE datatyping - Thread - BenchmarkFig5 - false`,
        )
    }
}
public fun main(){
