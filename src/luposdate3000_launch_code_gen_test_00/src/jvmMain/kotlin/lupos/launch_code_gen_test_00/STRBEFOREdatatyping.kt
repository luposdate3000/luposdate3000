...
public class STRBEFOREdatatyping {
    ...
    public fun `STRBEFORE datatyping - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `STRBEFORE datatyping - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            ...
            "STRBEFORE datatyping - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL" to ::`STRBEFORE datatyping - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL`,
            "STRBEFORE datatyping - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast" to ::`STRBEFORE datatyping - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main() {
