...
public class SimpleDELETE3USING {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Simple DELETE 3 USING - Thread - PartitionByID_1_AllCollations - true" to ::`Simple DELETE 3 USING - Thread - PartitionByID_1_AllCollations - true`,
            "Simple DELETE 3 USING - Thread - Simple - false" to ::`Simple DELETE 3 USING - Thread - Simple - false`,
        )
    }
}
public fun main(){
