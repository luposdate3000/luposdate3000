...
public class INSERT04 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT 04 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`INSERT 04 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
