...
public class INSERT04 {
    ...
    public fun `INSERT 04 - Thread - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/INSERT04.kt:94"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT 04 - Thread - Simple - false" to ::`INSERT 04 - Thread - Simple - false`,
            "INSERT 04 - in simulator - BenchmarkFig5 - Centralized - false - Process - AllShortestPath" to ::`INSERT 04 - in simulator - BenchmarkFig5 - Centralized - false - Process - AllShortestPath`,
            "INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL_Fast" to ::`INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL_Fast`,
            "INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath" to ::`INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath`,
            "INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL" to ::`INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL`,
            "INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast" to ::`INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`,
            "INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL_Fast" to ::`INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL_Fast`,
            "INSERT 04 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - AllShortestPath" to ::`INSERT 04 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - AllShortestPath`,
            "INSERT 04 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - AllShortestPath" to ::`INSERT 04 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - AllShortestPath`,
            "INSERT 04 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL" to ::`INSERT 04 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL`,
            "INSERT 04 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath" to ::`INSERT 04 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
