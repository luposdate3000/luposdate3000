...
public class INSERT04 {
    ...
    public fun `INSERT 04 - Thread - PartitionByKeyAllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/INSERT04.kt:109"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT 04 - Thread - PartitionByID_S_AllCollations - false" to ::`INSERT 04 - Thread - PartitionByID_S_AllCollations - false`,
            "INSERT 04 - Thread - PartitionByKeyAllCollations - false" to ::`INSERT 04 - Thread - PartitionByKeyAllCollations - false`,
            ...
            "INSERT 04 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL" to ::`INSERT 04 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`,
            "INSERT 04 - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath" to ::`INSERT 04 - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`,
            ...
            "INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`INSERT 04 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
            "INSERT 04 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL" to ::`INSERT 04 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL`,
            "INSERT 04 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL" to ::`INSERT 04 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`,
            "INSERT 04 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast" to ::`INSERT 04 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
