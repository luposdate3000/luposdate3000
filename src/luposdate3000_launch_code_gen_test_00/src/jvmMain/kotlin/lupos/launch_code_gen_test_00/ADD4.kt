...
public class ADD4 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.input1").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.input1",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.output1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.output1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ADD4.output2",
    )
    ...
    public fun `ADD 4 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `ADD 4 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 4 - Thread - PartitionByID_2_AllCollations - true" to ::`ADD 4 - Thread - PartitionByID_2_AllCollations - true`,
            "ADD 4 - in simulator - Simple - Centralized - false - None - RPL_Fast" to ::`ADD 4 - in simulator - Simple - Centralized - false - None - RPL_Fast`,
            "ADD 4 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL" to ::`ADD 4 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`,
            "ADD 4 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL_Fast" to ::`ADD 4 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL_Fast`,
            "ADD 4 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath" to ::`ADD 4 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath`,
            "ADD 4 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - AllShortestPath" to ::`ADD 4 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - AllShortestPath`,
            "ADD 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath" to ::`ADD 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - AllShortestPath`,
            "ADD 4 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL_Fast" to ::`ADD 4 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL_Fast`,
            "ADD 4 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL" to ::`ADD 4 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL`,
            "ADD 4 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast" to ::`ADD 4 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast`,
            "ADD 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL" to ::`ADD 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL`,
            "ADD 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast" to ::`ADD 4 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast`,
            "ADD 4 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL" to ::`ADD 4 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL`,
            "ADD 4 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath" to ::`ADD 4 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`,
            "ADD 4 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL" to ::`ADD 4 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL`,
            "ADD 4 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath" to ::`ADD 4 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in ADD4().getTests()){
        if (stop){
            return
        }
