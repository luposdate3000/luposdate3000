...
public class ADD4 {
    ...
    public fun `ADD 4 - Thread - PartitionByID_O_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/ADD4.kt:106"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `ADD 4 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL`() {
        simulatorHelper(
    ...
    public fun `ADD 4 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "ADD 4 - Thread - PartitionByID_O_AllCollations - false" to ::`ADD 4 - Thread - PartitionByID_O_AllCollations - false`,
            "ADD 4 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL" to ::`ADD 4 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL`,
            "ADD 4 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath" to ::`ADD 4 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath`,
            "ADD 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast" to ::`ADD 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`,
            "ADD 4 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - AllShortestPath" to ::`ADD 4 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - AllShortestPath`,
            ...
            "ADD 4 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath" to ::`ADD 4 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
