...
public class ADD4 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 4 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL" to ::`ADD 4 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL`,
        )
    }
}
public fun main(){
