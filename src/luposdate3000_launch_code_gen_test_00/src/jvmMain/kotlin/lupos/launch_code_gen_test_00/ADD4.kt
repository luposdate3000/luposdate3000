...
public class ADD4 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "ADD 4 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`ADD 4 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
