...
public class SimpleDELETEWHERE2 {
    ...
    public fun `Simple DELETE WHERE 2 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/SimpleDELETEWHERE2.kt:88"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
