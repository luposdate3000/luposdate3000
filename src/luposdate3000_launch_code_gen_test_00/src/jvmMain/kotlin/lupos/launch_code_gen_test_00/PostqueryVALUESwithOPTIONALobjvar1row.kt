...
public class PostqueryVALUESwithOPTIONALobjvar1row {
    ...
    public fun `Postquery VALUES with OPTIONAL objvar 1 row - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/PostqueryVALUESwithOPTIONALobjvar1row.kt:82"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Postquery VALUES with OPTIONAL objvar 1 row - Thread - Simple - true" to ::`Postquery VALUES with OPTIONAL objvar 1 row - Thread - Simple - true`,
        )
    }
}
public fun main(){
