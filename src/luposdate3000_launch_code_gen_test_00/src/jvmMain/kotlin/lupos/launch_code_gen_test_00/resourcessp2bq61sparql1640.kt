...
public class resourcessp2bq61sparql1640 {
    ...
    public fun `resourcessp2bq61sparql1640 - Thread - PartitionByIDTwiceAllCollations - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq61sparql1640 - Thread - PartitionByIDTwiceAllCollations - true" to ::`resourcessp2bq61sparql1640 - Thread - PartitionByIDTwiceAllCollations - true`,
        )
    }
}
public fun main(){
