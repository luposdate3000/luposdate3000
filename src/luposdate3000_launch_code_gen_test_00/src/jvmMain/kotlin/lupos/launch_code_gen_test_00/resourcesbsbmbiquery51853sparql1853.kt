...
public class resourcesbsbmbiquery51853sparql1853 {
    ...
    public fun `resourcesbsbmbiquery51853sparql1853 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery51853sparql1853 - Thread - PartitionByID_2_AllCollations - false" to ::`resourcesbsbmbiquery51853sparql1853 - Thread - PartitionByID_2_AllCollations - false`,
            "resourcesbsbmbiquery51853sparql1853 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast" to ::`resourcesbsbmbiquery51853sparql1853 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
