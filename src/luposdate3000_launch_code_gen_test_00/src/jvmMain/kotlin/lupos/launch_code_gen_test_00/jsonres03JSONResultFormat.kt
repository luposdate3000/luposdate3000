...
public class jsonres03JSONResultFormat {
    ...
    public fun `jsonres03  JSON Result Format - Thread - Simple - true`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "jsonres03  JSON Result Format - Thread - Simple - true" to ::`jsonres03  JSON Result Format - Thread - Simple - true`,
        )
    }
}
public fun main(){
