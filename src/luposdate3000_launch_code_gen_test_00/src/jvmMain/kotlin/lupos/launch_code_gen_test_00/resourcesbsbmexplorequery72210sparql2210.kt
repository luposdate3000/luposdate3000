...
public class resourcesbsbmexplorequery72210sparql2210 {
    ...
    public fun `resourcesbsbmexplorequery72210sparql2210 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmexplorequery72210sparql2210 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast" to ::`resourcesbsbmexplorequery72210sparql2210 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
