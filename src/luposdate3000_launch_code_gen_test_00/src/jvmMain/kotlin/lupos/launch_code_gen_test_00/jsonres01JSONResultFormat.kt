...
public class jsonres01JSONResultFormat {
    ...
    public fun `jsonres01  JSON Result Format - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/jsonres01JSONResultFormat.kt:73"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
