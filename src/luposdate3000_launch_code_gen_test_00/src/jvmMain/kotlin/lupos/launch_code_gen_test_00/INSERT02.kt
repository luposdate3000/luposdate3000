...
public class INSERT02 {
    ...
    public fun `INSERT 02 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT 02 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL" to ::`INSERT 02 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL`,
            "INSERT 02 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast" to ::`INSERT 02 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`,
