...
public class INSERT02 {
    ...
    public fun `INSERT 02 - Thread - PartitionByID_S_AllCollations - true`() {
    ...
    public fun `INSERT 02 - Thread - PartitionByKeyAllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/INSERT02.kt:105"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `INSERT 02 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT 02 - Thread - PartitionByID_S_AllCollations - true" to ::`INSERT 02 - Thread - PartitionByID_S_AllCollations - true`,
            "INSERT 02 - Thread - PartitionByKeyAllCollations - false" to ::`INSERT 02 - Thread - PartitionByKeyAllCollations - false`,
            "INSERT 02 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast" to ::`INSERT 02 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`,
        )
    }
}
public fun main(){
