...
public class INSERT02 {
    ...
    public fun `INSERT 02 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT 02 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`INSERT 02 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
