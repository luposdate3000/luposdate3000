...
public class ErrorinAVG {
    ...
    public fun `Error in AVG - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "src/luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "Error in AVG - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - AllShortestPath" to ::`Error in AVG - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
