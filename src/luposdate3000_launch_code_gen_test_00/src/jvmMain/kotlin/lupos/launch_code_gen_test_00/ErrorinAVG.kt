...
public class ErrorinAVG {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ErrorinAVG.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ErrorinAVG.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/ErrorinAVG.output").readAsString()
    ...
    public fun `Error in AVG - Thread - PartitionByID_O_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/ErrorinAVG.kt:74"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `Error in AVG - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Error in AVG - Thread - PartitionByID_O_AllCollations - true" to ::`Error in AVG - Thread - PartitionByID_O_AllCollations - true`,
            "Error in AVG - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath" to ::`Error in AVG - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath`,
        )
    }
}
public fun main(){
    for((name,func) in ErrorinAVG().getTests()){
