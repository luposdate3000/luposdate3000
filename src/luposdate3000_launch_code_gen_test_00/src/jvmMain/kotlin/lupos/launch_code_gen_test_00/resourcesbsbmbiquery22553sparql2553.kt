...
public class resourcesbsbmbiquery22553sparql2553 {
    ...
    public fun `resourcesbsbmbiquery22553sparql2553 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcesbsbmbiquery22553sparql2553 - Thread - PartitionByIDTwiceAllCollations - false" to ::`resourcesbsbmbiquery22553sparql2553 - Thread - PartitionByIDTwiceAllCollations - false`,
            "resourcesbsbmbiquery22553sparql2553 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast" to ::`resourcesbsbmbiquery22553sparql2553 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
