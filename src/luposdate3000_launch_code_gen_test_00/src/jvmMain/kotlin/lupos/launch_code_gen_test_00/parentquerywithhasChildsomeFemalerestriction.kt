...
public class parentquerywithhasChildsomeFemalerestriction {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/parentquerywithhasChildsomeFemalerestriction.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/parentquerywithhasChildsomeFemalerestriction.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/parentquerywithhasChildsomeFemalerestriction.output").readAsString()
    ...
    public fun `parent query with hasChild some Female restriction - Thread - PartitionByID_S_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/parentquerywithhasChildsomeFemalerestriction.kt:74"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    public fun `parent query with hasChild some Female restriction - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "parent query with hasChild some Female restriction - Thread - PartitionByID_S_AllCollations - true" to ::`parent query with hasChild some Female restriction - Thread - PartitionByID_S_AllCollations - true`,
            "parent query with hasChild some Female restriction - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast" to ::`parent query with hasChild some Female restriction - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast`,
...
public fun main(){
    for((name,func) in parentquerywithhasChildsomeFemalerestriction().getTests()){
