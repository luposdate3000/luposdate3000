...
public class INSERT03 {
    ...
    public fun `INSERT 03 - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/INSERT03.kt:108"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "INSERT 03 - None - Simple - true" to ::`INSERT 03 - None - Simple - true`,
            "INSERT 03 - None - Simple - false" to ::`INSERT 03 - None - Simple - false`,
        )
    }
}
public fun main() {
