...
public class INSERT03 {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "INSERT 03 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast" to ::`INSERT 03 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast`,
        )
    }
}
public fun main() {
