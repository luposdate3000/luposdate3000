...
public class INSERT03 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/INSERT03.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/INSERT03.input1").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/INSERT03.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/INSERT03.input1",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/INSERT03.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/INSERT03.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/INSERT03.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/INSERT03.output1",
    )
    ...
    public fun `INSERT 03 - Thread - PartitionByID_1_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/INSERT03.kt:93"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT 03 - Thread - PartitionByID_1_AllCollations - true" to ::`INSERT 03 - Thread - PartitionByID_1_AllCollations - true`,
            "INSERT 03 - in simulator - Simple - Centralized - true - None - RPL_Fast" to ::`INSERT 03 - in simulator - Simple - Centralized - true - None - RPL_Fast`,
            "INSERT 03 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL" to ::`INSERT 03 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL`,
            "INSERT 03 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - AllShortestPath" to ::`INSERT 03 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - AllShortestPath`,
            "INSERT 03 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - AllShortestPath" to ::`INSERT 03 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - AllShortestPath`,
            "INSERT 03 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL" to ::`INSERT 03 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`,
            "INSERT 03 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast" to ::`INSERT 03 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`,
            "INSERT 03 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL_Fast" to ::`INSERT 03 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL_Fast`,
            "INSERT 03 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath" to ::`INSERT 03 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in INSERT03().getTests()){
        if (stop){
            return
        }
