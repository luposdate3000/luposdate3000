...
public class INSERT03 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "INSERT 03 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`INSERT 03 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
