...
public class CLEARNAMED {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR NAMED - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`CLEAR NAMED - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
