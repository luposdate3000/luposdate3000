...
public class CLEARNAMED {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "CLEAR NAMED - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath" to ::`CLEAR NAMED - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
}
public fun main() {
