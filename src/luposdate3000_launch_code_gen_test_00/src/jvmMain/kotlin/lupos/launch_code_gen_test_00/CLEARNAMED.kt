...
public class CLEARNAMED {
    ...
    public fun `CLEAR NAMED - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CLEARNAMED.kt:111"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR NAMED - None - Simple - true" to ::`CLEAR NAMED - None - Simple - true`,
            "CLEAR NAMED - None - Simple - false" to ::`CLEAR NAMED - None - Simple - false`,
        )
    }
}
public fun main(){
