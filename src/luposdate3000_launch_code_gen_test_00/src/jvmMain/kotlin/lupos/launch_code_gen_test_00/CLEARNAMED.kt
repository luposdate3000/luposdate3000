...
public class CLEARNAMED {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR NAMED - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL" to ::`CLEAR NAMED - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`,
            "CLEAR NAMED - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast" to ::`CLEAR NAMED - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
