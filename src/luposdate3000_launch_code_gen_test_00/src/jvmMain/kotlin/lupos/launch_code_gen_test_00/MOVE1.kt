...
public class MOVE1 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "MOVE 1 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`MOVE 1 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
