...
public class MOVE1 {
    ...
    public fun `MOVE 1 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "MOVE 1 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL" to ::`MOVE 1 - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`,
        )
    }
}
public fun main() {
