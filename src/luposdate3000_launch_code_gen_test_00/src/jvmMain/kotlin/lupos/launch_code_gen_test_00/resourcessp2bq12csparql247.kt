...
public class resourcessp2bq12csparql247 {
    ...
    public fun `resourcessp2bq12csparql247 - Thread - BenchmarkFig5 - false`() {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq12csparql247 - Thread - BenchmarkFig5 - false" to ::`resourcessp2bq12csparql247 - Thread - BenchmarkFig5 - false`,
            "resourcessp2bq12csparql247 - Thread - PartitionByID_O_AllCollations - false" to ::`resourcessp2bq12csparql247 - Thread - PartitionByID_O_AllCollations - false`,
        )
    }
}
public fun main(){
