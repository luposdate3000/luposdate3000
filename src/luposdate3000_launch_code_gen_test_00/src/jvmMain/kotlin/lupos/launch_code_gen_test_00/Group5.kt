...
public class Group5 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Group5 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`Group5 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
