...
public class Group5 {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Group5 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast" to ::`Group5 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL_Fast`,
        )
    }
}
public fun main(){
