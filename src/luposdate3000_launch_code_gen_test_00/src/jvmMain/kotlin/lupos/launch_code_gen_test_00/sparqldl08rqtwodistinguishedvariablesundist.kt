...
public class sparqldl08rqtwodistinguishedvariablesundist {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "sparqldl08rq two distinguished variables  undist - Thread - PartitionByID_2_AllCollations - false" to ::`sparqldl08rq two distinguished variables  undist - Thread - PartitionByID_2_AllCollations - false`,
        )
    }
}
public fun main(){
