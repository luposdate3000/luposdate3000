...
public class CLEARALL {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR ALL - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath" to ::`CLEAR ALL - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
