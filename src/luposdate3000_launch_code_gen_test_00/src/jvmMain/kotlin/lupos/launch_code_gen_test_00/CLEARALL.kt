...
public class CLEARALL {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            ...
            "CLEAR ALL - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL" to ::`CLEAR ALL - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
