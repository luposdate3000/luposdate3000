...
public class CLEARALL {
    ...
    public fun `CLEAR ALL - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CLEARALL.kt:111"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun getTests(): Set<Pair<String, () -> Unit>> {
        return setOf(
            "CLEAR ALL - None - Simple - true" to ::`CLEAR ALL - None - Simple - true`,
            "CLEAR ALL - None - Simple - false" to ::`CLEAR ALL - None - Simple - false`,
        )
    }
}
public fun main() {
