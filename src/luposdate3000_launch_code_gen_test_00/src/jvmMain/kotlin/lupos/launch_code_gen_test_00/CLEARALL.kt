...
public class CLEARALL {
    internal val inputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.input").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.input1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.input",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.input1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.output0").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.output1").readAsString(),
        File("src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.output0",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.output1",
        "src/luposdate3000_launch_code_gen_test_00/src/jvmTest/resources/CLEARALL.output2",
    )
    ...
    public fun `CLEAR ALL - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_code_gen_test_00/src/jvmMain/kotlin/lupos/launch_code_gen_test_00/CLEARALL.kt:96"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR ALL - Thread - Simple - true" to ::`CLEAR ALL - Thread - Simple - true`,
            "CLEAR ALL - in simulator - BenchmarkFig5 - Routing - true - Process - RPL" to ::`CLEAR ALL - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`,
            "CLEAR ALL - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL" to ::`CLEAR ALL - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`,
            "CLEAR ALL - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath" to ::`CLEAR ALL - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath`,
            "CLEAR ALL - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL" to ::`CLEAR ALL - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL`,
            "CLEAR ALL - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast" to ::`CLEAR ALL - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast`,
            "CLEAR ALL - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast" to ::`CLEAR ALL - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast`,
            "CLEAR ALL - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast" to ::`CLEAR ALL - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`,
            "CLEAR ALL - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast" to ::`CLEAR ALL - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast`,
            "CLEAR ALL - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL" to ::`CLEAR ALL - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`,
            "CLEAR ALL - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL" to ::`CLEAR ALL - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL`,
            "CLEAR ALL - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath" to ::`CLEAR ALL - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`,
        )
    }
}
public fun main(){
    var idx=0
    var stop=false
    for((name,func) in CLEARALL().getTests()){
        if (stop){
            return
        }
