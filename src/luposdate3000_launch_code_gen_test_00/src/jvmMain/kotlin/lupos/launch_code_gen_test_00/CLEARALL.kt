...
public class CLEARALL {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "CLEAR ALL - Thread - PartitionByIDTwiceAllCollations - true" to ::`CLEAR ALL - Thread - PartitionByIDTwiceAllCollations - true`,
            "CLEAR ALL - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL" to ::`CLEAR ALL - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL`,
        )
    }
}
public fun main(){
