...
public class resourcesbsbmexplorequery42210sparql2210 {
    ...
    public fun `resourcesbsbmexplorequery42210sparql2210 - Thread - PartitionByID_S_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTrace(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesbsbmexplorequery42210sparql2210.kt:105"/*SOURCE_FILE_END*/ )() //otherwise this would be silently ignored
        throw e
      }finally{
