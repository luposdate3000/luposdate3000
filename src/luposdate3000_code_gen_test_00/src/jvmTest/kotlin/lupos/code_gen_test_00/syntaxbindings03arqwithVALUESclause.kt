...
public class syntaxbindings03arqwithVALUESclause {
    ...
    @Test
    public fun `syntaxbindings03arq with VALUES clause - Thread - PartitionByAll - true`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
    ...
    @Test
    public fun `syntaxbindings03arq with VALUES clause - Thread - PartitionByAll - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.Thread
