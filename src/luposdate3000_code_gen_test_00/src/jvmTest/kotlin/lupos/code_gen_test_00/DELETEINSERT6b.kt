...
public class DELETEINSERT6b {
    ...
    @Test(timeout = 10000)
    public fun `DELETE INSERT 6b - Thread - BenchmarkFig5 - true`() {
    ...
    @Test(timeout = 10000)
    public fun `DELETE INSERT 6b - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `DELETE INSERT 6b - in simulator - BenchmarkFig5 - Routing - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    @Test(timeout = 10000)
    public fun `DELETE INSERT 6b - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
