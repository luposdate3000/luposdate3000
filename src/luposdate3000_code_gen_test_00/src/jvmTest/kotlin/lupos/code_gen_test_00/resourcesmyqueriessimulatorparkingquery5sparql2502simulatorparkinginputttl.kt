...
public class resourcesmyqueriessimulatorparkingquery5sparql2502simulatorparkinginputttl {
    ...
    @Test
    public fun `resourcesmyqueriessimulatorparkingquery5sparql2502 simulatorparkinginputttl - in simulator - Simple - Centralized - true - None - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcesmyqueriessimulatorparkingquery5sparql2502 simulatorparkinginputttl - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
