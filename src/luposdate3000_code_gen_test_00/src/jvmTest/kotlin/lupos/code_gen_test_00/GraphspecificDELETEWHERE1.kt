...
public class GraphspecificDELETEWHERE1 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/GraphspecificDELETEWHERE1.input",
        "src/jvmTest/resources/GraphspecificDELETEWHERE1.input1",
        "src/jvmTest/resources/GraphspecificDELETEWHERE1.input2",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/GraphspecificDELETEWHERE1.output0",
        "src/jvmTest/resources/GraphspecificDELETEWHERE1.output1",
        "src/jvmTest/resources/GraphspecificDELETEWHERE1.output2",
    )
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - Thread - BenchmarkFig5 - false`() {
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - Simple - Centralized - false - None - RPL`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - Simple - Centralized - false - None - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - BenchmarkFig5 - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE WHERE 1 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
