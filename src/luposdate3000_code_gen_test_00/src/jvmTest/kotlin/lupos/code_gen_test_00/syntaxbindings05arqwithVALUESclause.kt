...
public class syntaxbindings05arqwithVALUESclause {
    ...
    @Test
    public fun `syntaxbindings05arq with VALUES clause - Thread - PartitionByAll - true`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
    ...
    @Test
    public fun `syntaxbindings05arq with VALUES clause - Thread - PartitionByAll - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.Thread
