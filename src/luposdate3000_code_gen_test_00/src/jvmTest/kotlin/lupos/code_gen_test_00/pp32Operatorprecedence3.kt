...
public class pp32Operatorprecedence3 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/pp32Operatorprecedence3.input",
    )
    ...
    @Test(timeout = 10000)
    public fun `pp32 Operator precedence 3 - in simulator - Simple - Centralized - true - None - RPL`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `pp32 Operator precedence 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `pp32 Operator precedence 3 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `pp32 Operator precedence 3 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `pp32 Operator precedence 3 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `pp32 Operator precedence 3 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
