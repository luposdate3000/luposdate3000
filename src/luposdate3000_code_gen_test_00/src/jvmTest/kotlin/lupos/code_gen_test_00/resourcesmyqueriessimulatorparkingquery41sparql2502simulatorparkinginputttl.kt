...
public class resourcesmyqueriessimulatorparkingquery41sparql2502simulatorparkinginputttl {
    ...
    public fun `resourcesmyqueriessimulatorparkingquery41sparql2502 simulatorparkinginputttl - None - Simple - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesmyqueriessimulatorparkingquery41sparql2502simulatorparkinginputttl.kt:81"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
