...
public class resourcesbsbmbiquery31853sparql1853 {
    ...
    public fun `resourcesbsbmbiquery31853sparql1853 - None - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTrace(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesbsbmbiquery31853sparql1853.kt:104"/*SOURCE_FILE_END*/ )() //otherwise this would be silently ignored
        throw e
      }finally{
