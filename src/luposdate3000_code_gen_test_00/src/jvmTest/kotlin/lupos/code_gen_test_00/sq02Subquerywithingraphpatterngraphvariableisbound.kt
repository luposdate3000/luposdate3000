...
public class sq02Subquerywithingraphpatterngraphvariableisbound {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/sq02Subquerywithingraphpatterngraphvariableisbound.input0",
    )
    ...
    @Test(timeout = 10000)
    public fun `sq02  Subquery within graph pattern graph variable is bound - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `sq02  Subquery within graph pattern graph variable is bound - in simulator - BenchmarkFig5 - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    @Test(timeout = 10000)
    public fun `sq02  Subquery within graph pattern graph variable is bound - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `sq02  Subquery within graph pattern graph variable is bound - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `sq02  Subquery within graph pattern graph variable is bound - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `sq02  Subquery within graph pattern graph variable is bound - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
