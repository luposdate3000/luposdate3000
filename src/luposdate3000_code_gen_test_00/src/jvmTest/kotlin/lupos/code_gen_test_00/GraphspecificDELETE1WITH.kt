...
public class GraphspecificDELETE1WITH {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/GraphspecificDELETE1WITH.input0",
        "src/jvmTest/resources/GraphspecificDELETE1WITH.input1",
        "src/jvmTest/resources/GraphspecificDELETE1WITH.input2",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/GraphspecificDELETE1WITH.output0",
        "src/jvmTest/resources/GraphspecificDELETE1WITH.output1",
        "src/jvmTest/resources/GraphspecificDELETE1WITH.output2",
    )
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE 1 WITH - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Graphspecific DELETE 1 WITH - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
