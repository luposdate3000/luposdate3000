...
public class resourcesbsbmbiquery71853sparql1853 {
    ...
    public fun `resourcesbsbmbiquery71853sparql1853 - Thread - PartitionByID_2_AllCollations - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesbsbmbiquery71853sparql1853.kt:106"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun `resourcesbsbmbiquery71853sparql1853 - Thread - PartitionByID_S_AllCollations - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesbsbmbiquery71853sparql1853.kt:122"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
        LuposdateEndpoint.close(instance)
      }
    }
