...
public class resourcessp2bq12bsparql1294 {
    ...
    public fun `resourcessp2bq12bsparql1294 - None - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTrace(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcessp2bq12bsparql1294.kt:95"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
        throw e
      }finally{
    ...
    public fun `resourcessp2bq12bsparql1294 - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTrace(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcessp2bq12bsparql1294.kt:112"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
        throw e
      }finally{
        LuposdateEndpoint.close(instance)
      }
