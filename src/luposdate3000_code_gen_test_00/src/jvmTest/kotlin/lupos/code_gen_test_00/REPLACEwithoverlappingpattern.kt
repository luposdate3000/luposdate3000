...
public class REPLACEwithoverlappingpattern {
    internal val inputData = arrayOf(
        File("src/jvmTest/resources/REPLACEwithoverlappingpattern.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/REPLACEwithoverlappingpattern.input",
    )
    ...
    internal val targetData = File("src/jvmTest/resources/REPLACEwithoverlappingpattern.output").readAsString()
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - Thread - BenchmarkFig5 - false`() {
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - Thread - PartitionByID_S_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - Thread - Simple - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - Thread - Simple - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - in simulator - Simple - Centralized - false - None - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `REPLACE with overlapping pattern - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
