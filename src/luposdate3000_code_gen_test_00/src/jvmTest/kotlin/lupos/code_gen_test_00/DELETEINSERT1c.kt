...
public class DELETEINSERT1c {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/DELETEINSERT1c.input",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/DELETEINSERT1c.output0",
    )
    ...
    @Test(timeout = 10000)
    public fun `DELETE INSERT 1c - Thread - BenchmarkFig5 - false`() {
    ...
    @Test(timeout = 10000)
    public fun `DELETE INSERT 1c - in simulator - BenchmarkFig5 - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `DELETE INSERT 1c - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `DELETE INSERT 1c - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `DELETE INSERT 1c - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
