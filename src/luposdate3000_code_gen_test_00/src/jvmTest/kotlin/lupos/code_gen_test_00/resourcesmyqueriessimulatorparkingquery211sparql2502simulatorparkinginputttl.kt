...
public class resourcesmyqueriessimulatorparkingquery211sparql2502simulatorparkinginputttl {
    ...
    @Test
    public fun `resourcesmyqueriessimulatorparkingquery211sparql2502 simulatorparkinginputttl - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcesmyqueriessimulatorparkingquery211sparql2502 simulatorparkinginputttl - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
