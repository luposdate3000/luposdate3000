...
public class DROPNAMED {
    ...
    public fun `DROP NAMED - Thread - PartitionByID_1_AllCollations - true`() {
      ...
      try{
        ...
        val graph77 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected77 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
    ...
    public fun `DROP NAMED - Thread - PartitionByID_1_AllCollations - false`() {
      ...
      try{
        ...
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator83, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query84 = Query(instance)
        val graph84 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected84 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
    ...
    public fun `DROP NAMED - Thread - PartitionByID_2_AllCollations - true`() {
      ...
      try{
        ...
        val graph87 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected87 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        ...
        val operator88 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator88, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query89 = Query(instance)
        val graph89 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected89 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
    ...
    public fun `DROP NAMED - Thread - PartitionByID_O_AllCollations - true`() {
      ...
      try{
        ...
        val graph97 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected97 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
    ...
    public fun `DROP NAMED - Thread - PartitionByID_O_AllCollations - false`() {
      ...
      try{
        ...
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator103, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query104 = Query(instance)
        val graph104 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected104 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
    ...
    public fun `DROP NAMED - Thread - PartitionByID_S_AllCollations - false`() {
      ...
      try{
        ...
        val graph112 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected112 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        ...
        val operator113 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator113, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query114 = Query(instance)
        val graph114 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected114 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
    ...
    public fun `DROP NAMED - Thread - PartitionByKeyAllCollations - true`() {
      ...
      try{
        ...
        val graph117 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected117 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        ...
        val operator118 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator118, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query119 = Query(instance)
        val graph119 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected119 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
    ...
    public fun `DROP NAMED - Thread - Simple - true`() {
      ...
      try{
        ...
        val graph127 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        ...
        val expected127 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
