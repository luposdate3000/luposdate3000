...
public class resourcesbsbmexplorequery122210sparql2210 {
    ...
    public fun `resourcesbsbmexplorequery122210sparql2210 - Thread - PartitionByIDTwiceAllCollations - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesbsbmexplorequery122210sparql2210.kt:101"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
    ...
    public fun `resourcesbsbmexplorequery122210sparql2210 - Thread - PartitionByID_1_AllCollations - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesbsbmexplorequery122210sparql2210.kt:117"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun `resourcesbsbmexplorequery122210sparql2210 - Thread - PartitionByID_1_AllCollations - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesbsbmexplorequery122210sparql2210.kt:133"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
    ...
    public fun `resourcesbsbmexplorequery122210sparql2210 - Thread - PartitionByID_S_AllCollations - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesbsbmexplorequery122210sparql2210.kt:149"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
            LuposdateEndpoint.close(instance)
        }
    }
