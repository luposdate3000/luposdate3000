...
public class MOVE4 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/MOVE4.input",
        "src/jvmTest/resources/MOVE4.input1",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/MOVE4.output0",
        "src/jvmTest/resources/MOVE4.output1",
    )
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - Simple - Centralized - true - None - RPL`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `MOVE 4 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
