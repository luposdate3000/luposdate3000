...
public class pp01Simplepath {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/pp01Simplepath.input",
    )
    ...
    @Test(timeout = 10000)
    public fun `pp01 Simple path - in simulator - Simple - Centralized - false - None - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `pp01 Simple path - in simulator - BenchmarkFig5 - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `pp01 Simple path - in simulator - PartitionByID_1_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `pp01 Simple path - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `pp01 Simple path - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `pp01 Simple path - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `pp01 Simple path - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
