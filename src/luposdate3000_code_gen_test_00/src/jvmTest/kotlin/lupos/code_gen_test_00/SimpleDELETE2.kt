...
public class SimpleDELETE2 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/SimpleDELETE2.input0",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/SimpleDELETE2.output0",
    )
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 2 - in simulator - Simple - Centralized - true - None - RPL_Fast`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 2 - in simulator - Simple - Centralized - false - None - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 2 - in simulator - Simple - Centralized - false - None - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 2 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 2 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 2 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 2 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 2 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 2 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
