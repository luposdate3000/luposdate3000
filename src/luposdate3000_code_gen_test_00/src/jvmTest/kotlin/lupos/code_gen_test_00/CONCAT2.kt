...
public class CONCAT2 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/CONCAT2.input",
    )
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - Thread - PartitionByIDTwiceAllCollations - true`() {
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - Thread - PartitionByID_1_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - Thread - PartitionByID_1_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - Thread - PartitionByID_2_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - Thread - PartitionByID_O_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `CONCAT 2 - in simulator - PartitionByKeyAllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
