...
public class Existswithingraphpattern {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/Existswithingraphpattern.input",
        "src/jvmTest/resources/Existswithingraphpattern.input1",
    )
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - None - Simple - true`() {
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - None - Simple - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - Thread - BenchmarkFig5 - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - Thread - Simple - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.Thread
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - Simple - Centralized - false - None - RPL_Fast`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - BenchmarkFig5 - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Exists within graph pattern - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
