...
public class SimpleDELETEWHERE1 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/SimpleDELETEWHERE1.input",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/SimpleDELETEWHERE1.output0",
    )
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE WHERE 1 - Thread - BenchmarkFig5 - false`() {
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE WHERE 1 - in simulator - Simple - Centralized - true - None - RPL`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE WHERE 1 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE WHERE 1 - in simulator - BenchmarkFig5 - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE WHERE 1 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE WHERE 1 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE WHERE 1 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE WHERE 1 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE WHERE 1 - in simulator - PartitionByKeyAllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
