...
public class resourcesbsbmbiquery32553sparql2553 {
    ...
    public fun `resourcesbsbmbiquery32553sparql2553 - Thread - PartitionByID_S_AllCollations - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmTest/kotlin/lupos/code_gen_test_00/resourcesbsbmbiquery32553sparql2553.kt:105"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
