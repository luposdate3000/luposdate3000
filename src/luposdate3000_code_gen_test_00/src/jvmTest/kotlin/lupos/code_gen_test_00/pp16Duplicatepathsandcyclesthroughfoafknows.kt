...
public class pp16Duplicatepathsandcyclesthroughfoafknows {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/pp16Duplicatepathsandcyclesthroughfoafknows.input",
    )
    ...
    @Test(timeout = 10000)
    public fun `pp16 Duplicate paths and cycles through foafknows - Thread - PartitionByIDTwiceAllCollations - true`() {
    ...
    @Test(timeout = 10000)
    public fun `pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 10000)
    public fun `pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `pp16 Duplicate paths and cycles through foafknows - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
