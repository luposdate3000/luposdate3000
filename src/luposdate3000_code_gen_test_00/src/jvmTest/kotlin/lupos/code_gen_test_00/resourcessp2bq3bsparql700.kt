...
public class resourcessp2bq3bsparql700 {
    ...
    @Test
    public fun `resourcessp2bq3bsparql700 - in simulator - Simple - Centralized - false - Thread - RPL`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcessp2bq3bsparql700 - in simulator - Simple - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `resourcessp2bq3bsparql700 - in simulator - Simple - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
