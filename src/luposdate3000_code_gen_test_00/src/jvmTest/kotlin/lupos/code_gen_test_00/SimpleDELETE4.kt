...
public class SimpleDELETE4 {
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 4 - Thread - BenchmarkFig5 - true`() {
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 4 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 4 - in simulator - BenchmarkFig5 - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
