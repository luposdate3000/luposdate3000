...
public class SubtractionwithMINUSfromafullyboundminuend {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/SubtractionwithMINUSfromafullyboundminuend.input",
    )
    ...
    @Test(timeout = 10000)
    public fun `Subtraction with MINUS from a fully bound minuend - Thread - BenchmarkFig5 - true`() {
    ...
    @Test(timeout = 10000)
    public fun `Subtraction with MINUS from a fully bound minuend - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Subtraction with MINUS from a fully bound minuend - in simulator - PartitionByID_2_AllCollations - Routing - false - Process - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Subtraction with MINUS from a fully bound minuend - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Subtraction with MINUS from a fully bound minuend - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
