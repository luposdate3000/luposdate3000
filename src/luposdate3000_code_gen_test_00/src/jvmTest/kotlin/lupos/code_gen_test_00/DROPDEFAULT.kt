...
public class DROPDEFAULT {
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - None - PartitionByIDTwiceAllCollations - true`() {
    ...
    public fun `DROP DEFAULT - Thread - Simple - false`() {
      ...
      try{
        ...
        val graph162 = instance.tripleStoreManager!!.getGraph(inputGraph[0])
        ...
        val expected162 = MemoryTable.parseFromAny(inputData[0], inputType[0], Query(instance))!!
        ...
        val graph163 = instance.tripleStoreManager!!.getGraph(inputGraph[1])
        ...
        val expected163 = MemoryTable.parseFromAny(inputData[1], inputType[1], Query(instance))!!
        ...
        val query164 = Query(instance)
        val graph164 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        val operator164 = graph164.getIterator(query164, arrayOf(AOPVariable(query164, "s"), AOPVariable(query164, "p"), AOPVariable(query164, "o")), EIndexPatternExt.SPO)
        val actual164 = (LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator164, buf, EQueryResultToStreamExt.MEMORY_TABLE) as List<MemoryTable>).first()
        val expected164 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        val buf_err164 = MyPrintWriter()
        if (!expected164.equalsVerbose(actual164, true, true, buf_err164)) {
            fail(expected164.toString() + " .. " + actual164.toString() + " .. " + buf_err164.toString() + " .. " + operator164)
        }
        val operator165 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator165, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query166 = Query(instance)
        val graph166 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        ...
        val expected166 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        ...
        val graph167 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        ...
        val expected167 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - in simulator - PartitionByID_1_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - in simulator - PartitionByID_2_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - in simulator - PartitionByID_O_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - in simulator - PartitionByID_S_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - in simulator - PartitionByID_S_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `DROP DEFAULT - in simulator - PartitionByID_S_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
