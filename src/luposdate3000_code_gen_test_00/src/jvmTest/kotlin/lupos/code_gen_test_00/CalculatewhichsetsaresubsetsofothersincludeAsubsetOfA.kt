...
public class CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA.input",
    )
    ...
    @Test(timeout = 10000)
    public fun `Calculate which sets are subsets of others include A subsetOf A - in simulator - BenchmarkFig5 - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Calculate which sets are subsets of others include A subsetOf A - in simulator - PartitionByID_1_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Calculate which sets are subsets of others include A subsetOf A - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Calculate which sets are subsets of others include A subsetOf A - in simulator - PartitionByID_O_AllCollations - Routing - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 10000)
    public fun `Calculate which sets are subsets of others include A subsetOf A - in simulator - PartitionByKeyAllCollations - Centralized - true - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test(timeout = 10000)
    public fun `Calculate which sets are subsets of others include A subsetOf A - in simulator - PartitionByKeyAllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
