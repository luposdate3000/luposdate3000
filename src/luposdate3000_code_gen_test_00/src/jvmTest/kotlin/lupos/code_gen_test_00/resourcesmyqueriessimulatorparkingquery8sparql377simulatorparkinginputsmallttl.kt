...
public class resourcesmyqueriessimulatorparkingquery8sparql377simulatorparkinginputsmallttl {
    ...
    @Test
    public fun `resourcesmyqueriessimulatorparkingquery8sparql377 simulatorparkinginputsmallttl - None - Simple - true - binary`() {
    ...
    @Test
    public fun `resourcesmyqueriessimulatorparkingquery8sparql377 simulatorparkinginputsmallttl - None - Simple - false - binary`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
