...
public class SimpleDELETE4USING {
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 4 USING - Thread - BenchmarkFig5 - true`() {
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Centralized - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `Simple DELETE 4 USING - in simulator - BenchmarkFig5 - Routing - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_db/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "BenchmarkFig5",
