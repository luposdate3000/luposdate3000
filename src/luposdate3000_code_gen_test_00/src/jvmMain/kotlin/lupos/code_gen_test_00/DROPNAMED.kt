...
public class DROPNAMED {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPNAMED.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPNAMED.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPNAMED.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPNAMED.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPNAMED.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPNAMED.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPNAMED.output0").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPNAMED.output0",
    )
