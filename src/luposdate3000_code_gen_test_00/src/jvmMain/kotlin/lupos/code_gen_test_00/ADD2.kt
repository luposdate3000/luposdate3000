...
public class ADD2 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD2.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD2.input",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD2.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD2.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD2.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD2.output1",
    )
