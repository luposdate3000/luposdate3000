...
public class bind07BINDfixeddataforOWLDL {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//bind07BINDfixeddataforOWLDL.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//bind07BINDfixeddataforOWLDL.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//bind07BINDfixeddataforOWLDL.output").readAsString()
