...
public class COPY1 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY1.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY1.input1").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY1.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY1.input1",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY1.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY1.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY1.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY1.output1",
    )
