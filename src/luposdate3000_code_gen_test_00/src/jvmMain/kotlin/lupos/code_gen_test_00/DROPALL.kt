...
public class DROPALL {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPALL.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPALL.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPALL.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPALL.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPALL.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPALL.input2",
    )
