...
public class resourcessp2bq67sparql700 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/resourcessp2bq67sparql700.input",
    )
    ...
    public fun `resourcessp2bq67sparql700 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - AllShortestPath`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq67sparql700 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - AllShortestPath" to ::`resourcessp2bq67sparql700 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process - AllShortestPath`,
        )
    }
    public fun main(){
