...
public class GROUPCONCAT1 {
    ...
    public fun `GROUPCONCAT 1 - None - Simple - false`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmMain/kotlin/lupos/code_gen_test_00/GROUPCONCAT1.kt:75"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "GROUPCONCAT 1 - None - Simple - false" to ::`GROUPCONCAT 1 - None - Simple - false`,
        )
    }
    public fun main(){
