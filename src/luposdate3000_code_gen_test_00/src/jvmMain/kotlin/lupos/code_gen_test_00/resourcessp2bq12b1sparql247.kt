...
public class resourcessp2bq12b1sparql247 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcessp2bq12b1sparql247.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcessp2bq12b1sparql247.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcessp2bq12b1sparql247.output").readAsString()
