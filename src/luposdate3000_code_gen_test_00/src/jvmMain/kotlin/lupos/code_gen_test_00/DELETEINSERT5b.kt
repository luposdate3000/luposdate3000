...
public class DELETEINSERT5b {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/DELETEINSERT5b.input",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/DELETEINSERT5b.output0",
    )
    ...
    public fun `DELETE INSERT 5b - Thread - PartitionByIDTwiceAllCollations - true`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmMain/kotlin/lupos/code_gen_test_00/DELETEINSERT5b.kt:93"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
    ...
    public fun getTests(): Set<Pair<String, ()->Unit>> {
        return setOf(
            "DELETE INSERT 5b - Thread - PartitionByIDTwiceAllCollations - true" to ::`DELETE INSERT 5b - Thread - PartitionByIDTwiceAllCollations - true`,
        )
    }
}
