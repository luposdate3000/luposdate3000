...
public class COPY3 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.output1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.output1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//COPY3.output2",
    )
