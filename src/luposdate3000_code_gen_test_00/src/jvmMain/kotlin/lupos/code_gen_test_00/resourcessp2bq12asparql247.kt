...
public class resourcessp2bq12asparql247 {
    ...
    public fun `resourcessp2bq12asparql247 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "resourcessp2bq12asparql247 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL" to ::`resourcessp2bq12asparql247 - in simulator - BenchmarkFig5 - Centralized - true - Process - RPL`,
        )
    }
    public fun main(){
