...
public class resourcessp2bq12bsparql247 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcessp2bq12bsparql247.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcessp2bq12bsparql247.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcessp2bq12bsparql247.output").readAsString()
    ...
    @Test
    public fun `resourcessp2bq12bsparql247 - in simulator - Simple - Centralized - true - None`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcessp2bq12bsparql247 - in simulator - Simple - Centralized - false - None`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
