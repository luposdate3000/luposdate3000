...
public class bind10BINDscopingVariableinfilternotinscope {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//bind10BINDscopingVariableinfilternotinscope.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//bind10BINDscopingVariableinfilternotinscope.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//bind10BINDscopingVariableinfilternotinscope.output").readAsString()
