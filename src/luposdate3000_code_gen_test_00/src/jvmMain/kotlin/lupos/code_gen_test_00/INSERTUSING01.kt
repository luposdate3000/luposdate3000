...
public class INSERTUSING01 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.output1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.output1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//INSERTUSING01.output2",
    )
