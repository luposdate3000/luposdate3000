...
public class sparqldl07rqtwodistinguishedvariablesundist {
    ...
    public fun `sparqldl07rq two distinguished variables  undist - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "sparqldl07rq two distinguished variables  undist - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast" to ::`sparqldl07rq two distinguished variables  undist - in simulator - BenchmarkFig5 - Routing - true - Process - RPL_Fast`,
        )
    }
    public fun main(){
