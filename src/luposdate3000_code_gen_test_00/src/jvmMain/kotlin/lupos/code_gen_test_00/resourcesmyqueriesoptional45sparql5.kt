...
public class resourcesmyqueriesoptional45sparql5 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcesmyqueriesoptional45sparql5.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcesmyqueriesoptional45sparql5.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcesmyqueriesoptional45sparql5.output").readAsString()
    ...
    @Test
    public fun `resourcesmyqueriesoptional45sparql5 - in simulator - PartitionByKeyAllCollations - Centralized - false - Process`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcesmyqueriesoptional45sparql5 - in simulator - PartitionByKeyAllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
