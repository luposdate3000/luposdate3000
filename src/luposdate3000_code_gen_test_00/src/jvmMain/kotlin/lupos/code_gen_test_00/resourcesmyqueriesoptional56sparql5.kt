...
public class resourcesmyqueriesoptional56sparql5 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcesmyqueriesoptional56sparql5.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcesmyqueriesoptional56sparql5.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//resourcesmyqueriesoptional56sparql5.output").readAsString()
