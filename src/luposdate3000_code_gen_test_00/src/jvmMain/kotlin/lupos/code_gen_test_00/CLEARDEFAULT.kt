...
public class CLEARDEFAULT {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.output1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.output1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARDEFAULT.output2",
    )
