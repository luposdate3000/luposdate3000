...
public class CLEARALL {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.output1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.output1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARALL.output2",
    )
