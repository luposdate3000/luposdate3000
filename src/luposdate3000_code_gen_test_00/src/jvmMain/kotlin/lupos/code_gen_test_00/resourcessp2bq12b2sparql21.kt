...
public class resourcessp2bq12b2sparql21 {
    ...
    public fun `resourcessp2bq12b2sparql21 - None - Simple - false`() {
        ...
        try {
            ...
            e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmMain/kotlin/lupos/code_gen_test_00/resourcessp2bq12b2sparql21.kt:80"/*SOURCE_FILE_END*/) // otherwise this would be silently ignored
        } finally {
