...
public class DROPGRAPH {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPGRAPH.output1",
    )
