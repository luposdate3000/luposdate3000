...
public class PostqueryVALUESwithsubjobjvars2rowswithUNDEF {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//PostqueryVALUESwithsubjobjvars2rowswithUNDEF.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//PostqueryVALUESwithsubjobjvars2rowswithUNDEF.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//PostqueryVALUESwithsubjobjvars2rowswithUNDEF.output").readAsString()
