...
public class ADD8 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD8.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD8.input1").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD8.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD8.input1",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD8.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD8.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD8.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD8.output1",
    )
