...
public class CLEARNAMED {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.output1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.output1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//CLEARNAMED.output2",
    )
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - Simple - Centralized - false - None`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Process`() {
        simulatorHelper(
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByIDTwiceAllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByIDTwiceAllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_1_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_2_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_2_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_O_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_O_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_S_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_S_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByKeyAllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByKeyAllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByKeyAllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByKeyAllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - PartitionByID_2_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `CLEAR NAMED - in simulator - Simple - Centralized - false - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
