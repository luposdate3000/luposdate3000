...
public class STRLEN {
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "STRLEN - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast" to ::`STRLEN - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process - RPL_Fast`,
        )
    }
    public fun main(){
