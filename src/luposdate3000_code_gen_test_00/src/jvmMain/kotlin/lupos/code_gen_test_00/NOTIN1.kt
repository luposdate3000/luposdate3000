...
public class NOTIN1 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//NOTIN1.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//NOTIN1.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//NOTIN1.output").readAsString()
