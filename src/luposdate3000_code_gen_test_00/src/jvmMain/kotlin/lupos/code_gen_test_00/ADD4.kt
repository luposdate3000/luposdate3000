...
public class ADD4 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.input1").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.input1",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.output1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.output2").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.output1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//ADD4.output2",
    )
    ...
    public fun simulatorHelper(fileName: String, cfg: MutableMap<String, Any>) {
        ...
        val pkg7 = MySimulatorTestingCompareGraphPackage(null, MemoryTable.parseFromAny(outputData[2], outputType[2], Query(instance))!!, { verifyExecuted7++ }, outputGraph[2], instance)
