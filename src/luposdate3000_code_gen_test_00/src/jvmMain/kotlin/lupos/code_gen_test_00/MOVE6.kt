...
public class MOVE6 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE6.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE6.input1").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE6.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE6.input1",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE6.output0").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE6.output0",
    )
