...
public class DROPDEFAULT {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//DROPDEFAULT.output1",
    )
