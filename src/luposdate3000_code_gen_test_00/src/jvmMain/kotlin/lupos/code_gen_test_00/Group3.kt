...
public class Group3 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/Group3.input",
    )
    ...
    public fun `Group3 - Thread - Simple - true`() {
      ...
      try{
        ...
        e.myPrintStackTraceAndThrowAgain(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_code_gen_test_00/src/jvmMain/kotlin/lupos/code_gen_test_00/Group3.kt:75"/*SOURCE_FILE_END*/ ) //otherwise this would be silently ignored
      }finally{
    ...
    public fun getTests():Set<Pair<String,()->Unit>> {
        return setOf(
            "Group3 - Thread - Simple - true" to ::`Group3 - Thread - Simple - true`,
        )
    }
    public fun main(){
