...
public class sparqldl08rqtwodistinguishedvariablesundist {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//sparqldl08rqtwodistinguishedvariablesundist.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//sparqldl08rqtwodistinguishedvariablesundist.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//sparqldl08rqtwodistinguishedvariablesundist.output").readAsString()
