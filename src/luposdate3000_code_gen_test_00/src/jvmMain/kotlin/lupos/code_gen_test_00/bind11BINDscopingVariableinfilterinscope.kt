...
public class bind11BINDscopingVariableinfilterinscope {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//bind11BINDscopingVariableinfilterinscope.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//bind11BINDscopingVariableinfilterinscope.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//bind11BINDscopingVariableinfilterinscope.output").readAsString()
