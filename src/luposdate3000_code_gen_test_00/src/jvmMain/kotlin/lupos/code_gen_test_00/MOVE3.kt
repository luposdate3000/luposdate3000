...
public class MOVE3 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.input").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.input1").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.input2").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.input",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.input1",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.input2",
    )
    ...
    internal val outputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.output0").readAsString(),
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.output1").readAsString(),
    )
    internal val outputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.output0",
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MOVE3.output1",
    )
