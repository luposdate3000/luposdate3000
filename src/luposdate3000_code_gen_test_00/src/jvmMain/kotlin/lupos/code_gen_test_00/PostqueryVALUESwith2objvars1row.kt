...
public class PostqueryVALUESwith2objvars1row {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//PostqueryVALUESwith2objvars1row.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//PostqueryVALUESwith2objvars1row.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//PostqueryVALUESwith2objvars1row.output").readAsString()
    ...
    @Test
    public fun `Postquery VALUES with 2 objvars 1 row - in simulator - PartitionByKeyAllCollations - Centralized - true - Process`() {
        simulatorHelper(
    ...
    @Test
    public fun `Postquery VALUES with 2 objvars 1 row - in simulator - PartitionByKeyAllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
