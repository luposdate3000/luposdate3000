...
public class MD5 {
    internal val inputData = arrayOf(
        File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MD5.input").readAsString(),
    )
    internal val inputDataFile = arrayOf(
        "src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MD5.input",
    )
    ...
    internal val targetData = File("src/luposdate3000_code_gen_test_00/src/jvmMain/resources//MD5.output").readAsString()
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_1_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_2_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_O_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_S_AllCollations - Routing - true - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `MD5 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "src/luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
