...
public class simpletriplepatternmatch {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - true - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - true - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - false - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - false - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - true - Routing - true - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - true - Routing - true - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - true - Routing - false - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - true - Routing - false - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - false - Routing - true - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - false - Routing - true - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - false - Routing - false - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByIDTwiceAllCollations - false - Routing - false - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - true - Centralized - true - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - true - Centralized - true - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - true - Centralized - false - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - true - Centralized - false - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - true - Routing - true - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - true - Routing - true - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - true - Routing - false - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - true - Routing - false - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - false - Centralized - true - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - false - Centralized - true - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - false - Centralized - false - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - false - Centralized - false - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - false - Routing - true - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - false - Routing - true - false`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - false - Routing - false - true`() {
    ...
    @Test
    public fun `simple triple pattern match - in simulator - PartitionByKeyAllCollations - false - Routing - false - false`() {
