...
public object XMLElementToOPBase {
    ...
    public fun createProjectedVariables(node: XMLElement): List<String> {
        ...
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_factory/src/commonMain/kotlin/lupos/operator/factory/XMLElementToOPBase.kt:168"/*SOURCE_FILE_END*/ }, { node["projectedVariables"] != null })
