...
public class AVGwithGROUPBY {
    ...
    public fun `AVG with GROUP BY - None - PartitionByIDTwiceAllCollations - false`() {
        var instance = Luposdate3000Instance()
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
        instance.predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations
    ...
    public fun `AVG with GROUP BY - None - PartitionByKeyAllCollations - true`() {
        var instance = Luposdate3000Instance()
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
    ...
    public fun `AVG with GROUP BY - None - PartitionByKeyAllCollations - false`() {
        var instance = Luposdate3000Instance()
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
        instance.predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - None`() {
        simulatorHelper(
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - false - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - false - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - false - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - false - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - true - Process`() {
        simulatorHelper(
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - true - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - true - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - false - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - false - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - true - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - true - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - true - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - true - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - false - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - false - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - false - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - false - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - true - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - true - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - true - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - true - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - false - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - false - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - false - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - false - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - false - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - PartitionByKeyAllCollations - false - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - false - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `AVG with GROUP BY - in simulator - Simple - false - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
