...
public class CLEARNAMED {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/CLEARNAMED.input",
        "src/jvmTest/resources/CLEARNAMED.input1",
        "src/jvmTest/resources/CLEARNAMED.input2",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/CLEARNAMED.output0",
        "src/jvmTest/resources/CLEARNAMED.output1",
        "src/jvmTest/resources/CLEARNAMED.output2",
    )
