...
public class resourcesmyqueriesoptional34sparql4 {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - true - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - true - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - false - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - false - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - true - Routing - true - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - true - Routing - true - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - true - Routing - false - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - true - Routing - false - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - false - Routing - true - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - false - Routing - true - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - false - Routing - false - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByIDTwiceAllCollations - false - Routing - false - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - true - Centralized - true - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - true - Centralized - true - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - true - Centralized - false - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - true - Centralized - false - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - true - Routing - true - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - true - Routing - true - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - true - Routing - false - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - true - Routing - false - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - false - Centralized - true - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - false - Centralized - true - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - false - Centralized - false - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - false - Centralized - false - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - false - Routing - true - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - false - Routing - true - false`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - false - Routing - false - true`() {
    ...
    @Ignore // Reason: >too slow<
    @Test
    public fun `resourcesmyqueriesoptional34sparql4 - in simulator - PartitionByKeyAllCollations - false - Routing - false - false`() {
