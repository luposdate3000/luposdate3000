...
public class resourcessp2bq7sparql247 {
    ...
    @Test
    public fun `resourcessp2bq7sparql247 - in simulator - Simple - Centralized - false - None - RPL`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcessp2bq7sparql247 - in simulator - Simple - Centralized - false - None - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
