...
public class aggemptygroupinsimulatorPartitionByKeyAllCollationsCentralizedfalseNone {
    ...
    @Test(timeout = 2000)
    public fun `agg empty group - in simulator - PartitionByKeyAllCollations - Centralized - false - None`() {
        simulatorHelper(
