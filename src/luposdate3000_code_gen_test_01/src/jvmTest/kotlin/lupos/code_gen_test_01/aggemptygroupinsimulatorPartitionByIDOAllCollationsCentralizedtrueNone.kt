...
public class aggemptygroupinsimulatorPartitionByIDOAllCollationsCentralizedtrueNone {
    ...
    @Test(timeout = 2000)
    public fun `agg empty group - in simulator - PartitionByID_O_AllCollations - Centralized - true - None`() {
        simulatorHelper(
