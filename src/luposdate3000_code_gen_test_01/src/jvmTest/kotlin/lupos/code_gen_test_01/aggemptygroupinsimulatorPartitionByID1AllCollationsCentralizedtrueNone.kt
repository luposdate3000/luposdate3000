...
public class aggemptygroupinsimulatorPartitionByID1AllCollationsCentralizedtrueNone {
    ...
    @Test(timeout = 2000)
    public fun `agg empty group - in simulator - PartitionByID_1_AllCollations - Centralized - true - None`() {
        simulatorHelper(
