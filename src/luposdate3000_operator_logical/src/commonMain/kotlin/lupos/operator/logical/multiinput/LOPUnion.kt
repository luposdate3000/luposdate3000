...
public class LOPUnion public constructor(query: IQuery, first: IOPBase, second: IOPBase) : LOPBase(query, EOperatorIDExt.LOPUnionID, "LOPUnion", arrayOf(first, second), ESortPriorityExt.UNION) {
    ...
    override /*suspend*/ fun calculateHistogram(): HistogramResult {
        ...
        if (provided.containsAll(p)) {
            ...
            SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_logical/src/commonMain/kotlin/lupos/operator/logical/multiinput/LOPUnion.kt:45"/*SOURCE_FILE_END*/ }, { provided.containsAll(p) })
        }
        try {
            for (v in p) {
