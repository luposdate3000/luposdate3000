...
public class AOPAggregationMIN public constructor(query: IQuery, @JvmField public val distinct: Boolean, childs: Array<AOPBase>) : AOPAggregationBase(query, EOperatorIDExt.AOPAggregationMINID, "AOPAggregationMIN", ArrayAllocatorIOPBase(childs.size) { childs[it] }) {
    ...
    override fun cloneOP(): IOPBase = AOPAggregationMIN(query, distinct, ArrayAllocatorAOPBase(children.size) { (children[it].cloneOP()) as AOPBase })
}
