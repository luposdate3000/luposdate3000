...
public class AOPBuildInCallSHA256 public constructor(query: IQuery, child: AOPBase) : AOPBase(query, EOperatorIDExt.AOPBuildInCallSHA256ID, "AOPBuildInCallSHA256", arrayOf(child)) {
