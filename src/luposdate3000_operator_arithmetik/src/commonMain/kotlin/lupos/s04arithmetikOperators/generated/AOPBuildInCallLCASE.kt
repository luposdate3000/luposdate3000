        ...
        return {
            ...
            when (tmp_1) {
                ETripleComponentTypeExt.STRING -> {
                    ...
                    val tmp_4: String = tmp_3.toLowerCase()
                ...
                ETripleComponentTypeExt.STRING_LANG -> {
                    ...
                    val tmp_7_content: String = tmp_6_content.toLowerCase()
                    val tmp_7_lang: String = tmp_6_lang
                    DictionaryHelper.langToByteArray(tmp_2, tmp_7_content, tmp_7_lang)
                    res = query.getDictionary().createValue(tmp_2)
                }
                ETripleComponentTypeExt.STRING_TYPED -> {
                    ...
                    val tmp_10_content: String = tmp_9_content.toLowerCase()
                    val tmp_10_type: String = tmp_9_type
