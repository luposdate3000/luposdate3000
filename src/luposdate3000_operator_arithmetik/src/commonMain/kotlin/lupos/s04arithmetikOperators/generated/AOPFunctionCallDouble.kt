...
public class AOPFunctionCallDouble public constructor(query: IQuery, child0: AOPBase,) : AOPBase(query, EOperatorIDExt.AOPFunctionCallDoubleID, "AOPFunctionCallDouble", arrayOf(child0,)) {
        ...
        return {
            ...
            when (tmp_1) {
                ETripleComponentTypeExt.BOOLEAN -> {
                    ...
                    DictionaryHelper.doubleToByteArray(tmp_2, tmp_4)
                ...
                ETripleComponentTypeExt.STRING_LANG -> {
                    ...
                    try {
                        ...
                        DictionaryHelper.doubleToByteArray(tmp_2, tmp_22)
                        res = query.getDictionary().createValue(tmp_2)
                    } catch (e: Throwable) {
                        DictionaryHelper.errorToByteArray(tmp_2)
                        res = query.getDictionary().createValue(tmp_2)
                ...
                ETripleComponentTypeExt.STRING_TYPED -> {
                    ...
                    try {
                        ...
                        DictionaryHelper.doubleToByteArray(tmp_2, tmp_25)
                        res = query.getDictionary().createValue(tmp_2)
                    } catch (e: Throwable) {
                        DictionaryHelper.errorToByteArray(tmp_2)
                        res = query.getDictionary().createValue(tmp_2)
