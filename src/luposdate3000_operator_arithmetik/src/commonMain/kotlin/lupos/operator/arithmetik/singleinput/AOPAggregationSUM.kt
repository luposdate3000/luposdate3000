...
public class AOPAggregationSUM public constructor(query: IQuery, @JvmField public val distinct: Boolean, child: AOPBase) : AOPAggregationBase(query, EOperatorIDExt.AOPAggregationSUMID, "AOPAggregationSUM", arrayOf(child)) {
    ...
    override fun cloneOP(): IOPBase = AOPAggregationSUM(query, distinct, children[0]as AOPBase)
}
