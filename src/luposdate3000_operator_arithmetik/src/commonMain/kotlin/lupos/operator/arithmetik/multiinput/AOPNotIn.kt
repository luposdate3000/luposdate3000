        ...
        return {
            ...
            for (childB in childsB) {
                try {
                    ...
                    e.myPrintStackTrace(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_arithmetik/src/commonMain/kotlin/lupos/operator/arithmetik/multiinput/AOPNotIn.kt:47"/*SOURCE_FILE_END*/)
                    noError = false
                }
            }
            if (!found || noError) {
