...
public class AOPIn public constructor(query: IQuery, childA: IAOPBase, childB: IAOPBase) : AOPBase(query, EOperatorIDExt.AOPInID, "AOPIn", arrayOf(childA, childB)) {
    ...
    override fun evaluate(row: IteratorBundle): () -> ValueDefinition {
        ...
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_arithmetik/src/commonMain/kotlin/lupos/operator/arithmetik/multiinput/AOPIn.kt:33"/*SOURCE_FILE_END*/ }, { children[1] is AOPSet })
