...
import lupos.shared.Crypto_SHA1
        ...
        return {
            ...
            when (DictionaryHelper.byteArrayToType(tmp_0)) {
                ...
                ETripleComponentTypeExt.STRING -> {
                    ...
                    val tmp_13: String = Crypto_SHA1.sha1(tmp_12)
                ...
                ETripleComponentTypeExt.STRING_LANG -> {
                    ...
                    val tmp_16: String = Crypto_SHA1.sha1(tmp_15_content)
                ...
                ETripleComponentTypeExt.STRING_TYPED -> {
                    ...
                    val tmp_19: String = Crypto_SHA1.sha1(tmp_18_content)
