    ...
    override fun evaluateID(row: IteratorBundle): () -> DictionaryValueType {
        ...
        return {
            ...
            try {
                ...
                e.myPrintStackTrace(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_arithmetik/src/commonMain/kotlin/lupos/operator/arithmetik/multiinput/AOPGEQ.kt:52"/*SOURCE_FILE_END*/)
            }
            res
        }
    }
