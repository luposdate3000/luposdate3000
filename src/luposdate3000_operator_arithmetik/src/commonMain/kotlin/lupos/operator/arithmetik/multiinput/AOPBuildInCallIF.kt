    ...
    override fun evaluate(row: IteratorBundle): () -> ByteArrayWrapper {
        ...
        return {
            ...
            try {
                ...
                e.myPrintStackTrace(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_arithmetik/src/commonMain/kotlin/lupos/operator/arithmetik/multiinput/AOPBuildInCallIF.kt:46"/*SOURCE_FILE_END*/)
            }
            res
        }
    }
