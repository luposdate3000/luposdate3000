...
class AOPVariableTest {
    ...
    fun testresources_sparql11_test_suite_functions_strdt02_rq() = listOf(
            ...
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p21219");resultSet.createVariable("str");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTRDT(AOPBuildInCallSTR(AOPVariable("str")),AOPIri("http://www.w3.org/2001/XMLSchema#string","http://example.org/")),{resultRow[resultSet.createVariable("s")]=resultSet.createValue("<http://example.org/s2>");resultRow[resultSet.createVariable("#p21219")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")]=resultSet.createValue("\"bar\"@en");resultRow}(),resultSet,Exception("AOPBuiltInCall STRDT only works with simple string input"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p21219");resultSet.createVariable("str");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANGMATCHES(AOPBuildInCallLANG(AOPVariable("str")),AOPSimpleLiteral("\"","en")),{resultRow[resultSet.createVariable("s")]=resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p21219")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")]=resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow}(),resultSet,AOPBoolean(false))}()*/
    ...
    fun testresources_sparql11_test_suite_functions_strlang02_rq() = listOf(
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANG(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", ""))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANGMATCHES(AOPBuildInCallLANG(AOPVariable("str")), AOPSimpleLiteral("\"", "en")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPBoolean(false))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANG(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s2>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"bar\"@en");resultRow }(), resultSet, AOPSimpleLiteral("\"", "en"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANGMATCHES(AOPBuildInCallLANG(AOPVariable("str")), AOPSimpleLiteral("\"", "en")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s2>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"bar\"@en");resultRow }(), resultSet, AOPBoolean(true))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANG(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", ""))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANGMATCHES(AOPBuildInCallLANG(AOPVariable("str")), AOPSimpleLiteral("\"", "en")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPBoolean(false))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANG(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"食べ物\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", ""))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTR(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s2>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"bar\"@en");resultRow }(), resultSet, AOPSimpleLiteral("\"", "bar"))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANG(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"100%\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", ""))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANGMATCHES(AOPBuildInCallLANG(AOPVariable("str")), AOPSimpleLiteral("\"", "en")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"100%\"");resultRow }(), resultSet, AOPBoolean(false))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANG(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPSimpleLiteral("\"", ""))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANGMATCHES(AOPBuildInCallLANG(AOPVariable("str")), AOPSimpleLiteral("\"", "en")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(false))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANG(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPSimpleLiteral("\"", ""))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22043");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLANGMATCHES(AOPBuildInCallLANG(AOPVariable("str")), AOPSimpleLiteral("\"", "en")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p22043")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(false))
    ...
    fun testresources_sparql11_test_suite_functions_abs01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22577");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallABS(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n1>");resultRow[resultSet.createVariable("#p22577")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"-1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, AOPInteger(1))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22577");resultSet.createVariable("num");
    ...
    fun testresources_sparql11_test_suite_functions_ceil01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22709");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCEIL(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n1>");resultRow[resultSet.createVariable("#p22709")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"-1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, AOPInteger(-1))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22709");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCEIL(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n2>");resultRow[resultSet.createVariable("#p22709")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"-1.6\"^^<http://www.w3.org/2001/XMLSchema#decimal>");resultRow }(), resultSet, AOPDecimal(-1.0))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22709");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCEIL(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n3>");resultRow[resultSet.createVariable("#p22709")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"1.1\"^^<http://www.w3.org/2001/XMLSchema#decimal>");resultRow }(), resultSet, AOPDecimal(2.0))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22709");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCEIL(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n4>");resultRow[resultSet.createVariable("#p22709")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"-2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, AOPInteger(-2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22709");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCEIL(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n5>");resultRow[resultSet.createVariable("#p22709")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"2.5\"^^<http://www.w3.org/2001/XMLSchema#decimal>");resultRow }(), resultSet, AOPDecimal(3.0))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_round01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22887");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallROUND(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n1>");resultRow[resultSet.createVariable("#p22887")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"-1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, AOPInteger(-1))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22887");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallROUND(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n2>");resultRow[resultSet.createVariable("#p22887")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"-1.6\"^^<http://www.w3.org/2001/XMLSchema#decimal>");resultRow }(), resultSet, AOPDecimal(-2.0))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22887");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallROUND(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n3>");resultRow[resultSet.createVariable("#p22887")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"1.1\"^^<http://www.w3.org/2001/XMLSchema#decimal>");resultRow }(), resultSet, AOPDecimal(1.0))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22887");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallROUND(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n4>");resultRow[resultSet.createVariable("#p22887")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"-2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, AOPInteger(-2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p22887");resultSet.createVariable("num");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallROUND(AOPVariable("num")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/n5>");resultRow[resultSet.createVariable("#p22887")] = resultSet.createValue("<http://example.org/num>");resultRow[resultSet.createVariable("num")] = resultSet.createValue("\"2.5\"^^<http://www.w3.org/2001/XMLSchema#decimal>");resultRow }(), resultSet, AOPDecimal(3.0))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_concat01_rq() = listOf(
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s22988");resultSet.createVariable("#p22988");resultSet.createVariable("str1");resultSet.createVariable("#s22989");resultSet.createVariable("#p22989");resultSet.createVariable("str2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONCAT(AOPVariable("str1"),AOPVariable("str2")),{resultRow[resultSet.createVariable("#s22988")]=resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p22988")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str1")]=resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("#s22989")]=resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p22989")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str2")]=resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow}(),resultSet,Exception("AOPBuiltInCall CONCAT only works with compatible string input"))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
            }()
    ...
    fun testresources_sparql11_test_suite_functions_concat02_rq() = listOf(
            ...
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s1");resultSet.createVariable("#p23068");resultSet.createVariable("str1");resultSet.createVariable("s2");resultSet.createVariable("#p23069");resultSet.createVariable("str2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONCAT(AOPVariable("str1"),AOPVariable("str2")),{resultRow[resultSet.createVariable("s1")]=resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p23068")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str1")]=resultSet.createValue("\"def\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p23069")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str2")]=resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow}(),resultSet,Exception("AOPBuiltInCall CONCAT only works with compatible string input"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s1");resultSet.createVariable("#p23068");resultSet.createVariable("str1");resultSet.createVariable("s2");resultSet.createVariable("#p23069");resultSet.createVariable("str2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONCAT(AOPVariable("str1"),AOPVariable("str2")),{resultRow[resultSet.createVariable("s1")]=resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p23068")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str1")]=resultSet.createValue("\"7\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p23069")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str2")]=resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow}(),resultSet,Exception("AOPBuiltInCall CONCAT only works with compatible string input"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s1");resultSet.createVariable("#p23068");resultSet.createVariable("str1");resultSet.createVariable("s2");resultSet.createVariable("#p23069");resultSet.createVariable("str2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONCAT(AOPVariable("str1"),AOPVariable("str2")),{resultRow[resultSet.createVariable("s1")]=resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p23068")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str1")]=resultSet.createValue("\"123\"");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p23069")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str2")]=resultSet.createValue("\"def\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow}(),resultSet,Exception("AOPBuiltInCall CONCAT only works with compatible string input"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s1");resultSet.createVariable("#p23068");resultSet.createVariable("str1");resultSet.createVariable("s2");resultSet.createVariable("#p23069");resultSet.createVariable("str2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONCAT(AOPVariable("str1"),AOPVariable("str2")),{resultRow[resultSet.createVariable("s1")]=resultSet.createValue("<http://example.org/s2>");resultRow[resultSet.createVariable("#p23068")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str1")]=resultSet.createValue("\"日本語\"@ja");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p23069")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str2")]=resultSet.createValue("\"def\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow}(),resultSet,Exception("AOPBuiltInCall CONCAT only works with compatible string input"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s1");resultSet.createVariable("#p23068");resultSet.createVariable("str1");resultSet.createVariable("s2");resultSet.createVariable("#p23069");resultSet.createVariable("str2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONCAT(AOPVariable("str1"),AOPVariable("str2")),{resultRow[resultSet.createVariable("s1")]=resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p23068")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str1")]=resultSet.createValue("\"english\"@en");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p23069")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str2")]=resultSet.createValue("\"def\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow}(),resultSet,Exception("AOPBuiltInCall CONCAT only works with compatible string input"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s1");resultSet.createVariable("#p23068");resultSet.createVariable("str1");resultSet.createVariable("s2");resultSet.createVariable("#p23069");resultSet.createVariable("str2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONCAT(AOPVariable("str1"),AOPVariable("str2")),{resultRow[resultSet.createVariable("s1")]=resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p23068")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str1")]=resultSet.createValue("\"français\"@fr");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p23069")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str2")]=resultSet.createValue("\"def\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow}(),resultSet,Exception("AOPBuiltInCall CONCAT only works with compatible string input"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s1");resultSet.createVariable("#p23068");resultSet.createVariable("str1");resultSet.createVariable("s2");resultSet.createVariable("#p23069");resultSet.createVariable("str2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONCAT(AOPVariable("str1"),AOPVariable("str2")),{resultRow[resultSet.createVariable("s1")]=resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p23068")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str1")]=resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p23069")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str2")]=resultSet.createValue("\"def\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow}(),resultSet,Exception("AOPBuiltInCall CONCAT only works with compatible string input"))}()*/
    ...
    fun testresources_sparql11_test_suite_functions_lcase01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24084");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLCASE(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p24084")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "foo"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24084");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLCASE(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s2>");resultRow[resultSet.createVariable("#p24084")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"bar\"@en");resultRow }(), resultSet, AOPLanguageTaggedLiteral("\"", "bar", "en"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24084");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLCASE(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p24084")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "baz"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24084");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLCASE(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p24084")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"食べ物\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "食べ物"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24084");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLCASE(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p24084")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"100%\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "100%"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24084");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLCASE(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p24084")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPTypedLiteral("\"", "abc", "http://www.w3.org/2001/XMLSchema#string"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24084");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallLCASE(AOPVariable("str")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p24084")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPTypedLiteral("\"", "def", "http://www.w3.org/2001/XMLSchema#string"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_contains01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24223");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p24223")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24223");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s2>");resultRow[resultSet.createVariable("#p24223")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"bar\"@en");resultRow }(), resultSet, AOPBoolean(true))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24223");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p24223")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24223");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p24223")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"食べ物\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24223");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p24223")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"100%\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24223");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p24223")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(true))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24223");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p24223")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24294");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p24294")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24294");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s2>");resultRow[resultSet.createVariable("#p24294")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"bar\"@en");resultRow }(), resultSet, AOPBoolean(true))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24294");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p24294")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24294");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p24294")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"食べ物\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24294");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p24294")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"100%\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24294");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p24294")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(true))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p24294");resultSet.createVariable("str");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONTAINS(AOPVariable("str"), AOPSimpleLiteral("\"", "a")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p24294")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("str")] = resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_plus_1_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24561");resultSet.createVariable("x");resultSet.createVariable("#p24562");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("x")), { resultRow[resultSet.createVariable("#p24561")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("_:b");resultRow[resultSet.createVariable("#p24562")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x2>");resultRow }(), resultSet, Exception("AOPAddition only works with numeric input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24561");resultSet.createVariable("x");resultSet.createVariable("#p24562");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("x")), { resultRow[resultSet.createVariable("#p24561")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://example/a>");resultRow[resultSet.createVariable("#p24562")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x3>");resultRow }(), resultSet, Exception("AOPAddition only works with numeric input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24561");resultSet.createVariable("x");resultSet.createVariable("#p24562");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("x")), { resultRow[resultSet.createVariable("#p24561")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p24562")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x4>");resultRow }(), resultSet, AOPInteger(3))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24561");resultSet.createVariable("x");resultSet.createVariable("#p24562");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("x")), { resultRow[resultSet.createVariable("#p24561")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"1.0\"^^<http://www.w3.org/2001/XMLSchema#decimal>");resultRow[resultSet.createVariable("#p24562")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x5>");resultRow }(), resultSet, AOPDecimal(3.0))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24561");resultSet.createVariable("x");resultSet.createVariable("#p24562");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("x")), { resultRow[resultSet.createVariable("#p24561")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"1\"");resultRow[resultSet.createVariable("#p24562")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x6>");resultRow }(), resultSet, Exception("AOPAddition only works with numeric input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24561");resultSet.createVariable("x");resultSet.createVariable("#p24562");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("x")), { resultRow[resultSet.createVariable("#p24561")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("#p24562")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x7>");resultRow }(), resultSet, Exception("AOPAddition only works with numeric input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_plus_2_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTR(AOPVariable("y")), { resultRow[resultSet.createVariable("#p24733")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"a\"");resultRow[resultSet.createVariable("#p24734")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x1>");resultRow }(), resultSet, Exception("AOPBuiltInCall STR only works with string input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTR(AOPVariable("y")), { resultRow[resultSet.createVariable("#p24733")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("_:b");resultRow[resultSet.createVariable("#p24734")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x2>");resultRow }(), resultSet, AOPSimpleLiteral("\"", "1"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTR(AOPVariable("x")), { resultRow[resultSet.createVariable("#p24733")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("_:b");resultRow[resultSet.createVariable("#p24734")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x2>");resultRow }(), resultSet, Exception("AOPBuiltInCall STR only works with string input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTR(AOPVariable("y")), { resultRow[resultSet.createVariable("#p24733")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://example/a>");resultRow[resultSet.createVariable("#p24734")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x3>");resultRow }(), resultSet, AOPSimpleLiteral("\"", "1"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTR(AOPVariable("y")), { resultRow[resultSet.createVariable("#p24733")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p24734")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x4>");resultRow }(), resultSet, Exception("AOPBuiltInCall STR only works with string input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTR(AOPVariable("y")), { resultRow[resultSet.createVariable("#p24733")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"1.0\"^^<http://www.w3.org/2001/XMLSchema#decimal>");resultRow[resultSet.createVariable("#p24734")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x5>");resultRow }(), resultSet, Exception("AOPBuiltInCall STR only works with string input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTR(AOPVariable("y")), { resultRow[resultSet.createVariable("#p24733")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"1\"");resultRow[resultSet.createVariable("#p24734")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x6>");resultRow }(), resultSet, AOPSimpleLiteral("\"", "2"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPBuildInCallSTR(AOPVariable("y")), AOPBuildInCallSTR(AOPVariable("x"))), { resultRow[resultSet.createVariable("#p24733")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"1\"");resultRow[resultSet.createVariable("#p24734")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x6>");resultRow }(), resultSet, Exception("AOPAddition only works with numeric input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSTR(AOPVariable("y")), { resultRow[resultSet.createVariable("#p24733")] = resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("#p24734")] = resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"");resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example/x7>");resultRow }(), resultSet, AOPSimpleLiteral("\"", "2"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p24733");resultSet.createVariable("x");resultSet.createVariable("#p24734");resultSet.createVariable("y");resultSet.createVariable("s");
    ...
    fun testresources_sparql11_test_suite_functions_md5_01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s24950");resultSet.createVariable("#p24950");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMD5(AOPVariable("l")), { resultRow[resultSet.createVariable("#s24950")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p24950")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "acbd18db4cc2f85cedef654fccc4a4d8"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s24968");resultSet.createVariable("#p24968");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMD5(AOPVariable("l")), { resultRow[resultSet.createVariable("#s24968")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p24968")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "acbd18db4cc2f85cedef654fccc4a4d8"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_md5_02_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25030");resultSet.createVariable("#p25030");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMD5(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25030")] = resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p25030")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"食べ物\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "e7ada485d13b1decf628c9211bc3a97b"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25048");resultSet.createVariable("#p25048");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMD5(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25048")] = resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p25048")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"食べ物\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "e7ada485d13b1decf628c9211bc3a97b"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_sha1_01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25110");resultSet.createVariable("#p25110");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSHA1(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25110")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p25110")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25128");resultSet.createVariable("#p25128");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSHA1(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25128")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p25128")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_sha1_02_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25190");resultSet.createVariable("#p25190");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSHA1(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25190")] = resultSet.createValue("<http://example.org/s8>");resultRow[resultSet.createVariable("#p25190")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"食\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "d46696735b6a09ff407bfc1a9407e008840db9c9"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25208");resultSet.createVariable("#p25208");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSHA1(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25208")] = resultSet.createValue("<http://example.org/s8>");resultRow[resultSet.createVariable("#p25208")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"食\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "d46696735b6a09ff407bfc1a9407e008840db9c9"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_sha256_01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25270");resultSet.createVariable("#p25270");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSHA256(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25270")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p25270")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "2c26b46b68ffc68ff99b453c1d30413413422d706483bfa0f98a5e886266e7ae"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25288");resultSet.createVariable("#p25288");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSHA256(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25288")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p25288")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "2c26b46b68ffc68ff99b453c1d30413413422d706483bfa0f98a5e886266e7ae"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_sha256_02_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25350");resultSet.createVariable("#p25350");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSHA256(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25350")] = resultSet.createValue("<http://example.org/s8>");resultRow[resultSet.createVariable("#p25350")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"食\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "0fbe868d1df356ca9df7ebff346da3a56280e059a7ea81186ef885b140d254ee"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#s25368");resultSet.createVariable("#p25368");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallSHA256(AOPVariable("l")), { resultRow[resultSet.createVariable("#s25368")] = resultSet.createValue("<http://example.org/s8>");resultRow[resultSet.createVariable("#p25368")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"食\"");resultRow }(), resultSet, AOPSimpleLiteral("\"", "0fbe868d1df356ca9df7ebff346da3a56280e059a7ea81186ef885b140d254ee"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_minutes_01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25484");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMINUTES(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p25484")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(28))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25484");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMINUTES(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p25484")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(38))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25484");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMINUTES(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p25484")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(59))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25484");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMINUTES(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p25484")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25526");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMINUTES(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p25526")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(28))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25526");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMINUTES(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p25526")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(38))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25526");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMINUTES(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p25526")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(59))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25526");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMINUTES(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p25526")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_hours_01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25699");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallHOURS(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p25699")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(11))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25699");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallHOURS(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p25699")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(15))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25699");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallHOURS(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p25699")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(23))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25699");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallHOURS(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p25699")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(1))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25741");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallHOURS(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p25741")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(11))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25741");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallHOURS(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p25741")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(15))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25741");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallHOURS(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p25741")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(23))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25741");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallHOURS(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p25741")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(1))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_month_01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25830");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMONTH(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p25830")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(6))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25830");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMONTH(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p25830")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(12))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25830");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMONTH(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p25830")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(6))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25830");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMONTH(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p25830")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25872");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMONTH(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p25872")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(6))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25872");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMONTH(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p25872")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(12))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25872");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMONTH(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p25872")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(6))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25872");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallMONTH(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p25872")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_year_01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25961");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallYEAR(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p25961")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2010))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25961");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallYEAR(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p25961")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2010))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25961");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallYEAR(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p25961")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2008))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p25961");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallYEAR(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p25961")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2011))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26003");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallYEAR(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p26003")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2010))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26003");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallYEAR(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p26003")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2010))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26003");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallYEAR(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p26003")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2008))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26003");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallYEAR(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p26003")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(2011))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_day_01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26092");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDAY(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p26092")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(21))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26092");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDAY(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p26092")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(21))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26092");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDAY(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p26092")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(20))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26092");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDAY(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p26092")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(1))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26134");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDAY(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p26134")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(21))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26134");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDAY(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p26134")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(21))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26134");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDAY(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p26134")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(20))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26134");resultSet.createVariable("date");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDAY(AOPVariable("date")), { resultRow[resultSet.createVariable("s")] = resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p26134")] = resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")] = resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow }(), resultSet, AOPInteger(1))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_functions_tz_01_rq() = listOf(
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26307");resultSet.createVariable("date");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallTZ(AOPVariable("date")),{resultRow[resultSet.createVariable("s")]=resultSet.createValue("<http://example.org/d1>");resultRow[resultSet.createVariable("#p26307")]=resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")]=resultSet.createValue("\"2010-06-21T11:28:01Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow}(),resultSet,AOPSimpleLiteral("\"","\"Z\""))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26307");resultSet.createVariable("date");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallTZ(AOPVariable("date")),{resultRow[resultSet.createVariable("s")]=resultSet.createValue("<http://example.org/d2>");resultRow[resultSet.createVariable("#p26307")]=resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")]=resultSet.createValue("\"2010-12-21T15:38:02-08:00\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow}(),resultSet,AOPSimpleLiteral("\"","\"-08:00\""))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26307");resultSet.createVariable("date");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallTZ(AOPVariable("date")),{resultRow[resultSet.createVariable("s")]=resultSet.createValue("<http://example.org/d3>");resultRow[resultSet.createVariable("#p26307")]=resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")]=resultSet.createValue("\"2008-06-20T23:59:00Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow}(),resultSet,AOPSimpleLiteral("\"","\"Z\""))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("s");resultSet.createVariable("#p26307");resultSet.createVariable("date");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallTZ(AOPVariable("date")),{resultRow[resultSet.createVariable("s")]=resultSet.createValue("<http://example.org/d4>");resultRow[resultSet.createVariable("#p26307")]=resultSet.createValue("<http://example.org/date>");resultRow[resultSet.createVariable("date")]=resultSet.createValue("\"2011-02-01T01:02:03\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow}(),resultSet,AOPSimpleLiteral("\"","\"\""))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
            }()
    ...
    fun testresources_sparql11_test_suite_functions_bnode01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s1", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPBoolean(true))
            ...
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("b2");resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallBNODE1(AOPVariable("s1")),{resultRow[resultSet.createVariable("b2")]=resultSet.createValue("_:26411\"foo\"");resultRow[resultSet.createVariable("a")]=resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")]=resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")]=resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26457")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("\"foo\"");resultRow}(),resultSet,AOPBnode("26405\"foo\""))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPOr(AOPEQ(AOPVariable("a"), AOPIri("http://example.org/s3", "http://example.org/")), AOPEQ(AOPVariable("a"), AOPIri("http://example.org/s1", "http://example.org/"))), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"食べ物\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            ...
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("b2");resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallBNODE1(AOPVariable("s1")),{resultRow[resultSet.createVariable("b2")]=resultSet.createValue("_:26411\"foo\"");resultRow[resultSet.createVariable("a")]=resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26456")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")]=resultSet.createValue("\"BAZ\"");resultRow[resultSet.createVariable("b")]=resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26457")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("\"foo\"");resultRow}(),resultSet,AOPBnode("26405\"BAZ\""))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s1", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPBoolean(true))
            }(),
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s2>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"bar\"@en");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("a"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"foo\"");resultRow }(), resultSet, AOPBoolean(false))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPBoolean(true))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s1", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPBoolean(false))
            ...
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallBNODE1(AOPVariable("s2")),{resultRow[resultSet.createVariable("a")]=resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")]=resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")]=resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26457")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("\"BAZ\"");resultRow}(),resultSet,AOPBnode("26411\"BAZ\""))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPBoolean(true))
            }(),
            ...
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("b2");resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallBNODE1(AOPVariable("s1")),{resultRow[resultSet.createVariable("b2")]=resultSet.createValue("_:26411\"BAZ\"");resultRow[resultSet.createVariable("a")]=resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")]=resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")]=resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26457")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("\"BAZ\"");resultRow}(),resultSet,AOPBnode("26405\"foo\""))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPOr(AOPEQ(AOPVariable("a"), AOPIri("http://example.org/s3", "http://example.org/")), AOPEQ(AOPVariable("a"), AOPIri("http://example.org/s1", "http://example.org/"))), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"食べ物\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            ...
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("b2");resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallBNODE1(AOPVariable("s1")),{resultRow[resultSet.createVariable("b2")]=resultSet.createValue("_:26411\"BAZ\"");resultRow[resultSet.createVariable("a")]=resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26456")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")]=resultSet.createValue("\"BAZ\"");resultRow[resultSet.createVariable("b")]=resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26457")]=resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")]=resultSet.createValue("\"BAZ\"");resultRow}(),resultSet,AOPBnode("26405\"BAZ\""))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s1", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s4>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"食べ物\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("a"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s3>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"BAZ\"");resultRow }(), resultSet, AOPBoolean(false))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"100%\"");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s1", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s5>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"100%\"");resultRow }(), resultSet, AOPBoolean(false))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s1", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s6>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"abc\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(false))
            ...
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s3", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("a");resultSet.createVariable("#p26456");resultSet.createVariable("s1");resultSet.createVariable("b");resultSet.createVariable("#p26457");resultSet.createVariable("s2");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("b"), AOPIri("http://example.org/s1", "http://example.org/")), { resultRow[resultSet.createVariable("a")] = resultSet.createValue("<http://example.org/s1>");resultRow[resultSet.createVariable("#p26456")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s1")] = resultSet.createValue("\"foo\"");resultRow[resultSet.createVariable("b")] = resultSet.createValue("<http://example.org/s7>");resultRow[resultSet.createVariable("#p26457")] = resultSet.createValue("<http://example.org/str>");resultRow[resultSet.createVariable("s2")] = resultSet.createValue("\"DEF\"^^<http://www.w3.org/2001/XMLSchema#string>");resultRow }(), resultSet, AOPBoolean(false))
    ...
    fun testresources_sparql11_test_suite_functions_bnode02_rq() = listOf(
            /*{val resultSet = ResultSet(ResultSetDictionary());val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallBNODE0(),{resultRow}(),resultSet,AOPBnode("2921629241"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("b2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallBNODE0(),{resultRow[resultSet.createVariable("b2")]=resultSet.createValue("_:2921629241");resultRow}(),resultSet,AOPBnode("2921129243"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallBNODE0(),{resultRow}(),resultSet,AOPBnode("2924929267"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("b2");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallBNODE0(),{resultRow[resultSet.createVariable("b2")]=resultSet.createValue("_:2924929267");resultRow}(),resultSet,AOPBnode("2925629269"))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
            }()
    ...
    fun testresources_sparql11_test_suite_functions_now01_rq() = listOf(
            /*{val resultSet = ResultSet(ResultSetDictionary());val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallNOW(),{resultRow}(),resultSet,AOPDateTime(""2020-02-22T09:54:48Z"^^<http://www.w3.org/2001/XMLSchema#dateTime>"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("n");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDATATYPE(AOPVariable("n")),{resultRow[resultSet.createVariable("n")]=resultSet.createValue("\"2020-02-22T09:54:48Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");resultRow}(),resultSet,Exception("AOPBuiltInCall DATATYPE only works with typed string input"))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
            }()
    ...
    fun testresources_sparql11_test_suite_functions_iri01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallIRI(AOPSimpleLiteral("\"", "iri"), "http://example.org/"), { resultRow }(), resultSet, AOPIri("iri", "http://example.org/"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("iri");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallURI(AOPSimpleLiteral("\"", "uri"), "http://example.org/"), { resultRow[resultSet.createVariable("iri")] = resultSet.createValue("<http://example.org/iri>");resultRow }(), resultSet, AOPIri("uri", "http://example.org/"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_grouping_group03_rq() = listOf(
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p30535");resultSet.createVariable("v");resultSet.createVariable("#p30536");resultSet.createVariable("w");resultSet.createVariable("s");val resultRow = resultSet.createResultRow();MicroTest(AOPAggregation(Aggregation.SAMPLE,false,arrayOf(AOPVariable("v"))),{resultRow[resultSet.createVariable("#p30535")]=resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("v")]=resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p30536")]=resultSet.createValue("<http://example/q>");resultRow[resultSet.createVariable("w")]=resultSet.createValue("\"9\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("s")]=resultSet.createValue("<http://example/s1>");resultRow}(),resultSet,AOPInteger(1))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p30535");resultSet.createVariable("v");resultSet.createVariable("#p30536");resultSet.createVariable("w");resultSet.createVariable("s");val resultRow = resultSet.createResultRow();MicroTest(AOPAggregation(Aggregation.SAMPLE,false,arrayOf(AOPVariable("v"))),{resultSet.setUndefValue(resultRow,resultSet.createVariable("#p30535"));resultSet.setUndefValue(resultRow,resultSet.createVariable("v"));resultSet.setUndefValue(resultRow,resultSet.createVariable("#p30536"));resultSet.setUndefValue(resultRow,resultSet.createVariable("w"));resultSet.setUndefValue(resultRow,resultSet.createVariable("s"));resultRow}(),resultSet,AOPInteger(1))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p30535");resultSet.createVariable("v");resultSet.createVariable("#p30536");resultSet.createVariable("w");resultSet.createVariable("s");val resultRow = resultSet.createResultRow();MicroTest(AOPAggregation(Aggregation.SAMPLE,false,arrayOf(AOPVariable("v"))),{resultRow[resultSet.createVariable("#p30535")]=resultSet.createValue("<http://example/p>");resultRow[resultSet.createVariable("v")]=resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultSet.setUndefValue(resultRow,resultSet.createVariable("#p30536"));resultSet.setUndefValue(resultRow,resultSet.createVariable("w"));resultRow[resultSet.createVariable("s")]=resultSet.createValue("<http://example/s2>");resultRow}(),resultSet,AOPInteger(2))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p30535");resultSet.createVariable("v");resultSet.createVariable("#p30536");resultSet.createVariable("w");resultSet.createVariable("s");val resultRow = resultSet.createResultRow();MicroTest(AOPAggregation(Aggregation.SAMPLE,false,arrayOf(AOPVariable("v"))),{resultSet.setUndefValue(resultRow,resultSet.createVariable("#p30535"));resultSet.setUndefValue(resultRow,resultSet.createVariable("v"));resultSet.setUndefValue(resultRow,resultSet.createVariable("#p30536"));resultSet.setUndefValue(resultRow,resultSet.createVariable("w"));resultSet.setUndefValue(resultRow,resultSet.createVariable("s"));resultRow}(),resultSet,AOPInteger(2))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
            }()
    ...
    fun testresources_sparql11_test_suite_project_expression_projexp01_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p32767");resultSet.createVariable("y");resultSet.createVariable("#p32768");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("y"), AOPVariable("z")), { resultRow[resultSet.createVariable("#p32767")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p32768")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPBoolean(true))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p32767");resultSet.createVariable("y");resultSet.createVariable("#p32768");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("y"), AOPVariable("z")), { resultRow[resultSet.createVariable("#p32767")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p32768")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p32806");resultSet.createVariable("y");resultSet.createVariable("#p32807");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("y"), AOPVariable("z")), { resultRow[resultSet.createVariable("#p32806")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p32807")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPBoolean(true))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p32806");resultSet.createVariable("y");resultSet.createVariable("#p32807");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPEQ(AOPVariable("y"), AOPVariable("z")), { resultRow[resultSet.createVariable("#p32806")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p32807")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPBoolean(false))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_project_expression_projexp02_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p32915");resultSet.createVariable("y");resultSet.createVariable("#p32916");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("z"), AOPVariable("y")), { resultRow[resultSet.createVariable("#p32915")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p32916")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPInteger(2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p32943");resultSet.createVariable("y");resultSet.createVariable("#p32944");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("z"), AOPVariable("y")), { resultRow[resultSet.createVariable("#p32943")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p32944")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPInteger(2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_project_expression_projexp03_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p33054");resultSet.createVariable("y");resultSet.createVariable("#p33055");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("z"), AOPVariable("y")), { resultRow[resultSet.createVariable("#p33054")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p33055")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPInteger(3))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("sum");resultSet.createVariable("#p33054");resultSet.createVariable("y");resultSet.createVariable("#p33055");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPMultiplication(AOPVariable("sum"), AOPInteger(2)), { resultRow[resultSet.createVariable("sum")] = resultSet.createValue("\"3\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p33054")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p33055")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPInteger(6))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p33099");resultSet.createVariable("y");resultSet.createVariable("#p33100");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("z"), AOPVariable("y")), { resultRow[resultSet.createVariable("#p33099")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p33100")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPInteger(3))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("sum");resultSet.createVariable("#p33099");resultSet.createVariable("y");resultSet.createVariable("#p33100");resultSet.createVariable("z");resultSet.createVariable("x");
                val resultRow = resultSet.createResultRow();MicroTest(AOPMultiplication(AOPVariable("sum"), AOPInteger(2)), { resultRow[resultSet.createVariable("sum")] = resultSet.createValue("\"3\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p33099")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p33100")] = resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("z")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow }(), resultSet, AOPInteger(6))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_project_expression_projexp04_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("x");resultSet.createVariable("#p33211");resultSet.createVariable("y");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("y")), { resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow[resultSet.createVariable("#p33211")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, AOPInteger(2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("x");resultSet.createVariable("#p33211");resultSet.createVariable("y");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("y")), { resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow[resultSet.createVariable("#p33211")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, AOPInteger(4))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("x");resultSet.createVariable("#p33241");resultSet.createVariable("y");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("y")), { resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow[resultSet.createVariable("#p33241")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, AOPInteger(2))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("x");resultSet.createVariable("#p33241");resultSet.createVariable("y");
                val resultRow = resultSet.createResultRow();MicroTest(AOPAddition(AOPVariable("y"), AOPVariable("y")), { resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow[resultSet.createVariable("#p33241")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")] = resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, AOPInteger(4))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_project_expression_projexp05_rq() = listOf(
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("x");resultSet.createVariable("#p33326");resultSet.createVariable("l");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDATATYPE(AOPVariable("l")),{resultRow[resultSet.createVariable("x")]=resultSet.createValue("<http://www.example.org/instance#a>");resultRow[resultSet.createVariable("#p33326")]=resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("l")]=resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow}(),resultSet,Exception("AOPBuiltInCall DATATYPE only works with typed string input"))}()*/
    ...
    fun testresources_sparql11_test_suite_project_expression_projexp06_rq() = listOf(
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("m");resultSet.createVariable("x");resultSet.createVariable("#p33403");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDATATYPE(AOPVariable("m")), { resultSet.setUndefValue(resultRow, resultSet.createVariable("m"));resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow[resultSet.createVariable("#p33403")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, Exception("AOPBuiltInCall DATATYPE only works with typed string input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("m");resultSet.createVariable("x");resultSet.createVariable("#p33427");resultSet.createVariable("l");
                val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDATATYPE(AOPVariable("m")), { resultSet.setUndefValue(resultRow, resultSet.createVariable("m"));resultRow[resultSet.createVariable("x")] = resultSet.createValue("<http://www.example.org/instance#a>");resultRow[resultSet.createVariable("#p33427")] = resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("l")] = resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow }(), resultSet, Exception("AOPBuiltInCall DATATYPE only works with typed string input"))
            }(),
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
    ...
    fun testresources_sparql11_test_suite_project_expression_projexp07_rq() = listOf(
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p33522");resultSet.createVariable("y");resultSet.createVariable("#p33523");resultSet.createVariable("l");resultSet.createVariable("x");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDATATYPE(AOPVariable("l")),{resultRow[resultSet.createVariable("#p33522")]=resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")]=resultSet.createValue("\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("#p33523")]=resultSet.createValue("<http://www.example.org/schema#q>");resultRow[resultSet.createVariable("l")]=resultSet.createValue("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultRow[resultSet.createVariable("x")]=resultSet.createValue("<http://www.example.org/instance#a>");resultRow}(),resultSet,Exception("AOPBuiltInCall DATATYPE only works with typed string input"))}()*/
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p33522");resultSet.createVariable("y");resultSet.createVariable("#p33523");resultSet.createVariable("l");resultSet.createVariable("x");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallDATATYPE(AOPVariable("l")),{resultRow[resultSet.createVariable("#p33522")]=resultSet.createValue("<http://www.example.org/schema#p>");resultRow[resultSet.createVariable("y")]=resultSet.createValue("\"3\"^^<http://www.w3.org/2001/XMLSchema#integer>");resultSet.setUndefValue(resultRow,resultSet.createVariable("#p33523"));resultSet.setUndefValue(resultRow,resultSet.createVariable("l"));resultRow[resultSet.createVariable("x")]=resultSet.createValue("<http://www.example.org/instance#b>");resultRow}(),resultSet,Exception("AOPBuiltInCall DATATYPE only works with typed string input"))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
            }()
    ...
    fun testresources_sparql11_test_suite_subquery_sq12_rq() = listOf(
            /*{val resultSet = ResultSet(ResultSetDictionary());resultSet.createVariable("#p35054");resultSet.createVariable("F");resultSet.createVariable("#p35055");resultSet.createVariable("L");resultSet.createVariable("P");val resultRow = resultSet.createResultRow();MicroTest(AOPBuildInCallCONCAT(AOPVariable("F"),AOPSimpleLiteral("\""," ")),{resultRow[resultSet.createVariable("#p35054")]=resultSet.createValue("<http://xmlns.com/foaf/0.1/firstName>");resultRow[resultSet.createVariable("F")]=resultSet.createValue("\"John\"");resultRow[resultSet.createVariable("#p35055")]=resultSet.createValue("<http://xmlns.com/foaf/0.1/lastName>");resultRow[resultSet.createVariable("L")]=resultSet.createValue("\"Doe\"");resultRow[resultSet.createVariable("P")]=resultSet.createValue("<http://p1>");resultRow}(),resultSet,AOPSimpleLiteral("\"","John "))}()*/
            {
                val resultSet = ResultSet(ResultSetDictionary());
                val resultRow = resultSet.createResultRow();MicroTest(AOPUndef(), resultRow, resultSet, AOPUndef())
            }()
