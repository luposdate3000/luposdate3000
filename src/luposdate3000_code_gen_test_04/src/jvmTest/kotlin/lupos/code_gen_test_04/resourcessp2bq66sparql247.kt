...
public class resourcessp2bq66sparql247 {
    ...
    @Test
    public fun `resourcessp2bq66sparql247 - in simulator - Simple - Centralized - true - None`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcessp2bq66sparql247 - in simulator - Simple - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `resourcessp2bq66sparql247 - in simulator - PartitionByID_1_AllCollations - Routing - false - Process`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcessp2bq66sparql247 - in simulator - PartitionByID_O_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `resourcessp2bq66sparql247 - in simulator - PartitionByID_S_AllCollations - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
    ...
    @Test
    public fun `resourcessp2bq66sparql247 - in simulator - Simple - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `resourcessp2bq66sparql247 - in simulator - Simple - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
