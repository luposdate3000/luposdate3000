...
public class DROPNAMED {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/DROPNAMED.input",
        "src/jvmTest/resources/DROPNAMED.input1",
        "src/jvmTest/resources/DROPNAMED.input2",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/DROPNAMED.output0",
    )
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - true - None - RPL`() {
        simulatorHelper(
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - false - None - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - false - None - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - false - None - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_2_AllCollations - Centralized - false - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_2_AllCollations - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_2_AllCollations - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_S_AllCollations - Centralized - false - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_S_AllCollations - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByID_S_AllCollations - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByKeyAllCollations - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByKeyAllCollations - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - PartitionByKeyAllCollations - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - true - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - true - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - true - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - false - Thread - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - false - Thread - RPL_Fast`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test
    public fun `DROP NAMED - in simulator - Simple - Centralized - false - Thread - AllShortestPath`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
