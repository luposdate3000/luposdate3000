...
public class CLBRACE(index: Int) : Token("{", index)
public class CRBRACE(index: Int) : Token("}", index)
public class SLBRACE(index: Int) : Token("[", index)
public class SRBRACE(index: Int) : Token("]", index)
public class PATHOPTION(index: Int) : Token("|", index)
public class PATHOPTIONAL(index: Int) : Token("?", index)
public class OR(index: Int) : Token("||", index)
public class AND(index: Int) : Token("&&", index)
public class EQ(index: Int) : Token("=", index)
public class NEQ(index: Int) : Token("!=", index)
public class NOT(index: Int) : Token("!", index)
public class LT(index: Int) : Token("<", index)
public class LEQ(index: Int) : Token("<=", index)
public class GT(index: Int) : Token(">", index)
public class GEQ(index: Int) : Token(">=", index)
...
public class PLUS(index: Int) : Token("+", index)
public class MINUS(index: Int) : Token("-", index)
public class MUL(index: Int) : Token("*", index)
public class DIV(index: Int) : Token("/", index)
...
public class CIRCUMFLEX(index: Int) : Token("^", index)
...
public class VAR(prefix: Char, @JvmField public val identifier: String, index: Int) : Token(prefix + identifier, index)
...
public class TokenIteratorSPARQLParser(@JvmField public val iterator: LexerCharIterator) : TokenIterator {
    private fun skip() {
        loop@ while (true) {
