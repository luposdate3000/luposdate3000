(function (root, factory) {
  ...
  function ValueKeyStore() {
    ...
    this.firstInnerID_0 = -1;
    this.firstLeafID_0 = -1;
  }
  ...
  ValueKeyStore.prototype.delete = function () {
    this.deleteContent_za3lpa$(this.firstInnerID_0);
    var rootPage = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:66', this.rootPageID_0);
    this.bufferManager_0.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:67', this.rootPageID_0);
  };
  ValueKeyStore.prototype.deleteContent_za3lpa$ = function (root) {
    ...
    while (nextStage !== -1) {
      ...
      var first = true;
      while (node !== -1) {
        var page = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:77', node);
        var nextPageID = page.readInt4_za3lpa$(4);
        if (first) {
          first = false;
          if (page.readInt4_za3lpa$(0) === 1) {
            nextStage = page.readInt4_za3lpa$(12);
          } else {
            nextStage = -1;
          }
        }this.bufferManager_0.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:87', node);
        node = nextPageID;
      }
    }
  };
  ...
  ValueKeyStore.prototype.getIterator_jxlg18$ = function (buffer) {
    return new ValueKeyStoreIteratorLeaf(this.bufferManager_0, this.firstLeafID_0, buffer);
  };
  ValueKeyStore.prototype.hasValue_jxlg18$ = function (data) {
    var buffer = ByteArrayWrapper_init();
    var iterator = new ValueKeyStoreIteratorSearch(this.bufferManager_0, this.firstLeafID_0, buffer);
    return iterator.search_m6lixb$(data);
  };
  ...
  ValueKeyStore.prototype.createValue_8lcwwa$ = function (data, value) {
    var res = {v: -1};
    var buffer = ByteArrayWrapper_init();
    var writer = ValueKeyStoreWriter_init(this.bufferManager_0, 0);
    var reader = new ValueKeyStoreIteratorLeaf(this.bufferManager_0, this.firstLeafID_0, buffer);
    ...
    while (!isInserted && reader.hasNext()) {
      ...
      if (data != null ? data.equals(buffer) : null) {
        ...
        writer.write_vnop0h$(res.v, data);
      }writer.write_vnop0h$(id, buffer);
    }
    while (reader.hasNext()) {
      var id_0 = reader.next();
      writer.write_vnop0h$(id_0, buffer);
    }
    if (!isInserted) {
      res.v = value();
    ...
    writer.close_8be2vx$();
    this.deleteContent_za3lpa$(this.firstInnerID_0);
    this.firstLeafID_0 = writer.firstLeafID_8be2vx$;
    var parent = writer;
    while (parent.parentLayer_8be2vx$ != null) {
      parent = ensureNotNull(parent.parentLayer_8be2vx$);
    }
    this.firstInnerID_0 = parent.firstLeafID_8be2vx$;
    var rootPage = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:146', this.rootPageID_0);
    rootPage.writeInt4_vux9f0$(0, this.firstLeafID_0);
    rootPage.writeInt4_vux9f0$(4, this.firstInnerID_0);
    this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:149', this.rootPageID_0);
    return res.v;
  };
  ...
  function ValueKeyStore$createValues$lambda_0(closure$res) {
    return function () {
      return closure$res !== -1;
    };
  }
  ValueKeyStore.prototype.createValues_oir6ul$ = function (hasNext, next, value) {
    if (hasNext()) {
      var data = next();
      var buffer = ByteArrayWrapper_init();
      var writer = ValueKeyStoreWriter_init(this.bufferManager_0, 0);
      ...
      while (!isInserted && reader.hasNext()) {
        ...
        if (data != null ? data.equals(buffer) : null) {
          ...
          var res = value(data);
          writer.write_vnop0h$(res, data);
          isInserted = true;
          localloop: while (hasNext()) {
            data = next();
            if (data.compareTo_11rb$(buffer) < 0) {
              var res_0 = value(data);
              writer.write_vnop0h$(res_0, data);
            } else {
              isInserted = false;
              break localloop;
            }
      ...
      if (!isInserted) {
        var res_1 = value(data);
        SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStore$createValues$lambda(res_1));
        writer.write_vnop0h$(res_1, data);
        while (hasNext()) {
          data = next();
          var res_2 = value(data);
          SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStore$createValues$lambda_0(res_2));
          writer.write_vnop0h$(res_2, data);
        }
      }reader.close();
      writer.close_8be2vx$();
      this.deleteContent_za3lpa$(this.firstInnerID_0);
      ...
      this.firstInnerID_0 = parent.firstLeafID_8be2vx$;
      var rootPage = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:212', this.rootPageID_0);
      rootPage.writeInt4_vux9f0$(0, this.firstLeafID_0);
      rootPage.writeInt4_vux9f0$(4, this.firstInnerID_0);
      this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:215', this.rootPageID_0);
    }};
  ...
  function ValueKeyStore_init(bufferManager, rootPageID, initFromRootPage, $this) {
    ...
    var rootPage = bufferManager.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:44', rootPageID);
    if (initFromRootPage) {
      $this.firstLeafID_0 = rootPage.readInt4_za3lpa$(0);
      $this.firstInnerID_0 = rootPage.readInt4_za3lpa$(4);
    } else {
    ...
    bufferManager.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:60', rootPageID);
    return $this;
  }
  ...
  ValueKeyStoreWriter.prototype.writeHeader_0 = function () {
    this.page_8be2vx$.writeInt4_vux9f0$(0, this.pageType_8be2vx$);
    this.page_8be2vx$.writeInt4_vux9f0$(4, -1);
    if (this.pageType_8be2vx$ === 1) {
      this.offset_8be2vx$ = 16;
      this.page_8be2vx$.writeInt4_vux9f0$(12, this.lastChildPageID_8be2vx$);
    } else {
      this.offset_8be2vx$ = 12;
    }
    this.page_8be2vx$.writeInt4_vux9f0$(8, this.offset_8be2vx$);
  };
  ValueKeyStoreWriter.prototype.write_vnop0h$ = function (id, buffer) {
    this.write_9hgx69$(-1, id, buffer);
  };
  function ValueKeyStoreWriter$write$lambda(this$ValueKeyStoreWriter, closure$id, closure$buffer) {
    return function () {
      ...
      }ensureNotNull(this$ValueKeyStoreWriter.parentLayer_8be2vx$).write_9hgx69$(this$ValueKeyStoreWriter.pageid_8be2vx$, closure$id, closure$buffer);
      return Unit;
    };
  }
  ValueKeyStoreWriter.prototype.write_9hgx69$ = function (childPageID, id, buffer) {
    this.write_rro62m$(childPageID, id, buffer, ValueKeyStoreWriter$write$lambda(this, id, buffer));
  ...
  function ValueKeyStoreWriter$write$lambda_2(closure$nextpageid, closure$nextpage) {
    return function (page2, pageid2) {
      closure$nextpageid.v = pageid2;
      closure$nextpage.v = page2;
      return Unit;
    };
  }
  ValueKeyStoreWriter.prototype.write_rro62m$ = function (childPageID, id, buffer, onNextEntryPoint) {
    ...
    var common = buffer.commonBytes_jxlg18$(this.lastBuffer_8be2vx$);
    buffer.copyInto_jxlg18$(this.lastBuffer_8be2vx$);
    this.page_8be2vx$.writeInt4_vux9f0$(this.offset_8be2vx$, id);
    this.page_8be2vx$.writeInt4_vux9f0$(this.offset_8be2vx$ + 4 | 0, buffer.getSize());
    this.page_8be2vx$.writeInt4_vux9f0$(this.offset_8be2vx$ + 8 | 0, common);
    this.offset_8be2vx$ = this.offset_8be2vx$ + 12 | 0;
    if (this.pageType_8be2vx$ === 1) {
      this.page_8be2vx$.writeInt4_vux9f0$(this.offset_8be2vx$, childPageID);
      this.offset_8be2vx$ = this.offset_8be2vx$ + 4 | 0;
    }this.lastPageID_8be2vx$ = this.pageid_8be2vx$;
    var len = buffer.getSize();
    ...
    while (bufferOffset < len) {
      ...
      if (l1 > 0) {
        this.page_8be2vx$.copyFrom_elxobu$(buffer.getBuf(), this.offset_8be2vx$, bufferOffset, bufferOffset + l1 | 0);
        bufferOffset = bufferOffset + l1 | 0;
        this.offset_8be2vx$ = this.offset_8be2vx$ + l1 | 0;
      }if (this.offset_8be2vx$ > 8176) {
        var nextpageid = {v: -1};
        var nextpage = {v: null};
        this.bufferManager_8be2vx$.createPage_5otl51$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:308', ValueKeyStoreWriter$write$lambda_2(nextpageid, nextpage));
        this.page_8be2vx$.writeInt4_vux9f0$(4, nextpageid.v);
        this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:314', this.pageid_8be2vx$);
        this.pageid_8be2vx$ = nextpageid.v;
        this.page_8be2vx$ = ensureNotNull(nextpage.v);
        this.writeHeader_0();
        writeEntryPoint = true;
      }}
    if (writeEntryPoint) {
      this.page_8be2vx$.writeInt4_vux9f0$(8, this.offset_8be2vx$);
      this.lastBuffer_8be2vx$.setSize_za3lpa$(0);
  ...
  ValueKeyStoreWriter.prototype.close_8be2vx$ = function () {
    var tmp$;
    if (this.offset_8be2vx$ <= 8176) {
      this.page_8be2vx$.writeInt4_vux9f0$(this.offset_8be2vx$, -1);
    }this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:335', this.pageid_8be2vx$);
  ...
  function ValueKeyStoreWriter_init_0(bufferManager, pageType, childPageID, $this) {
    ...
    var nextpageid = {v: -1};
    var nextpage = {v: null};
    bufferManager.createPage_5otl51$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:254', ValueKeyStoreWriter_init$lambda(nextpageid, nextpage));
    $this.pageid_8be2vx$ = nextpageid.v;
    $this.page_8be2vx$ = ensureNotNull(nextpage.v);
  ...
  function ValueKeyStoreWriter_init$lambda(closure$nextpageid, closure$nextpage) {
    return function (page2, pageid2) {
      closure$nextpageid.v = pageid2;
      closure$nextpage.v = page2;
      return Unit;
  ...
  function ValueKeyStoreIteratorLeaf(bufferManager, startPageID, buffer) {
    ...
    this.page_8be2vx$ = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:342', this.pageid_8be2vx$);
    this.nextPageID_8be2vx$ = this.page_8be2vx$.readInt4_za3lpa$(4);
    this.offset_8be2vx$ = this.page_8be2vx$.readInt4_za3lpa$(8);
  }
  function ValueKeyStoreIteratorLeaf$hasNext$lambda(this$ValueKeyStoreIteratorLeaf) {
    return function () {
      return this$ValueKeyStoreIteratorLeaf.page_8be2vx$.readInt4_za3lpa$(0) === 0;
    };
  }
  ValueKeyStoreIteratorLeaf.prototype.hasNext = function () {
    if (this.pageid_8be2vx$ === -1) {
      ...
      return this.page_8be2vx$.readInt4_za3lpa$(this.offset_8be2vx$) !== -1;
    }
  };
  ...
  ValueKeyStoreIteratorLeaf.prototype.next = function () {
    ...
    var id = this.page_8be2vx$.readInt4_za3lpa$(this.offset_8be2vx$);
    var len = this.page_8be2vx$.readInt4_za3lpa$(this.offset_8be2vx$ + 4 | 0);
    var bufferOffset = {v: this.page_8be2vx$.readInt4_za3lpa$(this.offset_8be2vx$ + 8 | 0)};
    this.offset_8be2vx$ = this.offset_8be2vx$ + 12 | 0;
    this.buffer_0.setSizeCopy_za3lpa$(len);
    while (bufferOffset.v < len) {
      var a = 8192 - this.offset_8be2vx$ | 0;
      var b = len - bufferOffset.v | 0;
      var l1 = Math_0.min(a, b);
      if (l1 > 0) {
        this.page_8be2vx$.copyInto_elxobu$(this.buffer_0.getBuf(), bufferOffset.v, this.offset_8be2vx$, this.offset_8be2vx$ + l1 | 0);
        bufferOffset.v = bufferOffset.v + l1 | 0;
        this.offset_8be2vx$ = this.offset_8be2vx$ + l1 | 0;
      }if (this.offset_8be2vx$ > 8176) {
        this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:369', this.pageid_8be2vx$);
        ...
        if (this.pageid_8be2vx$ === -1) {
          ...
          this.page_8be2vx$ = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:374', this.pageid_8be2vx$);
  ...
  ValueKeyStoreIteratorLeaf.prototype.close = function () {
    if (this.pageid_8be2vx$ !== -1) {
      ...
      this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:387', this.pageid_8be2vx$);
    }};
  ...
  function ValueKeyStoreIteratorSearch$search$hasNext$lambda(closure$page) {
    return function () {
      return closure$page.v.readInt4_za3lpa$(0) === 0;
    };
  }
  function ValueKeyStoreIteratorSearch$search$hasNext(this$ValueKeyStoreIteratorSearch, closure$page, closure$offset) {
    return function () {
      if (this$ValueKeyStoreIteratorSearch.pageid_8be2vx$ === -1) {
        return false;
      } else {
        SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreIteratorSearch$search$hasNext$lambda(closure$page));
        return closure$page.v.readInt4_za3lpa$(closure$offset.v) !== -1;
      }
    };
  }
  ...
  ValueKeyStoreIteratorSearch.prototype.search_m6lixb$ = function (target) {
    while (true) {
      var page = {v: this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:399', this.pageid_8be2vx$)};
      var nextPageID = page.v.readInt4_za3lpa$(4);
      var offset = {v: page.v.readInt4_za3lpa$(8)};
      var pageType = page.v.readInt4_za3lpa$(0);
      var childPageID = page.v.readInt4_za3lpa$(12);
      var lastID = -1;
      var lastPageID = childPageID;
      var hasNext = ValueKeyStoreIteratorSearch$search$hasNext(this, page, offset);
      localloop: while (hasNext()) {
        var localChildPageID = childPageID;
        lastID = page.v.readInt4_za3lpa$(offset.v);
        var len = page.v.readInt4_za3lpa$(offset.v + 4 | 0);
        var bufferOffset = {v: page.v.readInt4_za3lpa$(offset.v + 8 | 0)};
        offset.v = offset.v + 12 | 0;
        if (pageType === 1) {
          localChildPageID = page.v.readInt4_za3lpa$(offset.v);
          offset.v = offset.v + 4 | 0;
        }this.buffer_0.setSizeCopy_za3lpa$(len);
        while (bufferOffset.v < len) {
          var a = 8192 - offset.v | 0;
          var b = len - bufferOffset.v | 0;
          var l1 = Math_0.min(a, b);
          if (l1 > 0) {
            page.v.copyInto_elxobu$(this.buffer_0.getBuf(), bufferOffset.v, offset.v, offset.v + l1 | 0);
            bufferOffset.v = bufferOffset.v + l1 | 0;
            offset.v = offset.v + l1 | 0;
          }if (offset.v > 8176) {
            this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:433', this.pageid_8be2vx$);
            ...
            if (this.pageid_8be2vx$ === -1) {
              ...
              page.v = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:439', this.pageid_8be2vx$);
              SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreIteratorSearch$search$lambda_0(page));
              nextPageID = page.v.readInt4_za3lpa$(4);
              offset.v = 12;
            }
          }}
        if (target.compareTo_11rb$(this.buffer_0) <= 0) {
          break localloop;
        } else {
      ...
      if (this.pageid_8be2vx$ !== -1) {
        this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:453', this.pageid_8be2vx$);
      }if (pageType === 1) {
        this.pageid_8be2vx$ = childPageID;
      } else if (target != null ? target.equals(this.buffer_0) : null) {
        return lastID;
      } else {
        return -1;
      }
  ...
  Object.defineProperty(package$Luposdate3000_VK, '_ColumnIteratorQueueExt', {
    get: _ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_VK, '_DictionaryHelper', {
    get: _DictionaryHelper_getInstance
  });
  package$Luposdate3000_VK._MyInputStreamFixedLength = _MyInputStreamFixedLength;
  package$Luposdate3000_VK._MyStringStream = _MyStringStream;
  Object.defineProperty(package$Luposdate3000_VK, '_PartitionExt', {
  ...
  package$vk.ValueKeyStore_init_7gacri$ = ValueKeyStore_init;
  package$vk.ValueKeyStore = ValueKeyStore;
  package$vk.ValueKeyStoreWriter_init_ki9ace$ = ValueKeyStoreWriter_init;
  package$vk.ValueKeyStoreWriter_init_wjug44$ = ValueKeyStoreWriter_init_0;
  ...
  Object.defineProperty(package$Luposdate3000_VK, '_ByteArrayHelper', {
    get: _ByteArrayHelper_getInstance
  });
  package$Luposdate3000_VK._DateHelper_init = _DateHelper_init;
  package$Luposdate3000_VK._DateHelper = _DateHelper;
  package$Luposdate3000_VK._File_init_61zpoe$ = _File_init;
  package$Luposdate3000_VK._File = _File;
  Object.defineProperty(package$Luposdate3000_VK, '_IntegerExt', {
    get: _IntegerExt_getInstance
  });
  package$Luposdate3000_VK._MyInputStream_init_y4putb$ = _MyInputStream_init;
  package$Luposdate3000_VK._MyInputStream_init_kcn2v3$ = _MyInputStream_init_0;
  package$Luposdate3000_VK._MyInputStream = _MyInputStream;
  package$Luposdate3000_VK._MyOutputStream_init_8be2vx$ = _MyOutputStream_init;
  package$Luposdate3000_VK._MyOutputStream = _MyOutputStream;
  package$Luposdate3000_VK._MyPrintWriter_init_6taknv$ = _MyPrintWriter_init;
  package$Luposdate3000_VK._MyPrintWriter = _MyPrintWriter;
  Object.defineProperty(package$Luposdate3000_VK, '_Platform', {
