(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'KotlinBigInteger-bignum-jsLegacy', 'Luposdate3000_Shared', 'Luposdate3000_Shared_JS'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('KotlinBigInteger-bignum-jsLegacy'), require('Luposdate3000_Shared'), require('Luposdate3000_Shared_JS'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_VK'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'Luposdate3000_VK'.");
    }if (typeof this['KotlinBigInteger-bignum-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_VK'. Its dependency 'KotlinBigInteger-bignum-jsLegacy' was not found. Please, check whether 'KotlinBigInteger-bignum-jsLegacy' is loaded prior to 'Luposdate3000_VK'.");
    }if (typeof Luposdate3000_Shared === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_VK'. Its dependency 'Luposdate3000_Shared' was not found. Please, check whether 'Luposdate3000_Shared' is loaded prior to 'Luposdate3000_VK'.");
    }if (typeof Luposdate3000_Shared_JS === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_VK'. Its dependency 'Luposdate3000_Shared_JS' was not found. Please, check whether 'Luposdate3000_Shared_JS' is loaded prior to 'Luposdate3000_VK'.");
    }root.Luposdate3000_VK = factory(typeof Luposdate3000_VK === 'undefined' ? {} : Luposdate3000_VK, kotlin, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared, Luposdate3000_Shared_JS);
  }
}(this, function (_, Kotlin, $module$KotlinBigInteger_bignum_jsLegacy, $module$Luposdate3000_Shared, $module$Luposdate3000_Shared_JS) {
  'use strict';
  ...
  function ValueKeyStore() {
    ValueKeyStore$Companion_getInstance();
    this.rootPageID_8be2vx$ = 0;
    this.bufferManager_8be2vx$ = null;
    this.firstInnerID_8be2vx$ = -1;
    this.firstLeafID_8be2vx$ = -1;
  }
  function ValueKeyStore$Companion() {
    ValueKeyStore$Companion_instance = this;
    this.ID_NULL = -1;
    this.PAGEID_NULL_PTR_8be2vx$ = -1;
    this.PAGE_TYPE_LEAF_8be2vx$ = 0;
    this.PAGE_TYPE_INNER_8be2vx$ = 1;
    this.RESERVED_SPACE_8be2vx$ = 16;
    this.MIN_BRANCHING_8be2vx$ = 10;
  }
  ValueKeyStore$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var ValueKeyStore$Companion_instance = null;
  function ValueKeyStore$Companion_getInstance() {
    if (ValueKeyStore$Companion_instance === null) {
      new ValueKeyStore$Companion();
    }return ValueKeyStore$Companion_instance;
  }
  ValueKeyStore.prototype.delete = function () {
    this.deleteContent_za3lpa$(this.firstInnerID_8be2vx$);
    this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:74', this.rootPageID_8be2vx$);
    this.bufferManager_8be2vx$.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:75', this.rootPageID_8be2vx$);
  };
  ValueKeyStore.prototype.deleteContent_za3lpa$ = function (root) {
    var nextStage = root;
    while (nextStage !== -1) {
      var node = nextStage;
      var first = true;
      while (node !== -1) {
        var page = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:85', node);
        var nextPageID = BufferManagerPage_getInstance().readInt4_pao7sd$(page, 4);
        if (first) {
          first = false;
          if (BufferManagerPage_getInstance().readInt4_pao7sd$(page, 0) === 1) {
            nextStage = BufferManagerPage_getInstance().readInt4_pao7sd$(page, 12);
          } else {
            nextStage = -1;
          }
        }this.bufferManager_8be2vx$.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:95', node);
        node = nextPageID;
      }
    }
  };
  ValueKeyStore.prototype.close = function () {
  };
  ValueKeyStore.prototype.getIterator_b1q5io$ = function (buffer) {
    return new ValueKeyStoreIteratorLeaf(this.bufferManager_8be2vx$, this.firstLeafID_8be2vx$, buffer);
  };
  ValueKeyStore.prototype.hasValue_b1q5io$ = function (data) {
    var buffer = ByteArrayWrapper_init();
    var iterator = new ValueKeyStoreIteratorSearch(this.bufferManager_8be2vx$, this.firstLeafID_8be2vx$, buffer);
    return iterator.search_48wea5$(data);
  };
  function ValueKeyStore$createValue$lambda(closure$res) {
    return function () {
      return closure$res.v !== -1;
    };
  }
  function ValueKeyStore$createValue$lambda_0(closure$res) {
    return function () {
      return closure$res.v !== -1;
    };
  }
  function ValueKeyStore$createValue$lambda_1(closure$res) {
    return function () {
      return closure$res.v !== -1;
    };
  }
  ValueKeyStore.prototype.createValue_vjfv52$ = function (data, value) {
    var res = {v: -1};
    var buffer = ByteArrayWrapper_init();
    var writer = ValueKeyStoreWriter_init(this.bufferManager_8be2vx$, 0);
    var reader = new ValueKeyStoreIteratorLeaf(this.bufferManager_8be2vx$, this.firstLeafID_8be2vx$, buffer);
    var isInserted = false;
    while (!isInserted && reader.hasNext()) {
      var id = reader.next();
      if (data != null ? data.equals(buffer) : null) {
        res.v = id;
        isInserted = true;
        SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStore$createValue$lambda(res));
      } else if (data.compareTo_11rb$(buffer) < 0) {
        res.v = value();
        isInserted = true;
        SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStore$createValue$lambda_0(res));
        writer.write_r7bz0d$(res.v, data);
      }writer.write_r7bz0d$(id, buffer);
    }
    while (reader.hasNext()) {
      var id_0 = reader.next();
      writer.write_r7bz0d$(id_0, buffer);
    }
    if (!isInserted) {
      res.v = value();
      SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStore$createValue$lambda_1(res));
      writer.write_r7bz0d$(res.v, data);
    }reader.close();
    writer.close_8be2vx$();
    this.deleteContent_za3lpa$(this.firstInnerID_8be2vx$);
    this.firstLeafID_8be2vx$ = writer.firstLeafID_8be2vx$;
    var parent = writer;
    while (parent.parentLayer_8be2vx$ != null) {
      parent = ensureNotNull(parent.parentLayer_8be2vx$);
    }
    this.firstInnerID_8be2vx$ = parent.firstLeafID_8be2vx$;
    var rootPage = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:154', this.rootPageID_8be2vx$);
    BufferManagerPage_getInstance().writeInt4_qibw1t$(rootPage, 0, this.firstLeafID_8be2vx$);
    BufferManagerPage_getInstance().writeInt4_qibw1t$(rootPage, 4, this.firstInnerID_8be2vx$);
    this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:157', this.rootPageID_8be2vx$);
    return res.v;
  };
  function ValueKeyStore$createValues$lambda(closure$res) {
    return function () {
      return closure$res !== -1;
    };
  }
  function ValueKeyStore$createValues$lambda_0(closure$res2) {
    return function () {
      return closure$res2 !== -1;
    };
  }
  ValueKeyStore.prototype.createValues_58v2z8$ = function (hasNext, next, onNotFound, onFound) {
    if (hasNext()) {
      var data = next();
      var buffer = ByteArrayWrapper_init();
      var writer = ValueKeyStoreWriter_init(this.bufferManager_8be2vx$, 0);
      ...
      while (!isInserted && reader.hasNext()) {
        ...
        if (data != null ? data.equals(buffer) : null) {
          ...
          var res = onNotFound(data);
          writer.write_r7bz0d$(res, data);
          isInserted = true;
          localloop: while (hasNext()) {
            data = next();
            if (data.compareTo_11rb$(buffer) < 0) {
              var res2 = onNotFound(data);
              writer.write_r7bz0d$(res2, data);
            } else {
              isInserted = false;
              break localloop;
            }
      ...
      if (!isInserted) {
        var res_0 = onNotFound(data);
        SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStore$createValues$lambda(res_0));
        writer.write_r7bz0d$(res_0, data);
        while (hasNext()) {
          data = next();
          var res2_0 = onNotFound(data);
          SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStore$createValues$lambda_0(res2_0));
          writer.write_r7bz0d$(res2_0, data);
        }
      }reader.close();
      writer.close_8be2vx$();
      this.deleteContent_za3lpa$(this.firstInnerID_8be2vx$);
      ...
      this.firstInnerID_8be2vx$ = parent.firstLeafID_8be2vx$;
      var rootPage = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:221', this.rootPageID_8be2vx$);
      BufferManagerPage_getInstance().writeInt4_qibw1t$(rootPage, 0, this.firstLeafID_8be2vx$);
      BufferManagerPage_getInstance().writeInt4_qibw1t$(rootPage, 4, this.firstInnerID_8be2vx$);
      this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:224', this.rootPageID_8be2vx$);
    }};
  ValueKeyStore.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ValueKeyStore',
    interfaces: []
  };
  function ValueKeyStore_init(bufferManager, rootPageID, initFromRootPage, $this) {
    $this = $this || Object.create(ValueKeyStore.prototype);
    ValueKeyStore.call($this);
    $this.bufferManager_8be2vx$ = bufferManager;
    $this.rootPageID_8be2vx$ = rootPageID;
    var rootPage = bufferManager.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:52', rootPageID);
    if (initFromRootPage) {
      $this.firstLeafID_8be2vx$ = BufferManagerPage_getInstance().readInt4_pao7sd$(rootPage, 0);
      $this.firstInnerID_8be2vx$ = BufferManagerPage_getInstance().readInt4_pao7sd$(rootPage, 4);
    } else {
      var writer = ValueKeyStoreWriter_init(bufferManager, 0);
      writer.close_8be2vx$();
      $this.firstLeafID_8be2vx$ = writer.firstLeafID_8be2vx$;
      var parent = writer;
      while (parent.parentLayer_8be2vx$ != null) {
    ...
    bufferManager.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:68', rootPageID);
    return $this;
  }
  function ValueKeyStoreWriter() {
    this.firstLeafID_8be2vx$ = -1;
    this.lastPageID_8be2vx$ = -1;
    this.pageid_8be2vx$ = -1;
    this.page_8be2vx$ = null;
    this.offset_8be2vx$ = 12;
    this.lastBuffer_8be2vx$ = ByteArrayWrapper_init();
    this.pageType_8be2vx$ = 0;
    this.bufferManager_8be2vx$ = null;
    this.parentLayer_8be2vx$ = null;
    this.counter_8be2vx$ = 0;
    this.lastChildPageID_8be2vx$ = -1;
  }
  ValueKeyStoreWriter.prototype.writeHeader_0 = function () {
    BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, 0, this.pageType_8be2vx$);
    BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, 4, -1);
    if (this.pageType_8be2vx$ === 1) {
      this.offset_8be2vx$ = 16;
      BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, 12, this.lastChildPageID_8be2vx$);
    } else {
      this.offset_8be2vx$ = 12;
    }
    BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, 8, this.offset_8be2vx$);
  };
  ValueKeyStoreWriter.prototype.write_r7bz0d$ = function (id, buffer) {
    this.write_xk9bgt$(-1, id, buffer);
  };
  function ValueKeyStoreWriter$write$lambda(this$ValueKeyStoreWriter, closure$id, closure$buffer) {
    return function () {
      if (this$ValueKeyStoreWriter.parentLayer_8be2vx$ == null) {
        this$ValueKeyStoreWriter.parentLayer_8be2vx$ = ValueKeyStoreWriter_init_0(this$ValueKeyStoreWriter.bufferManager_8be2vx$, 1, this$ValueKeyStoreWriter.firstLeafID_8be2vx$);
      }ensureNotNull(this$ValueKeyStoreWriter.parentLayer_8be2vx$).write_xk9bgt$(this$ValueKeyStoreWriter.pageid_8be2vx$, closure$id, closure$buffer);
      return Unit;
    };
  }
  ValueKeyStoreWriter.prototype.write_xk9bgt$ = function (childPageID, id, buffer) {
    this.write_gojvyy$(childPageID, id, buffer, ValueKeyStoreWriter$write$lambda(this, id, buffer));
    this.lastChildPageID_8be2vx$ = childPageID;
  };
  function ValueKeyStoreWriter$write$lambda_0(this$ValueKeyStoreWriter) {
    return function () {
      return this$ValueKeyStoreWriter.offset_8be2vx$ <= 8176;
    };
  }
  function ValueKeyStoreWriter$write$lambda_1(closure$id) {
    return function () {
      return closure$id !== -1;
    };
  }
  ValueKeyStoreWriter.prototype.write_gojvyy$ = function (childPageID, id, buffer, onNextEntryPoint) {
    SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreWriter$write$lambda_0(this));
    SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreWriter$write$lambda_1(id));
    this.counter_8be2vx$ = this.counter_8be2vx$ + 1 | 0;
    var common = ByteArrayWrapperExt_getInstance().commonBytes_sllwic$(buffer, this.lastBuffer_8be2vx$);
    ByteArrayWrapperExt_getInstance().copyInto_sllwic$(buffer, this.lastBuffer_8be2vx$);
    BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, this.offset_8be2vx$, id);
    BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, this.offset_8be2vx$ + 4 | 0, buffer.size);
    BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, this.offset_8be2vx$ + 8 | 0, common);
    this.offset_8be2vx$ = this.offset_8be2vx$ + 12 | 0;
    if (this.pageType_8be2vx$ === 1) {
      BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, this.offset_8be2vx$, childPageID);
      this.offset_8be2vx$ = this.offset_8be2vx$ + 4 | 0;
    }this.lastPageID_8be2vx$ = this.pageid_8be2vx$;
    var len = buffer.size;
    var bufferOffset = common;
    var writeEntryPoint = false;
    while (bufferOffset < len) {
      var a = 8192 - this.offset_8be2vx$ | 0;
      var b = len - bufferOffset | 0;
      var l1 = Math_0.min(a, b);
      if (l1 > 0) {
        BufferManagerPage_getInstance().copyFrom_v35ddt$(this.page_8be2vx$, buffer.buf, this.offset_8be2vx$, bufferOffset, bufferOffset + l1 | 0);
        bufferOffset = bufferOffset + l1 | 0;
        this.offset_8be2vx$ = this.offset_8be2vx$ + l1 | 0;
      }if (this.offset_8be2vx$ > 8176) {
        var nextpageid = this.bufferManager_8be2vx$.allocPage_61zpoe$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:331');
        BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, 4, nextpageid);
        this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:334', this.pageid_8be2vx$);
        this.pageid_8be2vx$ = nextpageid;
        this.page_8be2vx$ = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:336', nextpageid);
        this.writeHeader_0();
        writeEntryPoint = true;
      }}
    if (writeEntryPoint) {
      BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, 8, this.offset_8be2vx$);
      ByteArrayWrapperExt_getInstance().setSize_v5fxe$(this.lastBuffer_8be2vx$, 0);
      if (this.counter_8be2vx$ > 10) {
        this.counter_8be2vx$ = 0;
        onNextEntryPoint();
      }}};
  ValueKeyStoreWriter.prototype.close_8be2vx$ = function () {
    var tmp$;
    if (this.offset_8be2vx$ <= 8176) {
      BufferManagerPage_getInstance().writeInt4_qibw1t$(this.page_8be2vx$, this.offset_8be2vx$, -1);
    }this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:355', this.pageid_8be2vx$);
    (tmp$ = this.parentLayer_8be2vx$) != null ? (tmp$.close_8be2vx$(), Unit) : null;
  };
  ValueKeyStoreWriter.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ValueKeyStoreWriter',
    interfaces: []
  };
  function ValueKeyStoreWriter_init(bufferManager, pageType, $this) {
    $this = $this || Object.create(ValueKeyStoreWriter.prototype);
    ValueKeyStoreWriter_init_0(bufferManager, pageType, -1, $this);
    return $this;
  }
  function ValueKeyStoreWriter_init_0(bufferManager, pageType, childPageID, $this) {
    $this = $this || Object.create(ValueKeyStoreWriter.prototype);
    ValueKeyStoreWriter.call($this);
    $this.bufferManager_8be2vx$ = bufferManager;
    $this.pageType_8be2vx$ = pageType;
    $this.pageid_8be2vx$ = bufferManager.allocPage_61zpoe$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:282');
    $this.page_8be2vx$ = bufferManager.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:283', $this.pageid_8be2vx$);
    $this.firstLeafID_8be2vx$ = $this.pageid_8be2vx$;
    $this.lastChildPageID_8be2vx$ = childPageID;
    $this.writeHeader_0();
    return $this;
  }
  function ValueKeyStoreIteratorLeaf(bufferManager, startPageID, buffer) {
    this.bufferManager_8be2vx$ = bufferManager;
    this.buffer_8be2vx$ = buffer;
    this.pageid_8be2vx$ = startPageID;
    this.page_8be2vx$ = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:365', this.pageid_8be2vx$);
    this.nextPageID_8be2vx$ = BufferManagerPage_getInstance().readInt4_pao7sd$(this.page_8be2vx$, 4);
    this.offset_8be2vx$ = BufferManagerPage_getInstance().readInt4_pao7sd$(this.page_8be2vx$, 8);
  }
  function ValueKeyStoreIteratorLeaf$hasNext$lambda(this$ValueKeyStoreIteratorLeaf) {
    return function () {
      return BufferManagerPage_getInstance().readInt4_pao7sd$(this$ValueKeyStoreIteratorLeaf.page_8be2vx$, 0) === 0;
    };
  }
  ValueKeyStoreIteratorLeaf.prototype.hasNext = function () {
    if (this.pageid_8be2vx$ === -1) {
      return false;
    } else {
      SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreIteratorLeaf$hasNext$lambda(this));
      return BufferManagerPage_getInstance().readInt4_pao7sd$(this.page_8be2vx$, this.offset_8be2vx$) !== -1;
    }
  };
  function ValueKeyStoreIteratorLeaf$next$lambda(this$ValueKeyStoreIteratorLeaf) {
    return function () {
      return BufferManagerPage_getInstance().readInt4_pao7sd$(this$ValueKeyStoreIteratorLeaf.page_8be2vx$, 0) === 0;
    };
  }
  function ValueKeyStoreIteratorLeaf$next$lambda_0(closure$bufferOffset, closure$len) {
    return function () {
      return closure$bufferOffset.v === closure$len;
    };
  }
  function ValueKeyStoreIteratorLeaf$next$lambda_1(this$ValueKeyStoreIteratorLeaf) {
    return function () {
      return BufferManagerPage_getInstance().readInt4_pao7sd$(this$ValueKeyStoreIteratorLeaf.page_8be2vx$, 0) === 0;
    };
  }
  ValueKeyStoreIteratorLeaf.prototype.next = function () {
    SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreIteratorLeaf$next$lambda(this));
    var id = BufferManagerPage_getInstance().readInt4_pao7sd$(this.page_8be2vx$, this.offset_8be2vx$);
    var len = BufferManagerPage_getInstance().readInt4_pao7sd$(this.page_8be2vx$, this.offset_8be2vx$ + 4 | 0);
    var bufferOffset = {v: BufferManagerPage_getInstance().readInt4_pao7sd$(this.page_8be2vx$, this.offset_8be2vx$ + 8 | 0)};
    this.offset_8be2vx$ = this.offset_8be2vx$ + 12 | 0;
    ByteArrayWrapperExt_getInstance().setSizeCopy_v5fxe$(this.buffer_8be2vx$, len);
    while (bufferOffset.v < len) {
      var a = 8192 - this.offset_8be2vx$ | 0;
      var b = len - bufferOffset.v | 0;
      var l1 = Math_0.min(a, b);
      if (l1 > 0) {
        arrayCopy(this.page_8be2vx$, this.buffer_8be2vx$.buf, bufferOffset.v, this.offset_8be2vx$, this.offset_8be2vx$ + l1 | 0);
        bufferOffset.v = bufferOffset.v + l1 | 0;
        this.offset_8be2vx$ = this.offset_8be2vx$ + l1 | 0;
      }if (this.offset_8be2vx$ > 8176) {
        this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:396', this.pageid_8be2vx$);
        this.pageid_8be2vx$ = this.nextPageID_8be2vx$;
        if (this.pageid_8be2vx$ === -1) {
          SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreIteratorLeaf$next$lambda_0(bufferOffset, len));
        } else {
          this.page_8be2vx$ = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:401', this.pageid_8be2vx$);
          SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreIteratorLeaf$next$lambda_1(this));
          this.nextPageID_8be2vx$ = BufferManagerPage_getInstance().readInt4_pao7sd$(this.page_8be2vx$, 4);
          this.offset_8be2vx$ = 12;
        }
      }}
  ...
  function ValueKeyStoreIteratorLeaf$close$lambda(this$ValueKeyStoreIteratorLeaf) {
    return function () {
      return BufferManagerPage_getInstance().readInt4_pao7sd$(this$ValueKeyStoreIteratorLeaf.page_8be2vx$, 0) === 0;
    };
  }
  ValueKeyStoreIteratorLeaf.prototype.close = function () {
    if (this.pageid_8be2vx$ !== -1) {
      SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreIteratorLeaf$close$lambda(this));
      this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:414', this.pageid_8be2vx$);
    }};
  ValueKeyStoreIteratorLeaf.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ValueKeyStoreIteratorLeaf',
    interfaces: []
  };
  function ValueKeyStoreIteratorSearch(bufferManager, startPageID, buffer) {
    this.bufferManager_8be2vx$ = bufferManager;
    this.buffer_8be2vx$ = buffer;
    this.pageid_8be2vx$ = startPageID;
  }
  function ValueKeyStoreIteratorSearch$search$lambda(closure$bufferOffset, closure$len) {
    return function () {
      return closure$bufferOffset.v === closure$len;
    };
  }
  function ValueKeyStoreIteratorSearch$search$lambda_0(closure$page) {
    return function () {
      return BufferManagerPage_getInstance().readInt4_pao7sd$(closure$page.v, 0) === 0;
    };
  }
  ValueKeyStoreIteratorSearch.prototype.search_48wea5$ = function (target) {
    while (true) {
      var page = {v: this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:428', this.pageid_8be2vx$)};
      var nextPageID = BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, 4);
      var offset = BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, 8);
      var pageType = BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, 0);
      var childPageID = BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, 12);
      var lastID = -1;
      localloop: while (this.pageid_8be2vx$ !== -1 && BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, offset) !== -1) {
        var localChildPageID = childPageID;
        lastID = BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, offset);
        var len = BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, offset + 4 | 0);
        var bufferOffset = {v: BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, offset + 8 | 0)};
        offset = offset + 12 | 0;
        if (pageType === 1) {
          localChildPageID = BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, offset);
          offset = offset + 4 | 0;
        }ByteArrayWrapperExt_getInstance().setSizeCopy_v5fxe$(this.buffer_8be2vx$, len);
        while (bufferOffset.v < len) {
          var a = 8192 - offset | 0;
          ...
          var l1 = Math_0.min(a, b);
          if (l1 > 0) {
            arrayCopy(page.v, this.buffer_8be2vx$.buf, bufferOffset.v, offset, offset + l1 | 0);
            bufferOffset.v = bufferOffset.v + l1 | 0;
            offset = offset + l1 | 0;
          }if (offset > 8176) {
            this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:453', this.pageid_8be2vx$);
            this.pageid_8be2vx$ = nextPageID;
            if (this.pageid_8be2vx$ === -1) {
              SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreIteratorSearch$search$lambda(bufferOffset, len));
            } else {
              page.v = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:459', this.pageid_8be2vx$);
              SanityCheckOn_getInstance().check_8i7tro$(ValueKeyStoreIteratorSearch$search$lambda_0(page));
              nextPageID = BufferManagerPage_getInstance().readInt4_pao7sd$(page.v, 4);
              offset = 12;
            }
          }}
        if (target.compareTo_11rb$(this.buffer_8be2vx$) <= 0) {
          break localloop;
        } else {
      ...
      if (this.pageid_8be2vx$ !== -1) {
        this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_vk/src/commonMain/kotlin/lupos/vk/ValueKeyStore.kt:473', this.pageid_8be2vx$);
      }if (pageType === 1) {
        this.pageid_8be2vx$ = childPageID;
      } else if (target != null ? target.equals(this.buffer_8be2vx$) : null) {
        return lastID;
      } else {
        return -1;
      }
  ...
  ValueKeyStoreIteratorSearch.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ValueKeyStoreIteratorSearch',
    interfaces: []
  };
  ...
  var package$Luposdate3000_VK = package$lupos.Luposdate3000_VK || (package$lupos.Luposdate3000_VK = {});
  Object.defineProperty(package$Luposdate3000_VK, 'BufferManagerPage', {
    get: BufferManagerPage_getInstance
  });
  Object.defineProperty(package$Luposdate3000_VK, 'ColumnIteratorQueueExt', {
    get: ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_VK, 'DictionaryHelper', {
    get: DictionaryHelper_getInstance
  });
  var package$dynamicArray = package$Luposdate3000_VK.dynamicArray || (package$Luposdate3000_VK.dynamicArray = {});
  ...
  package$Luposdate3000_VK.MyInputStreamFixedLength = MyInputStreamFixedLength;
  package$Luposdate3000_VK.MyStringStream = MyStringStream;
  Object.defineProperty(package$Luposdate3000_VK, 'SanityCheckOff', {
    get: SanityCheckOff_getInstance
  });
  Object.defineProperty(package$Luposdate3000_VK, 'SanityCheckOn', {
    get: SanityCheckOn_getInstance
  });
  Object.defineProperty(ValueKeyStore, 'Companion', {
    get: ValueKeyStore$Companion_getInstance
  });
  var package$vk = package$lupos.vk || (package$lupos.vk = {});
  package$vk.ValueKeyStore_init_b7rl13$ = ValueKeyStore_init;
  package$vk.ValueKeyStore = ValueKeyStore;
  package$vk.ValueKeyStoreWriter_init_rnr5r$ = ValueKeyStoreWriter_init;
  package$vk.ValueKeyStoreWriter_init_q8qxg3$ = ValueKeyStoreWriter_init_0;
  package$vk.ValueKeyStoreWriter = ValueKeyStoreWriter;
  package$vk.ValueKeyStoreIteratorLeaf = ValueKeyStoreIteratorLeaf;
  package$vk.ValueKeyStoreIteratorSearch = ValueKeyStoreIteratorSearch;
  Object.defineProperty(package$Luposdate3000_VK, 'ByteArrayHelper', {
    get: ByteArrayHelper_getInstance
  });
  package$Luposdate3000_VK.DateHelper_init = DateHelper_init;
  package$Luposdate3000_VK.DateHelper = DateHelper;
  package$Luposdate3000_VK.File_init_61zpoe$ = File_init;
  package$Luposdate3000_VK.File = File;
  Object.defineProperty(package$Luposdate3000_VK, 'IntegerExt', {
    get: IntegerExt_getInstance
  });
  package$Luposdate3000_VK.MyInputStream_init_y4putb$ = MyInputStream_init;
  package$Luposdate3000_VK.MyInputStream_init_kcn2v3$ = MyInputStream_init_0;
  package$Luposdate3000_VK.MyInputStream = MyInputStream;
  package$Luposdate3000_VK.MyOutputStream_init_8be2vx$ = MyOutputStream_init;
  package$Luposdate3000_VK.MyOutputStream = MyOutputStream;
  package$Luposdate3000_VK.MyPrintWriter_init_6taknv$ = MyPrintWriter_init;
  package$Luposdate3000_VK.MyPrintWriter = MyPrintWriter;
  package$Luposdate3000_VK.MyThreadReadWriteLock = MyThreadReadWriteLock;
  Object.defineProperty(package$Luposdate3000_VK, 'ParallelThread', {
    get: ParallelThread_getInstance
  });
  package$Luposdate3000_VK.ParallelThreadCondition = ParallelThreadCondition;
  package$Luposdate3000_VK.ParallelThreadQueue_init_mh5how$ = ParallelThreadQueue_init;
  package$Luposdate3000_VK.ParallelThreadQueue = ParallelThreadQueue;
  Object.defineProperty(package$Luposdate3000_VK, 'Platform', {
    get: Platform_getInstance
  });
  Kotlin.defineModule('Luposdate3000_VK', _);
  return _;
}));

//# sourceMappingURL=Luposdate3000_VK.js.map
