(function (root, factory) {
  ...
  var package$Luposdate3000_Endpoint_None = package$lupos.Luposdate3000_Endpoint_None || (package$lupos.Luposdate3000_Endpoint_None = {});
  Object.defineProperty(package$Luposdate3000_Endpoint_None, '_ColumnIteratorQueueExt', {
    get: _ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Endpoint_None, '_DictionaryHelper', {
    get: _DictionaryHelper_getInstance
  });
  package$Luposdate3000_Endpoint_None._MyInputStreamFixedLength = _MyInputStreamFixedLength;
  package$Luposdate3000_Endpoint_None._MyStringStream = _MyStringStream;
  Object.defineProperty(package$Luposdate3000_Endpoint_None, '_PartitionExt', {
    get: _PartitionExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Endpoint_None, 'SanityCheckOff', {
    get: SanityCheckOff_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Endpoint_None, 'SanityCheckOn', {
    get: SanityCheckOn_getInstance
  });
  var package$s16network = package$lupos.s16network || (package$lupos.s16network = {});
  Object.defineProperty(package$s16network, 'HttpEndpointLauncher', {
    get: HttpEndpointLauncher_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Endpoint_None, '_ByteArrayHelper', {
    get: _ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Endpoint_None._DateHelper_init = _DateHelper_init;
  package$Luposdate3000_Endpoint_None._DateHelper = _DateHelper;
  package$Luposdate3000_Endpoint_None._File_init_61zpoe$ = _File_init;
  package$Luposdate3000_Endpoint_None._File = _File;
  Object.defineProperty(package$Luposdate3000_Endpoint_None, '_IntegerExt', {
    get: _IntegerExt_getInstance
  });
  package$Luposdate3000_Endpoint_None._MyInputStream_init_y4putb$ = _MyInputStream_init;
  package$Luposdate3000_Endpoint_None._MyInputStream_init_kcn2v3$ = _MyInputStream_init_0;
  package$Luposdate3000_Endpoint_None._MyInputStream = _MyInputStream;
  package$Luposdate3000_Endpoint_None._MyOutputStream_init_8be2vx$ = _MyOutputStream_init;
  package$Luposdate3000_Endpoint_None._MyOutputStream = _MyOutputStream;
  package$Luposdate3000_Endpoint_None._MyPrintWriter_init_6taknv$ = _MyPrintWriter_init;
  package$Luposdate3000_Endpoint_None._MyPrintWriter = _MyPrintWriter;
  Object.defineProperty(package$Luposdate3000_Endpoint_None, '_Platform', {
  ...
  package$Luposdate3000_Endpoint_None.MyThreadReadWriteLock = MyThreadReadWriteLock;
  Object.defineProperty(package$Luposdate3000_Endpoint_None, 'ParallelThread', {
    get: ParallelThread_getInstance
  });
  package$Luposdate3000_Endpoint_None.ParallelThreadCondition = ParallelThreadCondition;
  package$Luposdate3000_Endpoint_None.ParallelThreadQueue_init_mh5how$ = ParallelThreadQueue_init;
  package$Luposdate3000_Endpoint_None.ParallelThreadQueue = ParallelThreadQueue;
