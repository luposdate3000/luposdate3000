(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    }root.Luposdate3000_Buffer_Manager = factory(typeof Luposdate3000_Buffer_Manager === 'undefined' ? {} : Luposdate3000_Buffer_Manager, kotlin, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared, Luposdate3000_Shared_JS);
  }
  ...
  function BufferManager() {
    ...
    for (var i = 0; i <= tmp$; i++) {
      array[i] = BufferManagerPage_getInstance().create_8be2vx$();
    }
    this.allPages_8be2vx$ = array;
    this.allPagesRefcounters_8be2vx$ = new Int32Array(128);
    this.counter_8be2vx$ = 0;
    this.lock_8be2vx$ = new MyThreadReadWriteLock();
    this.freeList_8be2vx$ = new Int32Array(128);
    this.freeListSize_8be2vx$ = 0;
  }
  BufferManager.prototype.getNumberOfAllocatedPages = function () {
    return this.counter_8be2vx$ - this.freeListSize_8be2vx$ | 0;
  };
  ...
  function BufferManager$getNumberOfReferencedPages$lambda(this$BufferManager) {
    return function () {
      ...
      tmp$ = this$BufferManager.counter_8be2vx$;
      for (var i = 0; i < tmp$; i++) {
        if (this$BufferManager.allPagesRefcounters_8be2vx$[i] !== 0) {
          var value = this$BufferManager.allPagesRefcounters_8be2vx$[i];
  ...
  BufferManager.prototype.getNumberOfReferencedPages = function () {
    var res = sum(this.allPagesRefcounters_8be2vx$);
  ...
  function BufferManager$releasePage$lambda_0(this$BufferManager, closure$pageid) {
    return function () {
      return this$BufferManager.allPagesRefcounters_8be2vx$[closure$pageid] > 0;
    };
  }
  function BufferManager$releasePage$lambda_1(closure$pageid, this$BufferManager) {
    return function () {
      return 'Failed requirement allPagesRefcounters[' + closure$pageid + '] = ' + this$BufferManager.allPagesRefcounters_8be2vx$[closure$pageid] + ' > 0';
    };
  }
  BufferManager.prototype.releasePage_bm4lxs$ = function (call_location, pageid) {
    ...
    var tmp$;
    tmp$ = this.allPagesRefcounters_8be2vx$;
  ...
  function BufferManager$getPage$lambda$lambda(closure$pageid, this$BufferManager) {
    return function () {
      return closure$pageid < this$BufferManager.counter_8be2vx$;
    };
  }
  function BufferManager$getPage$lambda$lambda_0(closure$pageid, this$BufferManager) {
    return function () {
      return closure$pageid.toString() + ' < ' + this$BufferManager.counter_8be2vx$;
    };
  }
  ...
  function BufferManager$getPage$lambda$lambda_3(this$BufferManager, closure$i, closure$pageid) {
    return function () {
      return this$BufferManager.freeList_8be2vx$[closure$i] !== closure$pageid;
    };
  }
  function BufferManager$getPage$lambda_0(closure$pageid, this$BufferManager) {
    return function () {
      ...
      tmp$ = this$BufferManager.freeListSize_8be2vx$;
      for (var i = 0; i < tmp$; i++) {
        SanityCheckOn_getInstance().check_8i7tro$(BufferManager$getPage$lambda$lambda_3(this$BufferManager, i, closure$pageid));
      }
      return Unit;
    };
  }
  function BufferManager$getPage$lambda_1(this$BufferManager, closure$pageid) {
    return function () {
      return BufferManagerPage_getInstance().getPageID_ma41of$(this$BufferManager.allPages_8be2vx$[closure$pageid]) === closure$pageid;
    };
  }
  BufferManager.prototype.getPage_bm4lxs$ = function (call_location, pageid) {
    ...
    tmp$ = this.allPagesRefcounters_8be2vx$;
    tmp$[pageid] = tmp$[pageid] + 1 | 0;
    return this.allPages_8be2vx$[pageid];
  };
  function BufferManager$allocPage$lambda$lambda(this$BufferManager, closure$pageid) {
    return function () {
      return BufferManagerPage_getInstance().getPageID_ma41of$(this$BufferManager.allPages_8be2vx$[closure$pageid.v]) === -1;
    };
  }
  function BufferManager$allocPage$lambda$lambda_0(this$BufferManager, closure$pageid) {
    return function () {
      return BufferManagerPage_getInstance().getPageID_ma41of$(this$BufferManager.allPages_8be2vx$[closure$pageid.v]).toString() + ' ' + closure$pageid.v;
    };
  }
  function BufferManager$allocPage$lambda(this$BufferManager, closure$pageid) {
    return function () {
      var tmp$;
      if (this$BufferManager.freeListSize_8be2vx$ > 0) {
        closure$pageid.v = this$BufferManager.freeList_8be2vx$[this$BufferManager.freeListSize_8be2vx$ = this$BufferManager.freeListSize_8be2vx$ - 1 | 0, this$BufferManager.freeListSize_8be2vx$];
      } else {
        if (this$BufferManager.counter_8be2vx$ === this$BufferManager.allPages_8be2vx$.length) {
          var size = this$BufferManager.counter_8be2vx$ * 2 | 0;
          if (size < 128) {
            size = 128;
          }var size_0 = size;
          ...
          for (var i = 0; i <= tmp$_0; i++) {
            ...
            var tmp$_1;
            if (i < this$BufferManager_0.counter_8be2vx$) {
              tmp$_1 = this$BufferManager_0.allPages_8be2vx$[i];
            } else {
              tmp$_1 = BufferManagerPage_getInstance().create_8be2vx$();
            }
            var res = tmp$_1;
            array[i] = res;
          }
          ...
          var $receiver = this$BufferManager.allPagesRefcounters_8be2vx$;
          arrayCopy($receiver, tmp2, 0, 0, $receiver.length);
          this$BufferManager.allPages_8be2vx$ = tmp;
          this$BufferManager.allPagesRefcounters_8be2vx$ = tmp2;
        }closure$pageid.v = (tmp$ = this$BufferManager.counter_8be2vx$, this$BufferManager.counter_8be2vx$ = tmp$ + 1 | 0, tmp$);
      }
      ...
      BufferManagerPage_getInstance().setPageID_pao7sd$(this$BufferManager.allPages_8be2vx$[closure$pageid.v], closure$pageid.v);
      return Unit;
    };
  }
  ...
  BufferManager.prototype.allocPage_61zpoe$ = function (call_location) {
    var pageid = {v: 0};
    this.lock_8be2vx$.withWriteLock_i3ch5z$(BufferManager$allocPage$lambda(this, pageid));
  ...
  function BufferManager$deletePage$lambda$lambda$lambda(this$BufferManager, closure$i, closure$pageid) {
    return function () {
      return this$BufferManager.freeList_8be2vx$[closure$i] !== closure$pageid;
    };
  }
  function BufferManager$deletePage$lambda$lambda_0(this$BufferManager, closure$pageid) {
    return function () {
      ...
      tmp$ = this$BufferManager.freeListSize_8be2vx$;
      for (var i = 0; i < tmp$; i++) {
        SanityCheckOn_getInstance().check_8i7tro$(BufferManager$deletePage$lambda$lambda$lambda(this$BufferManager, i, closure$pageid));
      }
      return Unit;
    };
  }
  function BufferManager$deletePage$lambda$lambda_1(this$BufferManager, closure$pageid) {
    return function () {
      return this$BufferManager.allPagesRefcounters_8be2vx$[closure$pageid] === 1;
    };
  }
  function BufferManager$deletePage$lambda$lambda_2(closure$pageid, this$BufferManager) {
    return function () {
      return 'Failed requirement allPagesRefcounters[' + closure$pageid + '] = ' + this$BufferManager.allPagesRefcounters_8be2vx$[closure$pageid] + ' == 1';
    };
  }
  ...
  function BufferManager$deletePage$lambda$lambda_4(this$BufferManager, closure$pageid) {
    return function () {
      this$BufferManager.allPages_8be2vx$[closure$pageid] = BufferManagerPage_getInstance().create_8be2vx$();
      return Unit;
    };
  }
  function BufferManager$deletePage$lambda(closure$pageid, closure$call_location, this$BufferManager) {
    return function () {
      ...
      this$BufferManager.allPagesRefcounters_8be2vx$[closure$pageid] = 0;
      SanityCheckOn_getInstance().check_8i7tro$(BufferManager$deletePage$lambda$lambda_3(this$BufferManager, closure$pageid));
      BufferManagerPage_getInstance().setPageID_pao7sd$(this$BufferManager.allPages_8be2vx$[closure$pageid], -1);
      SanityCheckOn_getInstance().invoke_ls4sck$(BufferManager$deletePage$lambda$lambda_4(this$BufferManager, closure$pageid));
      if (this$BufferManager.freeListSize_8be2vx$ === this$BufferManager.freeList_8be2vx$.length) {
        var tmp = new Int32Array(this$BufferManager.freeListSize_8be2vx$ * 2 | 0);
        var $receiver = this$BufferManager.freeList_8be2vx$;
        arrayCopy($receiver, tmp, 0, 0, $receiver.length);
        this$BufferManager.freeList_8be2vx$ = tmp;
      }this$BufferManager.freeList_8be2vx$[tmp$ = this$BufferManager.freeListSize_8be2vx$, this$BufferManager.freeListSize_8be2vx$ = tmp$ + 1 | 0, tmp$] = closure$pageid;
      return Unit;
    };
  }
  BufferManager.prototype.deletePage_bm4lxs$ = function (call_location, pageid) {
    this.lock_8be2vx$.withWriteLock_i3ch5z$(BufferManager$deletePage$lambda(pageid, call_location, this));
  };
  ...
  function BufferManagerExt() {
    ...
    this.bufferManager_8be2vx$ = new BufferManager();
  }
  BufferManagerExt.prototype.getBuffermanager = function () {
    return this.bufferManager_8be2vx$;
  };
  BufferManagerExt.prototype.close = function () {
    this.bufferManager_8be2vx$.close();
  };
  ...
  function MyIntArray(filename, initialize) {
    ...
    this.bufferManagerPage_8be2vx$ = null;
    this.closed_8be2vx$ = false;
    this.lock_8be2vx$ = new MyThreadReadWriteLock();
    this.data_8be2vx$ = new Int32Array(0);
    this._size_8be2vx$ = 0;
  }
  MyIntArray.prototype.getSize = function () {
    return this._size_8be2vx$;
  };
  function MyIntArray$get$lambda(this$MyIntArray) {
    return function () {
      return !this$MyIntArray.closed_8be2vx$;
    };
  }
  ...
  function MyIntArray$get$lambda_1(closure$idx, this$MyIntArray) {
    return function () {
      return closure$idx < this$MyIntArray._size_8be2vx$;
    };
  }
  function MyIntArray$get$lambda_2(this$MyIntArray, closure$idx, closure$res) {
    return function () {
      closure$res.v = this$MyIntArray.data_8be2vx$[closure$idx];
      return Unit;
    };
  }
  MyIntArray.prototype.get_za3lpa$ = function (idx) {
    ...
    var res = {v: 0};
    this.lock_8be2vx$.withReadLock_i3ch5z$(MyIntArray$get$lambda_2(this, idx, res));
    return res.v;
  };
  ...
  function MyIntArray$set$lambda_2(closure$value, this$MyIntArray, closure$idx) {
    return function () {
      this$MyIntArray.data_8be2vx$[closure$idx] = closure$value;
      return Unit;
    };
  }
  MyIntArray.prototype.set_vux9f0$ = function (idx, value) {
    ...
    this.lock_8be2vx$.withWriteLock_i3ch5z$(MyIntArray$set$lambda_2(value, this, idx));
  };
  ...
  function MyIntArray$setSize$lambda_0(this$MyIntArray, closure$size, closure$clean) {
    return function () {
      var tmp$, tmp$_0;
      if (this$MyIntArray.data_8be2vx$.length < closure$size) {
        var a = this$MyIntArray._size_8be2vx$;
        var newSize = Math_0.max(a, 1);
        while (newSize < closure$size) {
          newSize = newSize * 2 | 0;
        }
        var newData = new Int32Array(newSize);
        if (this$MyIntArray._size_8be2vx$ < newSize) {
          arrayCopy(this$MyIntArray.data_8be2vx$, newData, 0, 0, this$MyIntArray._size_8be2vx$);
        } else {
          arrayCopy(this$MyIntArray.data_8be2vx$, newData, 0, 0, newSize);
        }
        this$MyIntArray.data_8be2vx$ = newData;
      } else if (closure$clean) {
        tmp$ = this$MyIntArray._size_8be2vx$;
        tmp$_0 = closure$size;
        for (var i = tmp$; i < tmp$_0; i++) {
          this$MyIntArray.data_8be2vx$[i] = 0;
        }
      }this$MyIntArray._size_8be2vx$ = closure$size;
      return Unit;
    };
  }
  MyIntArray.prototype.setSize_fzusl$ = function (size, clean) {
    ...
    if (size !== this._size_8be2vx$) {
      this.lock_8be2vx$.withWriteLock_i3ch5z$(MyIntArray$setSize$lambda_0(this, size, clean));
    }};
  ...
  function MyIntArray$setSize$lambda_2(this$MyIntArray, closure$size) {
    return function () {
      if (this$MyIntArray.data_8be2vx$.length < closure$size) {
        var a = this$MyIntArray._size_8be2vx$;
        var newSize = Math_0.max(a, 1);
        ...
        var newData = new Int32Array(newSize);
        if (this$MyIntArray._size_8be2vx$ < newSize) {
          var $receiver = this$MyIntArray.data_8be2vx$;
  ...
  MyIntArray.prototype.setSize_za3lpa$ = function (size) {
    ...
    if (size !== this._size_8be2vx$) {
      this.lock_8be2vx$.withWriteLock_i3ch5z$(MyIntArray$setSize$lambda_2(this, size));
    }};
  ...
  MyIntArray.prototype.delete = function () {
    ...
    this.close();
    if (this.bufferManagerPage_8be2vx$ != null) {
      (tmp$ = this.bufferManager_8be2vx$) != null ? tmp$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_buffer_manager_inmemory/src/commonMain/kotlin/lupos/buffer_manager/MyIntArray.kt:128', ensureNotNull(this.bufferManagerPage_8be2vx$)) : null;
      (tmp$_0 = this.bufferManager_8be2vx$) != null ? (tmp$_0.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_buffer_manager_inmemory/src/commonMain/kotlin/lupos/buffer_manager/MyIntArray.kt:129', ensureNotNull(this.bufferManagerPage_8be2vx$)), Unit) : null;
      this.bufferManager_8be2vx$ = null;
      this.bufferManagerPage_8be2vx$ = null;
    }};
  MyIntArray.$metadata$ = {
  ...
  function MyIntArray_init(bufferManager, id, initialize, $this) {
    ...
    $this.bufferManagerPage_8be2vx$ = id;
    return $this;
  }
  ...
  var package$buffer_manager = package$lupos.buffer_manager || (package$lupos.buffer_manager = {});
  package$buffer_manager.BufferManager = BufferManager;
  Object.defineProperty(package$buffer_manager, 'BufferManagerExt', {
    get: BufferManagerExt_getInstance
  });
  package$buffer_manager.MyIntArray_init_b7rl13$ = MyIntArray_init;
  package$buffer_manager.MyIntArray = MyIntArray;
  ...
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, 'BufferManagerPage', {
    get: BufferManagerPage_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, 'ColumnIteratorQueueExt', {
    get: ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, 'DictionaryHelper', {
    get: DictionaryHelper_getInstance
  });
  var package$dynamicArray = package$Luposdate3000_Buffer_Manager_Inmemory.dynamicArray || (package$Luposdate3000_Buffer_Manager_Inmemory.dynamicArray = {});
  ...
  package$Luposdate3000_Buffer_Manager_Inmemory.MyInputStreamFixedLength = MyInputStreamFixedLength;
  package$Luposdate3000_Buffer_Manager_Inmemory.MyStringStream = MyStringStream;
  ...
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, 'ByteArrayHelper', {
    get: ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Buffer_Manager_Inmemory.DateHelper_init = DateHelper_init;
  package$Luposdate3000_Buffer_Manager_Inmemory.DateHelper = DateHelper;
  package$Luposdate3000_Buffer_Manager_Inmemory.File_init_61zpoe$ = File_init;
  package$Luposdate3000_Buffer_Manager_Inmemory.File = File;
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, 'IntegerExt', {
    get: IntegerExt_getInstance
  });
  package$Luposdate3000_Buffer_Manager_Inmemory.MyInputStream_init_y4putb$ = MyInputStream_init;
  package$Luposdate3000_Buffer_Manager_Inmemory.MyInputStream_init_kcn2v3$ = MyInputStream_init_0;
  package$Luposdate3000_Buffer_Manager_Inmemory.MyInputStream = MyInputStream;
  package$Luposdate3000_Buffer_Manager_Inmemory.MyOutputStream_init_8be2vx$ = MyOutputStream_init;
  package$Luposdate3000_Buffer_Manager_Inmemory.MyOutputStream = MyOutputStream;
  package$Luposdate3000_Buffer_Manager_Inmemory.MyPrintWriter_init_6taknv$ = MyPrintWriter_init;
  package$Luposdate3000_Buffer_Manager_Inmemory.MyPrintWriter = MyPrintWriter;
  ...
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, 'Platform', {
