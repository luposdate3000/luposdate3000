(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Buffer_Manager'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'Luposdate3000_Buffer_Manager'.");
    }if (typeof Luposdate3000_Shared === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Buffer_Manager'. Its dependency 'Luposdate3000_Shared' was not found. Please, check whether 'Luposdate3000_Shared' is loaded prior to 'Luposdate3000_Buffer_Manager'.");
    }if (typeof this['KotlinBigInteger-bignum-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Buffer_Manager'. Its dependency 'KotlinBigInteger-bignum-jsLegacy' was not found. Please, check whether 'KotlinBigInteger-bignum-jsLegacy' is loaded prior to 'Luposdate3000_Buffer_Manager'.");
    }if (typeof Luposdate3000_Shared_JS === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Buffer_Manager'. Its dependency 'Luposdate3000_Shared_JS' was not found. Please, check whether 'Luposdate3000_Shared_JS' is loaded prior to 'Luposdate3000_Buffer_Manager'.");
    }root.Luposdate3000_Buffer_Manager = factory(typeof Luposdate3000_Buffer_Manager === 'undefined' ? {} : Luposdate3000_Buffer_Manager, kotlin, Luposdate3000_Shared, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared_JS);
  }
  ...
  var createBufferManagerPage = $module$Luposdate3000_Shared.lupos.buffermanager.createBufferManagerPage;
  var sum = Kotlin.kotlin.collections.sum_tmsbgo$;
  ...
  function BufferManager(name) {
    this.name = name;
    var array = Array_0(100);
    var tmp$;
    tmp$ = array.length - 1 | 0;
    for (var i = 0; i <= tmp$; i++) {
      array[i] = createBufferManagerPage();
    }
    this.allPages_0 = array;
    this.allPagesRefcounters_0 = new Int32Array(100);
    this.counter_0 = 0;
    this.lock_0 = new MyThreadReadWriteLock();
    this.freeList_0 = ArrayList_init();
  }
  function BufferManager$clearAssumeLocks$lambda$lambda(this$BufferManager, closure$i) {
    return function () {
      return this$BufferManager.allPagesRefcounters_0[closure$i] === 0;
    };
  }
  function BufferManager$clearAssumeLocks$lambda$lambda_0(closure$i, this$BufferManager) {
    return function () {
      return 'Failed requirement allPagesRefcounters[' + closure$i + '] = ' + this$BufferManager.allPagesRefcounters_0[closure$i] + ' == 0';
    };
  }
  function BufferManager$clearAssumeLocks$lambda(this$BufferManager) {
    return function () {
      var tmp$;
      tmp$ = this$BufferManager.counter_0;
      for (var i = 0; i < tmp$; i++) {
        SanityCheckOn_getInstance().check_a3x0x2$(BufferManager$clearAssumeLocks$lambda$lambda(this$BufferManager, i), BufferManager$clearAssumeLocks$lambda$lambda_0(i, this$BufferManager));
      }
      return Unit;
    };
  }
  BufferManager.prototype.clearAssumeLocks_0 = function () {
    this.counter_0 = 0;
    SanityCheckOn_getInstance().invoke_ls4sck$(BufferManager$clearAssumeLocks$lambda(this));
    var array = Array_0(100);
    var tmp$;
    tmp$ = array.length - 1 | 0;
    for (var i = 0; i <= tmp$; i++) {
    ...
    if (BUFFER_MANAGER_USE_FREE_LIST) {
      this.freeList_0.clear();
    }};
  BufferManager.prototype.getNumberOfAllocatedPages = function () {
    return this.counter_0 - this.freeList_0.size | 0;
  };
  function BufferManager$getNumberOfReferencedPages$lambda$lambda(closure$tmp) {
    return function () {
      return 'getNumberOfReferencedPages = ' + closure$tmp;
    };
  }
  function BufferManager$getNumberOfReferencedPages$lambda(this$BufferManager) {
    return function () {
      var tmp$;
      var tmp = LinkedHashMap_init();
      tmp$ = this$BufferManager.counter_0;
      for (var i = 0; i < tmp$; i++) {
        if (this$BufferManager.allPagesRefcounters_0[i] !== 0) {
          var value = this$BufferManager.allPagesRefcounters_0[i];
          tmp.put_xwzc9p$(i, value);
        }}
      SanityCheckOn_getInstance().println_buffermanager_lh572t$(BufferManager$getNumberOfReferencedPages$lambda$lambda(tmp));
      return Unit;
    };
  }
  BufferManager.prototype.getNumberOfReferencedPages = function () {
    var res = sum(this.allPagesRefcounters_0);
    SanityCheckOn_getInstance().invoke_ls4sck$(BufferManager$getNumberOfReferencedPages$lambda(this));
    return res;
  };
  function BufferManager$flushPage$lambda(closure$pageid, closure$call_location) {
    return function () {
      return 'BufferManager.flushPage(' + closure$pageid + ') : ' + closure$call_location;
    };
  }
  BufferManager.prototype.flushPage_bm4lxs$ = function (call_location, pageid) {
    SanityCheckOn_getInstance().println_buffermanager_lh572t$(BufferManager$flushPage$lambda(pageid, call_location));
  };
  function BufferManager$releasePage$lambda(closure$pageid, closure$call_location) {
    return function () {
      return 'BufferManager.releasePage(' + closure$pageid + ') : ' + closure$call_location;
    };
  }
  function BufferManager$releasePage$lambda_0(this$BufferManager, closure$pageid) {
    return function () {
      return this$BufferManager.allPagesRefcounters_0[closure$pageid] > 0;
    };
  }
  function BufferManager$releasePage$lambda_1(closure$pageid, this$BufferManager) {
    return function () {
      return 'Failed requirement allPagesRefcounters[' + closure$pageid + '] = ' + this$BufferManager.allPagesRefcounters_0[closure$pageid] + ' > 0';
    };
  }
  BufferManager.prototype.releasePage_bm4lxs$ = function (call_location, pageid) {
    SanityCheckOn_getInstance().println_buffermanager_lh572t$(BufferManager$releasePage$lambda(pageid, call_location));
    SanityCheckOn_getInstance().check_a3x0x2$(BufferManager$releasePage$lambda_0(this, pageid), BufferManager$releasePage$lambda_1(pageid, this));
    var tmp$;
    tmp$ = this.allPagesRefcounters_0;
    tmp$[pageid] = tmp$[pageid] - 1 | 0;
  };
  function BufferManager$getPage$lambda(closure$pageid, closure$call_location) {
    return function () {
      return 'BufferManager.getPage(' + closure$pageid + ') : ' + closure$call_location;
    };
  }
  function BufferManager$getPage$lambda$lambda(closure$pageid, this$BufferManager) {
    return function () {
      return closure$pageid < this$BufferManager.counter_0;
    };
  }
  function BufferManager$getPage$lambda$lambda_0(closure$pageid, this$BufferManager) {
    return function () {
      return closure$pageid.toString() + ' < ' + this$BufferManager.counter_0;
    };
  }
  function BufferManager$getPage$lambda$lambda_1(closure$pageid) {
    return function () {
      return closure$pageid >= 0;
    };
  }
  function BufferManager$getPage$lambda$lambda_2(closure$pageid) {
    return function () {
      return closure$pageid.toString() + ' >= 0';
    };
  }
  function BufferManager$getPage$lambda$lambda_3(this$BufferManager, closure$pageid) {
    return function () {
      return !this$BufferManager.freeList_0.contains_11rb$(closure$pageid);
    };
  }
  function BufferManager$getPage$lambda_0(closure$pageid, this$BufferManager) {
    return function () {
      SanityCheckOn_getInstance().check_a3x0x2$(BufferManager$getPage$lambda$lambda(closure$pageid, this$BufferManager), BufferManager$getPage$lambda$lambda_0(closure$pageid, this$BufferManager));
      SanityCheckOn_getInstance().check_a3x0x2$(BufferManager$getPage$lambda$lambda_1(closure$pageid), BufferManager$getPage$lambda$lambda_2(closure$pageid));
      if (BUFFER_MANAGER_USE_FREE_LIST) {
        SanityCheckOn_getInstance().check_8i7tro$(BufferManager$getPage$lambda$lambda_3(this$BufferManager, closure$pageid));
      }return Unit;
    };
  }
  function BufferManager$getPage$lambda_1(this$BufferManager, closure$pageid) {
    return function () {
      return this$BufferManager.allPages_0[closure$pageid].getPageID() === closure$pageid;
    };
  }
  BufferManager.prototype.getPage_bm4lxs$ = function (call_location, pageid) {
    SanityCheckOn_getInstance().println_buffermanager_lh572t$(BufferManager$getPage$lambda(pageid, call_location));
    SanityCheckOn_getInstance().invoke_ls4sck$(BufferManager$getPage$lambda_0(pageid, this));
    SanityCheckOn_getInstance().check_8i7tro$(BufferManager$getPage$lambda_1(this, pageid));
    var tmp$;
    tmp$ = this.allPagesRefcounters_0;
    tmp$[pageid] = tmp$[pageid] + 1 | 0;
    return this.allPages_0[pageid];
  };
  function BufferManager$allocPage$lambda$lambda(this$BufferManager, closure$pageid) {
    return function () {
      return this$BufferManager.allPages_0[closure$pageid.v].getPageID() === -1;
    };
  }
  function BufferManager$allocPage$lambda$lambda_0(this$BufferManager, closure$pageid) {
    return function () {
      return this$BufferManager.allPages_0[closure$pageid.v].getPageID().toString();
    };
  }
  function BufferManager$allocPage$lambda(this$BufferManager, closure$pageid) {
    return function () {
      var tmp$;
      if (this$BufferManager.freeList_0.size > 0 && BUFFER_MANAGER_USE_FREE_LIST) {
        closure$pageid.v = this$BufferManager.freeList_0.removeAt_za3lpa$(0);
      } else {
        if (this$BufferManager.counter_0 === this$BufferManager.allPages_0.length) {
          var size = this$BufferManager.counter_0 * 2 | 0;
          if (size < 100) {
            size = 100;
          } else if (this$BufferManager.counter_0 > 1000) {
            size = this$BufferManager.counter_0 + 1000 | 0;
          }var size_0 = size;
          var array = Array_0(size_0);
          var tmp$_0;
          tmp$_0 = array.length - 1 | 0;
          for (var i = 0; i <= tmp$_0; i++) {
            var this$BufferManager_0 = this$BufferManager;
            var tmp$_1;
            if (i < this$BufferManager_0.counter_0) {
              tmp$_1 = this$BufferManager_0.allPages_0[i];
            } else {
              tmp$_1 = createBufferManagerPage();
            }
            var res = tmp$_1;
            array[i] = res;
          }
          var tmp = array;
          var tmp2 = new Int32Array(size);
          var $receiver = this$BufferManager.allPagesRefcounters_0;
          arrayCopy($receiver, tmp2, 0, 0, $receiver.length);
          this$BufferManager.allPages_0 = tmp;
          this$BufferManager.allPagesRefcounters_0 = tmp2;
        }closure$pageid.v = (tmp$ = this$BufferManager.counter_0, this$BufferManager.counter_0 = tmp$ + 1 | 0, tmp$);
      }
      SanityCheckOn_getInstance().check_a3x0x2$(BufferManager$allocPage$lambda$lambda(this$BufferManager, closure$pageid), BufferManager$allocPage$lambda$lambda_0(this$BufferManager, closure$pageid));
      this$BufferManager.allPages_0[closure$pageid.v].setPageID_za3lpa$(closure$pageid.v);
      return Unit;
    };
  }
  function BufferManager$allocPage$lambda_0(closure$pageid, closure$call_location) {
    return function () {
      return 'BufferManager.allocPage(' + closure$pageid.v + ') : ' + closure$call_location;
    };
  }
  BufferManager.prototype.allocPage_61zpoe$ = function (call_location) {
    var pageid = {v: 0};
    this.lock_0.withWriteLock_i3ch5z$(BufferManager$allocPage$lambda(this, pageid));
    SanityCheckOn_getInstance().println_buffermanager_lh572t$(BufferManager$allocPage$lambda_0(pageid, call_location));
    return pageid.v;
  };
  function BufferManager$createPage$lambda(closure$pageid, closure$call_location) {
    return function () {
      return 'BufferManager.createPage(' + closure$pageid + ') : ' + closure$call_location;
    };
  }
  BufferManager.prototype.createPage_5otl51$ = function (call_location, action) {
    var pageid = this.allocPage_61zpoe$(call_location);
    var tmp$;
    tmp$ = this.allPagesRefcounters_0;
    tmp$[pageid] = tmp$[pageid] + 1 | 0;
    SanityCheckOn_getInstance().println_buffermanager_lh572t$(BufferManager$createPage$lambda(pageid, call_location));
    action(this.allPages_0[pageid], pageid);
  };
  function BufferManager$deletePage$lambda$lambda(closure$pageid, closure$call_location) {
    return function () {
      return 'BufferManager.deletePage(' + closure$pageid + ') : ' + closure$call_location;
    };
  }
  function BufferManager$deletePage$lambda$lambda$lambda(this$BufferManager, closure$pageid) {
    return function () {
      return !this$BufferManager.freeList_0.contains_11rb$(closure$pageid);
    };
  }
  function BufferManager$deletePage$lambda$lambda_0(this$BufferManager, closure$pageid) {
    return function () {
      if (BUFFER_MANAGER_USE_FREE_LIST) {
        SanityCheckOn_getInstance().check_8i7tro$(BufferManager$deletePage$lambda$lambda$lambda(this$BufferManager, closure$pageid));
      }return Unit;
    };
  }
  function BufferManager$deletePage$lambda$lambda_1(this$BufferManager, closure$pageid) {
    return function () {
      return this$BufferManager.allPagesRefcounters_0[closure$pageid] === 1;
    };
  }
  function BufferManager$deletePage$lambda$lambda_2(closure$pageid, this$BufferManager) {
    return function () {
      return 'Failed requirement allPagesRefcounters[' + closure$pageid + '] = ' + this$BufferManager.allPagesRefcounters_0[closure$pageid] + ' == 1';
    };
  }
  function BufferManager$deletePage$lambda$lambda_3(this$BufferManager, closure$pageid) {
    return function () {
      return this$BufferManager.allPages_0[closure$pageid].getPageID() === closure$pageid;
    };
  }
  function BufferManager$deletePage$lambda$lambda_4(this$BufferManager, closure$pageid) {
    return function () {
      this$BufferManager.allPages_0[closure$pageid] = createBufferManagerPage();
      return Unit;
    };
  }
  function BufferManager$deletePage$lambda(closure$pageid, closure$call_location, this$BufferManager) {
    return function () {
      SanityCheckOn_getInstance().println_buffermanager_lh572t$(BufferManager$deletePage$lambda$lambda(closure$pageid, closure$call_location));
      SanityCheckOn_getInstance().invoke_ls4sck$(BufferManager$deletePage$lambda$lambda_0(this$BufferManager, closure$pageid));
      SanityCheckOn_getInstance().check_a3x0x2$(BufferManager$deletePage$lambda$lambda_1(this$BufferManager, closure$pageid), BufferManager$deletePage$lambda$lambda_2(closure$pageid, this$BufferManager));
      this$BufferManager.allPagesRefcounters_0[closure$pageid] = 0;
      SanityCheckOn_getInstance().check_8i7tro$(BufferManager$deletePage$lambda$lambda_3(this$BufferManager, closure$pageid));
      this$BufferManager.allPages_0[closure$pageid].setPageID_za3lpa$(-1);
      SanityCheckOn_getInstance().invoke_ls4sck$(BufferManager$deletePage$lambda$lambda_4(this$BufferManager, closure$pageid));
      if (BUFFER_MANAGER_USE_FREE_LIST) {
        this$BufferManager.freeList_0.add_11rb$(closure$pageid);
        if (this$BufferManager.freeList_0.size === this$BufferManager.counter_0) {
          this$BufferManager.clearAssumeLocks_0();
        }} else {
        if (this$BufferManager.counter_0 === 0) {
          this$BufferManager.clearAssumeLocks_0();
        }}
      return Unit;
    };
  }
  BufferManager.prototype.deletePage_bm4lxs$ = function (call_location, pageid) {
    this.lock_0.withWriteLock_i3ch5z$(BufferManager$deletePage$lambda(pageid, call_location, this));
  };
  function BufferManager$close$lambda$lambda(closure$allErrors) {
    return function () {
      return closure$allErrors.size === 0;
    };
  }
  function BufferManager$close$lambda$lambda_0(closure$allErrors) {
    return function () {
      return closure$allErrors.toString();
    };
  }
  function BufferManager$close$lambda(this$BufferManager) {
    return function () {
      var tmp$;
      var allErrors = LinkedHashMap_init();
      tmp$ = this$BufferManager.counter_0;
      for (var i = 0; i < tmp$; i++) {
        if (this$BufferManager.allPagesRefcounters_0[i] !== 0) {
          var value = this$BufferManager.allPagesRefcounters_0[i];
          allErrors.put_xwzc9p$(i, value);
        }}
      SanityCheckOn_getInstance().check_a3x0x2$(BufferManager$close$lambda$lambda(allErrors), BufferManager$close$lambda$lambda_0(allErrors));
      return Unit;
    };
  }
  BufferManager.prototype.close = function () {
    SanityCheckOn_getInstance().invoke_ls4sck$(BufferManager$close$lambda(this));
  };
  ...
  function BufferManager_init($this) {
    $this = $this || Object.create(BufferManager.prototype);
    BufferManager.call($this, '');
    return $this;
  }
  function BufferManagerExt() {
    BufferManagerExt_instance = this;
    this.isInMemoryOnly = true;
    this.allowInitFromDisk = false;
    this.bufferPrefix = ensureNotNull(_Platform_getInstance().getEnv_9lovpo$('LUPOS_HOME', '/tmp/luposdate3000/'));
    this.managerList_8be2vx$ = LinkedHashMap_init();
    this.managerListLock_8be2vx$ = new MyThreadReadWriteLock();
  }
  function BufferManagerExt$getBuffermanager$lambda(this$BufferManagerExt, closure$name, closure$res) {
    return function () {
      closure$res.v = this$BufferManagerExt.managerList_8be2vx$.get_11rb$(closure$name);
      if (closure$res.v == null) {
        closure$res.v = new BufferManager(closure$name);
        var $receiver = this$BufferManagerExt.managerList_8be2vx$;
  ...
  BufferManagerExt.prototype.getBuffermanager_61zpoe$ = function (name) {
    var res = {v: null};
    this.managerListLock_8be2vx$.withWriteLock_i3ch5z$(BufferManagerExt$getBuffermanager$lambda(this, name, res));
    return ensureNotNull(res.v);
  };
  function BufferManagerExt$close$lambda(this$BufferManagerExt) {
    return function () {
      var tmp$;
      tmp$ = this$BufferManagerExt.managerList_8be2vx$.values.iterator();
      while (tmp$.hasNext()) {
        var v = tmp$.next();
        v.close();
      }
  ...
  BufferManagerExt.prototype.close = function () {
    this.managerListLock_8be2vx$.withWriteLock_i3ch5z$(BufferManagerExt$close$lambda(this));
  };
  BufferManagerExt.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'BufferManagerExt',
    interfaces: []
  };
  var BufferManagerExt_instance = null;
  function BufferManagerExt_getInstance() {
    if (BufferManagerExt_instance === null) {
      new BufferManagerExt();
    }return BufferManagerExt_instance;
  }
  function MyIntArray(filename, initialize) {
    this.filename_0 = filename;
    this.bufferManager_0 = null;
    this.bufferManagerPage_0 = null;
    this.closed_0 = false;
    this.lock_0 = new MyThreadReadWriteLock();
    this.data_0 = new Int32Array(0);
  }
  MyIntArray.prototype.getSize = function () {
    return this.data_0.length;
  };
  function MyIntArray$get$lambda(this$MyIntArray) {
    return function () {
      return !this$MyIntArray.closed_0;
    };
  }
  function MyIntArray$get$lambda_0(closure$idx) {
    return function () {
      return closure$idx >= 0;
    };
  }
  function MyIntArray$get$lambda_1(closure$idx, this$MyIntArray) {
    return function () {
      return closure$idx < this$MyIntArray.data_0.length;
    };
  }
  function MyIntArray$get$lambda_2(this$MyIntArray, closure$idx, closure$res) {
    return function () {
      closure$res.v = this$MyIntArray.data_0[closure$idx];
      return Unit;
    };
  }
  MyIntArray.prototype.get_za3lpa$ = function (idx) {
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$get$lambda(this));
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$get$lambda_0(idx));
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$get$lambda_1(idx, this));
    var res = {v: 0};
    this.lock_0.withReadLock_i3ch5z$(MyIntArray$get$lambda_2(this, idx, res));
    return res.v;
  };
  function MyIntArray$set$lambda(this$MyIntArray) {
    return function () {
      return !this$MyIntArray.closed_0;
    };
  }
  function MyIntArray$set$lambda_0(closure$idx) {
    return function () {
      return closure$idx >= 0;
    };
  }
  function MyIntArray$set$lambda_1(closure$idx, this$MyIntArray) {
    return function () {
      return closure$idx < this$MyIntArray.data_0.length;
    };
  }
  function MyIntArray$set$lambda_2(closure$value, this$MyIntArray, closure$idx) {
    return function () {
      this$MyIntArray.data_0[closure$idx] = closure$value;
      return Unit;
    };
  }
  MyIntArray.prototype.set_vux9f0$ = function (idx, value) {
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$set$lambda(this));
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$set$lambda_0(idx));
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$set$lambda_1(idx, this));
    this.lock_0.withWriteLock_i3ch5z$(MyIntArray$set$lambda_2(value, this, idx));
  };
  function MyIntArray$setSize$lambda(this$MyIntArray) {
    return function () {
      return !this$MyIntArray.closed_0;
    };
  }
  function MyIntArray$setSize$lambda_0(closure$size, this$MyIntArray) {
    return function () {
      var newData = new Int32Array(closure$size);
      if (this$MyIntArray.data_0.length < newData.length) {
        var $receiver = this$MyIntArray.data_0;
        arrayCopy($receiver, newData, 0, 0, $receiver.length);
      } else {
        arrayCopy(this$MyIntArray.data_0, newData, 0, 0, newData.length);
      }
      this$MyIntArray.data_0 = newData;
      return Unit;
    };
  }
  MyIntArray.prototype.setSize_fzusl$ = function (size, clean) {
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$setSize$lambda(this));
    if (size !== this.data_0.length) {
      this.lock_0.withWriteLock_i3ch5z$(MyIntArray$setSize$lambda_0(size, this));
    }};
  function MyIntArray$setSize$lambda_1(this$MyIntArray) {
    return function () {
      return !this$MyIntArray.closed_0;
    };
  }
  function MyIntArray$setSize$lambda_2(closure$size, this$MyIntArray) {
    return function () {
      var newData = new Int32Array(closure$size);
      if (this$MyIntArray.data_0.length < newData.length) {
        var $receiver = this$MyIntArray.data_0;
  ...
  MyIntArray.prototype.setSize_za3lpa$ = function (size) {
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$setSize$lambda_1(this));
    if (size !== this.data_0.length) {
      this.lock_0.withWriteLock_i3ch5z$(MyIntArray$setSize$lambda_2(size, this));
    }};
  function MyIntArray$close$lambda(this$MyIntArray) {
    return function () {
      return !this$MyIntArray.closed_0;
    };
  }
  MyIntArray.prototype.close = function () {
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$close$lambda(this));
    this.closed_0 = true;
  };
  function MyIntArray$delete$lambda(this$MyIntArray) {
    return function () {
      return !this$MyIntArray.closed_0;
    };
  }
  MyIntArray.prototype.delete = function () {
    var tmp$, tmp$_0;
    SanityCheckOn_getInstance().check_8i7tro$(MyIntArray$delete$lambda(this));
    this.close();
    if (this.bufferManagerPage_0 != null) {
      (tmp$ = this.bufferManager_0) != null ? tmp$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_buffer_manager_inmemory/src/commonMain/kotlin/lupos/buffermanager/MyIntArray.kt:99', ensureNotNull(this.bufferManagerPage_0)) : null;
      (tmp$_0 = this.bufferManager_0) != null ? (tmp$_0.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_buffer_manager_inmemory/src/commonMain/kotlin/lupos/buffermanager/MyIntArray.kt:100', ensureNotNull(this.bufferManagerPage_0)), Unit) : null;
      this.bufferManager_0 = null;
      this.bufferManagerPage_0 = null;
    }};
  MyIntArray.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'MyIntArray',
    interfaces: []
  };
  function MyIntArray_init(bufferManager, id, initialize, $this) {
    $this = $this || Object.create(MyIntArray.prototype);
    MyIntArray.call($this, '', initialize);
    $this.bufferManager_0 = bufferManager;
    $this.bufferManagerPage_0 = id;
    return $this;
  }
  ...
  var BUFFER_MANAGER_USE_FREE_LIST;
  ...
  package$buffermanager.BufferManager_init = BufferManager_init;
  package$buffermanager.BufferManager = BufferManager;
  Object.defineProperty(package$buffermanager, 'BufferManagerExt', {
    get: BufferManagerExt_getInstance
  });
  package$buffermanager.MyIntArray_init_7gacri$ = MyIntArray_init;
  package$buffermanager.MyIntArray = MyIntArray;
  var package$Luposdate3000_Buffer_Manager_Inmemory = package$lupos.Luposdate3000_Buffer_Manager_Inmemory || (package$lupos.Luposdate3000_Buffer_Manager_Inmemory = {});
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, '_ColumnIteratorQueueExt', {
    get: _ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, '_DictionaryHelper', {
    get: _DictionaryHelper_getInstance
  });
  package$Luposdate3000_Buffer_Manager_Inmemory._MyInputStreamFixedLength = _MyInputStreamFixedLength;
  package$Luposdate3000_Buffer_Manager_Inmemory._MyStringStream = _MyStringStream;
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, '_PartitionExt', {
    get: _PartitionExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, 'SanityCheckOff', {
    get: SanityCheckOff_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, 'SanityCheckOn', {
    get: SanityCheckOn_getInstance
  });
  var package$s00misc = package$lupos.s00misc || (package$lupos.s00misc = {});
  Object.defineProperty(package$s00misc, 'BUFFER_MANAGER_USE_FREE_LIST_8be2vx$', {
    get: function () {
      return BUFFER_MANAGER_USE_FREE_LIST;
    }
  });
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, '_ByteArrayHelper', {
    get: _ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Buffer_Manager_Inmemory._DateHelper_init = _DateHelper_init;
  package$Luposdate3000_Buffer_Manager_Inmemory._DateHelper = _DateHelper;
  package$Luposdate3000_Buffer_Manager_Inmemory._File_init_61zpoe$ = _File_init;
  package$Luposdate3000_Buffer_Manager_Inmemory._File = _File;
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, '_IntegerExt', {
    get: _IntegerExt_getInstance
  });
  package$Luposdate3000_Buffer_Manager_Inmemory._MyInputStream_init_y4putb$ = _MyInputStream_init;
  package$Luposdate3000_Buffer_Manager_Inmemory._MyInputStream_init_kcn2v3$ = _MyInputStream_init_0;
  package$Luposdate3000_Buffer_Manager_Inmemory._MyInputStream = _MyInputStream;
  package$Luposdate3000_Buffer_Manager_Inmemory._MyOutputStream_init_8be2vx$ = _MyOutputStream_init;
  package$Luposdate3000_Buffer_Manager_Inmemory._MyOutputStream = _MyOutputStream;
  package$Luposdate3000_Buffer_Manager_Inmemory._MyPrintWriter_init_6taknv$ = _MyPrintWriter_init;
  package$Luposdate3000_Buffer_Manager_Inmemory._MyPrintWriter = _MyPrintWriter;
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, '_Platform', {
  ...
  package$Luposdate3000_Buffer_Manager_Inmemory.MyThreadReadWriteLock = MyThreadReadWriteLock;
  Object.defineProperty(package$Luposdate3000_Buffer_Manager_Inmemory, 'ParallelThread', {
    get: ParallelThread_getInstance
  });
  package$Luposdate3000_Buffer_Manager_Inmemory.ParallelThreadCondition = ParallelThreadCondition;
  package$Luposdate3000_Buffer_Manager_Inmemory.ParallelThreadQueue_init_mh5how$ = ParallelThreadQueue_init;
  package$Luposdate3000_Buffer_Manager_Inmemory.ParallelThreadQueue = ParallelThreadQueue;
  BUFFER_MANAGER_USE_FREE_LIST = true;
  Kotlin.defineModule('Luposdate3000_Buffer_Manager', _);
  return _;
}));

//# sourceMappingURL=Luposdate3000_Buffer_Manager.js.map
