(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'Luposdate3000_Shared', 'Luposdate3000_Operator_Physical', 'Luposdate3000_Triple_Store_Manager', 'Luposdate3000_Operator_Base', 'Luposdate3000_Operator_Factory', 'KotlinBigInteger-bignum-jsLegacy', 'Luposdate3000_Shared_JS'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('Luposdate3000_Shared'), require('Luposdate3000_Operator_Physical'), require('Luposdate3000_Triple_Store_Manager'), require('Luposdate3000_Operator_Base'), require('Luposdate3000_Operator_Factory'), require('KotlinBigInteger-bignum-jsLegacy'), require('Luposdate3000_Shared_JS'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Optimizer_Distributed_Query'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'Luposdate3000_Optimizer_Distributed_Query'.");
    }if (typeof Luposdate3000_Shared === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Optimizer_Distributed_Query'. Its dependency 'Luposdate3000_Shared' was not found. Please, check whether 'Luposdate3000_Shared' is loaded prior to 'Luposdate3000_Optimizer_Distributed_Query'.");
    }if (typeof Luposdate3000_Operator_Physical === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Optimizer_Distributed_Query'. Its dependency 'Luposdate3000_Operator_Physical' was not found. Please, check whether 'Luposdate3000_Operator_Physical' is loaded prior to 'Luposdate3000_Optimizer_Distributed_Query'.");
    }if (typeof Luposdate3000_Triple_Store_Manager === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Optimizer_Distributed_Query'. Its dependency 'Luposdate3000_Triple_Store_Manager' was not found. Please, check whether 'Luposdate3000_Triple_Store_Manager' is loaded prior to 'Luposdate3000_Optimizer_Distributed_Query'.");
    }if (typeof Luposdate3000_Operator_Base === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Optimizer_Distributed_Query'. Its dependency 'Luposdate3000_Operator_Base' was not found. Please, check whether 'Luposdate3000_Operator_Base' is loaded prior to 'Luposdate3000_Optimizer_Distributed_Query'.");
    }if (typeof Luposdate3000_Operator_Factory === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Optimizer_Distributed_Query'. Its dependency 'Luposdate3000_Operator_Factory' was not found. Please, check whether 'Luposdate3000_Operator_Factory' is loaded prior to 'Luposdate3000_Optimizer_Distributed_Query'.");
    }if (typeof this['KotlinBigInteger-bignum-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Optimizer_Distributed_Query'. Its dependency 'KotlinBigInteger-bignum-jsLegacy' was not found. Please, check whether 'KotlinBigInteger-bignum-jsLegacy' is loaded prior to 'Luposdate3000_Optimizer_Distributed_Query'.");
    }if (typeof Luposdate3000_Shared_JS === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Optimizer_Distributed_Query'. Its dependency 'Luposdate3000_Shared_JS' was not found. Please, check whether 'Luposdate3000_Shared_JS' is loaded prior to 'Luposdate3000_Optimizer_Distributed_Query'.");
    }root.Luposdate3000_Optimizer_Distributed_Query = factory(typeof Luposdate3000_Optimizer_Distributed_Query === 'undefined' ? {} : Luposdate3000_Optimizer_Distributed_Query, kotlin, Luposdate3000_Shared, Luposdate3000_Operator_Physical, Luposdate3000_Triple_Store_Manager, Luposdate3000_Operator_Base, Luposdate3000_Operator_Factory, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared_JS);
  }
}(this, function (_, Kotlin, $module$Luposdate3000_Shared, $module$Luposdate3000_Operator_Physical, $module$Luposdate3000_Triple_Store_Manager, $module$Luposdate3000_Operator_Base, $module$Luposdate3000_Operator_Factory, $module$KotlinBigInteger_bignum_jsLegacy, $module$Luposdate3000_Shared_JS) {
  'use strict';
  ...
  var Partition_init_0 = $module$Luposdate3000_Shared.lupos.shared.Partition_init_ylttpy$;
  ...
  var POPSplitPartitionPassThrough = $module$Luposdate3000_Operator_Physical.lupos.operator.physical.partition.POPSplitPartitionPassThrough;
  ...
  var IDistributedOptimizer = $module$Luposdate3000_Shared.lupos.shared.optimizer.IDistributedOptimizer;
  ...
  function DistributedOptimizerAssignAnyChild() {
  }
  DistributedOptimizerAssignAnyChild.prototype.optimize_ps4byu$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    var tmp$;
    tmp$ = dependenciesTopDown.iterator();
    while (tmp$.hasNext()) {
      var s = tmp$.next();
      var tmp = keytoHostMapGet(s);
      if (tmp != null) {
        keytoHostMapSet(key, tmp);
        onChange();
      }}
  };
  DistributedOptimizerAssignAnyChild.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DistributedOptimizerAssignAnyChild',
    interfaces: [DistributedOptimizerBase]
  };
  function DistributedOptimizerAssignAnyParent() {
  }
  DistributedOptimizerAssignAnyParent.prototype.optimize_ps4byu$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    var tmp$;
    tmp$ = dependenciesBottomUp.iterator();
    while (tmp$.hasNext()) {
      var s = tmp$.next();
      var tmp = keytoHostMapGet(s);
      if (tmp != null) {
  ...
  DistributedOptimizerAssignAnyParent.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DistributedOptimizerAssignAnyParent',
    interfaces: [DistributedOptimizerBase]
  };
  function DistributedOptimizerAssignChild() {
  }
  DistributedOptimizerAssignChild.prototype.optimize_ps4byu$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    var tmp$;
    if (dependenciesTopDown.size > 0) {
      var possibleHost = keytoHostMapGet(first(dependenciesTopDown));
      if (possibleHost != null) {
        tmp$ = dependenciesTopDown.iterator();
        while (tmp$.hasNext()) {
          var s = tmp$.next();
          if (!equals(possibleHost, keytoHostMapGet(s))) {
            return;
          }}
        keytoHostMapSet(key, possibleHost);
        onChange();
      }}};
  DistributedOptimizerAssignChild.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DistributedOptimizerAssignChild',
    interfaces: [DistributedOptimizerBase]
  };
  function DistributedOptimizerAssignLocalhost() {
  }
  DistributedOptimizerAssignLocalhost.prototype.optimize_ps4byu$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    keytoHostMapSet(key, shared.tripleStoreManager.getLocalhost());
    onChange();
  };
  DistributedOptimizerAssignLocalhost.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DistributedOptimizerAssignLocalhost',
    interfaces: [DistributedOptimizerBase]
  };
  function DistributedOptimizerAssignParent() {
  }
  DistributedOptimizerAssignParent.prototype.optimize_ps4byu$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    var tmp$;
    if (dependenciesBottomUp.size > 0) {
      var possibleHost = keytoHostMapGet(first(dependenciesBottomUp));
      if (possibleHost != null) {
        tmp$ = dependenciesBottomUp.iterator();
        while (tmp$.hasNext()) {
          var s = tmp$.next();
  ...
  DistributedOptimizerAssignParent.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DistributedOptimizerAssignParent',
    interfaces: [DistributedOptimizerBase]
  };
  function DistributedOptimizerBase() {
  }
  DistributedOptimizerBase.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'DistributedOptimizerBase',
    interfaces: []
  };
  function DistributedOptimizerQuery() {
    this.query_8be2vx$ = null;
    this.operatorgraphParts_8be2vx$ = LinkedHashMap_init();
    this.operatorgraphPartsToHostMap_8be2vx$ = LinkedHashMap_init();
    this.dependenciesMapTopDown_8be2vx$ = LinkedHashMap_init();
    this.dependenciesMapBottomUp_8be2vx$ = LinkedHashMap_init();
    this.keyRepresentative_8be2vx$ = LinkedHashMap_init();
    this.childOptimizer_8be2vx$ = [[new DistributedOptimizerAssignChild(), new DistributedOptimizerAssignParent(), new DistributedOptimizerAssignAnyChild(), new DistributedOptimizerAssignAnyParent()], [new DistributedOptimizerAssignLocalhost()]];
  }
  function DistributedOptimizerQuery$splitPartitionsVariations$lambda(closure$allIdx) {
    return function () {
      return closure$allIdx.length === 1;
    };
  }
  function DistributedOptimizerQuery$splitPartitionsVariations$lambda_0(this$DistributedOptimizerQuery, closure$key, closure$target) {
    return function () {
      var $receiver = this$DistributedOptimizerQuery.operatorgraphPartsToHostMap_8be2vx$;
      var key = closure$key;
      var tmp$;
      return !(Kotlin.isType(tmp$ = $receiver, Map) ? tmp$ : throwCCE()).containsKey_11rb$(key) || equals(this$DistributedOptimizerQuery.operatorgraphPartsToHostMap_8be2vx$.get_11rb$(closure$key), closure$target);
    };
  }
  function DistributedOptimizerQuery$splitPartitionsVariations$lambda_1(closure$allIdx) {
    return function () {
      return closure$allIdx.length === 1;
    };
  }
  function DistributedOptimizerQuery$splitPartitionsVariations$lambda_2(this$DistributedOptimizerQuery, closure$key, closure$target) {
    return function () {
      var $receiver = this$DistributedOptimizerQuery.operatorgraphPartsToHostMap_8be2vx$;
      var key = closure$key;
      var tmp$;
  ...
  DistributedOptimizerQuery.prototype.splitPartitionsVariations_0 = function (node, allNames, allSize, allIdx, offset) {
    var tmp$, tmp$_0, tmp$_1;
    if (offset === allNames.length) {
      for (var i = 0; i < allNames.length; i++) {
        var $receiver = ensureNotNull(this.query_8be2vx$).allVariationsKey;
        var key = allNames[i];
        var value = allIdx[i];
        $receiver.put_xwzc9p$(key, value);
      }
      var xml = node.toXMLElementRoot_6taknv$(true);
      var keys = LinkedHashSet_init();
      tmp$ = xml.childs.iterator();
      while (tmp$.hasNext()) {
        var c = tmp$.next();
        if (equals(c.tag, 'partitionDistributionProvideKey')) {
          keys.add_11rb$(ensureNotNull(c.attributes.get_11rb$('key')));
        }}
      var key_0 = first(keys);
      if (keys.size > 1) {
        tmp$_0 = keys.iterator();
        while (tmp$_0.hasNext()) {
          var k = tmp$_0.next();
          this.keyRepresentative_8be2vx$.put_xwzc9p$(k, key_0);
        }
      }if (Kotlin.isType(node, POPSplitPartitionFromStore)) {
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitionsVariations$lambda(allIdx));
        var n = node;
        while (!Kotlin.isType(n, POPTripleStoreIterator)) {
          n = n.getChildren()[0];
        }
        var partition = Partition_init();
        for (var i_0 = 0; i_0 < allNames.length; i_0++) {
          partition = Partition_init_0(partition, allNames[i_0], allIdx[i_0], allSize[i_0]);
        }
        var target = n.getDesiredHostnameFor_t5uvj0$(partition);
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitionsVariations$lambda_0(this, key_0, target));
        this.operatorgraphPartsToHostMap_8be2vx$.put_xwzc9p$(key_0, target);
      }if (Kotlin.isType(node, POPSplitPartitionFromStoreCount)) {
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitionsVariations$lambda_1(allIdx));
        var n_0 = node;
        while (!Kotlin.isType(n_0, POPTripleStoreIterator)) {
          n_0 = n_0.getChildren()[0];
        }
        var partition_0 = Partition_init();
        for (var i_1 = 0; i_1 < allNames.length; i_1++) {
          partition_0 = Partition_init_0(partition_0, allNames[i_1], allIdx[i_1], allSize[i_1]);
        }
        var target_0 = n_0.getDesiredHostnameFor_t5uvj0$(partition_0);
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitionsVariations$lambda_2(this, key_0, target_0));
        this.operatorgraphPartsToHostMap_8be2vx$.put_xwzc9p$(key_0, target_0);
      }this.operatorgraphParts_8be2vx$.put_xwzc9p$(key_0, xml);
      ensureNotNull(this.query_8be2vx$).allVariationsKey.clear();
    } else {
      tmp$_1 = allSize[offset];
      for (var i_2 = 0; i_2 < tmp$_1; i_2++) {
        allIdx[offset] = i_2;
        this.splitPartitionsVariations_0(node, allNames, allSize, allIdx, offset + 1 | 0);
      }
    }
  };
  function DistributedOptimizerQuery$splitPartitions$lambda(closure$currentPartitionsCopy, closure$node) {
    return function () {
      return closure$currentPartitionsCopy.get_11rb$(closure$node.partitionVariable) == null;
    };
  }
  function DistributedOptimizerQuery$splitPartitions$lambda_0(closure$currentPartitionsCopy, closure$node) {
    return function () {
      return closure$currentPartitionsCopy.get_11rb$(closure$node.partitionVariable) == null;
    };
  }
  function DistributedOptimizerQuery$splitPartitions$lambda_1(closure$currentPartitionsCopy, closure$node) {
    return function () {
      return closure$currentPartitionsCopy.get_11rb$(closure$node.partitionVariable) == null;
    };
  }
  function DistributedOptimizerQuery$splitPartitions$lambda_2(closure$currentPartitionsCopy, closure$node) {
    return function () {
      return closure$currentPartitionsCopy.get_11rb$(closure$node.partitionVariable) === closure$node.partitionCountTo;
    };
  }
  function DistributedOptimizerQuery$splitPartitions$lambda_3(closure$currentPartitionsCopy, closure$node) {
    return function () {
      return closure$currentPartitionsCopy.get_11rb$(closure$node.partitionVariable) != null;
    };
  }
  function DistributedOptimizerQuery$splitPartitions$lambda_4(closure$currentPartitionsCopy, closure$node) {
    return function () {
      return closure$currentPartitionsCopy.get_11rb$(closure$node.partitionVariable) === closure$node.partitionCount;
    };
  }
  function DistributedOptimizerQuery$splitPartitions$lambda_5(closure$currentPartitionsCopy, closure$node) {
    return function () {
      return closure$currentPartitionsCopy.get_11rb$(closure$node.partitionVariable) === closure$node.partitionCount;
    };
  }
  function DistributedOptimizerQuery$splitPartitions$lambda_6(closure$currentPartitionsCopy, closure$node) {
    return function () {
      return closure$currentPartitionsCopy.get_11rb$(closure$node.partitionVariable) === closure$node.partitionCount;
    };
  }
  DistributedOptimizerQuery.prototype.splitPartitions_0 = function (node, currentPartitions, root) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2;
    if (Kotlin.isType(node, POPBase) || Kotlin.isType(node, OPBaseCompound)) {
      var currentPartitionsCopy = LinkedHashMap_init();
      currentPartitionsCopy.putAll_a2k3zr$(currentPartitions);
      if (Kotlin.isType(node, POPMergePartition)) {
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitions$lambda(currentPartitionsCopy, node));
        var key = node.partitionVariable;
        var value = node.partitionCount;
        currentPartitionsCopy.put_xwzc9p$(key, value);
      } else if (Kotlin.isType(node, POPMergePartitionCount)) {
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitions$lambda_0(currentPartitionsCopy, node));
        var key_0 = node.partitionVariable;
        var value_0 = node.partitionCount;
        currentPartitionsCopy.put_xwzc9p$(key_0, value_0);
      } else if (Kotlin.isType(node, POPMergePartitionOrderedByIntId)) {
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitions$lambda_1(currentPartitionsCopy, node));
        var key_1 = node.partitionVariable;
        var value_1 = node.partitionCount;
        currentPartitionsCopy.put_xwzc9p$(key_1, value_1);
      } else if (Kotlin.isType(node, POPChangePartitionOrderedByIntId)) {
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitions$lambda_2(currentPartitionsCopy, node));
        var key_2 = node.partitionVariable;
        var value_2 = node.partitionCountFrom;
        currentPartitionsCopy.put_xwzc9p$(key_2, value_2);
      } else if (Kotlin.isType(node, POPSplitPartition)) {
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitions$lambda_3(currentPartitionsCopy, node));
        currentPartitionsCopy.remove_11rb$(node.partitionVariable);
      } else if (Kotlin.isType(node, POPSplitPartitionFromStore))
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitions$lambda_4(currentPartitionsCopy, node));
      else if (Kotlin.isType(node, POPSplitPartitionFromStoreCount))
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitions$lambda_5(currentPartitionsCopy, node));
      else if (Kotlin.isType(node, POPSplitPartitionPassThrough))
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitions$lambda_6(currentPartitionsCopy, node));
      tmp$_0 = (Kotlin.isType(tmp$ = node, OPBase) ? tmp$ : throwCCE()).childrenToVerifyCount();
      for (var ci = 0; ci < tmp$_0; ci++) {
        var c = node.getChildren()[ci];
        this.splitPartitions_0(c, currentPartitionsCopy, false);
      }
      if (Kotlin.isType(node, POPMergePartition) || Kotlin.isType(node, POPMergePartitionCount) || Kotlin.isType(node, POPMergePartitionOrderedByIntId) || Kotlin.isType(node, POPChangePartitionOrderedByIntId) || Kotlin.isType(node, POPSplitPartition) || Kotlin.isType(node, POPSplitPartitionFromStore) || Kotlin.isType(node, POPSplitPartitionFromStoreCount) || Kotlin.isType(node, POPSplitPartitionPassThrough)) {
        var array = Array_0(currentPartitionsCopy.size);
        var tmp$_3;
        ...
        var allNames = array;
        var allSize = new Int32Array(currentPartitionsCopy.size);
        var i_0 = 0;
        tmp$_1 = currentPartitionsCopy.entries.iterator();
        ...
        this.splitPartitionsVariations_0(node, allNames, allSize, new Int32Array(currentPartitionsCopy.size), 0);
      }} else {
      throw Exception_init('this query is not executable ' + node.getClassname() + ' ' + (Kotlin.isType(tmp$_2 = node, OPBase) ? tmp$_2 : throwCCE()).uuid.toString());
    }
  };
  DistributedOptimizerQuery.prototype.calculateDependenciesTopDown_0 = function (node) {
    var tmp$;
    var res = LinkedHashSet_init();
    tmp$ = node.childs.iterator();
    while (tmp$.hasNext()) {
      var c = tmp$.next();
      res.addAll_brywnq$(this.calculateDependenciesTopDown_0(c));
    }
    if (equals(node.tag, 'partitionDistributionReceiveKey')) {
      res.add_11rb$(ensureNotNull(node.attributes.get_11rb$('key')));
    }return res;
  };
  DistributedOptimizerQuery.prototype.calculateDependenciesBottomUp_0 = function (node) {
    var tmp$;
    var res = LinkedHashSet_init();
    tmp$ = node.childs.iterator();
    while (tmp$.hasNext()) {
      var c = tmp$.next();
      res.addAll_brywnq$(this.calculateDependenciesBottomUp_0(c));
    }
    if (equals(node.tag, 'partitionDistributionProvideKey')) {
      res.add_11rb$(ensureNotNull(node.attributes.get_11rb$('key')));
    }return res;
  };
  DistributedOptimizerQuery.prototype.getHostForKey_0 = function (key) {
    var res = this.operatorgraphPartsToHostMap_8be2vx$.get_11rb$(key);
    if (res != null) {
      return res;
    }var $receiver = this.operatorgraphPartsToHostMap_8be2vx$;
    var key_0 = this.keyRepresentative_8be2vx$.get_11rb$(key);
    var tmp$;
    return (Kotlin.isType(tmp$ = $receiver, Map) ? tmp$ : throwCCE()).get_11rb$(key_0);
  };
  DistributedOptimizerQuery.prototype.assignHosts_0 = function (node) {
    var tmp$;
    tmp$ = node.childs.iterator();
    while (tmp$.hasNext()) {
      var c = tmp$.next();
      this.assignHosts_0(c);
    }
    if (equals(node.tag, 'partitionDistributionReceiveKey')) {
      println('key -> ' + toString(node.attributes.get_11rb$('key')));
      node.addAttribute_puj7f4$('host', ensureNotNull(this.getHostForKey_0(ensureNotNull(node.attributes.get_11rb$('key')))));
    }};
  function DistributedOptimizerQuery$optimize$lambda(this$DistributedOptimizerQuery) {
    return function (it) {
      return this$DistributedOptimizerQuery.getHostForKey_0(it);
    };
  }
  function DistributedOptimizerQuery$optimize$lambda_0(this$DistributedOptimizerQuery) {
    return function (key, value) {
      this$DistributedOptimizerQuery.operatorgraphPartsToHostMap_8be2vx$.put_xwzc9p$(key, value);
      return Unit;
    };
  }
  function DistributedOptimizerQuery$optimize$lambda_1(closure$changed) {
    return function () {
      closure$changed.v = true;
      return Unit;
    };
  }
  DistributedOptimizerQuery.prototype.optimize_ekbuhx$ = function (query) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3, tmp$_4, tmp$_5, tmp$_6, tmp$_7;
    this.query_8be2vx$ = Kotlin.isType(tmp$ = query, Query) ? tmp$ : throwCCE();
    var root = ensureNotNull(query.root);
    if (shared.tripleStoreManager.getPartitionMode() === 1) {
      this.operatorgraphParts_8be2vx$.clear();
      var $receiver = this.operatorgraphParts_8be2vx$;
      var value = root.toXMLElement_6taknv$(true);
      $receiver.put_xwzc9p$('', value);
      var $receiver_0 = this.operatorgraphPartsToHostMap_8be2vx$;
      var value_0 = shared.tripleStoreManager.getLocalhost();
      $receiver_0.put_xwzc9p$('', value_0);
      this.splitPartitions_0(root, LinkedHashMap_init(), true);
      tmp$_0 = this.operatorgraphParts_8be2vx$.entries.iterator();
      while (tmp$_0.hasNext()) {
        var tmp$_8 = tmp$_0.next();
        var k = tmp$_8.key;
        var v = tmp$_8.value;
        var $receiver_1 = this.dependenciesMapTopDown_8be2vx$;
        var value_1 = this.calculateDependenciesTopDown_0(v);
        $receiver_1.put_xwzc9p$(k, value_1);
      }
      tmp$_1 = this.operatorgraphParts_8be2vx$.entries.iterator();
      while (tmp$_1.hasNext()) {
        var tmp$_9 = tmp$_1.next();
        var k_0 = tmp$_9.key;
        var v_0 = tmp$_9.value;
        var $receiver_2 = this.dependenciesMapBottomUp_8be2vx$;
        var value_2 = this.calculateDependenciesBottomUp_0(v_0);
        $receiver_2.put_xwzc9p$(k_0, value_2);
      }
      tmp$_2 = this.childOptimizer_8be2vx$;
      for (tmp$_3 = 0; tmp$_3 !== tmp$_2.length; ++tmp$_3) {
        var childOptimizer2 = tmp$_2[tmp$_3];
        var changed = {v: true};
        loop: while (changed.v) {
          changed.v = false;
          for (tmp$_4 = 0; tmp$_4 !== childOptimizer2.length; ++tmp$_4) {
            var opt = childOptimizer2[tmp$_4];
            tmp$_5 = this.operatorgraphParts_8be2vx$.entries.iterator();
            while (tmp$_5.hasNext()) {
              var tmp$_10 = tmp$_5.next();
              var k_1 = tmp$_10.key;
              var v_1 = tmp$_10.value;
              var $receiver_3 = this.operatorgraphPartsToHostMap_8be2vx$;
              var tmp$_11;
              if (!(Kotlin.isType(tmp$_11 = $receiver_3, Map) ? tmp$_11 : throwCCE()).containsKey_11rb$(k_1)) {
                opt.optimize_ps4byu$(k_1, v_1, ensureNotNull(this.dependenciesMapTopDown_8be2vx$.get_11rb$(k_1)), ensureNotNull(this.dependenciesMapBottomUp_8be2vx$.get_11rb$(k_1)), DistributedOptimizerQuery$optimize$lambda(this), DistributedOptimizerQuery$optimize$lambda_0(this), DistributedOptimizerQuery$optimize$lambda_1(changed));
                if (changed.v) {
                  continue loop;
                }}}
          }
      ...
      tmp$_6 = this.operatorgraphParts_8be2vx$.keys.iterator();
      while (tmp$_6.hasNext()) {
        var k_2 = tmp$_6.next();
        println(k_2 + ' -> ' + toString(this.operatorgraphPartsToHostMap_8be2vx$.get_11rb$(k_2)));
      }
      var res = null;
      tmp$_7 = this.operatorgraphParts_8be2vx$.entries.iterator();
      while (tmp$_7.hasNext()) {
        var tmp$_12 = tmp$_7.next();
        var k_3 = tmp$_12.key;
        var v_2 = tmp$_12.value;
        println(v_2.toPrettyString());
        this.assignHosts_0(v_2);
        if (equals(k_3, '')) {
          res = v_2;
        } else {
          shared.communicationHandler.sendData_hq2gfh$(ensureNotNull(this.operatorgraphPartsToHostMap_8be2vx$.get_11rb$(k_3)), '/distributed/query/register', mapOf(to('query', v_2.toString())));
        }
      }
      return factory.XMLElementToOPBase.invoke_ldixbd$(query, ensureNotNull(res));
    } else {
      return root;
    }
  };
  DistributedOptimizerQuery.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DistributedOptimizerQuery',
  ...
  var package$distributed = package$optimizer.distributed || (package$optimizer.distributed = {});
  var package$query = package$distributed.query || (package$distributed.query = {});
  package$query.DistributedOptimizerAssignAnyChild = DistributedOptimizerAssignAnyChild;
  package$query.DistributedOptimizerAssignAnyParent = DistributedOptimizerAssignAnyParent;
  package$query.DistributedOptimizerAssignChild = DistributedOptimizerAssignChild;
  package$query.DistributedOptimizerAssignLocalhost = DistributedOptimizerAssignLocalhost;
  package$query.DistributedOptimizerAssignParent = DistributedOptimizerAssignParent;
  package$query.DistributedOptimizerBase = DistributedOptimizerBase;
  package$query.DistributedOptimizerQuery = DistributedOptimizerQuery;
  var package$Luposdate3000_Optimizer_Distributed_Query = package$lupos.Luposdate3000_Optimizer_Distributed_Query || (package$lupos.Luposdate3000_Optimizer_Distributed_Query = {});
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, 'BufferManagerPage', {
    get: BufferManagerPage_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, 'ColumnIteratorQueueExt', {
    get: ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, 'DictionaryHelper', {
    get: DictionaryHelper_getInstance
  });
  var package$dynamicArray = package$Luposdate3000_Optimizer_Distributed_Query.dynamicArray || (package$Luposdate3000_Optimizer_Distributed_Query.dynamicArray = {});
  ...
  package$Luposdate3000_Optimizer_Distributed_Query.MyInputStreamFixedLength = MyInputStreamFixedLength;
  package$Luposdate3000_Optimizer_Distributed_Query.MyStringStream = MyStringStream;
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, 'SanityCheckOff', {
    get: SanityCheckOff_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, 'SanityCheckOn', {
    get: SanityCheckOn_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, 'ByteArrayHelper', {
    get: ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Optimizer_Distributed_Query.DateHelper_init = DateHelper_init;
  package$Luposdate3000_Optimizer_Distributed_Query.DateHelper = DateHelper;
  package$Luposdate3000_Optimizer_Distributed_Query.File_init_61zpoe$ = File_init;
  package$Luposdate3000_Optimizer_Distributed_Query.File = File;
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, 'IntegerExt', {
    get: IntegerExt_getInstance
  });
  package$Luposdate3000_Optimizer_Distributed_Query.MyInputStream_init_y4putb$ = MyInputStream_init;
  package$Luposdate3000_Optimizer_Distributed_Query.MyInputStream_init_kcn2v3$ = MyInputStream_init_0;
  package$Luposdate3000_Optimizer_Distributed_Query.MyInputStream = MyInputStream;
  package$Luposdate3000_Optimizer_Distributed_Query.MyOutputStream_init_8be2vx$ = MyOutputStream_init;
  package$Luposdate3000_Optimizer_Distributed_Query.MyOutputStream = MyOutputStream;
  package$Luposdate3000_Optimizer_Distributed_Query.MyPrintWriter_init_6taknv$ = MyPrintWriter_init;
  package$Luposdate3000_Optimizer_Distributed_Query.MyPrintWriter = MyPrintWriter;
  package$Luposdate3000_Optimizer_Distributed_Query.MyThreadReadWriteLock = MyThreadReadWriteLock;
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, 'ParallelThread', {
    get: ParallelThread_getInstance
  });
  package$Luposdate3000_Optimizer_Distributed_Query.ParallelThreadCondition = ParallelThreadCondition;
  package$Luposdate3000_Optimizer_Distributed_Query.ParallelThreadQueue_init_mh5how$ = ParallelThreadQueue_init;
  package$Luposdate3000_Optimizer_Distributed_Query.ParallelThreadQueue = ParallelThreadQueue;
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, 'Platform', {
    get: Platform_getInstance
  });
  Kotlin.defineModule('Luposdate3000_Optimizer_Distributed_Query', _);
  return _;
}));

//# sourceMappingURL=Luposdate3000_Optimizer_Distributed_Query.js.map
