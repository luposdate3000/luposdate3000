(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'KotlinBigInteger-bignum-jsLegacy', 'Luposdate3000_Shared', 'Luposdate3000_Operator_Physical', 'Luposdate3000_Triple_Store_Manager', 'Luposdate3000_Operator_Base', 'Luposdate3000_Operator_Factory', 'Luposdate3000_Shared_JS'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('KotlinBigInteger-bignum-jsLegacy'), require('Luposdate3000_Shared'), require('Luposdate3000_Operator_Physical'), require('Luposdate3000_Triple_Store_Manager'), require('Luposdate3000_Operator_Base'), require('Luposdate3000_Operator_Factory'), require('Luposdate3000_Shared_JS'));
  else {
    ...
    }root.Luposdate3000_Optimizer_Distributed_Query = factory(typeof Luposdate3000_Optimizer_Distributed_Query === 'undefined' ? {} : Luposdate3000_Optimizer_Distributed_Query, kotlin, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared, Luposdate3000_Operator_Physical, Luposdate3000_Triple_Store_Manager, Luposdate3000_Operator_Base, Luposdate3000_Operator_Factory, Luposdate3000_Shared_JS);
  }
}(this, function (_, Kotlin, $module$KotlinBigInteger_bignum_jsLegacy, $module$Luposdate3000_Shared, $module$Luposdate3000_Operator_Physical, $module$Luposdate3000_Triple_Store_Manager, $module$Luposdate3000_Operator_Base, $module$Luposdate3000_Operator_Factory, $module$Luposdate3000_Shared_JS) {
  'use strict';
  ...
  var POPSplitPartitionPassThrough = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.partition.POPSplitPartitionPassThrough;
  ...
  DistributedOptimizerAssignAnyChild.prototype.optimize_m2q8bm$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    var tmp$;
  ...
  DistributedOptimizerAssignAnyParent.prototype.optimize_m2q8bm$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    var tmp$;
  ...
  DistributedOptimizerAssignChild.prototype.optimize_m2q8bm$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    var tmp$;
  ...
  DistributedOptimizerAssignLocalhost.prototype.optimize_m2q8bm$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    keytoHostMapSet(key, s05tripleStore.tripleStoreManager.getLocalhost());
    onChange();
  };
  ...
  DistributedOptimizerAssignParent.prototype.optimize_m2q8bm$ = function (key, node, dependenciesTopDown, dependenciesBottomUp, keytoHostMapGet, keytoHostMapSet, onChange) {
    var tmp$;
  ...
  function DistributedOptimizerQuery() {
    ...
    this.operatorgraphParts_0 = LinkedHashMap_init();
    this.operatorgraphPartsToHostMap_0 = LinkedHashMap_init();
    this.dependenciesMapTopDown_0 = LinkedHashMap_init();
    this.dependenciesMapBottomUp_0 = LinkedHashMap_init();
    this.keyRepresentative_0 = LinkedHashMap_init();
    this.childOptimizer_0 = [[new DistributedOptimizerAssignChild(), new DistributedOptimizerAssignParent(), new DistributedOptimizerAssignAnyChild(), new DistributedOptimizerAssignAnyParent()], [new DistributedOptimizerAssignLocalhost()]];
  }
  ...
  function DistributedOptimizerQuery$splitPartitionsVariations$lambda_0(this$DistributedOptimizerQuery, closure$key, closure$target) {
    return function () {
      var $receiver = this$DistributedOptimizerQuery.operatorgraphPartsToHostMap_0;
      var key = closure$key;
      var tmp$;
      return !(Kotlin.isType(tmp$ = $receiver, Map) ? tmp$ : throwCCE()).containsKey_11rb$(key) || equals(this$DistributedOptimizerQuery.operatorgraphPartsToHostMap_0.get_11rb$(closure$key), closure$target);
    };
  }
    ...
    if (offset === allNames.length) {
      ...
      if (keys.size > 1) {
        ...
        while (tmp$_0.hasNext()) {
          var k = tmp$_0.next();
          this.keyRepresentative_0.put_xwzc9p$(k, key_0);
        }
        ...
        var target_0 = n_0.getDesiredHostnameFor_euq53c$(partition_0);
        SanityCheckOn_getInstance().check_8i7tro$(DistributedOptimizerQuery$splitPartitionsVariations$lambda_2(this, key_0, target_0));
        this.operatorgraphPartsToHostMap_0.put_xwzc9p$(key_0, target_0);
      }this.operatorgraphParts_0.put_xwzc9p$(key_0, xml);
  ...
  DistributedOptimizerQuery.prototype.getHostForKey_0 = function (key) {
    var res = this.operatorgraphPartsToHostMap_0.get_11rb$(key);
    if (res != null) {
      return res;
    }var $receiver = this.operatorgraphPartsToHostMap_0;
    var key_0 = this.keyRepresentative_0.get_11rb$(key);
    var tmp$;
  ...
  function DistributedOptimizerQuery$optimize$lambda_0(this$DistributedOptimizerQuery) {
    return function (key, value) {
      this$DistributedOptimizerQuery.operatorgraphPartsToHostMap_0.put_xwzc9p$(key, value);
      return Unit;
    };
  }
  ...
  DistributedOptimizerQuery.prototype.optimize_zhvcmr$ = function (query) {
    ...
    if (s05tripleStore.tripleStoreManager.getPartitionMode() === 1) {
      this.operatorgraphParts_0.clear();
      var $receiver = this.operatorgraphParts_0;
      var value = root.toXMLElement_6taknv$(true);
      $receiver.put_xwzc9p$('', value);
      var $receiver_0 = this.operatorgraphPartsToHostMap_0;
      var value_0 = s05tripleStore.tripleStoreManager.getLocalhost();
      $receiver_0.put_xwzc9p$('', value_0);
      this.splitPartitions_0(root, LinkedHashMap_init(), true);
      tmp$_0 = this.operatorgraphParts_0.entries.iterator();
      while (tmp$_0.hasNext()) {
        var tmp$_8 = tmp$_0.next();
        var k = tmp$_8.key;
        var v = tmp$_8.value;
        var $receiver_1 = this.dependenciesMapTopDown_0;
        var value_1 = this.calculateDependenciesTopDown_0(v);
        $receiver_1.put_xwzc9p$(k, value_1);
      }
      tmp$_1 = this.operatorgraphParts_0.entries.iterator();
      while (tmp$_1.hasNext()) {
        var tmp$_9 = tmp$_1.next();
        var k_0 = tmp$_9.key;
        var v_0 = tmp$_9.value;
        var $receiver_2 = this.dependenciesMapBottomUp_0;
        var value_2 = this.calculateDependenciesBottomUp_0(v_0);
        $receiver_2.put_xwzc9p$(k_0, value_2);
      }
      tmp$_2 = this.childOptimizer_0;
      for (tmp$_3 = 0; tmp$_3 !== tmp$_2.length; ++tmp$_3) {
        ...
        loop: while (changed.v) {
          ...
          for (tmp$_4 = 0; tmp$_4 !== childOptimizer2.length; ++tmp$_4) {
            ...
            tmp$_5 = this.operatorgraphParts_0.entries.iterator();
            while (tmp$_5.hasNext()) {
              var tmp$_10 = tmp$_5.next();
              var k_1 = tmp$_10.key;
              var v_1 = tmp$_10.value;
              var $receiver_3 = this.operatorgraphPartsToHostMap_0;
              var tmp$_11;
              if (!(Kotlin.isType(tmp$_11 = $receiver_3, Map) ? tmp$_11 : throwCCE()).containsKey_11rb$(k_1)) {
                opt.optimize_m2q8bm$(k_1, v_1, ensureNotNull(this.dependenciesMapTopDown_0.get_11rb$(k_1)), ensureNotNull(this.dependenciesMapBottomUp_0.get_11rb$(k_1)), DistributedOptimizerQuery$optimize$lambda(this), DistributedOptimizerQuery$optimize$lambda_0(this), DistributedOptimizerQuery$optimize$lambda_1(changed));
                if (changed.v) {
                  continue loop;
                }}}
          }
      ...
      tmp$_6 = this.operatorgraphParts_0.keys.iterator();
      while (tmp$_6.hasNext()) {
        var k_2 = tmp$_6.next();
        println(k_2 + ' -> ' + toString(this.operatorgraphPartsToHostMap_0.get_11rb$(k_2)));
      }
      var res = null;
      tmp$_7 = this.operatorgraphParts_0.entries.iterator();
      while (tmp$_7.hasNext()) {
        ...
        if (equals(k_3, '')) {
          ...
          s00misc.communicationHandler.sendData_hq2gfh$(ensureNotNull(this.operatorgraphPartsToHostMap_0.get_11rb$(k_3)), '/distributed/query/register', mapOf(to('query', v_2.toString())));
        }
      }
      return factory.XMLElementToOPBase.invoke_d8op79$(query, ensureNotNull(res));
    } else {
      return root;
    }
  };
  ...
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, '_ColumnIteratorQueueExt', {
    get: _ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, '_DictionaryHelper', {
    get: _DictionaryHelper_getInstance
  });
  package$Luposdate3000_Optimizer_Distributed_Query._MyInputStreamFixedLength = _MyInputStreamFixedLength;
  package$Luposdate3000_Optimizer_Distributed_Query._MyStringStream = _MyStringStream;
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, '_PartitionExt', {
  ...
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, '_ByteArrayHelper', {
    get: _ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Optimizer_Distributed_Query._DateHelper_init = _DateHelper_init;
  package$Luposdate3000_Optimizer_Distributed_Query._DateHelper = _DateHelper;
  package$Luposdate3000_Optimizer_Distributed_Query._File_init_61zpoe$ = _File_init;
  package$Luposdate3000_Optimizer_Distributed_Query._File = _File;
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, '_IntegerExt', {
    get: _IntegerExt_getInstance
  });
  package$Luposdate3000_Optimizer_Distributed_Query._MyInputStream_init_y4putb$ = _MyInputStream_init;
  package$Luposdate3000_Optimizer_Distributed_Query._MyInputStream_init_kcn2v3$ = _MyInputStream_init_0;
  package$Luposdate3000_Optimizer_Distributed_Query._MyInputStream = _MyInputStream;
  package$Luposdate3000_Optimizer_Distributed_Query._MyOutputStream_init_8be2vx$ = _MyOutputStream_init;
  package$Luposdate3000_Optimizer_Distributed_Query._MyOutputStream = _MyOutputStream;
  package$Luposdate3000_Optimizer_Distributed_Query._MyPrintWriter_init_6taknv$ = _MyPrintWriter_init;
  package$Luposdate3000_Optimizer_Distributed_Query._MyPrintWriter = _MyPrintWriter;
  Object.defineProperty(package$Luposdate3000_Optimizer_Distributed_Query, '_Platform', {
