(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Code_Generator_Shared'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'Luposdate3000_Code_Generator_Shared'.");
    }if (typeof this['KotlinBigInteger-bignum-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Code_Generator_Shared'. Its dependency 'KotlinBigInteger-bignum-jsLegacy' was not found. Please, check whether 'KotlinBigInteger-bignum-jsLegacy' is loaded prior to 'Luposdate3000_Code_Generator_Shared'.");
    }if (typeof Luposdate3000_Shared === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Code_Generator_Shared'. Its dependency 'Luposdate3000_Shared' was not found. Please, check whether 'Luposdate3000_Shared' is loaded prior to 'Luposdate3000_Code_Generator_Shared'.");
    }if (typeof Luposdate3000_Shared_JS === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Code_Generator_Shared'. Its dependency 'Luposdate3000_Shared_JS' was not found. Please, check whether 'Luposdate3000_Shared_JS' is loaded prior to 'Luposdate3000_Code_Generator_Shared'.");
    }root.Luposdate3000_Code_Generator_Shared = factory(typeof Luposdate3000_Code_Generator_Shared === 'undefined' ? {} : Luposdate3000_Code_Generator_Shared, kotlin, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared, Luposdate3000_Shared_JS);
  }
  ...
  var package$Luposdate3000_Code_Generator_Shared = package$lupos.Luposdate3000_Code_Generator_Shared || (package$lupos.Luposdate3000_Code_Generator_Shared = {});
  Object.defineProperty(package$Luposdate3000_Code_Generator_Shared, 'BufferManagerPage', {
    get: BufferManagerPage_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Code_Generator_Shared, 'ColumnIteratorQueueExt', {
    get: ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Code_Generator_Shared, 'DictionaryHelper', {
    get: DictionaryHelper_getInstance
  });
  var package$dynamicArray = package$Luposdate3000_Code_Generator_Shared.dynamicArray || (package$Luposdate3000_Code_Generator_Shared.dynamicArray = {});
  ...
  package$Luposdate3000_Code_Generator_Shared.MyInputStreamFixedLength = MyInputStreamFixedLength;
  package$Luposdate3000_Code_Generator_Shared.MyStringStream = MyStringStream;
  Object.defineProperty(package$Luposdate3000_Code_Generator_Shared, 'SanityCheckOff', {
    get: SanityCheckOff_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Code_Generator_Shared, 'SanityCheckOn', {
    get: SanityCheckOn_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Code_Generator_Shared, 'ByteArrayHelper', {
    get: ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Code_Generator_Shared.DateHelper_init = DateHelper_init;
  package$Luposdate3000_Code_Generator_Shared.DateHelper = DateHelper;
  package$Luposdate3000_Code_Generator_Shared.File_init_61zpoe$ = File_init;
  package$Luposdate3000_Code_Generator_Shared.File = File;
  Object.defineProperty(package$Luposdate3000_Code_Generator_Shared, 'IntegerExt', {
    get: IntegerExt_getInstance
  });
  package$Luposdate3000_Code_Generator_Shared.MyInputStream_init_y4putb$ = MyInputStream_init;
  package$Luposdate3000_Code_Generator_Shared.MyInputStream_init_kcn2v3$ = MyInputStream_init_0;
  package$Luposdate3000_Code_Generator_Shared.MyInputStream = MyInputStream;
  package$Luposdate3000_Code_Generator_Shared.MyOutputStream_init_8be2vx$ = MyOutputStream_init;
  package$Luposdate3000_Code_Generator_Shared.MyOutputStream = MyOutputStream;
  package$Luposdate3000_Code_Generator_Shared.MyPrintWriter_init_6taknv$ = MyPrintWriter_init;
  package$Luposdate3000_Code_Generator_Shared.MyPrintWriter = MyPrintWriter;
  package$Luposdate3000_Code_Generator_Shared.MyThreadReadWriteLock = MyThreadReadWriteLock;
  Object.defineProperty(package$Luposdate3000_Code_Generator_Shared, 'ParallelThread', {
    get: ParallelThread_getInstance
  });
  package$Luposdate3000_Code_Generator_Shared.ParallelThreadCondition = ParallelThreadCondition;
  package$Luposdate3000_Code_Generator_Shared.ParallelThreadQueue_init_mh5how$ = ParallelThreadQueue_init;
  package$Luposdate3000_Code_Generator_Shared.ParallelThreadQueue = ParallelThreadQueue;
  Object.defineProperty(package$Luposdate3000_Code_Generator_Shared, 'Platform', {
    get: Platform_getInstance
  });
  Kotlin.defineModule('Luposdate3000_Code_Generator_Shared', _);
  return _;
}));

//# sourceMappingURL=Luposdate3000_Code_Generator_Shared.js.map
