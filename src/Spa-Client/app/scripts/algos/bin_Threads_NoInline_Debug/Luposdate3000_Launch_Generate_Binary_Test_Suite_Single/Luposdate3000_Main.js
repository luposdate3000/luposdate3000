(function (root, factory) {
  ...
  Object.defineProperty(package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single, '_ColumnIteratorQueueExt', {
    get: _ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single, '_DictionaryHelper', {
    get: _DictionaryHelper_getInstance
  });
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._MyInputStreamFixedLength = _MyInputStreamFixedLength;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._MyStringStream = _MyStringStream;
  Object.defineProperty(package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single, '_PartitionExt', {
  ...
  Object.defineProperty(package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single, '_ByteArrayHelper', {
    get: _ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._DateHelper_init = _DateHelper_init;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._DateHelper = _DateHelper;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._File_init_61zpoe$ = _File_init;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._File = _File;
  Object.defineProperty(package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single, '_IntegerExt', {
    get: _IntegerExt_getInstance
  });
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._MyInputStream_init_y4putb$ = _MyInputStream_init;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._MyInputStream_init_kcn2v3$ = _MyInputStream_init_0;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._MyInputStream = _MyInputStream;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._MyOutputStream_init_8be2vx$ = _MyOutputStream_init;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._MyOutputStream = _MyOutputStream;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._MyPrintWriter_init_6taknv$ = _MyPrintWriter_init;
  package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single._MyPrintWriter = _MyPrintWriter;
  Object.defineProperty(package$Luposdate3000_Launch_Generate_Binary_Test_Suite_Single, '_Platform', {
