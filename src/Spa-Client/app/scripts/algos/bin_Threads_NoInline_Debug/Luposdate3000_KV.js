(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'Luposdate3000_Buffer_Manager', 'KotlinBigInteger-bignum-jsLegacy', 'Luposdate3000_Shared', 'Luposdate3000_Shared_JS'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('Luposdate3000_Buffer_Manager'), require('KotlinBigInteger-bignum-jsLegacy'), require('Luposdate3000_Shared'), require('Luposdate3000_Shared_JS'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_KV'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'Luposdate3000_KV'.");
    }if (typeof Luposdate3000_Buffer_Manager === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_KV'. Its dependency 'Luposdate3000_Buffer_Manager' was not found. Please, check whether 'Luposdate3000_Buffer_Manager' is loaded prior to 'Luposdate3000_KV'.");
    }if (typeof this['KotlinBigInteger-bignum-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_KV'. Its dependency 'KotlinBigInteger-bignum-jsLegacy' was not found. Please, check whether 'KotlinBigInteger-bignum-jsLegacy' is loaded prior to 'Luposdate3000_KV'.");
    }if (typeof Luposdate3000_Shared === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_KV'. Its dependency 'Luposdate3000_Shared' was not found. Please, check whether 'Luposdate3000_Shared' is loaded prior to 'Luposdate3000_KV'.");
    }if (typeof Luposdate3000_Shared_JS === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_KV'. Its dependency 'Luposdate3000_Shared_JS' was not found. Please, check whether 'Luposdate3000_Shared_JS' is loaded prior to 'Luposdate3000_KV'.");
    }root.Luposdate3000_KV = factory(typeof Luposdate3000_KV === 'undefined' ? {} : Luposdate3000_KV, kotlin, Luposdate3000_Buffer_Manager, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared, Luposdate3000_Shared_JS);
  }
}(this, function (_, Kotlin, $module$Luposdate3000_Buffer_Manager, $module$KotlinBigInteger_bignum_jsLegacy, $module$Luposdate3000_Shared, $module$Luposdate3000_Shared_JS) {
  'use strict';
  var Unit = Kotlin.kotlin.Unit;
  var Kind_CLASS = Kotlin.Kind.CLASS;
  var MyIntArray_init = $module$Luposdate3000_Buffer_Manager.lupos.buffer_manager.MyIntArray_init_b7rl13$;
  ...
  function KeyValueStore() {
    ...
    this.lastPage_8be2vx$ = 0;
    this.lastPageBuf_8be2vx$ = null;
    this.lastPageOffset_8be2vx$ = 0;
    this.nextID_8be2vx$ = 0;
    this.mappingID2Page_8be2vx$ = null;
    this.mappingID2Off_8be2vx$ = null;
  }
  function KeyValueStore$delete$lambda(closure$pageid, this$KeyValueStore) {
    return function () {
      return closure$pageid.v === this$KeyValueStore.lastPage_8be2vx$;
    };
  }
  KeyValueStore.prototype.delete = function () {
    this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:87', this.lastPage_8be2vx$);
    var pageid = {v: -1};
    if (this.nextID_8be2vx$ === 0) {
      pageid.v = this.lastPage_8be2vx$;
    } else {
      pageid.v = this.mappingID2Page_8be2vx$.get_za3lpa$(0);
      while (pageid.v !== this.lastPage_8be2vx$) {
        var page = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:94', pageid.v);
        var nextPage = BufferManagerPage_getInstance().readInt4_pao7sd$(page, 0);
        this.bufferManager_8be2vx$.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:96', pageid.v);
        pageid.v = nextPage;
      }
    }
    SanityCheckOn_getInstance().check_8i7tro$(KeyValueStore$delete$lambda(pageid, this));
    this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:101', this.lastPage_8be2vx$);
    this.bufferManager_8be2vx$.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:102', this.lastPage_8be2vx$);
    this.mappingID2Page_8be2vx$.delete();
    this.mappingID2Off_8be2vx$.delete();
    this.bufferManager_8be2vx$.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:105', this.rootPageID_8be2vx$);
  };
  KeyValueStore.prototype.close = function () {
    this.mappingID2Page_8be2vx$.close();
    this.mappingID2Off_8be2vx$.close();
    this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:112', this.rootPageID_8be2vx$);
    this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:113', this.lastPage_8be2vx$);
  };
  KeyValueStore.prototype.readData_0 = function (data, page, off) {
    var tmp$;
    var p = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:118', page);
    var pid = page;
    var l = BufferManagerPage_getInstance().readInt4_pao7sd$(p, off);
    ByteArrayWrapperExt_getInstance().setSize_v5fxe$(data, l);
    var bufoff = 0;
    var toread = l;
    var pageoff = off + 4 | 0;
    while (toread > 0) {
      var available = 8192 - pageoff | 0;
      if (available === 0) {
        var id = BufferManagerPage_getInstance().readInt4_pao7sd$(p, 0);
        this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:129', pid);
        p = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:130', id);
        pid = id;
        pageoff = 4;
        available = 8192 - pageoff | 0;
      }if (available < toread) {
        tmp$ = available;
      } else {
        tmp$ = toread;
      ...
      var len = tmp$;
      BufferManagerPage_getInstance().copyInto_v35ddt$(p, data.buf, bufoff, pageoff, pageoff + len | 0);
      bufoff = bufoff + len | 0;
      pageoff = pageoff + len | 0;
      toread = toread - len | 0;
    }
    this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:145', pid);
  };
  KeyValueStore.prototype.writeData_0 = function (data, action) {
    var tmp$;
    if (this.lastPageOffset_8be2vx$ >= 8184) {
      var pageid = this.bufferManager_8be2vx$.allocPage_61zpoe$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:150');
      BufferManagerPage_getInstance().writeInt4_qibw1t$(this.lastPageBuf_8be2vx$, 0, pageid);
      this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:152', this.lastPage_8be2vx$);
      this.lastPageBuf_8be2vx$ = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:153', pageid);
      this.lastPage_8be2vx$ = pageid;
      BufferManagerPage_getInstance().writeInt4_qibw1t$(this.rootPage_8be2vx$, 0, this.lastPage_8be2vx$);
      this.lastPageOffset_8be2vx$ = 4;
      BufferManagerPage_getInstance().writeInt4_qibw1t$(this.rootPage_8be2vx$, 4, this.lastPageOffset_8be2vx$);
    }var resPage = this.lastPage_8be2vx$;
    var resOff = this.lastPageOffset_8be2vx$;
    BufferManagerPage_getInstance().writeInt4_qibw1t$(this.lastPageBuf_8be2vx$, this.lastPageOffset_8be2vx$, data.size);
    this.lastPageOffset_8be2vx$ = this.lastPageOffset_8be2vx$ + 4 | 0;
    BufferManagerPage_getInstance().writeInt4_qibw1t$(this.rootPage_8be2vx$, 4, this.lastPageOffset_8be2vx$);
    var dataoff = 0;
    var towrite = data.size;
    while (towrite > 0) {
      var available = 8192 - this.lastPageOffset_8be2vx$ | 0;
      if (available === 0) {
        var pageid_0 = this.bufferManager_8be2vx$.allocPage_61zpoe$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:169');
        BufferManagerPage_getInstance().writeInt4_qibw1t$(this.lastPageBuf_8be2vx$, 0, pageid_0);
        this.bufferManager_8be2vx$.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:171', this.lastPage_8be2vx$);
        this.lastPageBuf_8be2vx$ = this.bufferManager_8be2vx$.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:172', pageid_0);
        this.lastPage_8be2vx$ = pageid_0;
        BufferManagerPage_getInstance().writeInt4_qibw1t$(this.rootPage_8be2vx$, 0, this.lastPage_8be2vx$);
        this.lastPageOffset_8be2vx$ = 4;
        BufferManagerPage_getInstance().writeInt4_qibw1t$(this.rootPage_8be2vx$, 4, this.lastPageOffset_8be2vx$);
        available = 8192 - this.lastPageOffset_8be2vx$ | 0;
      ...
      var len = tmp$;
      BufferManagerPage_getInstance().copyFrom_v35ddt$(this.lastPageBuf_8be2vx$, data.buf, this.lastPageOffset_8be2vx$, dataoff, dataoff + len | 0);
      towrite = towrite - len | 0;
      this.lastPageOffset_8be2vx$ = this.lastPageOffset_8be2vx$ + len | 0;
      BufferManagerPage_getInstance().writeInt4_qibw1t$(this.rootPage_8be2vx$, 4, this.lastPageOffset_8be2vx$);
      dataoff = dataoff + len | 0;
    }
    action(resPage, resOff);
  };
  function KeyValueStore$createValue$lambda(closure$res, this$KeyValueStore) {
    return function (page, off) {
      if (closure$res.v >= this$KeyValueStore.mappingID2Page_8be2vx$.getSize()) {
        this$KeyValueStore.mappingID2Page_8be2vx$.setSize_fzusl$(closure$res.v + 1 | 0, false);
        this$KeyValueStore.mappingID2Off_8be2vx$.setSize_fzusl$(closure$res.v + 1 | 0, false);
      }this$KeyValueStore.mappingID2Page_8be2vx$.set_vux9f0$(closure$res.v, page);
      this$KeyValueStore.mappingID2Off_8be2vx$.set_vux9f0$(closure$res.v, off);
      return Unit;
    };
  }
  KeyValueStore.prototype.createValue_b1q5io$ = function (data) {
    var tmp$;
    var res = {v: 0};
    res.v = (tmp$ = this.nextID_8be2vx$, this.nextID_8be2vx$ = tmp$ + 1 | 0, tmp$);
    BufferManagerPage_getInstance().writeInt4_qibw1t$(this.rootPage_8be2vx$, 8, this.nextID_8be2vx$);
    this.writeData_0(data, KeyValueStore$createValue$lambda(res, this));
    return res.v;
  };
  function KeyValueStore$getValue$lambda(closure$value, this$KeyValueStore) {
    return function () {
      return closure$value < this$KeyValueStore.nextID_8be2vx$;
    };
  }
  function KeyValueStore$getValue$lambda_0(closure$value) {
    return function () {
      return closure$value >= 0;
    };
  }
  KeyValueStore.prototype.getValue_v5fxe$ = function (data, value) {
    SanityCheckOn_getInstance().check_8i7tro$(KeyValueStore$getValue$lambda(value, this));
    SanityCheckOn_getInstance().check_8i7tro$(KeyValueStore$getValue$lambda_0(value));
    this.readData_0(data, this.mappingID2Page_8be2vx$.get_za3lpa$(value), this.mappingID2Off_8be2vx$.get_za3lpa$(value));
  };
  KeyValueStore.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'KeyValueStore',
    interfaces: []
  };
  function KeyValueStore_init(bufferManager, rootPageID, initFromRootPage, $this) {
    $this = $this || Object.create(KeyValueStore.prototype);
    KeyValueStore.call($this);
    $this.bufferManager_8be2vx$ = bufferManager;
    $this.rootPageID_8be2vx$ = rootPageID;
    $this.rootPage_8be2vx$ = bufferManager.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:58', rootPageID);
    var id1 = 0;
    var id2 = 0;
    if (initFromRootPage) {
      $this.lastPage_8be2vx$ = BufferManagerPage_getInstance().readInt4_pao7sd$($this.rootPage_8be2vx$, 0);
      $this.lastPageBuf_8be2vx$ = bufferManager.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:63', $this.lastPage_8be2vx$);
      $this.lastPageOffset_8be2vx$ = BufferManagerPage_getInstance().readInt4_pao7sd$($this.rootPage_8be2vx$, 4);
      $this.nextID_8be2vx$ = BufferManagerPage_getInstance().readInt4_pao7sd$($this.rootPage_8be2vx$, 8);
      id1 = BufferManagerPage_getInstance().readInt4_pao7sd$($this.rootPage_8be2vx$, 12);
      id2 = BufferManagerPage_getInstance().readInt4_pao7sd$($this.rootPage_8be2vx$, 16);
    } else {
      $this.lastPageOffset_8be2vx$ = 4;
      $this.lastPage_8be2vx$ = bufferManager.allocPage_61zpoe$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:70');
      $this.lastPageBuf_8be2vx$ = bufferManager.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:71', $this.lastPage_8be2vx$);
      BufferManagerPage_getInstance().writeInt4_qibw1t$($this.rootPage_8be2vx$, 0, $this.lastPage_8be2vx$);
      BufferManagerPage_getInstance().writeInt4_qibw1t$($this.rootPage_8be2vx$, 4, $this.lastPageOffset_8be2vx$);
      $this.nextID_8be2vx$ = 0;
      BufferManagerPage_getInstance().writeInt4_qibw1t$($this.rootPage_8be2vx$, 8, $this.nextID_8be2vx$);
      id1 = bufferManager.allocPage_61zpoe$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:76');
      id2 = bufferManager.allocPage_61zpoe$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:77');
      BufferManagerPage_getInstance().writeInt4_qibw1t$($this.rootPage_8be2vx$, 12, id1);
      BufferManagerPage_getInstance().writeInt4_qibw1t$($this.rootPage_8be2vx$, 16, id2);
    }
    $this.mappingID2Page_8be2vx$ = MyIntArray_init(bufferManager, id1, initFromRootPage);
    $this.mappingID2Off_8be2vx$ = MyIntArray_init(bufferManager, id2, initFromRootPage);
    return $this;
  }
  ...
  var package$kv = package$lupos.kv || (package$lupos.kv = {});
  package$kv.KeyValueStore_init_b7rl13$ = KeyValueStore_init;
  package$kv.KeyValueStore = KeyValueStore;
  var package$Luposdate3000_KV = package$lupos.Luposdate3000_KV || (package$lupos.Luposdate3000_KV = {});
  Object.defineProperty(package$Luposdate3000_KV, 'BufferManagerPage', {
    get: BufferManagerPage_getInstance
  });
  Object.defineProperty(package$Luposdate3000_KV, 'ColumnIteratorQueueExt', {
    get: ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_KV, 'DictionaryHelper', {
    get: DictionaryHelper_getInstance
  });
  var package$dynamicArray = package$Luposdate3000_KV.dynamicArray || (package$Luposdate3000_KV.dynamicArray = {});
  ...
  package$Luposdate3000_KV.MyInputStreamFixedLength = MyInputStreamFixedLength;
  package$Luposdate3000_KV.MyStringStream = MyStringStream;
  Object.defineProperty(package$Luposdate3000_KV, 'SanityCheckOff', {
    get: SanityCheckOff_getInstance
  });
  Object.defineProperty(package$Luposdate3000_KV, 'SanityCheckOn', {
    get: SanityCheckOn_getInstance
  });
  Object.defineProperty(package$Luposdate3000_KV, 'ByteArrayHelper', {
    get: ByteArrayHelper_getInstance
  });
  package$Luposdate3000_KV.DateHelper_init = DateHelper_init;
  package$Luposdate3000_KV.DateHelper = DateHelper;
  package$Luposdate3000_KV.File_init_61zpoe$ = File_init;
  package$Luposdate3000_KV.File = File;
  Object.defineProperty(package$Luposdate3000_KV, 'IntegerExt', {
    get: IntegerExt_getInstance
  });
  package$Luposdate3000_KV.MyInputStream_init_y4putb$ = MyInputStream_init;
  package$Luposdate3000_KV.MyInputStream_init_kcn2v3$ = MyInputStream_init_0;
  package$Luposdate3000_KV.MyInputStream = MyInputStream;
  package$Luposdate3000_KV.MyOutputStream_init_8be2vx$ = MyOutputStream_init;
  package$Luposdate3000_KV.MyOutputStream = MyOutputStream;
  package$Luposdate3000_KV.MyPrintWriter_init_6taknv$ = MyPrintWriter_init;
  package$Luposdate3000_KV.MyPrintWriter = MyPrintWriter;
  package$Luposdate3000_KV.MyThreadReadWriteLock = MyThreadReadWriteLock;
  Object.defineProperty(package$Luposdate3000_KV, 'ParallelThread', {
    get: ParallelThread_getInstance
  });
  package$Luposdate3000_KV.ParallelThreadCondition = ParallelThreadCondition;
  package$Luposdate3000_KV.ParallelThreadQueue_init_mh5how$ = ParallelThreadQueue_init;
  package$Luposdate3000_KV.ParallelThreadQueue = ParallelThreadQueue;
  Object.defineProperty(package$Luposdate3000_KV, 'Platform', {
    get: Platform_getInstance
  });
  Kotlin.defineModule('Luposdate3000_KV', _);
  return _;
}));

//# sourceMappingURL=Luposdate3000_KV.js.map
