(function (root, factory) {
  ...
  var MyIntArray_init = $module$Luposdate3000_Buffer_Manager.lupos.buffermanager.MyIntArray_init_7gacri$;
  ...
  function KeyValueStore() {
    ...
    this.lastPage_0 = 0;
    this.lastPageBuf_0 = null;
    this.lastPageOffset_0 = 0;
    this.nextID_0 = 0;
    this.mappingID2Page_0 = null;
    this.mappingID2Off_0 = null;
  }
  function KeyValueStore$delete$lambda(closure$pageid, this$KeyValueStore) {
    return function () {
      return closure$pageid.v === this$KeyValueStore.lastPage_0;
    };
  }
  KeyValueStore.prototype.delete = function () {
    this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:83', this.lastPage_0);
    var pageid = {v: -1};
    if (this.nextID_0 === 0) {
      pageid.v = this.lastPage_0;
    } else {
      pageid.v = this.mappingID2Page_0.get_za3lpa$(0);
      while (pageid.v !== this.lastPage_0) {
        var page = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:90', pageid.v);
        var nextPage = page.readInt4_za3lpa$(0);
        this.bufferManager_0.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:92', pageid.v);
        pageid.v = nextPage;
      }
    }
    SanityCheckOn_getInstance().check_8i7tro$(KeyValueStore$delete$lambda(pageid, this));
    this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:97', this.lastPage_0);
    this.bufferManager_0.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:98', this.lastPage_0);
    this.mappingID2Page_0.delete();
    this.mappingID2Off_0.delete();
    this.bufferManager_0.deletePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:101', this.rootPageID_0);
  };
  KeyValueStore.prototype.close = function () {
    this.mappingID2Page_0.close();
    this.mappingID2Off_0.close();
    this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:108', this.rootPageID_0);
    this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:109', this.lastPage_0);
  };
  KeyValueStore.prototype.readData_0 = function (data, page, off) {
    var tmp$;
    var p = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:113', page);
    var pid = page;
    var l = p.readInt4_za3lpa$(off);
    data.setSize_za3lpa$(l);
    var bufoff = 0;
    var toread = l;
    var pageoff = off + 4 | 0;
    while (toread > 0) {
      ...
      if (available === 0) {
        var id = p.readInt4_za3lpa$(0);
        this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:124', pid);
        p = this.bufferManager_0.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:125', id);
        pid = id;
        pageoff = 4;
      ...
      var len = tmp$;
      p.copyInto_elxobu$(data.getBuf(), bufoff, pageoff, pageoff + len | 0);
      bufoff = bufoff + len | 0;
      pageoff = pageoff + len | 0;
      toread = toread - len | 0;
    }
    this.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:140', pid);
  };
  function KeyValueStore$writeData$lambda(this$KeyValueStore) {
    return function (page, pageid) {
      this$KeyValueStore.lastPageBuf_0.writeInt4_vux9f0$(0, pageid);
      this$KeyValueStore.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:147', this$KeyValueStore.lastPage_0);
      this$KeyValueStore.lastPageBuf_0 = page;
      this$KeyValueStore.lastPage_0 = pageid;
      this$KeyValueStore.rootPage_0.writeInt4_vux9f0$(0, this$KeyValueStore.lastPage_0);
      return Unit;
    };
  }
  function KeyValueStore$writeData$lambda_0(this$KeyValueStore) {
    return function (page, pageid) {
      this$KeyValueStore.lastPageBuf_0.writeInt4_vux9f0$(0, pageid);
      this$KeyValueStore.bufferManager_0.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:167', this$KeyValueStore.lastPage_0);
      this$KeyValueStore.lastPageBuf_0 = page;
      this$KeyValueStore.lastPage_0 = pageid;
      this$KeyValueStore.rootPage_0.writeInt4_vux9f0$(0, this$KeyValueStore.lastPage_0);
      return Unit;
  ...
  KeyValueStore.prototype.writeData_0 = function (data, action) {
    var tmp$;
    if (this.lastPageOffset_0 >= 8184) {
      this.bufferManager_0.createPage_5otl51$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:145', KeyValueStore$writeData$lambda(this));
      this.lastPageOffset_0 = 4;
      this.rootPage_0.writeInt4_vux9f0$(4, this.lastPageOffset_0);
    }var resPage = this.lastPage_0;
    var resOff = this.lastPageOffset_0;
    this.lastPageBuf_0.writeInt4_vux9f0$(this.lastPageOffset_0, data.getSize());
    this.lastPageOffset_0 = this.lastPageOffset_0 + 4 | 0;
    this.rootPage_0.writeInt4_vux9f0$(4, this.lastPageOffset_0);
    var dataoff = 0;
    var towrite = data.getSize();
    while (towrite > 0) {
      var available = 8192 - this.lastPageOffset_0 | 0;
      if (available === 0) {
        this.bufferManager_0.createPage_5otl51$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:165', KeyValueStore$writeData$lambda_0(this));
        this.lastPageOffset_0 = 4;
        this.rootPage_0.writeInt4_vux9f0$(4, this.lastPageOffset_0);
        available = 8192 - this.lastPageOffset_0 | 0;
      ...
      var len = tmp$;
      this.lastPageBuf_0.copyFrom_elxobu$(data.getBuf(), this.lastPageOffset_0, dataoff, dataoff + len | 0);
      towrite = towrite - len | 0;
      this.lastPageOffset_0 = this.lastPageOffset_0 + len | 0;
      this.rootPage_0.writeInt4_vux9f0$(4, this.lastPageOffset_0);
  ...
  function KeyValueStore$createValue$lambda(closure$res, this$KeyValueStore) {
    return function (page, off) {
      if (closure$res.v >= this$KeyValueStore.mappingID2Page_0.getSize()) {
        this$KeyValueStore.mappingID2Page_0.setSize_fzusl$(closure$res.v + 1 | 0, false);
        this$KeyValueStore.mappingID2Off_0.setSize_fzusl$(closure$res.v + 1 | 0, false);
      }this$KeyValueStore.mappingID2Page_0.set_vux9f0$(closure$res.v, page);
      this$KeyValueStore.mappingID2Off_0.set_vux9f0$(closure$res.v, off);
      return Unit;
    };
  }
  KeyValueStore.prototype.createValue_jxlg18$ = function (data) {
    var tmp$;
    var res = {v: 0};
    res.v = (tmp$ = this.nextID_0, this.nextID_0 = tmp$ + 1 | 0, tmp$);
    this.rootPage_0.writeInt4_vux9f0$(8, this.nextID_0);
  ...
  function KeyValueStore$getValue$lambda(closure$value, this$KeyValueStore) {
    return function () {
      return closure$value < this$KeyValueStore.nextID_0;
    };
  }
  ...
  KeyValueStore.prototype.getValue_rj5z7q$ = function (data, value) {
    ...
    this.readData_0(data, this.mappingID2Page_0.get_za3lpa$(value), this.mappingID2Off_0.get_za3lpa$(value));
  };
  ...
  function KeyValueStore_init(bufferManager, rootPageID, initFromRootPage, $this) {
    ...
    $this.rootPage_0 = bufferManager.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:40', rootPageID);
    if (initFromRootPage) {
      $this.lastPage_0 = $this.rootPage_0.readInt4_za3lpa$(0);
      $this.lastPageBuf_0 = bufferManager.getPage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:43', $this.lastPage_0);
      $this.lastPageOffset_0 = $this.rootPage_0.readInt4_za3lpa$(4);
      $this.nextID_0 = $this.rootPage_0.readInt4_za3lpa$(8);
      var id1 = $this.rootPage_0.readInt4_za3lpa$(12);
      var id2 = $this.rootPage_0.readInt4_za3lpa$(16);
      $this.mappingID2Page_0 = MyIntArray_init(bufferManager, id1, initFromRootPage);
      $this.mappingID2Off_0 = MyIntArray_init(bufferManager, id2, initFromRootPage);
    } else {
      var tmpPage = {v: null};
      $this.lastPage_0 = 0;
      $this.lastPageOffset_0 = 0;
      bufferManager.createPage_5otl51$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:54', KeyValueStore_init$lambda(tmpPage, $this));
      $this.lastPageBuf_0 = ensureNotNull(tmpPage.v);
      $this.rootPage_0.writeInt4_vux9f0$(0, $this.lastPage_0);
      $this.rootPage_0.writeInt4_vux9f0$(4, $this.lastPageOffset_0);
      $this.nextID_0 = 0;
      $this.rootPage_0.writeInt4_vux9f0$(8, $this.nextID_0);
      var id1_0 = {v: 0};
      var id2_0 = {v: 0};
      bufferManager.createPage_5otl51$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:66', KeyValueStore_init$lambda_0(id1_0));
      bufferManager.createPage_5otl51$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:69', KeyValueStore_init$lambda_1(id2_0));
      bufferManager.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:72', id1_0.v);
      bufferManager.releasePage_bm4lxs$('C:/Users/ricok/Desktop/Masterarbeit/luposdate3000/src/luposdate3000_kv/src/commonMain/kotlin/lupos/kv/KeyValueStore.kt:73', id2_0.v);
      $this.rootPage_0.writeInt4_vux9f0$(12, id1_0.v);
      $this.rootPage_0.writeInt4_vux9f0$(16, id2_0.v);
      $this.mappingID2Page_0 = MyIntArray_init(bufferManager, id1_0.v, initFromRootPage);
      $this.mappingID2Off_0 = MyIntArray_init(bufferManager, id2_0.v, initFromRootPage);
    }
    return $this;
  }
  function KeyValueStore_init$lambda(closure$tmpPage, this$KeyValueStore) {
    return function (page, pageid) {
      closure$tmpPage.v = page;
      this$KeyValueStore.lastPage_0 = pageid;
      this$KeyValueStore.lastPageOffset_0 = 4;
      return Unit;
    };
  }
  function KeyValueStore_init$lambda_0(closure$id1) {
    return function (page, pageid) {
      closure$id1.v = pageid;
      return Unit;
    };
  }
  function KeyValueStore_init$lambda_1(closure$id2) {
    return function (page, pageid) {
      closure$id2.v = pageid;
      return Unit;
    };
  }
  ...
  package$kv.KeyValueStore_init_7gacri$ = KeyValueStore_init;
  ...
  Object.defineProperty(package$Luposdate3000_KV, '_ColumnIteratorQueueExt', {
    get: _ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_KV, '_DictionaryHelper', {
    get: _DictionaryHelper_getInstance
  });
  package$Luposdate3000_KV._MyInputStreamFixedLength = _MyInputStreamFixedLength;
  package$Luposdate3000_KV._MyStringStream = _MyStringStream;
  Object.defineProperty(package$Luposdate3000_KV, '_PartitionExt', {
  ...
  Object.defineProperty(package$Luposdate3000_KV, '_ByteArrayHelper', {
    get: _ByteArrayHelper_getInstance
  });
  package$Luposdate3000_KV._DateHelper_init = _DateHelper_init;
  package$Luposdate3000_KV._DateHelper = _DateHelper;
  package$Luposdate3000_KV._File_init_61zpoe$ = _File_init;
  package$Luposdate3000_KV._File = _File;
  Object.defineProperty(package$Luposdate3000_KV, '_IntegerExt', {
    get: _IntegerExt_getInstance
  });
  package$Luposdate3000_KV._MyInputStream_init_y4putb$ = _MyInputStream_init;
  package$Luposdate3000_KV._MyInputStream_init_kcn2v3$ = _MyInputStream_init_0;
  package$Luposdate3000_KV._MyInputStream = _MyInputStream;
  package$Luposdate3000_KV._MyOutputStream_init_8be2vx$ = _MyOutputStream_init;
  package$Luposdate3000_KV._MyOutputStream = _MyOutputStream;
  package$Luposdate3000_KV._MyPrintWriter_init_6taknv$ = _MyPrintWriter_init;
  package$Luposdate3000_KV._MyPrintWriter = _MyPrintWriter;
  Object.defineProperty(package$Luposdate3000_KV, '_Platform', {
