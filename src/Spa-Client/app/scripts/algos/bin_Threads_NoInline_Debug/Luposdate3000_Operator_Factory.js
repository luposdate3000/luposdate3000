(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'KotlinBigInteger-bignum-jsLegacy', 'Luposdate3000_Shared', 'Luposdate3000_Operator_Arithmetik', 'Luposdate3000_Operator_Base', 'Luposdate3000_Operator_Logical', 'Luposdate3000_Operator_Physical', 'Luposdate3000_Triple_Store_Manager', 'Luposdate3000_Shared_JS'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('KotlinBigInteger-bignum-jsLegacy'), require('Luposdate3000_Shared'), require('Luposdate3000_Operator_Arithmetik'), require('Luposdate3000_Operator_Base'), require('Luposdate3000_Operator_Logical'), require('Luposdate3000_Operator_Physical'), require('Luposdate3000_Triple_Store_Manager'), require('Luposdate3000_Shared_JS'));
  else {
    ...
    }root.Luposdate3000_Operator_Factory = factory(typeof Luposdate3000_Operator_Factory === 'undefined' ? {} : Luposdate3000_Operator_Factory, kotlin, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared, Luposdate3000_Operator_Arithmetik, Luposdate3000_Operator_Base, Luposdate3000_Operator_Logical, Luposdate3000_Operator_Physical, Luposdate3000_Triple_Store_Manager, Luposdate3000_Shared_JS);
  }
}(this, function (_, Kotlin, $module$KotlinBigInteger_bignum_jsLegacy, $module$Luposdate3000_Shared, $module$Luposdate3000_Operator_Arithmetik, $module$Luposdate3000_Operator_Base, $module$Luposdate3000_Operator_Logical, $module$Luposdate3000_Operator_Physical, $module$Luposdate3000_Triple_Store_Manager, $module$Luposdate3000_Shared_JS) {
  'use strict';
  ...
  var ValueDateTime_init = $module$Luposdate3000_Shared.lupos.s03resultRepresentation.ValueDateTime_init_61zpoe$;
  ...
  var AOPConstant_init_0 = $module$Luposdate3000_Operator_Arithmetik.lupos.s04arithmetikOperators.noinput.AOPConstant_init_mtm5fp$;
  ...
  var POPSort = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPSort;
  var POPProjection = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPProjection;
  ...
  var POPMakeBooleanResult = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPMakeBooleanResult;
  ...
  var POPDistributedSendSingle = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.partition.POPDistributedSendSingle;
  var POPDistributedSendSingleCount = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.partition.POPDistributedSendSingleCount;
  var POPDistributedSendMulti = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.partition.POPDistributedSendMulti;
  var POPDistributedReceiveSingle = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.partition.POPDistributedReceiveSingle;
  var POPDistributedReceiveSingleCount = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.partition.POPDistributedReceiveSingleCount;
  var POPDistributedReceiveMulti = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.partition.POPDistributedReceiveMulti;
  var POPDistributedReceiveMultiCount = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.partition.POPDistributedReceiveMultiCount;
  var POPDistributedReceiveMultiOrdered = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.partition.POPDistributedReceiveMultiOrdered;
  ...
  var POPTripleStoreIterator = $module$Luposdate3000_Triple_Store_Manager.lupos.s05tripleStore.POPTripleStoreIterator;
  ...
  var POPEmptyRow = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.noinput.POPEmptyRow;
  var POPBind = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPBind;
  var POPGroup_init = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPGroup_init_895gc$;
  var LOPTriple = $module$Luposdate3000_Operator_Logical.lupos.s04logicalOperators.noinput.LOPTriple;
  var POPModify = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPModify;
  var POPFilter = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPFilter;
  var POPOffset = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.modifiers.POPOffset;
  var POPLimit = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.modifiers.POPLimit;
  var POPDebug = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPDebug;
  var POPReduced = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.modifiers.POPReduced;
  var toList = Kotlin.kotlin.collections.toList_us0mfu$;
  var POPValues_init = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.noinput.POPValues_init_cxi1tr$;
  var POPValues_init_0 = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.noinput.POPValues_init_mtm5fp$;
  var POPUnion = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.multiinput.POPUnion;
  var POPMinus = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.multiinput.POPMinus;
  var POPJoinHashMap = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.multiinput.POPJoinHashMap;
  var POPJoinCartesianProduct = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.multiinput.POPJoinCartesianProduct;
  var POPJoinMerge = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.multiinput.POPJoinMerge;
  var POPJoinMergeOptional = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.multiinput.POPJoinMergeOptional;
  var POPJoinMergeSingleColumn = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.multiinput.POPJoinMergeSingleColumn;
  var POPJoinWithStore = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.multiinput.POPJoinWithStore;
  var POPJoinWithStoreExists = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.multiinput.POPJoinWithStoreExists;
  ...
  var TripleStoreIndexDescription = $module$Luposdate3000_Triple_Store_Manager.lupos.s05tripleStore.TripleStoreIndexDescription;
  var UnknownOperatorTypeInXMLException = $module$Luposdate3000_Shared.lupos.s00misc.UnknownOperatorTypeInXMLException;
  var split_0 = Kotlin.kotlin.text.split_o64adg$;
  var XMLNotParseableException = $module$Luposdate3000_Shared.lupos.s00misc.XMLNotParseableException;
  ...
  XMLElementToOPBase.prototype.invoke_d8op79$ = function (query, node, mapping) {
    if (mapping === void 0) {
      mapping = LinkedHashMap_init();
    ...
    switch (node.tag) {
      case 'OPBaseCompound':
        ...
        while (tmp$.hasNext()) {
          var c = tmp$.next();
          childs.add_11rb$(XMLElementToOPBase_getInstance().invoke_d8op79$(query, c, mapping));
        }
      ...
      case 'AOPBuildInCallIsNUMERIC':
        res = new AOPBuildInCallIsNUMERIC(query, Kotlin.isType(tmp$_2 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_2 : throwCCE());
        break;
      case 'OPNothing':
        ...
        break;
      case 'LOPSubGroup':
        res = new LOPSubGroup(query, XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'ValueDateTime':
        res = AOPConstant_init(query, ValueDateTime_init(ensureNotNull(node.attributes.get_11rb$('value'))));
        break;
      case 'AOPNot':
        res = new AOPNot(query, Kotlin.isType(tmp$_4 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_4 : throwCCE());
        break;
      case 'AOPAddition':
        res = new AOPAddition(query, Kotlin.isType(tmp$_5 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_5 : throwCCE(), Kotlin.isType(tmp$_6 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_6 : throwCCE());
        break;
      case 'AOPSubtraction':
        res = new AOPSubtraction(query, Kotlin.isType(tmp$_7 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_7 : throwCCE(), Kotlin.isType(tmp$_8 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_8 : throwCCE());
        break;
      case 'AOPGEQ':
        res = new AOPGEQ(query, Kotlin.isType(tmp$_9 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_9 : throwCCE(), Kotlin.isType(tmp$_10 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_10 : throwCCE());
        break;
      case 'AOPLEQ':
        res = new AOPLEQ(query, Kotlin.isType(tmp$_11 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_11 : throwCCE(), Kotlin.isType(tmp$_12 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_12 : throwCCE());
        break;
      case 'AOPSet':
        ...
        while (tmp$_13.hasNext()) {
          ...
          children.add_11rb$(Kotlin.isType(tmp$_14 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_1, mapping), AOPBase) ? tmp$_14 : throwCCE());
        }
      ...
      case 'AOPBuildInCallCOALESCE':
        ...
        while (tmp$_15.hasNext()) {
          ...
          children_0.add_11rb$(Kotlin.isType(tmp$_16 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_2, mapping), AOPBase) ? tmp$_16 : throwCCE());
        }

        res = new AOPBuildInCallCOALESCE(query, children_0);
        break;
      case 'AOPBuildInCallCONTAINS':
        res = new AOPBuildInCallCONTAINS(query, Kotlin.isType(tmp$_17 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_17 : throwCCE(), Kotlin.isType(tmp$_18 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_18 : throwCCE());
        break;
      case 'AOPBuildInCallDAY':
        res = new AOPBuildInCallDAY(query, Kotlin.isType(tmp$_19 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_19 : throwCCE());
        break;
      case 'AOPFunctionCallFloat':
        res = new AOPFunctionCallFloat(query, Kotlin.isType(tmp$_20 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_20 : throwCCE());
        break;
      case 'AOPFunctionCallDouble':
        res = new AOPFunctionCallDouble(query, Kotlin.isType(tmp$_21 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_21 : throwCCE());
        break;
      case 'AOPFunctionCallString':
        res = new AOPFunctionCallString(query, Kotlin.isType(tmp$_22 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_22 : throwCCE());
        break;
      case 'AOPBuildInCallFLOOR':
        res = new AOPBuildInCallFLOOR(query, Kotlin.isType(tmp$_23 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_23 : throwCCE());
        break;
      case 'AOPBuildInCallCEIL':
        res = new AOPBuildInCallCEIL(query, Kotlin.isType(tmp$_24 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_24 : throwCCE());
        break;
      case 'AOPBuildInCallExists':
        res = new AOPBuildInCallExists(query, XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'AOPBuildInCallNotExists':
        res = new AOPBuildInCallNotExists(query, XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'AOPBuildInCallABS':
        res = new AOPBuildInCallABS(query, Kotlin.isType(tmp$_25 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_25 : throwCCE());
        break;
      case 'AOPBuildInCallIsIri':
        res = new AOPBuildInCallIsIri(query, Kotlin.isType(tmp$_26 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_26 : throwCCE());
        break;
      case 'AOPBuildInCallROUND':
        res = new AOPBuildInCallROUND(query, Kotlin.isType(tmp$_27 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_27 : throwCCE());
        break;
      case 'AOPBuildInCallBOUND':
        res = new AOPBuildInCallBOUND(query, Kotlin.isType(tmp$_28 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_28 : throwCCE());
        break;
      case 'AOPBuildInCallHOURS':
        res = new AOPBuildInCallHOURS(query, Kotlin.isType(tmp$_29 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_29 : throwCCE());
        break;
      case 'AOPBuildInCallIF':
        res = new AOPBuildInCallIF(query, Kotlin.isType(tmp$_30 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_30 : throwCCE(), Kotlin.isType(tmp$_31 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_31 : throwCCE(), Kotlin.isType(tmp$_32 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(2), mapping), AOPBase) ? tmp$_32 : throwCCE());
        break;
      case 'AOPBuildInCallLANGMATCHES':
        res = new AOPBuildInCallLANGMATCHES(query, Kotlin.isType(tmp$_33 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_33 : throwCCE(), Kotlin.isType(tmp$_34 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_34 : throwCCE());
        break;
      case 'AOPBuildInCallMD5':
        res = new AOPBuildInCallMD5(query, Kotlin.isType(tmp$_35 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_35 : throwCCE());
        break;
      case 'AOPBuildInCallSTRLEN':
        res = new AOPBuildInCallSTRLEN(query, Kotlin.isType(tmp$_36 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_36 : throwCCE());
        break;
      case 'AOPBuildInCallMINUTES':
        res = new AOPBuildInCallMINUTES(query, Kotlin.isType(tmp$_37 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_37 : throwCCE());
        break;
      case 'AOPBuildInCallSECONDS':
        res = new AOPBuildInCallSECONDS(query, Kotlin.isType(tmp$_38 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_38 : throwCCE());
        break;
      case 'AOPBuildInCallMONTH':
        res = new AOPBuildInCallMONTH(query, Kotlin.isType(tmp$_39 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_39 : throwCCE());
        break;
      case 'AOPBuildInCallSHA1':
        res = new AOPBuildInCallSHA1(query, Kotlin.isType(tmp$_40 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_40 : throwCCE());
        break;
      case 'AOPBuildInCallSHA256':
        res = new AOPBuildInCallSHA256(query, Kotlin.isType(tmp$_41 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_41 : throwCCE());
        break;
      case 'AOPBuildInCallYEAR':
        res = new AOPBuildInCallYEAR(query, Kotlin.isType(tmp$_42 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_42 : throwCCE());
        break;
      case 'AOPEQ':
        res = new AOPEQ(query, Kotlin.isType(tmp$_43 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_43 : throwCCE(), Kotlin.isType(tmp$_44 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_44 : throwCCE());
        break;
      case 'ValueUndef':
      ...
      case 'AOPBuildInCallIRI':
        res = new AOPBuildInCallIRI(query, Kotlin.isType(tmp$_45 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_45 : throwCCE(), ensureNotNull(node.attributes.get_11rb$('prefix')));
        break;
      case 'AOPBuildInCallDATATYPE':
        res = new AOPBuildInCallDATATYPE(query, Kotlin.isType(tmp$_46 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_46 : throwCCE());
        break;
      case 'AOPBuildInCallTIMEZONE':
        res = new AOPBuildInCallTIMEZONE(query, Kotlin.isType(tmp$_47 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_47 : throwCCE());
        break;
      case 'AOPBuildInCallUCASE':
        res = new AOPBuildInCallUCASE(query, Kotlin.isType(tmp$_48 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_48 : throwCCE());
        break;
      case 'AOPBuildInCallLCASE':
        res = new AOPBuildInCallLCASE(query, Kotlin.isType(tmp$_49 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_49 : throwCCE());
        break;
      case 'AOPBuildInCallLANG':
        res = new AOPBuildInCallLANG(query, Kotlin.isType(tmp$_50 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_50 : throwCCE());
        break;
      case 'AOPDivision':
        res = new AOPDivision(query, Kotlin.isType(tmp$_51 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_51 : throwCCE(), Kotlin.isType(tmp$_52 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_52 : throwCCE());
        break;
      case 'ValueInteger':
      ...
      case 'AOPMultiplication':
        res = new AOPMultiplication(query, Kotlin.isType(tmp$_53 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_53 : throwCCE(), Kotlin.isType(tmp$_54 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_54 : throwCCE());
        break;
      ...
      case 'AOPBuildInCallSTRDT':
        res = new AOPBuildInCallSTRDT(query, Kotlin.isType(tmp$_55 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_55 : throwCCE(), Kotlin.isType(tmp$_56 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_56 : throwCCE());
        break;
      case 'AOPBuildInCallSTRLANG':
        res = new AOPBuildInCallSTRLANG(query, Kotlin.isType(tmp$_57 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_57 : throwCCE(), Kotlin.isType(tmp$_58 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_58 : throwCCE());
        break;
      case 'AOPBuildInCallSTRAFTER':
        res = new AOPBuildInCallSTRAFTER(query, Kotlin.isType(tmp$_59 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_59 : throwCCE(), Kotlin.isType(tmp$_60 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_60 : throwCCE());
        break;
      case 'AOPBuildInCallSTRBEFORE':
        res = new AOPBuildInCallSTRBEFORE(query, Kotlin.isType(tmp$_61 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_61 : throwCCE(), Kotlin.isType(tmp$_62 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_62 : throwCCE());
        break;
      case 'AOPBuildInCallBNODE0':
        res = new AOPBuildInCallBNODE0(query);
        break;
      case 'AOPBuildInCallSTR':
        res = new AOPBuildInCallSTR(query, Kotlin.isType(tmp$_63 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_63 : throwCCE());
        break;
      case 'AOPBuildInCallIsLITERAL':
        res = new AOPBuildInCallIsLITERAL(query, Kotlin.isType(tmp$_64 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_64 : throwCCE());
        break;
      case 'ValueIri':
        res = AOPConstant_init(query, new ValueIri(ensureNotNull(node.attributes.get_11rb$('value'))));
        break;
      case 'AOPBuildInCallSTRENDS':
        res = new AOPBuildInCallSTRENDS(query, Kotlin.isType(tmp$_65 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_65 : throwCCE(), Kotlin.isType(tmp$_66 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_66 : throwCCE());
        break;
      case 'AOPBuildInCallSTRSTARTS':
        res = new AOPBuildInCallSTRSTARTS(query, Kotlin.isType(tmp$_67 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_67 : throwCCE(), Kotlin.isType(tmp$_68 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_68 : throwCCE());
        break;
      case 'AOPBuildInCallCONCAT':
        res = new AOPBuildInCallCONCAT(query, Kotlin.isType(tmp$_69 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_69 : throwCCE(), Kotlin.isType(tmp$_70 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_70 : throwCCE());
        break;
      case 'AOPAggregationCOUNT':
        ...
        if (node.get_61zpoe$('children') != null) {
          ...
          while (tmp$_71.hasNext()) {
            ...
            childs_0.add_11rb$(Kotlin.isType(tmp$_72 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_3, mapping), AOPBase) ? tmp$_72 : throwCCE());
          }
        }
      ...
      case 'AOPAggregationSAMPLE':
        ...
        while (tmp$_73.hasNext()) {
          ...
          childs_1.add_11rb$(Kotlin.isType(tmp$_74 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_4, mapping), AOPBase) ? tmp$_74 : throwCCE());
        }
        ...
        break;
      case 'AOPConstant':
        res = XMLElementToOPBase_getInstance().invoke_d8op79$(query, first(ensureNotNull(node.get_61zpoe$('value')).childs), mapping);
        break;
      case 'AOPAggregationAVG':
        ...
        while (tmp$_75.hasNext()) {
          ...
          childs_2.add_11rb$(Kotlin.isType(tmp$_76 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_5, mapping), AOPBase) ? tmp$_76 : throwCCE());
        }
      ...
      case 'AOPAggregationSUM':
        ...
        while (tmp$_77.hasNext()) {
          ...
          childs_3.add_11rb$(Kotlin.isType(tmp$_78 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_6, mapping), AOPBase) ? tmp$_78 : throwCCE());
        }
      ...
      case 'AOPAggregationMIN':
        ...
        while (tmp$_79.hasNext()) {
          ...
          childs_4.add_11rb$(Kotlin.isType(tmp$_80 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_7, mapping), AOPBase) ? tmp$_80 : throwCCE());
        }
      ...
      case 'AOPAggregationMAX':
        ...
        while (tmp$_81.hasNext()) {
          ...
          childs_5.add_11rb$(Kotlin.isType(tmp$_82 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_8, mapping), AOPBase) ? tmp$_82 : throwCCE());
        }
      ...
      case 'AOPGT':
        ...
        break;
      case 'AOPIn':
        res = new AOPIn(query, Kotlin.isType(tmp$_85 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_85 : throwCCE(), Kotlin.isType(tmp$_86 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_86 : throwCCE());
        break;
      case 'AOPNotIn':
        res = new AOPNotIn(query, Kotlin.isType(tmp$_87 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_87 : throwCCE(), Kotlin.isType(tmp$_88 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_88 : throwCCE());
        break;
      case 'AOPOr':
        ...
        break;
      case 'AOPLT':
        res = new AOPLT(query, Kotlin.isType(tmp$_91 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_91 : throwCCE(), Kotlin.isType(tmp$_92 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_92 : throwCCE());
        break;
      case 'AOPNEQ':
        res = new AOPNEQ(query, Kotlin.isType(tmp$_93 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_93 : throwCCE(), Kotlin.isType(tmp$_94 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_94 : throwCCE());
        break;
      case 'AOPAnd':
        res = new AOPAnd(query, Kotlin.isType(tmp$_95 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_95 : throwCCE(), Kotlin.isType(tmp$_96 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_96 : throwCCE());
        break;
      case 'AOPBuildInCallTZ':
        res = new AOPBuildInCallTZ(query, Kotlin.isType(tmp$_97 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_97 : throwCCE());
        break;
      case 'POPSort':
        var child = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping);
        ...
        break;
      case 'POPProjection':
        var child_0 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping);
        res = new POPProjection(query, this.createProjectedVariables_0(query, node, mapping), child_0);
        break;
      case 'LOPMakeBooleanResult':
        res = new LOPMakeBooleanResult(query, XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'POPMakeBooleanResult':
        res = new POPMakeBooleanResult(query, this.createProjectedVariables_0(query, node, mapping), XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'POPMergePartition':
        var id = toInt(ensureNotNull(node.attributes.get_11rb$('partitionID')));
        res = new POPMergePartition(query, this.createProjectedVariables_0(query, node, mapping), ensureNotNull(node.attributes.get_11rb$('partitionVariable')), toInt(ensureNotNull(node.attributes.get_11rb$('partitionCount'))), id, XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
      ...
      case 'POPMergePartitionCount':
        ...
        res = new POPMergePartitionCount(query, emptyList(), ensureNotNull(node.attributes.get_11rb$('partitionVariable')), toInt(ensureNotNull(node.attributes.get_11rb$('partitionCount'))), id_9, XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
      ...
      case 'POPSplitPartitionFromStoreCount':
        ...
        break;
      case 'POPGroup':
        var child_1 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping);
        ...
        while (tmp$_138.hasNext()) {
          ...
          var tmp$_139;
          bindings.v = new POPBind(query, emptyList(), this.createAOPVariable_0(query, mapping, ensureNotNull(element_0.attributes.get_11rb$('name'))), Kotlin.isType(tmp$_139 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, element_0.childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_139 : throwCCE(), bindings.v);
        }
      ...
      case 'POPModify':
        ...
        while (tmp$_108.hasNext()) {
          ...
          insert.add_11rb$(Kotlin.isType(tmp$_109 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_17, mapping), LOPTriple) ? tmp$_109 : throwCCE());
        }
        ...
        while (tmp$_110.hasNext()) {
          ...
          delete_0.add_11rb$(Kotlin.isType(tmp$_111 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, c_18, mapping), LOPTriple) ? tmp$_111 : throwCCE());
        }

        var child_2 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping);
        res = new POPModify(query, this.createProjectedVariables_0(query, node, mapping), insert, delete_0, child_2);
        break;
      case 'POPFilter':
        res = new POPFilter(query, this.createProjectedVariables_0(query, node, mapping), Kotlin.isType(tmp$_112 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_112 : throwCCE(), XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'POPBind':
        var child0 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping);
        var child1 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping);
        ...
        break;
      case 'POPOffset':
        res = new POPOffset(query, this.createProjectedVariables_0(query, node, mapping), toInt(ensureNotNull(node.attributes.get_11rb$('offset'))), XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'POPLimit':
        res = new POPLimit(query, this.createProjectedVariables_0(query, node, mapping), toInt(ensureNotNull(node.attributes.get_11rb$('limit'))), XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'POPDebug':
        res = new POPDebug(query, this.createProjectedVariables_0(query, node, mapping), XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'POPReduced':
        res = new POPReduced(query, this.createProjectedVariables_0(query, node, mapping), XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping));
        break;
      case 'POPValues':
      ...
      case 'POPTripleStoreIterator':
        var s = Kotlin.isType(tmp$_116 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('sparam')).childs.get_za3lpa$(0), mapping), IAOPBase) ? tmp$_116 : throwCCE();
        var p = Kotlin.isType(tmp$_117 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('pparam')).childs.get_za3lpa$(0), mapping), IAOPBase) ? tmp$_117 : throwCCE();
        var o = Kotlin.isType(tmp$_118 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('oparam')).childs.get_za3lpa$(0), mapping), IAOPBase) ? tmp$_118 : throwCCE();
        var tripleStoreIndexDescription = Kotlin.isType(tmp$_119 = s05tripleStore.tripleStoreManager.getIndexFromXML_w70l3r$(ensureNotNull(node.get_61zpoe$('idx'))), TripleStoreIndexDescription) ? tmp$_119 : throwCCE();
        ...
        break;
      case 'LOPTriple':
        res = new LOPTriple(query, Kotlin.isType(tmp$_120 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(0), mapping), AOPBase) ? tmp$_120 : throwCCE(), Kotlin.isType(tmp$_121 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(1), mapping), AOPBase) ? tmp$_121 : throwCCE(), Kotlin.isType(tmp$_122 = XMLElementToOPBase_getInstance().invoke_d8op79$(query, ensureNotNull(node.get_61zpoe$('children')).childs.get_za3lpa$(2), mapping), AOPBase) ? tmp$_122 : throwCCE(), ensureNotNull(node.attributes.get_11rb$('graph')), toBoolean(ensureNotNull(node.attributes.get_11rb$('graphVar'))));
        break;
    ...
    if (!Kotlin.isType(res, AOPBase)) {
      ...
      if (tmp != null && tmp.length > 2) {
        ...
        while (tmp$_123.hasNext()) {
          ...
          }var tmp7 = indexOf_0(s00misc.ESortTypeExt.names, tmp5.get_za3lpa$(1));
          if (tmp7 < 0) {
            throw new UnreachableException();
          }tmp3.add_11rb$(new SortHelper(tmp5.get_za3lpa$(0), tmp7));
        }
        res.setMySortPriority_71iwwu$(tmp3);
      }}return res;
  };
  ...
  Object.defineProperty(package$Luposdate3000_Operator_Factory, '_ColumnIteratorQueueExt', {
    get: _ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Operator_Factory, '_DictionaryHelper', {
    get: _DictionaryHelper_getInstance
  });
  package$Luposdate3000_Operator_Factory._MyInputStreamFixedLength = _MyInputStreamFixedLength;
  package$Luposdate3000_Operator_Factory._MyStringStream = _MyStringStream;
  Object.defineProperty(package$Luposdate3000_Operator_Factory, '_PartitionExt', {
  ...
  Object.defineProperty(package$Luposdate3000_Operator_Factory, '_ByteArrayHelper', {
    get: _ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Operator_Factory._DateHelper_init = _DateHelper_init;
  package$Luposdate3000_Operator_Factory._DateHelper = _DateHelper;
  package$Luposdate3000_Operator_Factory._File_init_61zpoe$ = _File_init;
  package$Luposdate3000_Operator_Factory._File = _File;
  Object.defineProperty(package$Luposdate3000_Operator_Factory, '_IntegerExt', {
    get: _IntegerExt_getInstance
  });
  package$Luposdate3000_Operator_Factory._MyInputStream_init_y4putb$ = _MyInputStream_init;
  package$Luposdate3000_Operator_Factory._MyInputStream_init_kcn2v3$ = _MyInputStream_init_0;
  package$Luposdate3000_Operator_Factory._MyInputStream = _MyInputStream;
  package$Luposdate3000_Operator_Factory._MyOutputStream_init_8be2vx$ = _MyOutputStream_init;
  package$Luposdate3000_Operator_Factory._MyOutputStream = _MyOutputStream;
  package$Luposdate3000_Operator_Factory._MyPrintWriter_init_6taknv$ = _MyPrintWriter_init;
  package$Luposdate3000_Operator_Factory._MyPrintWriter = _MyPrintWriter;
  Object.defineProperty(package$Luposdate3000_Operator_Factory, '_Platform', {
