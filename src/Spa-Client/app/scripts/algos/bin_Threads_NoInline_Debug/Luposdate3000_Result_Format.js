(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'Luposdate3000_Shared', 'Luposdate3000_Operator_Physical', 'Luposdate3000_Operator_Base', 'Luposdate3000_Operator_Logical', 'KotlinBigInteger-bignum-jsLegacy', 'Luposdate3000_Shared_JS'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('Luposdate3000_Shared'), require('Luposdate3000_Operator_Physical'), require('Luposdate3000_Operator_Base'), require('Luposdate3000_Operator_Logical'), require('KotlinBigInteger-bignum-jsLegacy'), require('Luposdate3000_Shared_JS'));
  else {
    ...
    }root.Luposdate3000_Result_Format = factory(typeof Luposdate3000_Result_Format === 'undefined' ? {} : Luposdate3000_Result_Format, kotlin, Luposdate3000_Shared, Luposdate3000_Operator_Physical, Luposdate3000_Operator_Base, Luposdate3000_Operator_Logical, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared_JS);
  }
}(this, function (_, Kotlin, $module$Luposdate3000_Shared, $module$Luposdate3000_Operator_Physical, $module$Luposdate3000_Operator_Base, $module$Luposdate3000_Operator_Logical, $module$KotlinBigInteger_bignum_jsLegacy, $module$Luposdate3000_Shared_JS) {
  'use strict';
  ...
  function QueryResultToEmptyStream$writeNodeResult$lambda(closure$node, closure$parent, closure$partitionVariable, closure$p, closure$partitionCount, closure$variables, closure$lock, closure$output, this$QueryResultToEmptyStream, closure$errors) {
    return function () {
      try {
        ...
        var child = child2.evaluateRoot_t5uvj0$(Partition_init_0(closure$parent, closure$partitionVariable.v, closure$p, closure$partitionCount.v));
  ...
  QueryResultToEmptyStream.prototype.writeNodeResult_0 = function (variables, node, output, parent) {
    ...
    if (shared.tripleStoreManager.getPartitionMode() === 2 && (Kotlin.isType(node, POPMergePartition) && node.partitionCount > 1 || (Kotlin.isType(node, POPMergePartitionOrderedByIntId) && node.partitionCount > 1))) {
      ...
      var child = node.evaluateRoot_t5uvj0$(parent);
      var destination = ArrayList_init(variables.length);
      var tmp$_4;
  ...
  QueryResultToEmptyStream.prototype.invoke_yn6l39$ = function (rootNode, output) {
  ...
  QueryResultToEmptyWithDictionaryStream.prototype.writeValue_0 = function (buffer, valueID, columnName, dictionary, output) {
    dictionary.getValue_v5fxe$(buffer, valueID);
  };
  ...
  QueryResultToEmptyWithDictionaryStream.prototype.invoke_yn6l39$ = function (rootNode, output) {
    var query = rootNode.getQuery();
    var flag = query.getDictionaryUrl() == null;
    var key = query.getTransactionID().toString();
    if (flag && shared.tripleStoreManager.getPartitionMode() === 1) {
    ...
    for (var i_0 = 0; i_0 !== nodes.length; ++i_0) {
      ...
      if (Kotlin.isType(node, OPNothing)) {
        ...
        if (variables.length === 1 && equals(variables[0], '?boolean')) {
          var child = node.evaluateRoot();
          var buffer = ByteArrayWrapper_init();
          query.getDictionary().getValue_v5fxe$(buffer, ensureNotNull(child.columns.get_11rb$('?boolean')).next());
  ...
  QueryResultToMemoryTable.prototype.invoke_76ws8p$ = function (rootNode, partition) {
    if (partition === void 0)
    ...
    var resultList = ArrayList_init_0();
    for (var i_0 = 0; i_0 !== nodes.length; ++i_0) {
      var tmp$_0;
      var node = nodes[i_0];
      if (Kotlin.isType(node, OPNothing)) {
        ...
        if (variables_0.length === 1 && equals(variables_0[0], '?boolean')) {
          var child = node.evaluateRoot_t5uvj0$(partition);
          var buffer = ByteArrayWrapper_init();
          query.getDictionary().getValue_v5fxe$(buffer, ensureNotNull(child.columns.get_11rb$('?boolean')).next());
          var value = DictionaryHelper_getInstance().byteArrayToValueDefinition_b1q5io$(buffer);
          ...
          if (variables_0.length === 0) {
            var child_0 = node.evaluateRoot_t5uvj0$(partition);
  ...
  QueryResultToTurtleStream.prototype.writeAllRows_0 = function (variables, columns, dictionary, lock, output) {
    var tmp$;
    var variablesIndices = new Int32Array([indexOf(variables, 's'), indexOf(variables, 'p'), indexOf(variables, 'o')]);
    var rowBuf = new Int32Array(variables.length);
    var resultWriter = MyPrintWriter_init(true);
    var buffer = ByteArrayWrapper_init();
    loop: while (true) {
      for (var variableIndex = 0; variableIndex !== variables.length; ++variableIndex) {
        var valueID = columns[variableIndex].next();
  ...
  QueryResultToTurtleStream.prototype.invoke_yn6l39$ = function (rootNode, output) {
    var query = rootNode.getQuery();
    var flag = query.getDictionaryUrl() == null;
    var key = query.getTransactionID().toString();
    if (flag && shared.tripleStoreManager.getPartitionMode() === 1) {
    ...
    for (var i_0 = 0; i_0 !== nodes.length; ++i_0) {
      ...
      if (!Kotlin.isType(node, OPNothing)) {
        ...
        var variables = copyToArray(columnNames);
        if (variables.length !== 3 || !contains(variables, 's') || !contains(variables, 'p') || !contains(variables, 'o')) {
  ...
  function QueryResultToXMLElement$toXML$lambda_0(closure$value) {
    return function () {
      return endsWith(closure$value, '"^^<http://www.w3.org/2001/XMLSchema#boolean>');
    };
  }
  ...
  QueryResultToXMLElement.prototype.toXML_tpi62f$ = function (rootNode) {
    var tmp$;
    var buffer = ByteArrayWrapper_init();
    var query = rootNode.getQuery();
    var flag = query.getDictionaryUrl() == null;
    ...
    for (var i_0 = 0; i_0 !== nodes.length; ++i_0) {
      ...
      if (Kotlin.isType(node, OPNothing)) {
        ...
        while (tmp$_1.hasNext()) {
          ...
          nodeHead.addContent_esm5gr$((new XMLElement('variable')).addAttribute_puj7f4$('name', variable));
        }
      } else {
        var columnNames;
        if (!columnProjectionOrder.get_za3lpa$(i_0).isEmpty()) {
        ...
        var child = node.evaluateRoot_t5uvj0$(Partition_init());
        var variables = copyToArray(columnNames);
        if (variables.length === 1 && equals(variables[0], '?boolean')) {
          query.getDictionary().getValue_v5fxe$(buffer, ensureNotNull(child.columns.get_11rb$('?boolean')).next());
          var value = ensureNotNull(DictionaryHelper_getInstance().byteArrayToValueDefinition_b1q5io$(buffer).valueToString());
          ...
          nodeSparql.addContent_esm5gr$(tmp$_4.addContent_61zpoe$(value.substring(1, endIndex)));
          ensureNotNull(child.columns.get_11rb$('?boolean')).close();
        } else {
          ...
          for (tmp$_2 = 0; tmp$_2 !== variables.length; ++tmp$_2) {
            ...
            nodeHead.addContent_esm5gr$((new XMLElement('variable')).addAttribute_puj7f4$('name', variable_0));
          }
          if (variables.length === 0) {
            tmp$_3 = child.count();
            for (var j = 0; j < tmp$_3; j++) {
              var nodeResult = new XMLElement('result');
              nodeResults_0.addContent_esm5gr$(nodeResult);
            }
          } else {
            var destination = ArrayList_init(variables.length);
            var tmp$_5;
            ...
            loop: while (true) {
              ...
              for (var variableIndex = 0; variableIndex !== variables.length; ++variableIndex) {
                ...
                if (valueID === 4) {
                  ...
                  query.getDictionary().getValue_v5fxe$(buffer, valueID);
                  ...
                  if (ensureNotNull(value_0).length > 1) {
                    if (startsWith(value_0, '"') && !endsWith(value_0, '"')) {
                      ...
                      if (idx >= 0) {
                        ...
                        nodeBinding.addContent_esm5gr$((new XMLElement('literal')).addContent_61zpoe$(data).addAttribute_puj7f4$('datatype', type));
                      } else {
                        ...
                        nodeBinding.addContent_esm5gr$((new XMLElement('literal')).addContent_61zpoe$(data_0).addAttribute_puj7f4$('xml:lang', lang));
                      }
                    } else if (startsWith(value_0, '<') && endsWith(value_0, '>')) {
                      var tmp$_7 = new XMLElement('uri');
                      var endIndex_2 = value_0.length - 1 | 0;
                      nodeBinding.addContent_esm5gr$(tmp$_7.addContent_61zpoe$(value_0.substring(1, endIndex_2)));
                      ...
                      nodeBinding.addContent_esm5gr$((new XMLElement('bnode')).addContent_61zpoe$(name));
                    } else {
                      var tmp$_8 = new XMLElement('literal');
                      var endIndex_3 = value_0.length - 1 | 0;
                      nodeBinding.addContent_esm5gr$(tmp$_8.addContent_61zpoe$(value_0.substring(1, endIndex_3)));
                    }
                  }nodeResult_0.addContent_esm5gr$(nodeBinding);
                }}
              nodeResults_0.addContent_esm5gr$(nodeResult_0);
            }
          }
        }
      }
    ...
    while (tmp$.hasNext()) {
      var r = tmp$.next();
      compountResult.addContent_esm5gr$(r);
    }
    if (flag && shared.tripleStoreManager.getPartitionMode() === 1) {
      shared.communicationHandler.sendData_hq2gfh$(shared.tripleStoreManager.getLocalhost(), '/distributed/query/dictionary/remove', mapOf(to('key', key)));
  ...
  QueryResultToXMLStream.prototype.writeValue_0 = function (buffer, valueID, columnName, dictionary, output) {
    dictionary.getValue_v5fxe$(buffer, valueID);
    DictionaryHelper_getInstance().byteArrayToCallback_6o198z$(buffer, QueryResultToXMLStream$writeValue$lambda(output, columnName), QueryResultToXMLStream$writeValue$lambda_0(output, columnName), QueryResultToXMLStream$writeValue$lambda_1(output, columnName), QueryResultToXMLStream$writeValue$lambda_2(output, columnName), QueryResultToXMLStream$writeValue$lambda_3(output, columnName), QueryResultToXMLStream$writeValue$lambda_4(output, columnName), QueryResultToXMLStream$writeValue$lambda_5(output, columnName), QueryResultToXMLStream$writeValue$lambda_6(output, columnName), QueryResultToXMLStream$writeValue$lambda_7(output, columnName), QueryResultToXMLStream$writeValue$lambda_8(output, columnName), QueryResultToXMLStream$writeValue$lambda_9, QueryResultToXMLStream$writeValue$lambda_10);
  };
  ...
  QueryResultToXMLStream.prototype.invoke_yn6l39$ = function (rootNode, output) {
    var query = rootNode.getQuery();
    var flag = query.getDictionaryUrl() == null;
    var key = query.getTransactionID().toString();
    if (flag && shared.tripleStoreManager.getPartitionMode() === 1) {
    ...
    for (var i_0 = 0; i_0 !== nodes.length; ++i_0) {
      ...
      if (Kotlin.isType(node, OPNothing)) {
        ...
        if (variables_0.length === 1 && equals(variables_0[0], '?boolean')) {
          ...
          output.print_6taknv$(DictionaryHelper_getInstance().byteArrayToBoolean_b1q5io$(buffer));
          output.print_61zpoe$('<\/boolean>\n');
          ensureNotNull(child.columns.get_11rb$('?boolean')).close();
        } else {
          if (variables_0.length === 0) {
            var child_0 = node.evaluateRoot_t5uvj0$(Partition_init());
            output.print_61zpoe$(' <head/>\n <results>\n');
  ...
  var package$result_format = package$lupos.result_format || (package$lupos.result_format = {});
  Object.defineProperty(package$result_format, 'EQueryResultToStreamExt', {
    get: EQueryResultToStreamExt_getInstance
  });
  Object.defineProperty(package$result_format, 'QueryResultToEmptyStream', {
    get: QueryResultToEmptyStream_getInstance
  });
  Object.defineProperty(package$result_format, 'QueryResultToEmptyWithDictionaryStream', {
    get: QueryResultToEmptyWithDictionaryStream_getInstance
  });
  Object.defineProperty(package$result_format, 'QueryResultToMemoryTable', {
    get: QueryResultToMemoryTable_getInstance
  });
  Object.defineProperty(package$result_format, 'QueryResultToTurtleStream', {
    get: QueryResultToTurtleStream_getInstance
  });
  Object.defineProperty(package$result_format, 'QueryResultToXMLElement', {
    get: QueryResultToXMLElement_getInstance
  });
  Object.defineProperty(package$result_format, 'QueryResultToXMLStream', {
  ...
  Object.defineProperty(package$Luposdate3000_Result_Format, 'BufferManagerPage', {
    get: BufferManagerPage_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Result_Format, 'ColumnIteratorQueueExt', {
    get: ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Result_Format, 'DictionaryHelper', {
    get: DictionaryHelper_getInstance
  });
  var package$dynamicArray = package$Luposdate3000_Result_Format.dynamicArray || (package$Luposdate3000_Result_Format.dynamicArray = {});
  ...
  package$Luposdate3000_Result_Format.MyInputStreamFixedLength = MyInputStreamFixedLength;
  package$Luposdate3000_Result_Format.MyStringStream = MyStringStream;
  ...
  Object.defineProperty(package$Luposdate3000_Result_Format, 'ByteArrayHelper', {
    get: ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Result_Format.DateHelper_init = DateHelper_init;
  package$Luposdate3000_Result_Format.DateHelper = DateHelper;
  package$Luposdate3000_Result_Format.File_init_61zpoe$ = File_init;
  package$Luposdate3000_Result_Format.File = File;
  Object.defineProperty(package$Luposdate3000_Result_Format, 'IntegerExt', {
    get: IntegerExt_getInstance
  });
  package$Luposdate3000_Result_Format.MyInputStream_init_y4putb$ = MyInputStream_init;
  package$Luposdate3000_Result_Format.MyInputStream_init_kcn2v3$ = MyInputStream_init_0;
  package$Luposdate3000_Result_Format.MyInputStream = MyInputStream;
  package$Luposdate3000_Result_Format.MyOutputStream_init_8be2vx$ = MyOutputStream_init;
  package$Luposdate3000_Result_Format.MyOutputStream = MyOutputStream;
  package$Luposdate3000_Result_Format.MyPrintWriter_init_6taknv$ = MyPrintWriter_init;
  package$Luposdate3000_Result_Format.MyPrintWriter = MyPrintWriter;
  ...
  Object.defineProperty(package$Luposdate3000_Result_Format, 'Platform', {
