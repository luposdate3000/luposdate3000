(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'KotlinBigInteger-bignum-jsLegacy', 'Luposdate3000_Shared', 'Luposdate3000_Optimizer_Logical', 'Luposdate3000_Operator_Physical', 'Luposdate3000_Operator_Base', 'Luposdate3000_Operator_Logical', 'Luposdate3000_Triple_Store_Manager', 'Luposdate3000_Operator_Arithmetik', 'Luposdate3000_Shared_JS'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('KotlinBigInteger-bignum-jsLegacy'), require('Luposdate3000_Shared'), require('Luposdate3000_Optimizer_Logical'), require('Luposdate3000_Operator_Physical'), require('Luposdate3000_Operator_Base'), require('Luposdate3000_Operator_Logical'), require('Luposdate3000_Triple_Store_Manager'), require('Luposdate3000_Operator_Arithmetik'), require('Luposdate3000_Shared_JS'));
  else {
    ...
    }root.Luposdate3000_Optimizer_Physical = factory(typeof Luposdate3000_Optimizer_Physical === 'undefined' ? {} : Luposdate3000_Optimizer_Physical, kotlin, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared, Luposdate3000_Optimizer_Logical, Luposdate3000_Operator_Physical, Luposdate3000_Operator_Base, Luposdate3000_Operator_Logical, Luposdate3000_Triple_Store_Manager, Luposdate3000_Operator_Arithmetik, Luposdate3000_Shared_JS);
  }
}(this, function (_, Kotlin, $module$KotlinBigInteger_bignum_jsLegacy, $module$Luposdate3000_Shared, $module$Luposdate3000_Optimizer_Logical, $module$Luposdate3000_Operator_Physical, $module$Luposdate3000_Operator_Base, $module$Luposdate3000_Operator_Logical, $module$Luposdate3000_Triple_Store_Manager, $module$Luposdate3000_Operator_Arithmetik, $module$Luposdate3000_Shared_JS) {
  'use strict';
  ...
  var POPGraphOperation = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.noinput.POPGraphOperation;
  ...
  var POPModifyData = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.noinput.POPModifyData;
  var LOPModifyData = $module$Luposdate3000_Operator_Logical.lupos.s04logicalOperators.noinput.LOPModifyData;
  ...
  var POPValues_init = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.noinput.POPValues_init_jy50xw$;
  ...
  var POPGroup_init = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPGroup_init_zhfc1s$;
  ...
  var POPVisualisation = $module$Luposdate3000_Operator_Physical.lupos.s09physicalOperators.singleinput.POPVisualisation;
  ...
  PhysicalOptimizerDebug.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
    var res = {v: node};
  ...
  PhysicalOptimizerJoinType.prototype.embedWithinPartitionContext_0 = function (joinColumns, childA, childB, create, keepOrder) {
    var tmp$, tmp$_0;
    if (s05tripleStore.tripleStoreManager.getPartitionMode() === 2 || s05tripleStore.tripleStoreManager.getPartitionMode() === 1) {
      var a = childA;
      var b = childB;
  ...
  PhysicalOptimizerJoinType.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
          ...
          if (node.optional) {
            ...
            if (tmp$_7) {
              ...
              if (tmp$_10) {
                ...
                var tmp$_13 = Kotlin.isType(childA, POPTripleStoreIterator);
                if (!tmp$_13) {
                  var tmp$_14 = Kotlin.isType(childA, LOPTriple);
                  if (tmp$_14) {
                    var tmp$_15 = childB.getProvidedVariableNames();
                    ...
                    while (tmp$_16.hasNext()) {
                      var item_2 = tmp$_16.next();
                      destination_2.add_11rb$(item_2.variableName);
                    }
                    tmp$_14 = tmp$_15.containsAll_brywnq$(destination_2);
                  }tmp$_13 = tmp$_14;
                }if (tmp$_13) {
  ...
  PhysicalOptimizerNaive.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3, tmp$_4;
    var res = node;
    var change = true;
    ...
    try {
      ...
      if (Kotlin.isType(node, LOPSortAny)) {
        ...
        var tmp$_5 = s05tripleStore.tripleStoreManager.getGraph_61zpoe$(node.graph);
        ...
        res = tmp$_5.getIterator_no1dp4$(tmp$_6, array, 14);
  ...
  PhysicalOptimizerPartitionAssignsSamePartitionCountToAnyRelatedOperator.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
    if (s05tripleStore.tripleStoreManager.getPartitionMode() === 2 || s05tripleStore.tripleStoreManager.getPartitionMode() === 1) {
  ...
  PhysicalOptimizerPartitionAssingPartitionsToRemaining.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
    var tmp$, tmp$_0;
    var res = node;
    if (s05tripleStore.tripleStoreManager.getPartitionMode() === 2 || s05tripleStore.tripleStoreManager.getPartitionMode() === 1) {
  ...
  PhysicalOptimizerPartitionExpandPartitionTowardsStore.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
    var tmp$;
    var res = node;
    if (s05tripleStore.tripleStoreManager.getPartitionMode() === 2 || s05tripleStore.tripleStoreManager.getPartitionMode() === 1) {
  ...
  PhysicalOptimizerPartitionExpandTowardsRoot.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
      ...
      if (Kotlin.isType(node, POPSplitPartitionFromStore)) {
        ...
        if (Kotlin.isType(c0, POPMergePartition)) {
          ...
          if (columnCountC0 === columnCountC1) {
            var columnID = this.query.mergePartitionOperator_gydk9z$(columnIDC0, columnIDC1, c1.getChildren()[0]);
            switch (modeC0) {
              case 1:
        ...
        if (Kotlin.isType(c_3, POPMergePartition)) {
          if (equals(node.partitionVariable, c_3.partitionVariable)) {
            if (node.partitionCount === c_3.partitionCount) {
              ...
              this.query.removePartitionOperator_yhmem3$(node.getUUID(), node.partitionID);
              this.query.mergePartitionOperator_gydk9z$(node.partitionID, c_3.partitionID, res);
              this.query.partitionOperatorCount.clear();
              onChange();
  ...
  PhysicalOptimizerPartitionRemoveUselessPartitions.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
    var res = node;
    if (s05tripleStore.tripleStoreManager.getPartitionMode() === 2 || s05tripleStore.tripleStoreManager.getPartitionMode() === 1) {
      if (Kotlin.isType(node, POPSplitPartitionFromStore)) {
  ...
  PhysicalOptimizerPartitionRespectMaxPartitions.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
  ...
  PhysicalOptimizerTripleIndex.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
    var tmp$;
    var res = node;
    if (Kotlin.isType(node, LOPTriple)) {
      ...
      onChange();
      var store = s05tripleStore.tripleStoreManager.getGraph_61zpoe$(node.graph);
      var array = Array_0(3);
      var tmp$_0;
      ...
      var targetIdx = tmp$_2.getIndex_ibv87m$(tmp$_3, destination);
      println('targetIdx ' + s00misc.EIndexPatternExt.names[targetIdx]);
      res = store.getIterator_no1dp4$(this.query, params, targetIdx);
      println('PhysicalOptimizerTripleIndex : initialize any Iterator ' + res.getUUID().toString());
  ...
  PhysicalOptimizerVisualisation.prototype.optimize_wyxs0m$ = function (node, parent, onChange) {
    var res = node;
  ...
  Object.defineProperty(package$Luposdate3000_Optimizer_Physical, '_ColumnIteratorQueueExt', {
    get: _ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Optimizer_Physical, '_DictionaryHelper', {
    get: _DictionaryHelper_getInstance
  });
  package$Luposdate3000_Optimizer_Physical._MyInputStreamFixedLength = _MyInputStreamFixedLength;
  package$Luposdate3000_Optimizer_Physical._MyStringStream = _MyStringStream;
  Object.defineProperty(package$Luposdate3000_Optimizer_Physical, '_PartitionExt', {
  ...
  Object.defineProperty(package$Luposdate3000_Optimizer_Physical, '_ByteArrayHelper', {
    get: _ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Optimizer_Physical._DateHelper_init = _DateHelper_init;
  package$Luposdate3000_Optimizer_Physical._DateHelper = _DateHelper;
  package$Luposdate3000_Optimizer_Physical._File_init_61zpoe$ = _File_init;
  package$Luposdate3000_Optimizer_Physical._File = _File;
  Object.defineProperty(package$Luposdate3000_Optimizer_Physical, '_IntegerExt', {
    get: _IntegerExt_getInstance
  });
  package$Luposdate3000_Optimizer_Physical._MyInputStream_init_y4putb$ = _MyInputStream_init;
  package$Luposdate3000_Optimizer_Physical._MyInputStream_init_kcn2v3$ = _MyInputStream_init_0;
  package$Luposdate3000_Optimizer_Physical._MyInputStream = _MyInputStream;
  package$Luposdate3000_Optimizer_Physical._MyOutputStream_init_8be2vx$ = _MyOutputStream_init;
  package$Luposdate3000_Optimizer_Physical._MyOutputStream = _MyOutputStream;
  package$Luposdate3000_Optimizer_Physical._MyPrintWriter_init_6taknv$ = _MyPrintWriter_init;
  package$Luposdate3000_Optimizer_Physical._MyPrintWriter = _MyPrintWriter;
  Object.defineProperty(package$Luposdate3000_Optimizer_Physical, '_Platform', {
