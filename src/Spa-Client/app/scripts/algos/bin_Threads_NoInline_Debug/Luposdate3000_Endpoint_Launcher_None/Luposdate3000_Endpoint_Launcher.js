(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Endpoint_Launcher'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'Luposdate3000_Endpoint_Launcher'.");
    }if (typeof this['KotlinBigInteger-bignum-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Endpoint_Launcher'. Its dependency 'KotlinBigInteger-bignum-jsLegacy' was not found. Please, check whether 'KotlinBigInteger-bignum-jsLegacy' is loaded prior to 'Luposdate3000_Endpoint_Launcher'.");
    }if (typeof Luposdate3000_Shared === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Endpoint_Launcher'. Its dependency 'Luposdate3000_Shared' was not found. Please, check whether 'Luposdate3000_Shared' is loaded prior to 'Luposdate3000_Endpoint_Launcher'.");
    }if (typeof Luposdate3000_Shared_JS === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Endpoint_Launcher'. Its dependency 'Luposdate3000_Shared_JS' was not found. Please, check whether 'Luposdate3000_Shared_JS' is loaded prior to 'Luposdate3000_Endpoint_Launcher'.");
    }root.Luposdate3000_Endpoint_Launcher = factory(typeof Luposdate3000_Endpoint_Launcher === 'undefined' ? {} : Luposdate3000_Endpoint_Launcher, kotlin, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared, Luposdate3000_Shared_JS);
  }
  ...
  function HttpEndpointLauncher() {
    HttpEndpointLauncher_instance = this;
  }
  HttpEndpointLauncher.prototype.start = function () {
  };
  HttpEndpointLauncher.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'HttpEndpointLauncher',
    interfaces: []
  };
  var HttpEndpointLauncher_instance = null;
  function HttpEndpointLauncher_getInstance() {
    if (HttpEndpointLauncher_instance === null) {
      new HttpEndpointLauncher();
    }return HttpEndpointLauncher_instance;
  }
  ...
  Object.defineProperty(package$endpoint_launcher, 'HttpEndpointLauncher', {
    get: HttpEndpointLauncher_getInstance
  });
  var package$Luposdate3000_Endpoint_Launcher_None = package$lupos.Luposdate3000_Endpoint_Launcher_None || (package$lupos.Luposdate3000_Endpoint_Launcher_None = {});
  Object.defineProperty(package$Luposdate3000_Endpoint_Launcher_None, 'BufferManagerPage', {
    get: BufferManagerPage_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Endpoint_Launcher_None, 'ColumnIteratorQueueExt', {
    get: ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Endpoint_Launcher_None, 'DictionaryHelper', {
    get: DictionaryHelper_getInstance
  });
  var package$dynamicArray = package$Luposdate3000_Endpoint_Launcher_None.dynamicArray || (package$Luposdate3000_Endpoint_Launcher_None.dynamicArray = {});
  ...
  package$Luposdate3000_Endpoint_Launcher_None.MyInputStreamFixedLength = MyInputStreamFixedLength;
  package$Luposdate3000_Endpoint_Launcher_None.MyStringStream = MyStringStream;
  Object.defineProperty(package$Luposdate3000_Endpoint_Launcher_None, 'SanityCheckOff', {
    get: SanityCheckOff_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Endpoint_Launcher_None, 'SanityCheckOn', {
    get: SanityCheckOn_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Endpoint_Launcher_None, 'ByteArrayHelper', {
    get: ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Endpoint_Launcher_None.DateHelper_init = DateHelper_init;
  package$Luposdate3000_Endpoint_Launcher_None.DateHelper = DateHelper;
  package$Luposdate3000_Endpoint_Launcher_None.File_init_61zpoe$ = File_init;
  package$Luposdate3000_Endpoint_Launcher_None.File = File;
  Object.defineProperty(package$Luposdate3000_Endpoint_Launcher_None, 'IntegerExt', {
    get: IntegerExt_getInstance
  });
  package$Luposdate3000_Endpoint_Launcher_None.MyInputStream_init_y4putb$ = MyInputStream_init;
  package$Luposdate3000_Endpoint_Launcher_None.MyInputStream_init_kcn2v3$ = MyInputStream_init_0;
  package$Luposdate3000_Endpoint_Launcher_None.MyInputStream = MyInputStream;
  package$Luposdate3000_Endpoint_Launcher_None.MyOutputStream_init_8be2vx$ = MyOutputStream_init;
  package$Luposdate3000_Endpoint_Launcher_None.MyOutputStream = MyOutputStream;
  package$Luposdate3000_Endpoint_Launcher_None.MyPrintWriter_init_6taknv$ = MyPrintWriter_init;
  package$Luposdate3000_Endpoint_Launcher_None.MyPrintWriter = MyPrintWriter;
  package$Luposdate3000_Endpoint_Launcher_None.MyThreadReadWriteLock = MyThreadReadWriteLock;
  Object.defineProperty(package$Luposdate3000_Endpoint_Launcher_None, 'ParallelThread', {
    get: ParallelThread_getInstance
  });
  package$Luposdate3000_Endpoint_Launcher_None.ParallelThreadCondition = ParallelThreadCondition;
  package$Luposdate3000_Endpoint_Launcher_None.ParallelThreadQueue_init_mh5how$ = ParallelThreadQueue_init;
  package$Luposdate3000_Endpoint_Launcher_None.ParallelThreadQueue = ParallelThreadQueue;
  Object.defineProperty(package$Luposdate3000_Endpoint_Launcher_None, 'Platform', {
    get: Platform_getInstance
  });
  Kotlin.defineModule('Luposdate3000_Endpoint_Launcher', _);
  return _;
}));

//# sourceMappingURL=Luposdate3000_Endpoint_Launcher.js.map
