(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Jena_Wrapper'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'Luposdate3000_Jena_Wrapper'.");
    }if (typeof this['KotlinBigInteger-bignum-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Jena_Wrapper'. Its dependency 'KotlinBigInteger-bignum-jsLegacy' was not found. Please, check whether 'KotlinBigInteger-bignum-jsLegacy' is loaded prior to 'Luposdate3000_Jena_Wrapper'.");
    }if (typeof Luposdate3000_Shared === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Jena_Wrapper'. Its dependency 'Luposdate3000_Shared' was not found. Please, check whether 'Luposdate3000_Shared' is loaded prior to 'Luposdate3000_Jena_Wrapper'.");
    }if (typeof Luposdate3000_Shared_JS === 'undefined') {
      throw new Error("Error loading module 'Luposdate3000_Jena_Wrapper'. Its dependency 'Luposdate3000_Shared_JS' was not found. Please, check whether 'Luposdate3000_Shared_JS' is loaded prior to 'Luposdate3000_Jena_Wrapper'.");
    }root.Luposdate3000_Jena_Wrapper = factory(typeof Luposdate3000_Jena_Wrapper === 'undefined' ? {} : Luposdate3000_Jena_Wrapper, kotlin, this['KotlinBigInteger-bignum-jsLegacy'], Luposdate3000_Shared, Luposdate3000_Shared_JS);
  }
  ...
  function JenaWrapper() {
    JenaWrapper_instance = this;
  }
  JenaWrapper.prototype.dropAll = function () {
  };
  JenaWrapper.prototype.execQuery_61zpoe$ = function (queryString) {
    return '';
  };
  JenaWrapper.prototype.loadFromFile_61zpoe$ = function (fileName) {
  };
  JenaWrapper.prototype.loadFromFile_puj7f4$ = function (fileName, graph) {
  };
  JenaWrapper.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'JenaWrapper',
    interfaces: []
  };
  var JenaWrapper_instance = null;
  function JenaWrapper_getInstance() {
    if (JenaWrapper_instance === null) {
      new JenaWrapper();
    }return JenaWrapper_instance;
  }
  ...
  var package$jena_wrapper = package$lupos.jena_wrapper || (package$lupos.jena_wrapper = {});
  Object.defineProperty(package$jena_wrapper, 'JenaWrapper', {
    get: JenaWrapper_getInstance
  });
  var package$Luposdate3000_Jena_Wrapper_Off = package$lupos.Luposdate3000_Jena_Wrapper_Off || (package$lupos.Luposdate3000_Jena_Wrapper_Off = {});
  Object.defineProperty(package$Luposdate3000_Jena_Wrapper_Off, 'BufferManagerPage', {
    get: BufferManagerPage_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Jena_Wrapper_Off, 'ColumnIteratorQueueExt', {
    get: ColumnIteratorQueueExt_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Jena_Wrapper_Off, 'DictionaryHelper', {
    get: DictionaryHelper_getInstance
  });
  var package$dynamicArray = package$Luposdate3000_Jena_Wrapper_Off.dynamicArray || (package$Luposdate3000_Jena_Wrapper_Off.dynamicArray = {});
  ...
  package$Luposdate3000_Jena_Wrapper_Off.MyInputStreamFixedLength = MyInputStreamFixedLength;
  package$Luposdate3000_Jena_Wrapper_Off.MyStringStream = MyStringStream;
  Object.defineProperty(package$Luposdate3000_Jena_Wrapper_Off, 'SanityCheckOff', {
    get: SanityCheckOff_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Jena_Wrapper_Off, 'SanityCheckOn', {
    get: SanityCheckOn_getInstance
  });
  Object.defineProperty(package$Luposdate3000_Jena_Wrapper_Off, 'ByteArrayHelper', {
    get: ByteArrayHelper_getInstance
  });
  package$Luposdate3000_Jena_Wrapper_Off.DateHelper_init = DateHelper_init;
  package$Luposdate3000_Jena_Wrapper_Off.DateHelper = DateHelper;
  package$Luposdate3000_Jena_Wrapper_Off.File_init_61zpoe$ = File_init;
  package$Luposdate3000_Jena_Wrapper_Off.File = File;
  Object.defineProperty(package$Luposdate3000_Jena_Wrapper_Off, 'IntegerExt', {
    get: IntegerExt_getInstance
  });
  package$Luposdate3000_Jena_Wrapper_Off.MyInputStream_init_y4putb$ = MyInputStream_init;
  package$Luposdate3000_Jena_Wrapper_Off.MyInputStream_init_kcn2v3$ = MyInputStream_init_0;
  package$Luposdate3000_Jena_Wrapper_Off.MyInputStream = MyInputStream;
  package$Luposdate3000_Jena_Wrapper_Off.MyOutputStream_init_8be2vx$ = MyOutputStream_init;
  package$Luposdate3000_Jena_Wrapper_Off.MyOutputStream = MyOutputStream;
  package$Luposdate3000_Jena_Wrapper_Off.MyPrintWriter_init_6taknv$ = MyPrintWriter_init;
  package$Luposdate3000_Jena_Wrapper_Off.MyPrintWriter = MyPrintWriter;
  package$Luposdate3000_Jena_Wrapper_Off.MyThreadReadWriteLock = MyThreadReadWriteLock;
  Object.defineProperty(package$Luposdate3000_Jena_Wrapper_Off, 'ParallelThread', {
    get: ParallelThread_getInstance
  });
  package$Luposdate3000_Jena_Wrapper_Off.ParallelThreadCondition = ParallelThreadCondition;
  package$Luposdate3000_Jena_Wrapper_Off.ParallelThreadQueue_init_mh5how$ = ParallelThreadQueue_init;
  package$Luposdate3000_Jena_Wrapper_Off.ParallelThreadQueue = ParallelThreadQueue;
  Object.defineProperty(package$Luposdate3000_Jena_Wrapper_Off, 'Platform', {
    get: Platform_getInstance
  });
  Kotlin.defineModule('Luposdate3000_Jena_Wrapper', _);
  return _;
}));

//# sourceMappingURL=Luposdate3000_Jena_Wrapper.js.map
