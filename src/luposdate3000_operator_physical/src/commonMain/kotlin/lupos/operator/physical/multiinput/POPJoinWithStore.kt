...
public class POPJoinWithStore public constructor(query: IQuery, projectedVariables: List<String>, childA: IOPBase, @JvmField public val childB: LOPTriple, @JvmField public val optional: Boolean) : POPBase(query, projectedVariables, EOperatorIDExt.POPJoinWithStoreID, "POPJoinWithStore", arrayOf(childA), ESortPriorityExt.SAME_AS_CHILD) {
    ...
    override /*suspend*/ fun evaluate(parent: Partition): IteratorBundle {
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:57"/*SOURCE_FILE_END*/ }, { !optional })
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:58"/*SOURCE_FILE_END*/ }, { !childB.graphVar })
        ...
        for (i in 0 until 3) {
            ...
            if (t is AOPVariable) {
                ...
                if (columnsTmp[0].contains(name)) {
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:90"/*SOURCE_FILE_END*/ }, { name != "_" })
                    for (k in 0 until 3) {
                    ...
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:106"/*SOURCE_FILE_END*/ }, { columnsTmp[2].contains(name) || name == "_" })
                    if (name != "_") {
        ...
        for (name in tmp2) {
            SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:115"/*SOURCE_FILE_END*/ }, { columnsTmp[1].contains(name) || name == "_" })
            if (name != "_") {
                columnsOUT.add(Pair(name, 0))
                columnsINAO.add(0, childAv.columns[name]!!)
            }
        }
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:121"/*SOURCE_FILE_END*/ }, { variablINBO.size > 0 })
        ...
        for (i in 0 until indicesINBJ.size) {
            SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:133"/*SOURCE_FILE_END*/ }, { params[indicesINBJ[i]] is AOPVariable })
            params[indicesINBJ[i]] = AOPConstant(query, DictionaryExt.undefValue2)
            count++
        }
        SanityCheck(
            { /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:138"/*SOURCE_FILE_END*/ },
            {
                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:140"/*SOURCE_FILE_END*/ }, { count > 0 })
                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:141"/*SOURCE_FILE_END*/ }, { count < 3 })
                for (i in 0 until childB.mySortPriority.size) {
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:143"/*SOURCE_FILE_END*/ }, { childB.mySortPriority[i].sortType == ESortTypeExt.FAST })
                }
                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:145"/*SOURCE_FILE_END*/ }, { indicesINBJ.size > 0 })
                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:146"/*SOURCE_FILE_END*/ }, { valuesAJ.size == indicesINBJ.size })
            }
        )
                                ...
                                loopA@ while (true) {
                                    ...
                                    loopB@ for (i in 0 until variablINBO.size) {
                                        ...
                                        if (value == DictionaryValueHelper.nullValue) {
                                            ...
                                            SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStore.kt:199"/*SOURCE_FILE_END*/ }, { i == 0 })
                                            done = false
                                            break@loopB
                                        } else {
