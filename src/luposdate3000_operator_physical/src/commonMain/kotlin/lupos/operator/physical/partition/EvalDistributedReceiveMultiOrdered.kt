...
debugselected=min
                    println("EvalDistributedReceiveMultiOrdered id=$debugCurrentID selected input $min")
            ...
            println("EvalDistributedReceiveMultiOrdered id=$debugCurrentID key=${debugkeys[debugselected]} $variables ${
                if (res >= 0) {
