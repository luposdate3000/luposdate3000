...
public class POPJoinWithStoreExists public constructor(query: IQuery, projectedVariables: List<String>, childA: IOPBase, @JvmField public val childB: LOPTriple, @JvmField public val optional: Boolean) : POPBase(query, projectedVariables, EOperatorIDExt.POPJoinWithStoreExistsID, "POPJoinWithStoreExists", arrayOf(childA), ESortPriorityExt.SAME_AS_CHILD) {
    ...
    override /*suspend*/ fun evaluate(parent: Partition): IteratorBundle {
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStoreExists.kt:46"/*SOURCE_FILE_END*/ }, { !optional })
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStoreExists.kt:47"/*SOURCE_FILE_END*/ }, { !childB.graphVar })
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStoreExists.kt:48"/*SOURCE_FILE_END*/ }, { projectedVariables.isEmpty() })
        ...
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStoreExists.kt:66"/*SOURCE_FILE_END*/ }, { mapping.isNotEmpty() })
        for (i in mapping.indices) {
            ...
            if (tmp == DictionaryValueHelper.nullValue) {
                ...
                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStoreExists.kt:74"/*SOURCE_FILE_END*/ }, { i == 0 })
                break
            } else {
                    ...
                    loop@ while (!t && !done) {
                        for (i in mapping.indices) {
                            ...
                            if (tmp == DictionaryValueHelper.nullValue) {
                                ...
                                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinWithStoreExists.kt:94"/*SOURCE_FILE_END*/ }, { i == 0 })
                                break@loop
                            } else {
                                params[mapping[i]] = AOPConstant(query, tmp)
                            }
