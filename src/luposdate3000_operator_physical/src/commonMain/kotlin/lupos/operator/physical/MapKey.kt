...
internal class MapKey(@JvmField val data: DictionaryValueTypeArray) {
    ...
    fun equalsFuzzy(other: Any?): Boolean {
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/MapKey.kt:33"/*SOURCE_FILE_END*/ }, { other is MapKey })
