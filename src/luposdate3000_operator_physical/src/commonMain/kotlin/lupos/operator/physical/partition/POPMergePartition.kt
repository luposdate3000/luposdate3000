...
public class POPMergePartition public constructor(query: IQuery,
 ...
 projectedVariables, EOperatorIDExt.POPMergePartitionID, "POPMergePartition", arrayOf(child), ESortPriorityExt.PREVENT_ANY) {
