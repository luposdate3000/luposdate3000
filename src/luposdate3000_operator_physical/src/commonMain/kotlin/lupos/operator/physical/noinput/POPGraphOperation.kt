...
public class POPGraphOperation public constructor(
    ...
    public override fun usesDictionary(): Boolean {
        ...
        SanityCheck(
            { /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/noinput/POPGraphOperation.kt:210"/*SOURCE_FILE_END*/ },
            {
                res = true
            }
        )
