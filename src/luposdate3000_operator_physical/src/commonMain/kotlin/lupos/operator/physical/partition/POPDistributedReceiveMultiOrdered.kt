...
public class POPDistributedReceiveMultiOrdered public constructor(
    ...
    override /*suspend*/ fun evaluate(parent: Partition): IteratorBundle = EvalDistributedReceiveMultiOrdered(inputs, outputs, orderedBy, projectedVariables,IntArray(outputs.size){-it})
}
