...
public operator fun invoke(): IteratorBundle {
        if (partitionCount2 == 1) {
            ...
            SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/partition/EvalMergePartitionOrderedByIntId.kt:42"/*SOURCE_FILE_END*/ }, { variables0.containsAll(variables) })
            SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/partition/EvalMergePartitionOrderedByIntId.kt:43"/*SOURCE_FILE_END*/ }, { variables.containsAll(variables0) })
            // the variable may be eliminated directly after using it in the join            SanityCheck.check({/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/partition/EvalMergePartitionOrderedByIntId.kt:44"/*SOURCE_FILE_END*/},{ variables.contains(partitionVariable) })
            ...
            SanityCheck(
                { /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/partition/EvalMergePartitionOrderedByIntId.kt:170"/*SOURCE_FILE_END*/ },
                {
                    for (x in sortColumns.indices) {
                        SanityCheck.check(
                            { /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/partition/EvalMergePartitionOrderedByIntId.kt:174"/*SOURCE_FILE_END*/ },
                            { sortColumns[x] >= 0 },
                            { "${variables.map{it}} .. ${mySortPriority.map{it.variableName}}" }
                        )
                        SanityCheck.check(
                            { /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/partition/EvalMergePartitionOrderedByIntId.kt:179"/*SOURCE_FILE_END*/ },
