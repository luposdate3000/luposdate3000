...
public class POPGroup : POPBase {
    ...
    override fun getPartitionCount(variable: String): Int {
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/singleinput/POPGroup.kt:72"/*SOURCE_FILE_END*/ }, { children[0].getPartitionCount(variable) == 1 })
        return 1
    }
    ...
    override fun syntaxVerifyAllVariableExists(additionalProvided: List<String>, autocorrect: Boolean) {
        ...
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/singleinput/POPGroup.kt:132"/*SOURCE_FILE_END*/ }, { additionalProvided.isEmpty() })
                ...
                loop2@ while (true) {
                    for (columnIndex in 0 until valueColumnNames.size) {
                        ...
                        if (value == DictionaryValueHelper.nullValue) {
                            SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/singleinput/POPGroup.kt:230"/*SOURCE_FILE_END*/ }, { columnIndex == 0 })
            ...
            if (canUseSortedInput) {
                ...
                for (columnIndex in keyColumnNames.indices) {
                    ...
                    if (value == DictionaryValueHelper.nullValue) {
                        ...
                        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/singleinput/POPGroup.kt:277"/*SOURCE_FILE_END*/ }, { columnIndex == 0 })
                        emptyResult = true
                        break
                    }
                                        ...
                                        loop@ while (true) {
                                            ...
                                            for (columnIndex in keyColumnNames.indices) {
                                                ...
                                                if (value == DictionaryValueHelper.nullValue) {
                                                    ...
                                                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/singleinput/POPGroup.kt:358"/*SOURCE_FILE_END*/ }, { columnIndex == 0 })
                    ...
                    loop@ while (true) {
                        ...
                        for (columnIndex in keyColumnNames.indices) {
                            ...
                            if (value == DictionaryValueHelper.nullValue) {
                                ...
                                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/singleinput/POPGroup.kt:484"/*SOURCE_FILE_END*/ }, { columnIndex == 0 })
                                break@loop
                            }
                            currentKey[columnIndex] = value
                        }
