    ...
    override fun getPartitionCount(variable: String): Int {
        return if (children[0].getProvidedVariableNames().contains(variable)) {
            if (children[1].getProvidedVariableNames().contains(variable)) {
                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinHashMap.kt:40"/*SOURCE_FILE_END*/ }, { children[0].getPartitionCount(variable) == children[1].getPartitionCount(variable) })
...
// --- obtain child columns
        ...
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinHashMap.kt:65"/*SOURCE_FILE_END*/ }, { columns[0].size != 0 })
        ...
        var countA: Int
        var countB: Int
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinHashMap.kt:112"/*SOURCE_FILE_END*/ }, { columnsINAJ.size > 0 })
                            ...
                            while (!done) {
                                ...
                                loopA@ while (true) {
                                    ...
                                    for (columnIndex in 0 until columnsINAJ.size) {
                                        ...
                                        if (value == DictionaryValueHelper.nullValue) {
                                            SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinHashMap.kt:208"/*SOURCE_FILE_END*/ }, { columnIndex == 0 })
                                            nextKey = null
                                            break@loopA
                                        }
                                        nextKey!![columnIndex] = value
...
// search for_join-partners
                                    ...
                                    for (columnIndex in 0 until columnsINAO.size) {
                                        for (i in 0 until countA) {
                                            ...
                                            SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinHashMap.kt:258"/*SOURCE_FILE_END*/ }, { tmp2 != DictionaryValueHelper.nullValue })
