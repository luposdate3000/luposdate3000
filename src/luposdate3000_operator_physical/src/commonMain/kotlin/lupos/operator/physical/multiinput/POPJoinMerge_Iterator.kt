        ...
        return ColumnIteratorChildIteratorExt.nextHelper(
            this,
            {
                if (key0[0] != DictionaryValueHelper.nullValue && key1[0] != DictionaryValueHelper.nullValue) {
                    loop@ while (true) {
                        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:126"/*SOURCE_FILE_END*/ }, { columnsINJ0.isNotEmpty() })
// first join column
                        if (key0[0] != key1[0]) {
                            var skip0 = 0
                            var skip1 = 0
                            while (key0[0] != key1[0]) {
                                if (key0[0] < key1[0]) {
                                    ...
                                    skip0++
                                    skipO0++
                                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:139"/*SOURCE_FILE_END*/ }, { key0[0] != DictionaryValueHelper.undefValue })
                                    ...
                                    skip1++
                                    skipO1++
                                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:151"/*SOURCE_FILE_END*/ }, { key1[0] != DictionaryValueHelper.undefValue })
                            ...
                            if (skip0 > 0) {
                                ...
                                while (localNextJ < columnsINJ0.size) {
                                    ...
                                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:162"/*SOURCE_FILE_END*/ }, { key0[localNextJ] != DictionaryValueHelper.undefValue })
                                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:163"/*SOURCE_FILE_END*/ }, { key0[localNextJ] != DictionaryValueHelper.nullValue })
                                    localNextJ++
                                }
                            }
                            if (skip1 > 0) {
                                ...
                                while (localNextJ < columnsINJ1.size) {
                                    ...
                                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:171"/*SOURCE_FILE_END*/ }, { key1[localNextJ] != DictionaryValueHelper.undefValue })
                                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:172"/*SOURCE_FILE_END*/ }, { key1[localNextJ] != DictionaryValueHelper.nullValue })
                                    localNextJ++
                                }
                            }
                        }
                        ...
                        while (localNextI < columnsINJ0.size) {
                            if (key0[localNextI] < key1[localNextI]) {
                                ...
                                while (localNextJ < columnsINJ0.size) {
                                    ...
                                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:185"/*SOURCE_FILE_END*/ }, { key0[localNextJ] != DictionaryValueHelper.undefValue })
                                    if (key0[localNextJ] == DictionaryValueHelper.nullValue) {
                                        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:187"/*SOURCE_FILE_END*/ }, { localNextJ == 0 })
                                        __close()
                                        break@loop
                                    }
                                    localNextJ++
                                ...
                                while (localNextJ < columnsINJ1.size) {
                                    ...
                                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:199"/*SOURCE_FILE_END*/ }, { key1[localNextJ] != DictionaryValueHelper.undefValue })
                                    if (key1[localNextJ] == DictionaryValueHelper.nullValue) {
                                        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:201"/*SOURCE_FILE_END*/ }, { localNextJ == 0 })
                                        __close()
                                        break@loop
                                    }
                                    localNextJ++
...
// the only-A columns
                        ...
                        loop2@ while (true) {
                            ...
                            while (localNextI < columnsINJ0.size) {
                                ...
                                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:246"/*SOURCE_FILE_END*/ }, { key0[localNextI] != DictionaryValueHelper.undefValue })
                                localNextI++
                            }
                            localNextI = 0
                            while (localNextI < columnsINJ0.size) {
...
// the only-B columns
                        ...
                        loop2@ while (true) {
                            ...
                            while (localNextI < columnsINJ1.size) {
                                ...
                                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:286"/*SOURCE_FILE_END*/ }, { key1[localNextI] != DictionaryValueHelper.undefValue })
                                localNextI++
                            }
                            localNextI = 0
                            while (localNextI < columnsINJ1.size) {
