...
//                                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:238"/*SOURCE_FILE_END*/ }, { data0[localNextI][localNextCounta] != DictionaryValueHelper.nullValue })
                                    localNextI++
                                }
                                skipO0 = 0
                            }
                            ...
                            while (localNextI < columnsINJ0.size) {
                                ...
                                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:247"/*SOURCE_FILE_END*/ }, { key0[localNextI] != DictionaryValueHelper.undefValue })
                                localNextI++
                            }
                            localNextI = 0
                            while (localNextI < columnsINJ0.size) {
...
// the only-B columns
                        ...
                        loop2@ while (true) {
                            ...
                            while (localNextI < columnsINJ1.size) {
                                ...
                                SanityCheck.check({ /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_operator_physical/src/commonMain/kotlin/lupos/operator/physical/multiinput/POPJoinMerge_Iterator.kt:287"/*SOURCE_FILE_END*/ }, { key1[localNextI] != DictionaryValueHelper.undefValue })
                                localNextI++
                            }
                            localNextI = 0
                            while (localNextI < columnsINJ1.size) {
