...
public class SparqlTestSuiteConverterToUnitTest(resource_folder: String) : SparqlTestSuite() {
    ...
    override fun parseSPARQLAndEvaluate( //
        ...
        val ignoreListDueToBugs = setOf(
            "AVG",
            "AVGwithGROUPBY",
            "bind01BINDfixeddataforOWLDL",
            "bind02BINDfixeddataforOWLDL",
            "bind03BINDfixeddataforOWLDL",
            "bind04BINDfixeddataforOWLDL",
            "bind05BINDfixeddataforOWLDL",
            "bind06BINDfixeddataforOWLDL",
            "bind07BINDfixeddataforOWLDL",
            "bind08BINDfixeddataforOWLDL",
            "BNODE",
            "bnodesarenotexistentialswithanswer",
            "BNODEstr",
            "Calculatepropersubset",
            "CalculatewhichsetsaresubsetsofothersexcludeAsubsetOfA",
            "CalculatewhichsetsaresubsetsofothersincludeAsubsetOfA",
            "Calculatewhichsetshavethesameelements",
            "COALESCE",
            "CONCAT2",
            "COUNT4",
            "COUNT6",
            "COUNT7",
            "csv01CSVResultFormat",
            "csv03CSVResultFormat", // csv-parser
            "cvs02CSVResultFormat",
            "DELETEINSERT1",
            "DELETEINSERT1b",
            "DELETEINSERT1c",
            "DELETEINSERT2",
            ...
            "DELETEINSERT5b",
            "ErrorinAVG",
            "Expressionhasvariablethatmaybeunbound",
            "Expressionmayreturnnovalue",
            "Expressionraiseanerror",
            "filteredsubclassquerywithhasChildsomeThingrestriction",
            "IFerrorpropogation",
            "IRIURI",
            "MAX",
            "MAXwithGROUPBY",
            "MedicaltemporalproximitybyexclusionNOTEXISTS",
            "MINwithGROUPBY",
            "NOW",
            "papersparqldlQ1",
            "papersparqldlQ1rdfs",
            ...
            "papersparqldlQ4",
            "papersparqldlQ5",
            "parentquerywithdistinguishedvariable",
            "parentquerywithhasChildexactly1Femalerestriction",
            "parentquerywithhasChildmax1Femalerestriction",
            "parentquerywithhasChildmin1Femalerestriction",
            "parentquerywithhasChildmin1restriction",
            "parentquerywithhasChildsomeFemalerestriction",
            "parentquerywithhasChildsomeThingrestriction",
            "plus1",
            "plus2",
            "PostqueryVALUESwith2objvars1row",
            "PostqueryVALUESwith2objvars1rowwithUNDEF",
            "PostqueryVALUESwith2objvars2rowswithUNDEF",
            "PostqueryVALUESwithobjvar1row",
            "PostqueryVALUESwithOPTIONALobjvar1row",
            "PostqueryVALUESwithpredvar1row",
            "ProtectfromerrorinAVG",
            "RDFSinferencetestcombiningsubPropertyOfanddomain",
            "RDFSinferencetestdomain",
            "RDFSinferencetestrange",
            "RDFSinferencetestrdfssubPropertyOf",
            "RDFSinferencetestsubClassOf",
            "RDFSinferencetestsubPropertyandinstances",
            "RDFSinferencetesttransitivityofsubClassOf",
            "RDFSinferencetesttransitivityofsubPropertyOf",
            "Reuseaprojectexpressionvariableinselect",
            "SERVICEtest7",
            "SHA1onUnicodedata",
            "SHA256onUnicodedata", // sha256-function
            "simple1",
            "simple2",
            "simple3",
            "simple4",
            ...
            "SimpleDELETEDATA3",
            "SimpleDELETEWHERE1",
            "sparqldl02rqsimplecombinedquery",
            "sparqldl03rqcombinedquerywithcomplexclassdescription",
            "sparqldl04rqbugfixingtest",
            "sparqldl05rqsimpleundistinguishedvariabletest",
            "sparqldl06rqcycleofundistinguishedvariables",
            "sparqldl07rqtwodistinguishedvariablesundist",
            "sparqldl08rqtwodistinguishedvariablesundist",
            "sparqldl09rqundistvarstest",
            "sparqldl10rqundistvarstest",
            "sparqldl11rqdomaintest",
            "sparqldl12rqrangetest",
            "sparqldl13rqsameAs",
            "sq11Subquerylimitperresource",
            "sq13Subqueriesdontinjectbindings",
            "sq14limitbyresource",
            "STRAFTER",
            "STRAFTERdatatyping",
            "STRBEFORE",
            ...
            "STRLANG",
            "STRLANGTypeErrors",
            "subclassquerywithhasChildsomeThingrestriction",
            "SubtractionwithMINUSfromafullyboundminuend",
            "SubtractionwithMINUSfromapartiallyboundminuend",
            "SUM",
            "TIMEZONE",
            "TZ",
        )
        val ignoreList = ignoreListDueToTooSlow + ignoreListDueToNotImplemented + ignoreListDueToBugs
