...
internal object SparqlTestSuiteConverterToUnitTestIgnoreListDueToTooSlow {
    internal val ignoreListDueToTooSlow = mapOf(
        "bind01BIND" to "too slow",
        "bind03BIND" to "too slow",
        "Calculatepropersubset" to "too slow",
        "Calculatewhichsetshavethesameelements" to "too slow",
        "CEIL" to "too slow",
        "CLEARGRAPH" to "too slow",
        "DELETEINSERT4b" to "too slow",
        "ENCODEFORURI" to "too slow",
        "GraphspecificDELETE2USING" to "too slow",
        "InlineVALUESgraphpattern" to "too slow",
        "INSERT01" to "too slow",
        "MD5" to "too slow",
        "MedicaltemporalproximitybyexclusionNOTEXISTS" to "too slow",
        "Nestednegativeexistsinpositiveexists" to "too slow",
        "papersparqldlQ2" to "too slow",
        "parentquerywithhasChildsomeFemalerestriction" to "too slow",
        "Plainliteralswithlanguagetagarenotthesameasthesameliteralwithout" to "too slow",
        "PositiveEXISTS1" to "too slow",
        "PostqueryVALUESwith2objvars1row" to "too slow",
        "pp30Operatorprecedence1" to "too slow",
        "RAND" to "too slow",
        "RDFSinferencetestdomain" to "too slow",
        "RDFSinferencetesttoshowthatneitherliteralsinsubjectpositionnornewlyintroducedsurrogateblanknodesaretobereturnedinqueryanswers" to "too slow",
        ...
        "Reuseaprojectexpressionvariableinselect" to "too slow",
        "ROUND" to "too slow",
        "simple5" to "too slow",
        "sparqldl01rqtriplepattern" to "too slow",
        "STRDTTypeErrors" to "too slow",
        "STRENDS" to "too slow",
    )
}
