...
// grep org.junit.runners.model.TestTimedOutException x -B1 | grep "lupos.code_gen_test_" | sed "s/\[.*/\" to \"too slow\",/g" | sed "s/.*\./        \"/g" | sort | uniq
    internal val ignoreListDueToTooSlow = mapOf(
        "bind01BIND" to "too slow",
        "bind02BIND" to "too slow",
        "bind03BIND" to "too slow",
        "bind04BIND" to "too slow",
        "bind05BIND" to "too slow",
        "bind06BIND" to "too slow",
        "bind08BIND" to "too slow",
        "CLEARALL" to "too slow",
        "CLEARDEFAULT" to "too slow",
        "CLEARGRAPH" to "too slow",
        "CLEARNAMED" to "too slow",
        "CLEARSILENTGRAPHiri" to "too slow",
        "CONCAT" to "too slow",
        "constructwhere01CONSTRUCTWHERE" to "too slow",
        "CONTAINS" to "too slow",
        "COPY7" to "too slow",
        "COUNT2" to "too slow",
        "COUNT3" to "too slow",
        "COUNT5" to "too slow",
        ...
        "DEntailmenttesttoshowthatneitherliteralsinsubjectpositionnornewlyintroducedsurrogateblanknodesaretobereturnedinqueryanswers" to "too slow",
        "Group5" to "too slow",
        "isNumeric" to "too slow",
        "MOVE7" to "too slow",
        "NOTIN1" to "too slow",
        "RDFinferencetestluposDuplicate1" to "too slow",
        "RDFSinferencetestcontainers" to "too slow",
        "RDFSinferencetestrdfXMLLiteral" to "too slow",
        ...
        "RDFtestforblanknodecardinalities" to "too slow",
        "ROUND" to "too slow",
        "Simpleinsertdata1" to "too slow",
        "simpletriplepatternmatch" to "too slow",
        "sparqldl01rqtriplepattern" to "too slow",
        "STRENDS" to "too slow",
        "STRSTARTS" to "too slow",
        "SubsetsbyexclusionNOTEXISTS" to "too slow",
        "tsv01TSVResultFormat" to "too slow",
        "tsv03TSVResultFormat" to "too slow",
