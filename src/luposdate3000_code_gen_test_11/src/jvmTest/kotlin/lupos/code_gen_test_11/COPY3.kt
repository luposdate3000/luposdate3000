...
public class COPY3 {
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByIDTwiceAllCollations - true`() {
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByIDTwiceAllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByID_1_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByID_1_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByID_2_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByID_2_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByID_O_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByID_O_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByID_S_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByID_S_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByKeyAllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - None - PartitionByKeyAllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    public fun `COPY 3 - Thread - Simple - false`() {
      ...
      try{
        ...
        val query189 = Query(instance)
        val graph189 = instance.tripleStoreManager!!.getGraph(inputGraph[0])
        val operator189 = graph189.getIterator(query189, arrayOf(AOPVariable(query189, "s"), AOPVariable(query189, "p"), AOPVariable(query189, "o")), EIndexPatternExt.SPO)
        val actual189 = (LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator189, buf, EQueryResultToStreamExt.MEMORY_TABLE) as List<MemoryTable>).first()
        val expected189 = MemoryTable.parseFromAny(inputData[0], inputType[0], Query(instance))!!
        val buf_err189 = MyPrintWriter()
        if (!expected189.equalsVerbose(actual189, true, true, buf_err189)) {
            fail(expected189.toString() + " .. " + actual189.toString() + " .. " + buf_err189.toString() + " .. " + operator189)
        }
        val query190 = Query(instance)
        val graph190 = instance.tripleStoreManager!!.getGraph(inputGraph[1])
        val operator190 = graph190.getIterator(query190, arrayOf(AOPVariable(query190, "s"), AOPVariable(query190, "p"), AOPVariable(query190, "o")), EIndexPatternExt.SPO)
        val actual190 = (LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator190, buf, EQueryResultToStreamExt.MEMORY_TABLE) as List<MemoryTable>).first()
        val expected190 = MemoryTable.parseFromAny(inputData[1], inputType[1], Query(instance))!!
        val buf_err190 = MyPrintWriter()
        if (!expected190.equalsVerbose(actual190, true, true, buf_err190)) {
            fail(expected190.toString() + " .. " + actual190.toString() + " .. " + buf_err190.toString() + " .. " + operator190)
        }
        val query191 = Query(instance)
        val graph191 = instance.tripleStoreManager!!.getGraph(inputGraph[2])
        val operator191 = graph191.getIterator(query191, arrayOf(AOPVariable(query191, "s"), AOPVariable(query191, "p"), AOPVariable(query191, "o")), EIndexPatternExt.SPO)
        val actual191 = (LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator191, buf, EQueryResultToStreamExt.MEMORY_TABLE) as List<MemoryTable>).first()
        val expected191 = MemoryTable.parseFromAny(inputData[2], inputType[2], Query(instance))!!
        val buf_err191 = MyPrintWriter()
        if (!expected191.equalsVerbose(actual191, true, true, buf_err191)) {
            fail(expected191.toString() + " .. " + actual191.toString() + " .. " + buf_err191.toString() + " .. " + operator191)
        }
        val operator192 = LuposdateEndpoint.evaluateSparqlToOperatorgraphA(instance, query)
        LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator192, buf, EQueryResultToStreamExt.EMPTY_STREAM)
        val query193 = Query(instance)
        val graph193 = instance.tripleStoreManager!!.getGraph(outputGraph[0])
        val operator193 = graph193.getIterator(query193, arrayOf(AOPVariable(query193, "s"), AOPVariable(query193, "p"), AOPVariable(query193, "o")), EIndexPatternExt.SPO)
        val actual193 = (LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator193, buf, EQueryResultToStreamExt.MEMORY_TABLE) as List<MemoryTable>).first()
        val expected193 = MemoryTable.parseFromAny(outputData[0], outputType[0], Query(instance))!!
        val buf_err193 = MyPrintWriter()
        if (!expected193.equalsVerbose(actual193, true, true, buf_err193)) {
            fail(expected193.toString() + " .. " + actual193.toString() + " .. " + buf_err193.toString() + " .. " + operator193)
        }
        val query194 = Query(instance)
        val graph194 = instance.tripleStoreManager!!.getGraph(outputGraph[1])
        val operator194 = graph194.getIterator(query194, arrayOf(AOPVariable(query194, "s"), AOPVariable(query194, "p"), AOPVariable(query194, "o")), EIndexPatternExt.SPO)
        val actual194 = (LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator194, buf, EQueryResultToStreamExt.MEMORY_TABLE) as List<MemoryTable>).first()
        val expected194 = MemoryTable.parseFromAny(outputData[1], outputType[1], Query(instance))!!
        val buf_err194 = MyPrintWriter()
        if (!expected194.equalsVerbose(actual194, true, true, buf_err194)) {
            fail(expected194.toString() + " .. " + actual194.toString() + " .. " + buf_err194.toString() + " .. " + operator194)
        }
        val query195 = Query(instance)
        val graph195 = instance.tripleStoreManager!!.getGraph(outputGraph[2])
        val operator195 = graph195.getIterator(query195, arrayOf(AOPVariable(query195, "s"), AOPVariable(query195, "p"), AOPVariable(query195, "o")), EIndexPatternExt.SPO)
        val actual195 = (LuposdateEndpoint.evaluateOperatorgraphToResultA(instance, operator195, buf, EQueryResultToStreamExt.MEMORY_TABLE) as List<MemoryTable>).first()
        val expected195 = MemoryTable.parseFromAny(outputData[2], outputType[2], Query(instance))!!
        val buf_err195 = MyPrintWriter()
        if (!expected195.equalsVerbose(actual195, true, true, buf_err195)) {
            fail(expected195.toString() + " .. " + actual195.toString() + " .. " + buf_err195.toString() + " .. " + operator195)
        }
      }finally{
        LuposdateEndpoint.close(instance)
      }
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - None`() {
        simulatorHelper(
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_1_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_1_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_2_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_2_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_O_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_O_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByKeyAllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByKeyAllCollations - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - Simple - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - Simple - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByIDTwiceAllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_1_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_1_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_1_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_2_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_2_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_2_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_O_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_O_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByID_S_AllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByID_S_AllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByKeyAllCollations - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - PartitionByKeyAllCollations - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - Simple - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Test(timeout = 2000)
    public fun `COPY 3 - in simulator - Simple - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
