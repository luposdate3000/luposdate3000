...
for x in 3_3 4_4 5_5 3_4 3_5 4_5 3_6 4_6 5_6 6_6
do
arr=(${x//_/ })
ii=$(printf "%04d" $i)
...
do
ii=$(printf "%04d" $i)
echo "./12_joinopti_agent_eval.py 1 6 20 0.7 /src/luposdate3000/src/machinelearning/_tmpdata/complete.n3.nt  _tmpdata/model/model_${arr[0]}_${arr[1]}_20_0.7_${y}.model" > tasks/$ii.sh
echo "retVal=\$?" >> tasks/$ii.sh
echo "if [ \$retVal -eq 0 ]; then" >> tasks/$ii.sh
echo "truncate -s0 tasks/$ii.sh" >> tasks/$ii.sh
echo "fi" >> tasks/$ii.sh
