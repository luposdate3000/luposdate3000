...
do
ii=$(printf "%04d" $i)
echo ./12_joinopti_agent_eval.py 1 $upper 128 0.7 /mnt/luposdate-testdata/wordnet/wordnet.nt models/model_${arr[0]}_${arr[1]}_128_0.7_${y}.model > tasks/$ii.sh
chmod +x tasks/$ii.sh
i=$((i+1))
done
done
