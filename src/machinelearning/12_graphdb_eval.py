...
for queryrow in training_data:
    ...
    resultstringorg = re.sub('\s+',' ',result.decode('utf-8').replace("rdf:type","<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>").replace("rdfs:seeAlso","<http://www.w3.org/2000/01/rdf-schema#seeAlso>").replace("rdfs:subClassOf","<http://www.w3.org/2000/01/rdf-schema#subClassOf>"))
