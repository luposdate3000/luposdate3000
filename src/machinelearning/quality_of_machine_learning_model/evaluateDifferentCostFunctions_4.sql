...
select name,intermediate_on_traffic,traffic_on_traffic,intermediate_on_intermediate,traffic_on_intermediate from evaluate_ranking_based_on_network_traffic n, evaluate_ranking_based_on_intermediate i, mapping_optimizer o where o.id=n.optimizer_id and n.optimizer_id=i.optimizer_id and name != "all" and (name not like "%model" or name like "%_1048576.model") INTO OUTFILE '/var/lib/mysql-files/ranking_on_4.csv' FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';
