...
echo "z,intermediate on traffic,traffic on traffic,intermediate on intermediate,traffic on intermediate" > ranking_on_3.csv
echo "z,intermediate on traffic,traffic on traffic,intermediate on intermediate,traffic on intermediate" > ranking_on_4.csv
echo "z,intermediate on traffic,traffic on traffic,intermediate on intermediate,traffic on intermediate" > ranking_on_5.csv
echo "z,intermediate on traffic,traffic on traffic,intermediate on intermediate,traffic on intermediate" > ranking_on_6.csv
