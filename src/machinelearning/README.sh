...
for tripleCount in "${tripleCount[@]}"
do
...
if test -f "$tripleFile.bench.csv"
then
...
do
    ...
    echo ./src/machinelearning/11_joinopti_agent.py train
    ...
    echo ./src/machinelearning/11_joinopti_agent.py opti
