...
plot "rewardlog_3_3cleaned.csv" using 1:2 with lines title "3_3" ,\
     ...
     "rewardlog_3_5cleaned.csv" using 1:2 with lines title "3_6" ,\
     "rewardlog_4_5cleaned.csv" using 1:2 with lines title "4_6" ,\
     "rewardlog_4_5cleaned.csv" using 1:2 with lines title "5_6" ,\
     "rewardlog_5_5cleaned.csv" using 1:2 with lines title "6_6"
