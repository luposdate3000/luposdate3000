...
public class CLEARDEFAULT {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/CLEARDEFAULT.input",
        "src/jvmTest/resources/CLEARDEFAULT.input1",
        "src/jvmTest/resources/CLEARDEFAULT.input2",
    )
    ...
    internal val outputDataFile = arrayOf(
        "src/jvmTest/resources/CLEARDEFAULT.output0",
        "src/jvmTest/resources/CLEARDEFAULT.output1",
        "src/jvmTest/resources/CLEARDEFAULT.output2",
    )
    ...
    @Test
    public fun `CLEAR DEFAULT - None - Simple - true`() {
    ...
    @Test
    public fun `CLEAR DEFAULT - None - Simple - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
    ...
    @Test
    public fun `CLEAR DEFAULT - Thread - Simple - true`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
    ...
    @Test
    public fun `CLEAR DEFAULT - Thread - Simple - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.Thread
