...
public class resourcessp2bq12bsparql247 {
    ...
    @Test(timeout = 10000)
    public fun `resourcessp2bq12bsparql247 - in simulator - PartitionByID_2_AllCollations - Centralized - false - None`() {
        simulatorHelper(
    ...
    @Test(timeout = 10000)
    public fun `resourcessp2bq12bsparql247 - in simulator - PartitionByID_O_AllCollations - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
