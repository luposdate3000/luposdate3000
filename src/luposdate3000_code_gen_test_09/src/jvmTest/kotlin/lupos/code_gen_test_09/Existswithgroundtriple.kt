...
public class Existswithgroundtriple {
    ...
    public fun `Exists with ground triple - None - PartitionByIDTwiceAllCollations - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
    ...
    public fun `Exists with ground triple - None - PartitionByKeyAllCollations - true`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
    ...
    public fun `Exists with ground triple - None - PartitionByKeyAllCollations - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
    ...
    public fun `Exists with ground triple - None - Simple - true`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
    ...
    public fun `Exists with ground triple - None - Simple - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.None
    ...
    public fun `Exists with ground triple - Thread - PartitionByIDTwiceAllCollations - true`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
    ...
    public fun `Exists with ground triple - Thread - PartitionByIDTwiceAllCollations - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.Thread
    ...
    public fun `Exists with ground triple - Thread - PartitionByKeyAllCollations - true`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.Thread
    ...
    public fun `Exists with ground triple - Thread - PartitionByKeyAllCollations - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.Thread
    ...
    public fun `Exists with ground triple - Thread - Simple - true`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.Thread
    ...
    public fun `Exists with ground triple - Thread - Simple - false`() {
        var instance = Luposdate3000Instance()
        try {
            instance.LUPOS_BUFFER_SIZE = 128
            instance.LUPOS_PARTITION_MODE = EPartitionModeExt.Thread
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - None`() {
        simulatorHelper(
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - false - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - false - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - false - Centralized - true - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - false - Centralized - false - None`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - true - Process`() {
        simulatorHelper(
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - true - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - true - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - false - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - false - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - true - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - true - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - true - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - true - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - false - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - false - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - false - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - false - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - true - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - true - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - true - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - true - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - false - Centralized - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - false - Centralized - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - false - Routing - true - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - false - Routing - false - Process`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByIDTwiceAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - false - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - PartitionByKeyAllCollations - false - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "PartitionByKeyAllCollations",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - false - Centralized - true - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
    ...
    @Ignore // Reason: >using not implemented feature<
    @Test
    public fun `Exists with ground triple - in simulator - Simple - false - Centralized - false - Thread`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test2.json",
            mutableMapOf(
                "predefinedPartitionScheme" to "Simple",
