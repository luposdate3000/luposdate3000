        ...
        try {
            ...
            when (node) {
                ...
                is LOPGraphOperation -> {
                    SanityCheck.check(
                        { /*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_optimizer_physical/src/commonMain/kotlin/lupos/optimizer/physical/PhysicalOptimizerNaive.kt:133"/*SOURCE_FILE_END*/ },
