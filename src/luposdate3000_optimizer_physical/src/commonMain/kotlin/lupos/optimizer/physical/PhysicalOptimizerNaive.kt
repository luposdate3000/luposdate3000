        ...
        try {
            ...
            when (node) {
                ...
                is LOPGraphOperation -> {
                    ...
                    SanityCheck.check(
                        { /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_optimizer_physical/src/commonMain/kotlin/lupos/optimizer/physical/PhysicalOptimizerNaive.kt:135"/*SOURCE_FILE_END*/ },
