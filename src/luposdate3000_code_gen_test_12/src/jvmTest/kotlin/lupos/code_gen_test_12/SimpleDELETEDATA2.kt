...
public class SimpleDELETEDATA2 {
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - true`() {
        simulatorHelper(
            MySimulatorConfig(
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByIDTwiceAllCollations - true - Centralized - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByIDTwiceAllCollations - true - Routing - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByIDTwiceAllCollations - true - Routing - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByIDTwiceAllCollations - false - Centralized - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByIDTwiceAllCollations - false - Routing - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByIDTwiceAllCollations - false - Routing - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByIDTwiceAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByKeyAllCollations - true - Centralized - true`() {
        simulatorHelper(
            MySimulatorConfig(
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByKeyAllCollations - true - Centralized - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByKeyAllCollations - true - Routing - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByKeyAllCollations - true - Routing - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = true,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByKeyAllCollations - false - Centralized - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByKeyAllCollations - false - Centralized - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByKeyAllCollations - false - Routing - true`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = false,
    ...
    @Ignore // Reason: >Bug<
    @Test
    public fun `Simple DELETE DATA 2 - in simulator - PartitionByKeyAllCollations - false - Routing - false`() {
        simulatorHelper(
            MySimulatorConfig(
                predefinedPartitionScheme = EPredefinedPartitionSchemesExt.PartitionByKeyAllCollations,
                mergeLocalOperatorgraphs = false,
