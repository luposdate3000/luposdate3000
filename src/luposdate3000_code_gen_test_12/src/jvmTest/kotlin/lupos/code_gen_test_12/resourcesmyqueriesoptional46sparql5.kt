...
public class resourcesmyqueriesoptional46sparql5 {
    ...
    @Test(timeout = 2000)
    public fun `resourcesmyqueriesoptional46sparql5 - None - PartitionByID_1_AllCollations - false`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
    ...
    @Test(timeout = 2000)
    public fun `resourcesmyqueriesoptional46sparql5 - None - PartitionByID_S_AllCollations - true`() {
      var instance = Luposdate3000Instance()
      try{
        instance.LUPOS_BUFFER_SIZE = 128
        instance.LUPOS_PARTITION_MODE=EPartitionModeExt.None
