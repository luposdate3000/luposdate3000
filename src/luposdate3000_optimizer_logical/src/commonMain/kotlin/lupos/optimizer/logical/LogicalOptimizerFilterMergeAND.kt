        ...
        if (node is LOPFilter) {
            ...
            if (child is LOPFilter) {
                if (node.dontSplitFilter == 0 && child.dontSplitFilter == 0) {
                    ...
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_optimizer_logical/src/commonMain/kotlin/lupos/optimizer/logical/LogicalOptimizerFilterMergeAND.kt:40"/*SOURCE_FILE_END*/ }, { node.dontSplitFilter == 0 || child.dontSplitFilter == 0 })
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_optimizer_logical/src/commonMain/kotlin/lupos/optimizer/logical/LogicalOptimizerFilterMergeAND.kt:41"/*SOURCE_FILE_END*/ }, { node.dontSplitFilter == 1 || child.dontSplitFilter == 1 })
                    val a: AOPBase
                    val b: AOPBase
                    ...
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_optimizer_logical/src/commonMain/kotlin/lupos/optimizer/logical/LogicalOptimizerFilterMergeAND.kt:51"/*SOURCE_FILE_END*/ }, { b is AOPOr })
                    val c = b.getChildren()[0] as AOPBase
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_optimizer_logical/src/commonMain/kotlin/lupos/optimizer/logical/LogicalOptimizerFilterMergeAND.kt:53"/*SOURCE_FILE_END*/ }, { c is AOPAnd })
                    val d = c.getChildren()[1] as AOPBase
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_optimizer_logical/src/commonMain/kotlin/lupos/optimizer/logical/LogicalOptimizerFilterMergeAND.kt:55"/*SOURCE_FILE_END*/ }, { d is AOPBuildInCallCOALESCE })
