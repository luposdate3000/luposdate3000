...
public class LogicalOptimizerML public constructor(query: Query, joinOrder: Int) : OptimizerCompoundBase(query, EOptimizerIDExt.LogicalOptimizerID, "LogicalOptimizer") {
...
// join order must stant alone otherwise there are lots of recalulations
            LogicalOptimizerJoinOrderML(query, joinOrder) //
        ),
        arrayOf(
