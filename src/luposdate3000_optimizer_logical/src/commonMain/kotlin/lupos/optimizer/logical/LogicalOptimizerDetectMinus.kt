                    ...
                    searchForOptionalJoin(node, variableName) { p, i ->
                        ...
                        if (c is LOPFilter && !c.getProvidedVariableNames().containsAll(c.getChildren()[1].getRequiredVariableNamesRecoursive())) {
                            ...
                            if (b.getProvidedVariableNames().containsAll(a.getProvidedVariableNames())) {
                                ...
                                SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_optimizer_logical/src/commonMain/kotlin/lupos/optimizer/logical/LogicalOptimizerDetectMinus.kt:59"/*SOURCE_FILE_END*/ }, { c is LOPSubGroup || c is LOPFilter })
