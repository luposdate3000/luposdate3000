        ...
        for (dictType in 0 until EDictionaryTypeExt.values_size) {
            ...
            fun testGetValueFail(key: DictionaryValueType) {
                ...
                try {
                    ...
                    // e.myPrintStackTrace(/*SOURCE_FILE_START*/"/src/luposdate3000/src/luposdate3000_launch_test_dictionary/src/commonMain/kotlin/lupos/launch/test_dictionary/MainFunc.kt:235"/*SOURCE_FILE_END*/ ) this is handled correctly
                    flag = false
                }
