...
internal object NodeLeaf {
    ...
    internal inline fun initializeWith(node: ByteArray, iterator: TripleIterator) {
        SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_triple_store_id_triple/src/commonMain/kotlin/lupos/triple_store_id_triple/index_IDTriple/NodeLeaf.kt:86"/*SOURCE_FILE_END*/ }, { iterator.hasNext() })
        var writtenTriples: MutableList<DictionaryValueType>? = null
        SanityCheck(
            { /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_triple_store_id_triple/src/commonMain/kotlin/lupos/triple_store_id_triple/index_IDTriple/NodeLeaf.kt:89"/*SOURCE_FILE_END*/ },
            {
        ...
        while (iterator.hasNext() && offset <= offsetEnd) {
            ...
            SanityCheck(
                { /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_triple_store_id_triple/src/commonMain/kotlin/lupos/triple_store_id_triple/index_IDTriple/NodeLeaf.kt:101"/*SOURCE_FILE_END*/ },
                {
        ...
        SanityCheck(
            { /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_triple_store_id_triple/src/commonMain/kotlin/lupos/triple_store_id_triple/index_IDTriple/NodeLeaf.kt:114"/*SOURCE_FILE_END*/ },
            {
                ...
                while (remaining > 0) {
                    ...
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_triple_store_id_triple/src/commonMain/kotlin/lupos/triple_store_id_triple/index_IDTriple/NodeLeaf.kt:128"/*SOURCE_FILE_END*/ }, { value0 == writtenTriples!![i * 3] })
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_triple_store_id_triple/src/commonMain/kotlin/lupos/triple_store_id_triple/index_IDTriple/NodeLeaf.kt:129"/*SOURCE_FILE_END*/ }, { value1 == writtenTriples!![i * 3 + 1] })
                    SanityCheck.check({ /*SOURCE_FILE_START*/"D:/ideaprojects/luposdate3000/src/luposdate3000_triple_store_id_triple/src/commonMain/kotlin/lupos/triple_store_id_triple/index_IDTriple/NodeLeaf.kt:130"/*SOURCE_FILE_END*/ }, { value2 == writtenTriples!![i * 3 + 2] })
                    remaining--
                    i++
                }
            }
