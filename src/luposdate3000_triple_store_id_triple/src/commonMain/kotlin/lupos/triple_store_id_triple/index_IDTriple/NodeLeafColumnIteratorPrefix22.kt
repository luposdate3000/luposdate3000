...
internal class NodeLeafColumnIteratorPrefix22(node: BufferManagerPageWrapper, nodeid: Int, prefix: DictionaryValueTypeArray, lock: MyThreadReadWriteLock, nodeManager: NodeManager, timeout: Long) : NodeLeafColumnIteratorPrefix(node, nodeid, prefix, lock, nodeManager, timeout) {
    @JvmField
