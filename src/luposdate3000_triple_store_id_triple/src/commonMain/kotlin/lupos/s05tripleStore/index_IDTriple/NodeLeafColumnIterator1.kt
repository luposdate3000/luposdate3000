...
internal class NodeLeafColumnIterator1(node: BufferManagerPage, nodeid: Int, lock: MyReadWriteLock, nodeManager: NodeManager) : NodeLeafColumnIterator(node, nodeid, lock, nodeManager) {
    @JvmField
    var value = 0
