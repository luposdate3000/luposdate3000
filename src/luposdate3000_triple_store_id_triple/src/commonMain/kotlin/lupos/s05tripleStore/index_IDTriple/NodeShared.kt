...
internal object NodeShared {
    ...
    internal inline fun setNodeType(node: BufferManagerPage, type: Int) {
        node.writeInt4(0, type)
    }

    @Suppress("NOTHING_TO_INLINE")
    internal inline fun getNodeType(node: BufferManagerPage): Int {
        return node.readInt4(0)
    }

    @Suppress("NOTHING_TO_INLINE")
    internal inline fun setNextNode(node: BufferManagerPage, nextNode: Int) {
        node.writeInt4(8, nextNode)
    }

    @Suppress("NOTHING_TO_INLINE")
    internal inline fun getNextNode(node: BufferManagerPage): Int {
        return node.readInt4(8)
    }

    @Suppress("NOTHING_TO_INLINE")
    internal inline fun setTripleCount(node: BufferManagerPage, count: Int) {
        node.writeInt4(4, count)
    }

    @Suppress("NOTHING_TO_INLINE")
    internal inline fun getTripleCount(node: BufferManagerPage): Int {
    ...
    @Suppress("NOTHING_TO_INLINE")
    internal inline fun readTriple000(node: BufferManagerPage, offset: Int): Int {
        val header = node.readInt1(offset)
    ...
    internal inline fun readTriple111(node: BufferManagerPage, offset: Int, d0: Int, d1: Int, d2: Int, crossinline action: (d0: Int, d1: Int, d2: Int) -> Unit): Int {
        val header = node.readInt1(offset)
        var localOff = offset + 1
        decodeTripleHeader(header) { counter0, counter1, counter2 ->
    ...
    internal inline fun readTriple010(node: BufferManagerPage, offset: Int, d1: Int, crossinline action: (d1: Int) -> Unit): Int {
        val header = node.readInt1(offset)
        var localOff = offset + 1
        decodeTripleHeader(header) { counter0, counter1, counter2 ->
            localOff += counter0
    ...
    internal inline fun readTriple001(node: BufferManagerPage, offset: Int, d2: Int, crossinline action: (d2: Int) -> Unit): Int {
        val header = node.readInt1(offset)
        var localOff = offset + 1
        decodeTripleHeader(header) { counter0, counter1, counter2 ->
    ...
    internal inline fun readTriple100(node: BufferManagerPage, offset: Int, d0: Int, crossinline action: (d0: Int) -> Unit): Int {
        val header = node.readInt1(offset)
        var localOff = offset + 1
        decodeTripleHeader(header) { counter0, counter1, counter2 ->
            val v0 = d0 xor node.readIntX(localOff, counter0)
    ...
    internal inline fun readTriple110(node: BufferManagerPage, offset: Int, d0: Int, d1: Int, crossinline action: (d0: Int, d1: Int) -> Unit): Int {
        val header = node.readInt1(offset)
        var localOff = offset + 1
        decodeTripleHeader(header) { counter0, counter1, counter2 ->
            val v0 = d0 xor node.readIntX(localOff, counter0)
    ...
    internal inline fun readTriple101(node: BufferManagerPage, offset: Int, d0: Int, d2: Int, crossinline action: (d0: Int, d2: Int) -> Unit): Int {
        val header = node.readInt1(offset)
        var localOff = offset + 1
        decodeTripleHeader(header) { counter0, counter1, counter2 ->
            val v0 = d0 xor node.readIntX(localOff, counter0)
    ...
    @Suppress("NOTHING_TO_INLINE")
    internal inline fun writeTriple(node: BufferManagerPage, offset: Int, l: IntArray, d: IntArray): Int {
        val b0 = l[0] xor d[0]
        val b1 = l[1] xor d[1]
        val b2 = l[2] xor d[2]
