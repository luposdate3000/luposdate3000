...
public class resourcessp2bq1sparql973 {
    ...
    internal val inputDataFile = arrayOf(
        "src/jvmTest/resources/resourcessp2bq1sparql973.input",
    )
    ...
    @Test
    public fun `resourcessp2bq1sparql973 - in simulator - PartitionByID_2_AllCollations - Routing - true - Process - RPL_Fast`() {
        simulatorHelper(
    ...
    @Test
    public fun `resourcessp2bq1sparql973 - in simulator - PartitionByID_O_AllCollations - Centralized - false - Process - RPL`() {
        simulatorHelper(
            "../luposdate3000_simulator_iot/src/jvmTest/resources/autoIntegrationTest/test1.json",
            mutableMapOf(
