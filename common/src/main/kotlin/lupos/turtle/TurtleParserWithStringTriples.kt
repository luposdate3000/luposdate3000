    ...
    fun BooleanLiteral():String {
        ...
        when {
            t17.image == "true" -> {
                ...
                if((token as POSSIBLE_KEYWORD).original_image!="true"){ throw UnexpectedToken(token, arrayOf("true"), ltit);}; return "\"true\"^^<" + xsd_boolean + ">";
            }
            t17.image == "false" -> {
                token = ltit.nextToken()
                ...
                if((token as POSSIBLE_KEYWORD).original_image!="false"){ throw UnexpectedToken(token, arrayOf("false"), ltit);}; return "\"false\"^^<" + xsd_boolean + ">";
            }
