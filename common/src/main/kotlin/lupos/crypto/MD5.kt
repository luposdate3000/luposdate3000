...
object MD5 {
    ...
    fun compute(messageIn: String): String {
        val message = messageIn.encodeToByteArray()
        ...
        for (b in md5) sb.append(b.toString(16))
        return sb.toString()
    }
}
