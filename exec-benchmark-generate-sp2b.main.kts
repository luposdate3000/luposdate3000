...
val targetBaseFolder = "${Platform.getEnv("LUPOS_BENCHMARK_HOME", "${Platform.getPathSeparator()}mnt")!!}${Platform.getPathSeparator()}luposdate-testdata${Platform.getPathSeparator()}sp2b"
