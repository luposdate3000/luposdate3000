...
project.buildDir = file("build/build_jvm_S00LaunchGenerateTests_S00SanityChecksOn_S00ResultFlowFast_S00ExecutionSequential_S00TraceOff_S01Heap_S03DictionaryIntArray_S12Dummy_S14ServerNone_jvmS14ClientKtorTarget_S15Distributed")
dependencies {
