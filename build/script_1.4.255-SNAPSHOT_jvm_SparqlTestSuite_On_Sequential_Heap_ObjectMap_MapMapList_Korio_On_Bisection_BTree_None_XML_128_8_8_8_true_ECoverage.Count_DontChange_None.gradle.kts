...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_ObjectMap_MapMapList_Korio_On_Bisection_BTree_None_XML_128_8_8_8_true_ECoverage.Count_DontChange_None")
dependencies {
