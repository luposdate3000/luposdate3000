...
project.buildDir = file("build/build_jvm_commonS00LaunchGenerateTestsMain_commonS00ExecutionSequentialMain_commonS00TraceOnMain_jvmS01BufferRandomAccessMain_commonS12DummyMain_jvmS14ServerKorioMain_commonS14ClientNoneMain")
dependencies {
