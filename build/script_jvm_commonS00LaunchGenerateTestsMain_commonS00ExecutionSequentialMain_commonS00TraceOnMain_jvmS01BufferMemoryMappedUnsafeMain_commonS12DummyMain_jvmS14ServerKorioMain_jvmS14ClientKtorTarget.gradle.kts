...
project.buildDir = file("build/build_jvm_commonS00LaunchGenerateTestsMain_commonS00ExecutionSequentialMain_commonS00TraceOnMain_jvmS01BufferMemoryMappedUnsafeMain_commonS12DummyMain_jvmS14ServerKorioMain_jvmS14ClientKtorTarget")
dependencies {
...
sourceSets["main"].java.srcDir("src/jvmS01BufferMemoryMappedUnsafeMain/kotlin")
sourceSets["main"].java.srcDir("src/jvmS01BufferUnsafeHelperMain/kotlin")
sourceSets["main"].java.srcDir("src/jvmS01BufferUnsafeMain/kotlin")
