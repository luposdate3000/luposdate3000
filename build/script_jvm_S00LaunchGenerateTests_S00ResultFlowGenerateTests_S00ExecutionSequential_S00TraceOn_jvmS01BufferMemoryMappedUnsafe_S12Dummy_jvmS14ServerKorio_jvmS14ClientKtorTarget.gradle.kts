...
project.buildDir = file("build/build_jvm_S00LaunchGenerateTests_S00ResultFlowGenerateTests_S00ExecutionSequential_S00TraceOn_jvmS01BufferMemoryMappedUnsafe_S12Dummy_jvmS14ServerKorio_jvmS14ClientKtorTarget")
dependencies {
