...
project.buildDir = file("build/build_jvm_commonS00LaunchBinaryTestsMain_commonS00ExecutionSequentialMain_commonS00TraceOffMain_commonS01BufferMainmemoryMain_jvmS12DummyMain_jvmS14ServerKorioMain_jvmS14ClientKorioMain_commonS15DistributedMain")
dependencies {
