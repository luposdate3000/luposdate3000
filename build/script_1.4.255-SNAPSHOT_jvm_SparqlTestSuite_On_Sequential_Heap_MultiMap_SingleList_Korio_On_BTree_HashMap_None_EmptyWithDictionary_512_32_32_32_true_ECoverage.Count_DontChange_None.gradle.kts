...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_MultiMap_SingleList_Korio_On_BTree_HashMap_None_EmptyWithDictionary_512_32_32_32_true_ECoverage.Count_DontChange_None")
dependencies {
