...
project.buildDir = file("build/build_jvm_commonS00LaunchGenerateTestsMain_commonS00ExecutionSequentialMain_commonS00TraceOnMain_commonS01BufferMainmemoryMain_jvmS12DummyMain_jvmS14ServerKorioMain_jvmS14ClientKorioMain")
dependencies {
