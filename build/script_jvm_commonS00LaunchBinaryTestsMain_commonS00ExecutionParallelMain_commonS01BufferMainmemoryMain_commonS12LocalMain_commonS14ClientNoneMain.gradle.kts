...
project.buildDir = file("build/build_jvm_commonS00LaunchBinaryTestsMain_commonS00ExecutionParallelMain_commonS01BufferMainmemoryMain_commonS12LocalMain_commonS14ClientNoneMain")
dependencies {
