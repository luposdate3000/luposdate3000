...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_MultiMap_BPlusTree_Dummy_Korio_None_Local_On_BTree_BTree_Count_Empty_8196_1024_512_512_true_ECoverage.Count_On")
dependencies {
