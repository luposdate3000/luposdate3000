...
project.buildDir = file("build/build_jvm_S00LaunchEndpoint_S00SanityChecksOn_S00ResultFlowFast_S00ExecutionSequential_S00TraceOff_S01Heap_S03DictionaryIntArray_S12Local")
dependencies {
