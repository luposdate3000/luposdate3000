...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_MultiMap_BPlusTree_Korio_On_BTree_BTree_None_Empty_1024_64_64_64_1048576_true_ECoverage.Count_DontChange_None_2000_Off")
dependencies {
