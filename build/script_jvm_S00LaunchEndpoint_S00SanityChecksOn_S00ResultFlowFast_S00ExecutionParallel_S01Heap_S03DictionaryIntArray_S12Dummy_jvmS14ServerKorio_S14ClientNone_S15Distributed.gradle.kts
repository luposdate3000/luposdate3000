...
project.buildDir = file("build/build_jvm_S00LaunchEndpoint_S00SanityChecksOn_S00ResultFlowFast_S00ExecutionParallel_S01Heap_S03DictionaryIntArray_S12Dummy_jvmS14ServerKorio_S14ClientNone_S15Distributed")
dependencies {
