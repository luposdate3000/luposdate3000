...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_ObjectMap_MapMapList_None_On_Bisection_Bisection_None_XML_256_16_16_16_1024_false_ECoverage.Count_DontChange_Ktor_-1_On")
dependencies {
