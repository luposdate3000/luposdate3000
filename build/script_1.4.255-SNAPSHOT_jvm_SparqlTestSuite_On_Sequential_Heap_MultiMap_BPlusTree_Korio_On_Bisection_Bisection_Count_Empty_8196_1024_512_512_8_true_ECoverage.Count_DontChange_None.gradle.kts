...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_MultiMap_BPlusTree_Korio_On_Bisection_Bisection_Count_Empty_8196_1024_512_512_8_true_ECoverage.Count_DontChange_None")
dependencies {
