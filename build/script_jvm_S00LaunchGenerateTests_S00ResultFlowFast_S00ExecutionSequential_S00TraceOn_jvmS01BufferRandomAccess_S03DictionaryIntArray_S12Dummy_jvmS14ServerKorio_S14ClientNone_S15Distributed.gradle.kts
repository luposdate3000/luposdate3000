...
project.buildDir = file("build/build_jvm_S00LaunchGenerateTests_S00ResultFlowFast_S00ExecutionSequential_S00TraceOn_jvmS01BufferRandomAccess_S03DictionaryIntArray_S12Dummy_jvmS14ServerKorio_S14ClientNone_S15Distributed")
dependencies {
