...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_MultiMap_BPlusTree_Korio_On_BTree_BTree_None_Empty_8196_1024_512_512_1048576_true_ECoverage.Disabled_Off_None_-1_Off_On")
dependencies {
