...
project.buildDir = file("build/build_jvm_S00LaunchGenerateTests_S00SanityChecksOn_S00ResultFlowFast_S00ExecutionSequential_S00TraceOn_jvmS01BufferRandomAccess_S03DictionaryNone")
dependencies {
