...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_ObjectMap_MapMapList_Korio_On_Bisection_BTree_None_XML_1024_64_64_64_true_ECoverage.VeryVerbose_Off_None")
dependencies {
