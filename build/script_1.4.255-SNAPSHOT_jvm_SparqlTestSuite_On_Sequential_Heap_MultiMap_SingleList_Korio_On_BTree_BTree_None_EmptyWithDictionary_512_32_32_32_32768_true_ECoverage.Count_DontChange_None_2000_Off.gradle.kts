...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_MultiMap_SingleList_Korio_On_BTree_BTree_None_EmptyWithDictionary_512_32_32_32_32768_true_ECoverage.Count_DontChange_None_2000_Off")
dependencies {
