...
project.buildDir = file("build/build_jvm_commonS00LaunchGenerateTestsMain_commonS00ExecutionSequentialMain_commonS00TraceOffMain_commonS01HeapMain_jvmS12DummyMain_commonS14ServerNoneMain_jvmS14ClientKtorTarget")
dependencies {
