...
project.buildDir = file("build/build_jvm_commonS00LaunchBinaryTestsMain_commonS00ExecutionParallelMain_jvmS01BufferUnsafeMain_commonS12LocalMain")
dependencies {
...
sourceSets["main"].java.srcDir("src/commonS01BufferMainDiskbasedMain/kotlin")
