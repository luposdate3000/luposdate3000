...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_Benchmark_Off_Fast_Sequential_Heap_MultiMap_BPlusTree_Dummy_Korio_None_Local_Off_BTree_BTree_None_Empty_8196_1024_512")
dependencies {
