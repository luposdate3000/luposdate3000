...
project.buildDir = file("build/build_jvm_commonS00LaunchGenerateTestsMain_commonS00ExecutionSequentialMain_commonS00TraceOnMain_commonS01BufferDiskbasedMain_jvmS12DummyMain_jvmS14ServerKorioMain")
dependencies {
