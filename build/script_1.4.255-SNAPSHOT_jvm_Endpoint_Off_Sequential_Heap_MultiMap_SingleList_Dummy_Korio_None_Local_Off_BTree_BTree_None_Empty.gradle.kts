...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_Endpoint_Off_Sequential_Heap_MultiMap_SingleList_Dummy_Korio_None_Local_Off_BTree_BTree_None_Empty")
dependencies {
