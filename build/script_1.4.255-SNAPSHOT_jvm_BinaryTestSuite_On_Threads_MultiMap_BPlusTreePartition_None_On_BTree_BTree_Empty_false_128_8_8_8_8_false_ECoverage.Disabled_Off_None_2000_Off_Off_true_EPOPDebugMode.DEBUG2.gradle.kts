...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_BinaryTestSuite_On_Threads_MultiMap_BPlusTreePartition_None_On_BTree_BTree_Empty_false_128_8_8_8_8_false_ECoverage.Disabled_Off_None_2000_Off_Off_true_EPOPDebugMode.DEBUG2")
dependencies {
...
sourceSets["main"].java.srcDir("src.generated/commonS00LaunchBinaryTestSuiteMain/kotlin")
