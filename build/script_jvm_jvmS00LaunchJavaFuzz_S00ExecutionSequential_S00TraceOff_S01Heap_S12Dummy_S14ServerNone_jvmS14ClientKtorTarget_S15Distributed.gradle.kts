...
project.buildDir = file("build/build_jvm_jvmS00LaunchJavaFuzz_S00ExecutionSequential_S00TraceOff_S01Heap_S12Dummy_S14ServerNone_jvmS14ClientKtorTarget_S15Distributed")
dependencies {
