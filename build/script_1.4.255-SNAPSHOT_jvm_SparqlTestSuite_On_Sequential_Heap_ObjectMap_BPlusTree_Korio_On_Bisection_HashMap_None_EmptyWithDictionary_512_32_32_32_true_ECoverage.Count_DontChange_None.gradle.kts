...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_ObjectMap_BPlusTree_Korio_On_Bisection_HashMap_None_EmptyWithDictionary_512_32_32_32_true_ECoverage.Count_DontChange_None")
dependencies {
