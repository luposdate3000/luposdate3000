...
kotlin {
    project.buildDir = file("build/build_linuxX64_S00LaunchEndpoint_S00SanityChecksOn_S00ExecutionSequential_S00TraceOff_S03DictionaryIntArray_S12Dummy_nativeS14ClientKtorTarget_S15Distributed")
    linuxX64("linuxX64") {
