...
project.buildDir = file("build/build_1.4.255-SNAPSHOT_jvm_SparqlTestSuite_On_Sequential_Heap_MultiMap_SingleList_None_On_BTree_Bisection_None_Empty_256_16_16_16_false_ECoverage.Count_DontChange_Ktor")
dependencies {
